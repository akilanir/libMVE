...
/* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorBufferWithStartEndObservable.class */
public final class OperatorBufferWithStartEndObservable<T, TOpening, TClosing> implements Observable.Operator<List<T>, T> {
    ...
    /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorBufferWithStartEndObservable$BufferingSubscriber.class */
