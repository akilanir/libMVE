...
/* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OnSubscribeToObservableFuture.class */
public final class OnSubscribeToObservableFuture {
    private OnSubscribeToObservableFuture() {
        throw new IllegalStateException("No instances!");
    }

    /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OnSubscribeToObservableFuture$ToObservableFuture.class */
    static class ToObservableFuture<T> implements Observable.OnSubscribe<T> {
        ...
        public void call(Subscriber<? super T> subscriber) {
            ...
            try {
                ...
                subscriber.onNext((Object) (this.unit == null ? this.that.get() : this.that.get(this.time, this.unit)));
