...
/* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorGroupBy.class */
public class OperatorGroupBy<T, K, R> implements Observable.Operator<GroupedObservable<K, R>, T> {
    ...
    /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorGroupBy$GroupBySubscriber.class */
    static final class GroupBySubscriber<K, T, R> extends Subscriber<T> {
        ...
        volatile int wipForUnsubscribe = TERMINATED_WITH_COMPLETED;
        ...
        /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorGroupBy$GroupBySubscriber$GroupState.class */
        ...
        public void onCompleted() {
            if (TERMINATED_UPDATER.compareAndSet(this, UNTERMINATED, TERMINATED_WITH_COMPLETED)) {
                ...
                if (this.groups.isEmpty() && COMPLETION_EMITTED_UPDATER.compareAndSet(this, UNTERMINATED, TERMINATED_WITH_COMPLETED)) {
        ...
        private void requestMoreIfNecessary() {
            if (REQUESTED.get(this) == 0 && this.terminated == 0) {
                long toRequest = 1024 - BUFFERED_COUNT.get(this);
        ...
        private void completeInner() {
            if (WIP_FOR_UNSUBSCRIBE_UPDATER.decrementAndGet(this) == 0) {
                unsubscribe();
            } else if (this.groups.isEmpty() && this.terminated == TERMINATED_WITH_COMPLETED && COMPLETION_EMITTED_UPDATER.compareAndSet(this, UNTERMINATED, TERMINATED_WITH_COMPLETED)) {
                this.child.onCompleted();
            }
        }
    }
