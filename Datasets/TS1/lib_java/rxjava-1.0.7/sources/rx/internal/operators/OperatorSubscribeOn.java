...
/* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorSubscribeOn.class */
public class OperatorSubscribeOn<T> implements Observable.Operator<T, Observable<T>> {
    ...
    /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorSubscribeOn$1.class */
    class AnonymousClass1 extends Subscriber<Observable<T>> {
        ...
        /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorSubscribeOn$1$1.class */
        class C00151 implements Action0 {
            final /* synthetic */ Observable val$o;

            C00151(Observable observable) {
        ...
        public void onNext(Observable<T> o) {
            this.val$inner.schedule(new C00151(o));
        }
    }
}
