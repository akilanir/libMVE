...
@Experimental
/* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorTakeUntilPredicate.class */
public final class OperatorTakeUntilPredicate<T> implements Observable.Operator<T, T> {
    private final Func1<? super T, Boolean> stopPredicate;

    /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorTakeUntilPredicate$ParentSubscriber.class */
    private final class ParentSubscriber extends Subscriber<T> {
        ...
        public void onNext(T args) {
            this.child.onNext(args);
            try {
                boolean stop = ((Boolean) OperatorTakeUntilPredicate.this.stopPredicate.call(args)).booleanValue();
                if (stop) {
                    this.done = true;
