...
/* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorDematerialize.class */
public final class OperatorDematerialize<T> implements Observable.Operator<T, Notification<T>> {

    /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorDematerialize$Holder.class */
    ...
    /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorDematerialize$2.class */
