...
/* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorBufferWithSingleObservable.class */
public final class OperatorBufferWithSingleObservable<T, TClosing> implements Observable.Operator<List<T>, T> {
    ...
    /* loaded from: rxjava-1.0.7.jar:rx/internal/operators/OperatorBufferWithSingleObservable$BufferingSubscriber.class */
