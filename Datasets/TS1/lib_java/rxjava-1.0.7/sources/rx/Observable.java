...
/* loaded from: rxjava-1.0.7.jar:rx/Observable.class */
public class Observable<T> {
    ...
    /* loaded from: rxjava-1.0.7.jar:rx/Observable$OnSubscribe.class */
    public interface OnSubscribe<T> extends Action1<Subscriber<? super T>> {
    }

    /* loaded from: rxjava-1.0.7.jar:rx/Observable$Operator.class */
    public interface Operator<R, T> extends Func1<Subscriber<? super R>, Subscriber<? super T>> {
    }

    /* loaded from: rxjava-1.0.7.jar:rx/Observable$Transformer.class */
    ...
    public final Observable<Integer> count() {
        return reduce(0, new Func2<Integer, T, Integer>() { // from class: rx.Observable.7
            @Override // rx.functions.Func2
            public /* bridge */ /* synthetic */ Integer call(Integer num, Object x1) {
                return call2(num, (Integer) x1);
            }

            /* renamed from: call, reason: avoid collision after fix types in other method */
            public final Integer call2(Integer t1, T t2) {
                return Integer.valueOf(t1.intValue() + 1);
            }
        });
    }

    public final Observable<Long> countLong() {
        return reduce(0L, new Func2<Long, T, Long>() { // from class: rx.Observable.8
            @Override // rx.functions.Func2
            public /* bridge */ /* synthetic */ Long call(Long l, Object x1) {
                return call2(l, (Long) x1);
            }

            /* renamed from: call, reason: avoid collision after fix types in other method */
            public final Long call2(Long t1, T t2) {
                return Long.valueOf(t1.longValue() + 1);
            }
        });
    }
    ...
    public final Observable<T> distinct() {
        return (Observable<T>) lift(new OperatorDistinct(UtilityFunctions.identity()));
    }
    ...
    public final Observable<T> distinctUntilChanged() {
        return (Observable<T>) lift(new OperatorDistinctUntilChanged(UtilityFunctions.identity()));
    }
    ...
    public final Observable<T> doOnTerminate(final Action0 action0) {
        return (Observable<T>) lift(new OperatorDoOnEach(new Observer<T>() { // from class: rx.Observable.13
            @Override // rx.Observer
            public final void onCompleted() {
                action0.call();
            }
    ...
    public final <R> Observable<R> ofType(final Class<R> klass) {
        return filter(new Func1<T, Boolean>() { // from class: rx.Observable.14
            @Override // rx.functions.Func1
            public /* bridge */ /* synthetic */ Boolean call(Object x0) {
                return call((AnonymousClass14) x0);
            }
    ...
    public final Observable<T> onBackpressureBuffer() {
        return (Observable<T>) lift(new OperatorOnBackpressureBuffer());
    }
    ...
    public final Observable<T> repeatWhen(final Func1<? super Observable<? extends Void>, ? extends Observable<?>> notificationHandler) {
        Func1<? super Observable<? extends Notification<?>>, ? extends Observable<?>> dematerializedNotificationHandler = new Func1<Observable<? extends Notification<?>>, Observable<?>>() { // from class: rx.Observable.16
            @Override // rx.functions.Func1
            public Observable<?> call(Observable<? extends Notification<?>> notifications) {
                return (Observable) notificationHandler.call(notifications.map(new Func1<Notification<?>, Void>() { // from class: rx.Observable.16.1
                    @Override // rx.functions.Func1
                    public Void call(Notification<?> notification) {
                        return null;
                    }
    ...
    public final ConnectableObservable<T> replay() {
        return new OperatorMulticast(this, new Func0<Subject<? super T, ? extends T>>() { // from class: rx.Observable.17
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> selector, final long time, final TimeUnit unit, final Scheduler scheduler) {
        return create(new OnSubscribeMulticastSelector(this, new Func0<Subject<T, T>>() { // from class: rx.Observable.22
            @Override // rx.functions.Func0, java.util.concurrent.Callable
            public final Subject<T, T> call() {
    ...
    public final <R> Observable<R> replay(Func1<? super Observable<T>, ? extends Observable<R>> selector, final Scheduler scheduler) {
        return create(new OnSubscribeMulticastSelector(this, new Func0<Subject<T, T>>() { // from class: rx.Observable.23
            @Override // rx.functions.Func0, java.util.concurrent.Callable
            public final Subject<T, T> call() {
    ...
    public final ConnectableObservable<T> replay(final long time, final TimeUnit unit, final Scheduler scheduler) {
        return new OperatorMulticast(this, new Func0<Subject<? super T, ? extends T>>() { // from class: rx.Observable.27
            @Override // rx.functions.Func0, java.util.concurrent.Callable
            public Subject<? super T, ? extends T> call() {
                return ReplaySubject.createWithTime(time, unit, scheduler);
            }
    ...
    public final ConnectableObservable<T> replay(final Scheduler scheduler) {
        return new OperatorMulticast(this, new Func0<Subject<? super T, ? extends T>>() { // from class: rx.Observable.28
            @Override // rx.functions.Func0, java.util.concurrent.Callable
            public Subject<? super T, ? extends T> call() {
                return OperatorReplay.createScheduledSubject(ReplaySubject.create(), scheduler);
            }
    ...
    public final Observable<T> retryWhen(final Func1<? super Observable<? extends Throwable>, ? extends Observable<?>> notificationHandler) {
        Func1<? super Observable<? extends Notification<?>>, ? extends Observable<?>> dematerializedNotificationHandler = new Func1<Observable<? extends Notification<?>>, Observable<?>>() { // from class: rx.Observable.29
            @Override // rx.functions.Func1
            public Observable<?> call(Observable<? extends Notification<?>> notifications) {
                return (Observable) notificationHandler.call(notifications.map(new Func1<Notification<?>, Throwable>() { // from class: rx.Observable.29.1
                    @Override // rx.functions.Func1
    ...
    public final Observable<T> retryWhen(final Func1<? super Observable<? extends Throwable>, ? extends Observable<?>> notificationHandler, Scheduler scheduler) {
        Func1<? super Observable<? extends Notification<?>>, ? extends Observable<?>> dematerializedNotificationHandler = new Func1<Observable<? extends Notification<?>>, Observable<?>>() { // from class: rx.Observable.30
            @Override // rx.functions.Func1
            public Observable<?> call(Observable<? extends Notification<?>> notifications) {
                return (Observable) notificationHandler.call(notifications.map(new Func1<Notification<?>, Throwable>() { // from class: rx.Observable.30.1
                    @Override // rx.functions.Func1
                    public Throwable call(Notification<?> notification) {
                        return notification.getThrowable();
                    }
    ...
    public final Observable<List<T>> toSortedList() {
        return (Observable<List<T>>) lift(new OperatorToObservableSortedList());
    }

    public final Observable<List<T>> toSortedList(Func2<? super T, ? super T, Integer> func2) {
        return (Observable<List<T>>) lift(new OperatorToObservableSortedList(func2));
    }
    ...
    /* loaded from: rxjava-1.0.7.jar:rx/Observable$NeverObservable.class */
    ...
    /* loaded from: rxjava-1.0.7.jar:rx/Observable$ThrowObservable.class */
