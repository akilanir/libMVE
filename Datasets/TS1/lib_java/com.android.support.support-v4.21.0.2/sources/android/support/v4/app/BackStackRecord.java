...
/* loaded from: com.android.support.support-v4.21.0.2.jar:android/support/v4/app/BackStackRecord.class */
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, Runnable {
    ...
    /* loaded from: com.android.support.support-v4.21.0.2.jar:android/support/v4/app/BackStackRecord$Op.class */
    ...
    private void calculateFragments(SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        while (true) {
            ...
            if (op2 != null) {
                switch (op2.cmd) {
                    case 1:
                        setLastIn(lastInFragments, op2.fragment);
                        break;
                    case 2:
                        Fragment f = op2.fragment;
                        if (this.mManager.mAdded != null) {
                        ...
                        break;
                    case 3:
                        setFirstOut(firstOutFragments, op2.fragment);
                        break;
                    case 4:
                        setFirstOut(firstOutFragments, op2.fragment);
                        break;
            ...
            if (op2 != null) {
                switch (op2.cmd) {
                    ...
                    case 2:
                        if (op2.removed != null) {
                            for (int i = op2.removed.size() - 1; i >= 0; i--) {
                                setLastIn(lastInFragments, op2.removed.get(i));
                            }
                        }
                        setFirstOut(firstOutFragments, op2.fragment);
                        break;
    ...
    private static Object captureExitingViews(Object exitTransition, Fragment outFragment, ArrayList<View> exitingViews, ArrayMap<String, View> namedViews) {
        if (exitTransition != null) {
            exitTransition = FragmentTransitionCompat21.captureExitingViews(exitTransition, outFragment.getView(), exitingViews, namedViews);
        }
    ...
    /* loaded from: com.android.support.support-v4.21.0.2.jar:android/support/v4/app/BackStackRecord$TransitionState.class */
