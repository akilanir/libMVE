...
/* loaded from: com.android.support.support-v4.21.0.2.jar:android/support/v4/widget/ListPopupWindowCompat.class */
public class ListPopupWindowCompat {
    static final ListPopupWindowImpl IMPL;

    /* loaded from: com.android.support.support-v4.21.0.2.jar:android/support/v4/widget/ListPopupWindowCompat$ListPopupWindowImpl.class */
    interface ListPopupWindowImpl {
        View.OnTouchListener createDragToOpenListener(Object obj, View view);
    }

    /* loaded from: com.android.support.support-v4.21.0.2.jar:android/support/v4/widget/ListPopupWindowCompat$BaseListPopupWindowImpl.class */
    ...
    /* loaded from: com.android.support.support-v4.21.0.2.jar:android/support/v4/widget/ListPopupWindowCompat$KitKatListPopupWindowImpl.class */
