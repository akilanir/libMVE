...
/* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/renderer/YAxisRendererRadarChart.class */
        ...
        for (int i = 0; i < limitLines.size(); i++) {
            ...
            if (l.isEnabled()) {
                ...
                for (int j = 0; j < ((RadarData) this.mChart.getData()).getXValCount(); j++) {
                    PointF p = Utils.getPosition(center, r, (sliceangle * j) + this.mChart.getRotationAngle());
                    if (j == 0) {
