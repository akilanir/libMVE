...
/* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/data/filter/Approximator.class */
public class Approximator {
    ...
    /* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/data/filter/Approximator$ApproximatorType.class */
    ...
    public List<Entry> filter(List<Entry> points, double tolerance) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$github$mikephil$charting$data$filter$Approximator$ApproximatorType[this.mType.ordinal()]) {
    ...
    /* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/data/filter/Approximator$1.class */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$github$mikephil$charting$data$filter$Approximator$ApproximatorType = new int[ApproximatorType.values().length];
