...
@SuppressLint({"NewApi"})
/* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/charts/Chart.class */
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    protected void onDraw(Canvas canvas) {
        if (this.mData == null) {
            ...
            boolean hasDescription = !TextUtils.isEmpty(this.mNoDataTextDescription);
            float line1height = hasText ? Utils.calcTextHeight(this.mInfoPaint, this.mNoDataText) : 0.0f;
            float line2height = hasDescription ? Utils.calcTextHeight(this.mInfoPaint, this.mNoDataTextDescription) : 0.0f;
            float lineSpacing = (hasText && hasDescription) ? this.mInfoPaint.getFontSpacing() - line1height : 0.0f;
            float y = ((getHeight() - ((line1height + lineSpacing) + line2height)) / 2.0f) + line1height;
            if (hasText) {
                canvas.drawText(this.mNoDataText, getWidth() / 2, y, this.mInfoPaint);
                if (hasDescription) {
                    y = y + line1height + lineSpacing;
                }
            }
            if (hasDescription) {
                canvas.drawText(this.mNoDataTextDescription, getWidth() / 2, y, this.mInfoPaint);
                return;
            }
            return;
        }
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < this.mIndicesToHighlight.length; i++) {
            ...
            float deltaX = this.mXAxis != null ? this.mXAxis.mAxisRange : (this.mData == null ? 0.0f : this.mData.getXValCount()) - 1.0f;
            if (xIndex <= deltaX && xIndex <= deltaX * this.mAnimator.getPhaseX() && (e = this.mData.getEntryForHighlight(this.mIndicesToHighlight[i])) != null && e.getXIndex() == this.mIndicesToHighlight[i].getXIndex()) {
    ...
    public List<Entry> getEntriesAtIndex(int xIndex) {
        ...
        for (int i = 0; i < this.mData.getDataSetCount(); i++) {
            IDataSet set = this.mData.getDataSetByIndex(i);
    ...
    /* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/charts/Chart$2.class */
    ...
    public boolean saveToGallery(String fileName, int quality) {
        return saveToGallery(fileName, BuildConfig.FLAVOR, "MPAndroidChart-Library Save", Bitmap.CompressFormat.JPEG, quality);
    }
