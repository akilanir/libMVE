...
/* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/charts/PieChart.class */
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    protected float[] getMarkerPosition(Entry e, Highlight highlight) {
        ...
        float x = (float) ((r2 * Math.cos(Math.toRadians(((rotationAngle + this.mAbsoluteAngles[i]) - offset) * this.mAnimator.getPhaseY()))) + center.x);
        float y = (float) ((r2 * Math.sin(Math.toRadians(((rotationAngle + this.mAbsoluteAngles[i]) - offset) * this.mAnimator.getPhaseY()))) + center.y);
