...
/* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/renderer/XAxisRendererHorizontalBarChart.class */
public class XAxisRendererHorizontalBarChart extends XAxisRendererBarChart {
    ...
    protected void drawLabels(Canvas c, float pos, PointF anchor) {
        ...
        while (true) {
            int i2 = i;
            if (i2 <= this.mMaxX) {
                position[1] = (i2 * step) + (i2 * bd.getGroupSpace()) + (bd.getGroupSpace() / 2.0f);
                if (step > 1) {
                ...
                if (this.mViewPortHandler.isInBoundsY(position[1])) {
                    ...
                    drawLabel(c, label, i2, pos, position[1], anchor, labelRotationAngleDegrees);
                }
    ...
    public void renderGridLines(Canvas c) {
        ...
        while (true) {
            int i2 = i;
            if (i2 <= this.mMaxX) {
                position[1] = ((i2 * step) + (i2 * bd.getGroupSpace())) - 0.5f;
                this.mTrans.pointValuesToPixel(position);
                if (this.mViewPortHandler.isInBoundsY(position[1])) {
