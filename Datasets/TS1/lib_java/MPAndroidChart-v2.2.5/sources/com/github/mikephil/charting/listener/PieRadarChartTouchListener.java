...
/* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/listener/PieRadarChartTouchListener.class */
public class PieRadarChartTouchListener extends ChartTouchListener<PieRadarChartBase<?>> {
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        ...
        if (this.mChart instanceof RadarChart) {
            dataSetIndex = Utils.getClosestDataSetIndexByValue(valsAtIndex, distance / ((RadarChart) this.mChart).getFactor(), null);
        }
        if (dataSetIndex < 0) {
            ((PieRadarChartBase) this.mChart).highlightValues(null);
            this.mLastHighlighted = null;
    ...
    /* loaded from: MPAndroidChart-v2.2.5.jar:com/github/mikephil/charting/listener/PieRadarChartTouchListener$AngularVelocitySample.class */
