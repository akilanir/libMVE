...
/* loaded from: com.android.support.appcompat-v7.22.1.1.jar:android/support/v7/internal/widget/TintManager.class */
public final class TintManager {
    ...
    public final ColorStateList getTintList(int resId) {
        ...
        ColorStateList tint = this.mTintLists != null ? this.mTintLists.get(resId) : null;
        if (tint == null) {
    ...
    /* loaded from: com.android.support.appcompat-v7.22.1.1.jar:android/support/v7/internal/widget/TintManager$ColorFilterLruCache.class */
