...
/* loaded from: com.android.support.appcompat-v7.22.1.1.jar:android/support/v7/internal/view/menu/MenuBuilder.class */
public class MenuBuilder implements SupportMenu {
    ...
    /* loaded from: com.android.support.appcompat-v7.22.1.1.jar:android/support/v7/internal/view/menu/MenuBuilder$Callback.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.22.1.1.jar:android/support/v7/internal/view/menu/MenuBuilder$ItemInvoker.class */
    ...
    /* JADX WARN: Type inference failed for: r0v3, types: [android.support.v7.internal.view.menu.MenuItemImpl, android.view.MenuItem, java.lang.Object] */
    private MenuItem addInternal(int group, int id, int categoryOrder, CharSequence title) {
        int ordering = getOrdering(categoryOrder);
        ?? createNewMenuItem = createNewMenuItem(group, id, categoryOrder, ordering, title, this.mDefaultShowAsAction);
    ...
    public void removeGroup(int group) {
        ...
        if (i >= 0) {
            ...
            while (true) {
                int i2 = numRemoved;
                numRemoved++;
                if (i2 >= maxRemovable || this.mItems.get(i).getGroupId() != group) {
                    break;
                } else {
    ...
    /* JADX WARN: Type inference failed for: r0v8, types: [android.support.v7.internal.view.menu.MenuItemImpl, android.view.MenuItem] */
    public MenuItem findItem(int id) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (menuItemImpl.hasSubMenu() && (possibleItem = menuItemImpl.getSubMenu().findItem(id)) != null) {
                return possibleItem;
            }
        }
        return null;
    ...
    public boolean performShortcut(int keyCode, KeyEvent event, int flags) {
        SupportMenuItem findItemWithShortcutForKey = findItemWithShortcutForKey(keyCode, event);
        boolean handled = false;
        if (findItemWithShortcutForKey != null) {
            handled = performItemAction(findItemWithShortcutForKey, flags);
        }
        if ((flags & 2) != 0) {
            close(true);
        }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public boolean performItemAction(MenuItem menuItem, MenuPresenter preferredPresenter, int flags) {
        MenuItemImpl itemImpl = (MenuItemImpl) menuItem;
