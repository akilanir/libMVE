...
/* loaded from: commons-io-1.3.2.jar:org/apache/commons/io/FilenameUtils.class */
public class FilenameUtils {
    ...
    private static String doNormalize(String filename, boolean keepSeparator) {
        ...
        int i3 = prefix + 1;
        while (i3 < size) {
            if (array[i3] == SYSTEM_SEPARATOR && array[i3 - 1] == EXTENSION_SEPARATOR && (i3 == prefix + 1 || array[i3 - 2] == SYSTEM_SEPARATOR)) {
                if (i3 == size - 1) {
        ...
        int i4 = prefix + 2;
        while (i4 < size) {
            if (array[i4] == SYSTEM_SEPARATOR && array[i4 - 1] == EXTENSION_SEPARATOR && array[i4 - 2] == EXTENSION_SEPARATOR && (i4 == prefix + 2 || array[i4 - 3] == SYSTEM_SEPARATOR)) {
                if (i4 == prefix + 2) {
                    return null;
                }
                if (i4 == size - 1) {
