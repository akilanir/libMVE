...
/* loaded from: com.larswerkman.HoloColorPicker.1.5.jar:com/larswerkman/holocolorpicker/SVBar.class */
public class SVBar extends View {
            ...
            case 2:
                if (this.mIsMovingPointer) {
                    if (dimen >= this.mBarPointerHaloRadius && dimen <= this.mBarPointerHaloRadius + this.mBarLength) {
                        ...
                        if (dimen > this.mBarPointerHaloRadius + this.mBarLength) {
    ...
    private void calculateColor(int coord) {
        ...
        if (coord2 > 0 && coord2 < this.mBarLength) {
