...
/* loaded from: com.larswerkman.HoloColorPicker.1.5.jar:com/larswerkman/holocolorpicker/ColorPicker.class */
public class ColorPicker extends View {
    ...
    /* loaded from: com.larswerkman.HoloColorPicker.1.5.jar:com/larswerkman/holocolorpicker/ColorPicker$OnColorChangedListener.class */
    public interface OnColorChangedListener {
        void onColorChanged(int i);
    }

    /* loaded from: com.larswerkman.HoloColorPicker.1.5.jar:com/larswerkman/holocolorpicker/ColorPicker$OnColorSelectedListener.class */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int width;
        int height;
        int intrinsicSize = 2 * (this.mPreferredColorWheelRadius + this.mColorPointerHaloRadius);
