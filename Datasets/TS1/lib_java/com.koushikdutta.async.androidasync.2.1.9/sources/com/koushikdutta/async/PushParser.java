...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser.class */
public class PushParser implements DataCallback {
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser$ParseCallback.class */
    public interface ParseCallback<T> {
        void parsed(T t);
    }

    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser$Waiter.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser$IntWaiter.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser$ByteArrayWaiter.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser$LenByteArrayWaiter.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser$ByteBufferListWaiter.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser$LenByteBufferListWaiter.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser$UntilWaiter.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/PushParser$TapWaiter.class */
    ...
    static Method getTap(TapCallback callback) {
        ...
        Method[] arr$ = callback.getClass().getMethods();
