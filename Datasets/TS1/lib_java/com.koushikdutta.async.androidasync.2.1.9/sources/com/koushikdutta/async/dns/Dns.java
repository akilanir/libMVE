...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/dns/Dns.class */
public class Dns {
    ...
    public static Future<DnsResponse> lookup(AsyncServer server, String host, final boolean multicast, final FutureCallback<DnsResponse> callback) {
        ...
        try {
            ...
            final AsyncDatagramSocket asyncDatagramSocket = dgram;
            ...
            final AsyncDatagramSocket asyncDatagramSocket2 = dgram;
            dgram.setDataCallback(new DataCallback() { // from class: com.koushikdutta.async.dns.Dns.2
                ...
                public void onDataAvailable(DataEmitter emitter, ByteBufferList bb) {
                    try {
                        ...
                        response.source = asyncDatagramSocket2.getRemoteAddress();
                        if (!multicast) {
