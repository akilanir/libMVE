...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/body/MultipartFormDataBody.class */
public class MultipartFormDataBody extends BoundaryEmitter implements AsyncHttpRequestBody<Multimap> {
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/body/MultipartFormDataBody$MultipartCallback.class */
        ...
        while (i$.hasNext()) {
            ...
            c.add(new ContinuationCallback() { // from class: com.koushikdutta.async.http.body.MultipartFormDataBody.5
                ...
                public void onContinue(Continuation continuation, CompletedCallback next) throws Exception {
                    ...
                    if (partLength >= 0) {
                        MultipartFormDataBody.this.written = (int) (r0.written + partLength);
                    }
    ...
    public String getContentType() {
        if (getBoundary() == null) {
            setBoundary("----------------------------" + UUID.randomUUID().toString().replace("-", BuildConfig.FLAVOR));
        }
