...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/spdy/Settings.class */
final class Settings {
    ...
    int getCurrentCwnd(int defaultValue) {
        return (32 & this.set) != 0 ? this.values[CURRENT_CWND] : defaultValue;
    }

    int getDownloadRetransRate(int defaultValue) {
        return (64 & this.set) != 0 ? this.values[DOWNLOAD_RETRANS_RATE] : defaultValue;
    }

    public int getInitialWindowSize(int defaultValue) {
        return (128 & this.set) != 0 ? this.values[7] : defaultValue;
    }
