...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/AsyncHttpResponseImpl.class */
abstract class AsyncHttpResponseImpl extends FilteredDataEmitter implements AsyncSocket, AsyncHttpResponse, AsyncHttpClientMiddleware.ResponseHead {
    ...
    private void assertContent() {
        ...
        if (!$assertionsDisabled && null == this.mRequest.getHeaders().get("Content-Type")) {
