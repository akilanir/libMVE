...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/Util.class */
public class Util {
    ...
    public static void emitAllData(DataEmitter emitter, ByteBufferList list) {
        ...
        while (!emitter.isPaused()) {
            ...
            if (dataCallback == null || (remaining = list.remaining()) <= 0) {
                break;
            }
                ...
                do {
                    try {
                        if (!this.pending.hasRemaining()) {
                            ...
                            long toRead = Math.min(max - this.totalRead, b.capacity());
    ...
    /* JADX WARN: Type inference failed for: r3v0, types: [T extends com.koushikdutta.async.AsyncSocket, com.koushikdutta.async.AsyncSocket, java.lang.Object] */
    /* JADX WARN: Type inference failed for: r3v1 */
    /* JADX WARN: Type inference failed for: r3v2, types: [T extends com.koushikdutta.async.AsyncSocket, java.lang.Object] */
    public static <T extends AsyncSocket> T getWrappedSocket(AsyncSocket asyncSocket, Class<T> cls) {
        ...
        while (asyncSocket instanceof AsyncSocketWrapper) {
            asyncSocket = (T) asyncSocket.getSocket();
            if (cls.isInstance(asyncSocket)) {
                return asyncSocket;
            }
        }
