...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/spdy/SpdyMiddleware.class */
public class SpdyMiddleware extends AsyncSSLSocketMiddleware {
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/spdy/SpdyMiddleware$SpdyConnectionWaiter.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/spdy/SpdyMiddleware$NoSpdyException.class */
    ...
    protected AsyncSSLSocketWrapper.HandshakeCallback createHandshakeCallback(final AsyncHttpClientMiddleware.GetSocketData data, final ConnectCallback callback) {
        ...
        return new AsyncSSLSocketWrapper.HandshakeCallback() { // from class: com.koushikdutta.async.http.spdy.SpdyMiddleware.2
    ...
    protected ConnectCallback wrapCallback(AsyncHttpClientMiddleware.GetSocketData data, Uri uri, int port, boolean proxied, ConnectCallback callback) {
        ...
        return new ConnectCallback() { // from class: com.koushikdutta.async.http.spdy.SpdyMiddleware.3
