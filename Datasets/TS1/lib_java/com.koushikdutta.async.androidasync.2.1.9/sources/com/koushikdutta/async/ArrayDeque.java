...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/ArrayDeque.class */
public class ArrayDeque<E> extends AbstractCollection<E> implements Deque<E>, Cloneable, Serializable {
    ...
    private void allocateElements(int numElements) {
        ...
        if (numElements >= initialCapacity) {
            ...
            int initialCapacity5 = initialCapacity4 | (initialCapacity4 >>> MIN_INITIAL_CAPACITY);
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/ArrayDeque$DeqIterator.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/ArrayDeque$DescendingIterator.class */
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        while (true) {
            int i2 = i;
            if (i2 != this.tail) {
                s.writeObject(this.elements[i2]);
                i = (i2 + 1) & mask;
            } else {
                return;
            }
