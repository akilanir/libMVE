...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/cache/StrictLineReader.class */
        ...
        synchronized (this.in) {
            ...
            while (i2 != this.end) {
                if (this.buf[i2] != LF) {
                    ...
                    String res = new String(this.buf, this.pos, lineEnd - this.pos);
                    this.pos = i2 + 1;
                    return res;
                }
            }
