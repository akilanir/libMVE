...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncSSLSocketWrapper.class */
public class AsyncSSLSocketWrapper implements AsyncSocketWrapper, AsyncSSLSocket {
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncSSLSocketWrapper$HandshakeCallback.class */
    public interface HandshakeCallback {
        void onHandshakeCompleted(Exception exc, AsyncSSLSocket asyncSSLSocket);
    }

    static {
        $assertionsDisabled = !AsyncSSLSocketWrapper.class.desiredAssertionStatus();
        try {
