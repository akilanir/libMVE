...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/socketio/EventEmitter.class */
public class EventEmitter {
    HashList<EventCallback> callbacks = new HashList<>();

    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/socketio/EventEmitter$OnceCallback.class */
