...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/HybiParser.class */
abstract class HybiParser {
    ...
    private byte[] inflate(byte[] payload) throws DataFormatException {
        ...
        while (!inflater.needsInput()) {
            int chunkSize = inflater.inflate(this.mInflateBuffer);
            inflated.write(this.mInflateBuffer, 0, chunkSize);
        }
        inflater.setInput(new byte[]{0, 0, -1, -1});
        while (!inflater.needsInput()) {
            int chunkSize2 = inflater.inflate(this.mInflateBuffer);
            inflated.write(this.mInflateBuffer, 0, chunkSize2);
        }
        try {
            byte[] byteArray = inflated.toByteArray();
            inflater.end();
            return byteArray;
        } catch (Throwable th) {
            inflater.end();
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/HybiParser$ProtocolError.class */
