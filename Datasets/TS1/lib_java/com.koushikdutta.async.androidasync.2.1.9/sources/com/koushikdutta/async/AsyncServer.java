...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncServer.class */
public class AsyncServer {
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncServer$RunnableWrapper.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncServer$Scheduled.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncServer$Scheduler.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncServer$ObjectHolder.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncServer$ConnectFuture.class */
    ...
    public Future<InetAddress[]> getAllByName(final String host) {
        ...
        synchronousWorkers.execute(new Runnable() { // from class: com.koushikdutta.async.AsyncServer.9
            @Override // java.lang.Runnable
            public void run() {
                try {
    ...
    public Future<InetAddress> getByName(String host) {
        return (Future) getAllByName(host).then(new TransformFuture<InetAddress, InetAddress[]>() { // from class: com.koushikdutta.async.AsyncServer.10
            ...
            public void transform(InetAddress[] result) throws Exception {
                setComplete((AnonymousClass10) result[0]);
            }
        });
    }
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncServer$AsyncSelectorException.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/AsyncServer$NamedThreadFactory.class */
