...
/* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/spdy/AsyncSpdyConnection.class */
public class AsyncSpdyConnection implements FrameReader.Handler {
    ...
    void updateWindowRead(int length) {
        ...
        if (this.totalWindowRead >= this.okHttpSettings.getInitialWindowSize(Settings.DEFAULT_INITIAL_WINDOW_SIZE) / 2) {
            try {
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.9.jar:com/koushikdutta/async/http/spdy/AsyncSpdyConnection$SpdySocket.class */
    public class SpdySocket implements AsyncSocket {
        ...
        void updateWindowRead(int length) {
            this.totalWindowRead += length;
            if (this.totalWindowRead >= AsyncSpdyConnection.this.okHttpSettings.getInitialWindowSize(Settings.DEFAULT_INITIAL_WINDOW_SIZE) / 2) {
                try {
        ...
        public SpdySocket(int id, boolean outFinished, boolean inFinished, List<Header> headerBlock) {
            this.bytesLeftInWriteWindow = AsyncSpdyConnection.this.peerSettings.getInitialWindowSize(Settings.DEFAULT_INITIAL_WINDOW_SIZE);
            this.id = id;
        }
    ...
    public void sendConnectionPreface() throws IOException {
        ...
        int windowSize = this.okHttpSettings.getInitialWindowSize(Settings.DEFAULT_INITIAL_WINDOW_SIZE);
        if (windowSize != 65536) {
    ...
    public void settings(boolean clearPrevious, Settings settings) {
        long delta = 0;
        int priorWriteWindowSize = this.peerSettings.getInitialWindowSize(Settings.DEFAULT_INITIAL_WINDOW_SIZE);
        if (clearPrevious) {
        ...
        try {
            ...
            int peerInitialWindowSize = this.peerSettings.getInitialWindowSize(Settings.DEFAULT_INITIAL_WINDOW_SIZE);
