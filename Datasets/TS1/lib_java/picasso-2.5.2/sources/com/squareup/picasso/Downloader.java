...
/* loaded from: picasso-2.5.2.jar:com/squareup/picasso/Downloader.class */
public interface Downloader {
    Response load(Uri uri, int i) throws IOException;

    void shutdown();

    /* loaded from: picasso-2.5.2.jar:com/squareup/picasso/Downloader$ResponseException.class */
    ...
    /* loaded from: picasso-2.5.2.jar:com/squareup/picasso/Downloader$Response.class */
