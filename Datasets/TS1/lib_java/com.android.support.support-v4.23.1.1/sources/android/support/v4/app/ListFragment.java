...
/* loaded from: com.android.support.support-v4.23.1.1.jar:android/support/v4/app/ListFragment.class */
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ActivityCompatApi23.RequestPermissionsRequestCodeValidator activity = getActivity();
        FrameLayout frameLayout = new FrameLayout(activity);
        LinearLayout pframe = new LinearLayout(activity);
        pframe.setId(INTERNAL_PROGRESS_CONTAINER_ID);
        pframe.setOrientation(1);
        pframe.setVisibility(8);
        pframe.setGravity(17);
        ProgressBar progress = new ProgressBar(activity, null, R.attr.progressBarStyleLarge);
