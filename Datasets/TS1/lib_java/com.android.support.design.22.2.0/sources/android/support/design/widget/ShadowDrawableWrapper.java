...
/* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/ShadowDrawableWrapper.class */
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    void setShadowSize(float shadowSize, float maxShadowSize) {
        ...
        this.mShadowSize = Math.round(shadowSize2 * SHADOW_MULTIPLIER);
    ...
    public float getMinHeight() {
        ...
        return content + (this.mRawMaxShadowSize * SHADOW_MULTIPLIER * 2.0f);
    }
}
