...
/* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/TabLayout.class */
public class TabLayout extends HorizontalScrollView {
    ...
    /* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/TabLayout$Mode.class */
    public @interface Mode {
    }

    /* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/TabLayout$OnTabSelectedListener.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/TabLayout$TabGravity.class */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        switch (View.MeasureSpec.getMode(heightMeasureSpec)) {
            case Integer.MIN_VALUE:
                heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(dpToPx(DEFAULT_HEIGHT), View.MeasureSpec.getSize(heightMeasureSpec)), 1073741824);
                break;
            case 0:
                heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(dpToPx(DEFAULT_HEIGHT), 1073741824);
                break;
        }
    ...
    /* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/TabLayout$Tab.class */
    ...
    /* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/TabLayout$TabView.class */
        ...
        final void update() {
            ...
            if (icon != null) {
                if (this.mIconView == null) {
                    ...
                    lp.gravity = TabLayout.FIXED_WRAP_GUTTER_MIN;
    ...
    /* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/TabLayout$SlidingTabStrip.class */
    ...
    /* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/TabLayout$TabLayoutOnPageChangeListener.class */
    ...
    /* loaded from: com.android.support.design.22.2.0.jar:android/support/design/widget/TabLayout$ViewPagerOnTabSelectedListener.class */
