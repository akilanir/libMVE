...
/* loaded from: android-async-http-1.4.9.jar:com/loopj/android/http/AsyncHttpClient.class */
public class AsyncHttpClient {
            ...
            public void process(HttpRequest request, HttpContext context) {
                ...
                for (String header : AsyncHttpClient.this.clientHeaderMap.keySet()) {
                    if (request.containsHeader(header)) {
                        ...
                        AsyncHttpClient.log.d(AsyncHttpClient.LOG_TAG, String.format("Headers were overwritten! (%s | %s) overwrites (%s | %s)", header, AsyncHttpClient.this.clientHeaderMap.get(header), overwritten.getName(), overwritten.getValue()));
    ...
    public static String getUrlWithQueryString(boolean shouldEncodeUrl, String url, RequestParams params) {
        ...
        if (shouldEncodeUrl) {
            try {
                String decodedURL = URLDecoder.decode(url, AsyncHttpResponseHandler.DEFAULT_CHARSET);
    ...
    public void cancelRequests(Context context, final boolean mayInterruptIfRunning) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            Runnable runnable = new Runnable() { // from class: com.loopj.android.http.AsyncHttpClient.4
                ...
                public void run() {
                    AsyncHttpClient.this.cancelRequests((List<RequestHandle>) requestList, mayInterruptIfRunning);
                }
            };
    ...
    /* loaded from: android-async-http-1.4.9.jar:com/loopj/android/http/AsyncHttpClient$InflatingEntity.class */
