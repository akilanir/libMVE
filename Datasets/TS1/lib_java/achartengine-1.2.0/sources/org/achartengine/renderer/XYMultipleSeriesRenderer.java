...
/* loaded from: achartengine-1.2.0.jar:org/achartengine/renderer/XYMultipleSeriesRenderer.class */
public class XYMultipleSeriesRenderer extends DefaultRenderer {
    ...
    /* loaded from: achartengine-1.2.0.jar:org/achartengine/renderer/XYMultipleSeriesRenderer$Orientation.class */
    ...
    public void initAxesRangeForScale(int i) {
        ...
        double[] range = {this.mMinX[i], this.mMaxX[i], this.mMinY[i], this.mMaxY[i]};
    ...
    public synchronized String getYTextLabel(Double y, int scale) {
        return this.mYTextLabels.get(Integer.valueOf(scale)).get(y);
    }
