...
@Immutable
/* loaded from: httpcore-4.4.3.jar:org/apache/http/config/SocketConfig.class */
public class SocketConfig implements Cloneable {
    ...
    public SocketConfig m8clone() throws CloneNotSupportedException {
    ...
    /* loaded from: httpcore-4.4.3.jar:org/apache/http/config/SocketConfig$Builder.class */
