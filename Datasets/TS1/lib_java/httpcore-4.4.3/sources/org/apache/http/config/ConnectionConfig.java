...
@Immutable
/* loaded from: httpcore-4.4.3.jar:org/apache/http/config/ConnectionConfig.class */
public class ConnectionConfig implements Cloneable {
    ...
    public ConnectionConfig m4clone() throws CloneNotSupportedException {
    ...
    /* loaded from: httpcore-4.4.3.jar:org/apache/http/config/ConnectionConfig$Builder.class */
