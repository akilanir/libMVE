...
/* loaded from: httpcore-4.4.3.jar:org/apache/http/config/MessageConstraints.class */
public class MessageConstraints implements Cloneable {
    ...
    public MessageConstraints m6clone() throws CloneNotSupportedException {
    ...
    /* loaded from: httpcore-4.4.3.jar:org/apache/http/config/MessageConstraints$Builder.class */
