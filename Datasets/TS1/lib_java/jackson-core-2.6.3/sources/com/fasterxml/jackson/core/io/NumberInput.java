...
/* loaded from: jackson-core-2.6.3.jar:com/fasterxml/jackson/core/io/NumberInput.class */
public final class NumberInput {
    ...
    public static int parseInt(char[] ch, int off, int len) {
        ...
        if (len > 4) {
            int off2 = off + 1;
            int i = ((num * 10) + (ch[off2] - '0')) * 10;
            int off3 = off2 + 1;
            int i2 = (i + (ch[off3] - '0')) * 10;
            int off4 = off3 + 1;
            int i3 = (i2 + (ch[off4] - '0')) * 10;
            off = off4 + 1;
            num = i3 + (ch[off] - '0');
            len -= 4;
            if (len > 4) {
                int off5 = off + 1;
                int i4 = ((num * 10) + (ch[off5] - '0')) * 10;
                int off6 = off5 + 1;
                int i5 = (i4 + (ch[off6] - '0')) * 10;
                int off7 = off6 + 1;
                return ((i5 + (ch[off7] - '0')) * 10) + (ch[off7 + 1] - '0');
            }
        }
        if (len > 1) {
            int off8 = off + 1;
