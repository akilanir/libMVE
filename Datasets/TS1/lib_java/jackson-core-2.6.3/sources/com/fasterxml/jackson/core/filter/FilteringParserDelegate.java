...
/* loaded from: jackson-core-2.6.3.jar:com/fasterxml/jackson/core/filter/FilteringParserDelegate.class */
        ...
        switch (t6.id()) {
            ...
            case 5:
                ...
                if (f8 == null || (f2 = f8.includeProperty(name)) == null) {
                    ...
                    this._itemFilter = f2;
                    if (f2 == TokenFilter.INCLUDE_ALL && this._includePath) {
                        this._currToken = t6;
                        return t6;
                    }
                ...
                case 1:
                    ...
                    if (f2 == null) {
                        ...
                        if (f3 == null) {
                            ...
                            if (this._includePath && (t4 = _nextTokenWithBuffering(this._headContext)) != null) {
                                this._currToken = t4;
                                return t4;
                            }
                            break;
