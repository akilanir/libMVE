...
/* loaded from: com.android.support.cardview-v7.24.0.0-alpha1.jar:android/support/v7/widget/CardViewEclairMr1.class */
        ...
        RoundRectDrawableWithShadow.sRoundRectHelper = new RoundRectDrawableWithShadow.RoundRectHelper() { // from class: android.support.v7.widget.CardViewEclairMr1.1
            ...
            public void drawRoundRect(Canvas canvas, RectF bounds, float cornerRadius, Paint paint) {
                ...
                if (cornerRadius >= 1.0f) {
                    ...
                    canvas.drawRect((bounds.left + roundedCornerRadius) - 1.0f, (bounds.bottom - roundedCornerRadius) + 1.0f, (bounds.right - roundedCornerRadius) + 1.0f, bounds.bottom, paint);
                }
