...
/* loaded from: com.android.support.cardview-v7.24.0.0-alpha1.jar:android/support/v7/widget/RoundRectDrawableWithShadow.class */
class RoundRectDrawableWithShadow extends Drawable {
    ...
    /* loaded from: com.android.support.cardview-v7.24.0.0-alpha1.jar:android/support/v7/widget/RoundRectDrawableWithShadow$RoundRectHelper.class */
    ...
    void setShadowSize(float shadowSize, float maxShadowSize) {
        ...
        this.mShadowSize = (int) ((shadowSize2 * SHADOW_MULTIPLIER) + this.mInsetShadow + 0.5f);
        this.mMaxShadowSize = maxShadowSize2 + this.mInsetShadow;
        this.mDirty = true;
        invalidateSelf();
    }
    ...
    static float calculateVerticalPadding(float maxShadowSize, float cornerRadius, boolean addPaddingForCorners) {
        if (addPaddingForCorners) {
            return (float) ((maxShadowSize * SHADOW_MULTIPLIER) + ((1.0d - COS_45) * cornerRadius));
        }
    ...
    float getMinWidth() {
        ...
        return content + ((this.mRawMaxShadowSize + this.mInsetShadow) * 2.0f);
    }
    ...
    float getMinHeight() {
        ...
        return content + (((this.mRawMaxShadowSize * SHADOW_MULTIPLIER) + this.mInsetShadow) * 2.0f);
    }
