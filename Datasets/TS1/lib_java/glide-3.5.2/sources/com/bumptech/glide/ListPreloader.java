...
/* loaded from: glide-3.5.2.jar:com/bumptech/glide/ListPreloader.class */
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    /* loaded from: glide-3.5.2.jar:com/bumptech/glide/ListPreloader$PreloadModelProvider.class */
    ...
    /* loaded from: glide-3.5.2.jar:com/bumptech/glide/ListPreloader$PreloadSizeProvider.class */
    ...
    private void preloadItem(T item, int position, int i) {
        ...
        if (dimensions != null) {
            ...
            preloadRequestBuilder.into((GenericRequestBuilder) this.preloadTargetQueue.next(dimensions[0], dimensions[1]));
        }
    }
    ...
    /* loaded from: glide-3.5.2.jar:com/bumptech/glide/ListPreloader$PreloadTargetQueue.class */
    ...
    /* loaded from: glide-3.5.2.jar:com/bumptech/glide/ListPreloader$PreloadTarget.class */
