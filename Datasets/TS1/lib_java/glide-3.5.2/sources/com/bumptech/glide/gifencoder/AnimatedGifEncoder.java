...
/* loaded from: glide-3.5.2.jar:com/bumptech/glide/gifencoder/AnimatedGifEncoder.class */
public class AnimatedGifEncoder {
    ...
    private void getImagePixels() {
        ...
        double transparentPercentage = (100 * totalTransparentPixels) / pixelsInt.length;
