...
/* loaded from: glide-3.5.2.jar:com/bumptech/glide/request/animation/ViewAnimation.class */
public class ViewAnimation<R> implements GlideAnimation<R> {
    private final AnimationFactory animationFactory;

    /* loaded from: glide-3.5.2.jar:com/bumptech/glide/request/animation/ViewAnimation$AnimationFactory.class */
