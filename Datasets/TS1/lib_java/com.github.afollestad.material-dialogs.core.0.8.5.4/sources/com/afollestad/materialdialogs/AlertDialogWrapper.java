...
/* loaded from: com.github.afollestad.material-dialogs.core.0.8.5.4.jar:com/afollestad/materialdialogs/AlertDialogWrapper.class */
public class AlertDialogWrapper {

    /* loaded from: com.github.afollestad.material-dialogs.core.0.8.5.4.jar:com/afollestad/materialdialogs/AlertDialogWrapper$Builder.class */
    public static class Builder {
        ...
        private void setUpMultiChoiceCallback(@Nullable final boolean[] checkedItems, final DialogInterface.OnMultiChoiceClickListener listener) {
            ...
            this.builder.itemsCallbackMultiChoice(selectedIndicesArr, new MaterialDialog.ListCallbackMultiChoice() { // from class: com.afollestad.materialdialogs.AlertDialogWrapper.Builder.4
                @Override // com.afollestad.materialdialogs.MaterialDialog.ListCallbackMultiChoice
                public boolean onSelection(MaterialDialog dialog, Integer[] which, CharSequence[] text) {
                    List<Integer> whichList = Arrays.asList(which);
                    if (checkedItems != null) {
                        for (int i2 = 0; i2 < checkedItems.length; i2++) {
                            boolean oldChecked = checkedItems[i2];
                            checkedItems[i2] = whichList.contains(Integer.valueOf(i2));
                            if (oldChecked != checkedItems[i2]) {
                                listener.onClick(dialog, i2, checkedItems[i2]);
                            }
                        }
                        return true;
                    }
        ...
        public Builder setSingleChoiceItems(@NonNull String[] items, int checkedItem, final DialogInterface.OnClickListener listener) {
            this.builder.items(items);
            this.builder.itemsCallbackSingleChoice(checkedItem, new MaterialDialog.ListCallbackSingleChoice() { // from class: com.afollestad.materialdialogs.AlertDialogWrapper.Builder.5
        ...
        public Builder setSingleChoiceItems(@ArrayRes int itemsId, int checkedItem, final DialogInterface.OnClickListener listener) {
            this.builder.items(itemsId);
            this.builder.itemsCallbackSingleChoice(checkedItem, new MaterialDialog.ListCallbackSingleChoice() { // from class: com.afollestad.materialdialogs.AlertDialogWrapper.Builder.6
                @Override // com.afollestad.materialdialogs.MaterialDialog.ListCallbackSingleChoice
                public boolean onSelection(MaterialDialog dialog, View itemView, int which, CharSequence text) {
                    listener.onClick(dialog, which);
                    return true;
