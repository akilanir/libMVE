...
/* loaded from: com.inkapplications.viewpageindicator.library.2.4.3.jar:com/viewpagerindicator/UnderlinePageIndicator.class */
public class UnderlinePageIndicator extends View implements PageIndicator {
    ...
    public void setFadeLength(int fadeLength) {
        ...
        this.mFadeBy = 255 / (this.mFadeLength / FADE_FRAME_MS);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float left = paddingLeft + (pageWidth * (this.mCurrentPage + this.mPositionOffset));
    ...
    /* loaded from: com.inkapplications.viewpageindicator.library.2.4.3.jar:com/viewpagerindicator/UnderlinePageIndicator$SavedState.class */
