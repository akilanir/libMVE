...
/* loaded from: com.android.support.appcompat-v7.21.0.0.jar:android/support/v7/internal/widget/ActionBarContainer.class */
public class ActionBarContainer extends FrameLayout {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mActionBarView == null && View.MeasureSpec.getMode(heightMeasureSpec) == Integer.MIN_VALUE && this.mHeight >= 0) {
            heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Math.min(this.mHeight, View.MeasureSpec.getSize(heightMeasureSpec)), RtlSpacingHelper.UNDEFINED);
        }
        ...
        if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != 1073741824) {
            ...
            setMeasuredDimension(getMeasuredWidth(), Math.min(topMarginForTabs + getMeasuredHeightWithMargins(this.mTabContainer), maxHeight));
        }
    }
