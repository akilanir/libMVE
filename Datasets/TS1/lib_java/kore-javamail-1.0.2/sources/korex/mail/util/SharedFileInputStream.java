...
/* loaded from: kore-javamail-1.0.2.jar:korex/mail/util/SharedFileInputStream.class */
public class SharedFileInputStream extends BufferedInputStream implements SharedInputStream {
    ...
    /* loaded from: kore-javamail-1.0.2.jar:korex/mail/util/SharedFileInputStream$SharedFile.class */
    ...
    public synchronized int read(byte[] b, int off, int len) throws IOException {
        ...
        while (n < len && (n1 = read1(b, off + n, len - n)) > 0) {
            n += n1;
        }
        return n;
    }
