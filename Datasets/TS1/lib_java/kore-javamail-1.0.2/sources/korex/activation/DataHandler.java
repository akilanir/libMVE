...
/* loaded from: kore-javamail-1.0.2.jar:korex/activation/DataHandler.class */
public class DataHandler implements Transferable {
    ...
    public InputStream getInputStream() throws IOException {
        ...
        if (this.dataSource != null) {
            ...
            new Thread(new Runnable() { // from class: korex.activation.DataHandler.1
    ...
    @Override // kore.awt.datatransfer.Transferable
