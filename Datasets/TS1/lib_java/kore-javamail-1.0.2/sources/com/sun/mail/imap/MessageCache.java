...
/* loaded from: kore-javamail-1.0.2.jar:com/sun/mail/imap/MessageCache.class */
public class MessageCache {
    ...
    public void expungeMessage(int seqnum) {
        ...
        this.seqnums[msgnum - 1] = 0;
        for (int i3 = msgnum + 1; i3 <= this.seqnums.length; i3++) {
    ...
    private void shrink(int newend, int oldend) {
        ...
        if (this.size > SLOP && this.size < this.messages.length / 2) {
            this.logger.fine("reallocate array");
            IMAPMessage[] newm = new IMAPMessage[this.size + SLOP];
            System.arraycopy(this.messages, 0, newm, 0, this.size);
            this.messages = newm;
            if (this.seqnums != null) {
                int[] news = new int[this.size + SLOP];
    ...
    private void ensureCapacity(int newsize, int newSeqNum) {
        if (this.messages == null) {
            this.messages = new IMAPMessage[newsize + SLOP];
