...
import korex.mail.search.AddressTerm;
import korex.mail.search.AndTerm;
import korex.mail.search.BodyTerm;
import korex.mail.search.ComparisonTerm;
import korex.mail.search.DateTerm;
import korex.mail.search.FlagTerm;
import korex.mail.search.FromStringTerm;
import korex.mail.search.FromTerm;
import korex.mail.search.HeaderTerm;
import korex.mail.search.MessageIDTerm;
import korex.mail.search.NotTerm;
import korex.mail.search.OrTerm;
import korex.mail.search.ReceivedDateTerm;
import korex.mail.search.RecipientStringTerm;
import korex.mail.search.RecipientTerm;
import korex.mail.search.SearchException;
import korex.mail.search.SearchTerm;
import korex.mail.search.SentDateTerm;
import korex.mail.search.SizeTerm;
import korex.mail.search.StringTerm;
import korex.mail.search.SubjectTerm;

/* loaded from: kore-javamail-1.0.2.jar:com/sun/mail/imap/protocol/SearchSequence.class */
