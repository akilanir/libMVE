...
/* loaded from: kore-javamail-1.0.2.jar:com/sun/mail/util/MailLogger.class */
public final class MailLogger {
    ...
    private StackTraceElement inferCaller() {
        ...
        while (ix < stack.length) {
            String cname = stack[ix].getClassName();
        ...
        while (ix < stack.length) {
            ...
            String cname2 = frame.getClassName();
            if (!isLoggerImplFrame(cname2)) {
                return frame;
            }
            ix++;
        }
