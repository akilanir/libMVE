...
/* loaded from: kore-javamail-1.0.2.jar:com/sun/mail/imap/protocol/BODYSTRUCTURE.class */
    ...
    public BODYSTRUCTURE(FetchResponse r) throws ParsingException {
        ...
        if (r.peekByte() == 40) {
            ...
            if (b == 40) {
                ...
                throw new ParsingException("BODYSTRUCTURE parse error: " + this.type + "/" + this.subtype + ": bad multipart disposition, b " + ((int) b));
            }
            byte b2 = r.readByte();
            if (b2 == 41) {
                if (parseDebug) {
        ...
        if (b3 == 40) {
            ...
            throw new ParsingException("BODYSTRUCTURE parse error: " + this.type + "/" + this.subtype + ": bad single part disposition, b " + ((int) b3));
        }
        if (r.readByte() == 41) {
            if (parseDebug) {
                System.out.println("DEBUG IMAP: disposition DONE");
