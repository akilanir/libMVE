...
/* loaded from: eventbus-2.4.0.jar:de/greenrobot/event/util/AsyncExecutor.class */
public class AsyncExecutor {
    ...
    /* loaded from: eventbus-2.4.0.jar:de/greenrobot/event/util/AsyncExecutor$RunnableEx.class */
    public interface RunnableEx {
        void run() throws Exception;
    }

    /* loaded from: eventbus-2.4.0.jar:de/greenrobot/event/util/AsyncExecutor$Builder.class */
