...
/* loaded from: okhttp-2.6.0.jar:com/squareup/okhttp/ConnectionPool.class */
public final class ConnectionPool {
    ...
    boolean performCleanup() {
        synchronized (this) {
            ...
            Iterator<Connection> i2 = this.connections.descendingIterator();
            while (i2.hasNext() && idleConnectionCount > this.maxIdleConnections) {
                Connection connection2 = i2.next();
