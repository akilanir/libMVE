...
/* loaded from: jsch-0.1.51.jar:com/jcraft/jsch/DHGEX256.class */
public class DHGEX256 extends KeyExchange {
    ...
    public boolean next(Buffer _buf) throws Exception {
        switch (this.state) {
            case SSH_MSG_KEX_DH_GEX_GROUP /* 31 */:
                _buf.getInt();
                _buf.getByte();
                int j = _buf.getByte();
            ...
            case SSH_MSG_KEX_DH_GEX_REPLY /* 33 */:
                ...
                _buf.getByte();
                int j2 = _buf.getByte();
                if (j2 != SSH_MSG_KEX_DH_GEX_REPLY) {
                    System.err.println("type: must be SSH_MSG_KEX_DH_GEX_REPLY " + j2);
                    return false;
                }
                ...
                int i6 = i4 + 1;
                int j3 = i5 | (this.K_S[i4] & 255);
                String alg = Util.byte2str(this.K_S, i6, j3);
                int i7 = i6 + j3;
                ...
                if (alg.equals("ssh-rsa")) {
                    ...
                    int i13 = i11 + 1;
                    int j4 = i12 | (this.K_S[i11] & 255);
                    byte[] tmp = new byte[j4];
                    System.arraycopy(this.K_S, i13, tmp, 0, j4);
                    int i14 = i13 + j4;
                    int i15 = i14 + 1;
                    int i16 = i15 + 1;
                    ...
                    int i20 = i18 + 1;
                    int j5 = i19 | (this.K_S[i18] & 255);
                    byte[] tmp2 = new byte[j5];
                    System.arraycopy(this.K_S, i20, tmp2, 0, j5);
                    int i21 = i20 + j5;
                    ...
                    int i27 = i25 + 1;
                    int j6 = i26 | (this.K_S[i25] & 255);
                    byte[] tmp3 = new byte[j6];
                    System.arraycopy(this.K_S, i27, tmp3, 0, j6);
                    int i28 = i27 + j6;
                    this.p = tmp3;
                    int i29 = i28 + 1;
                    int i30 = i29 + 1;
                    ...
                    int i34 = i32 + 1;
                    int j7 = i33 | (this.K_S[i32] & 255);
                    byte[] tmp4 = new byte[j7];
                    System.arraycopy(this.K_S, i34, tmp4, 0, j7);
                    int i35 = i34 + j7;
                    int i36 = i35 + 1;
                    int i37 = i36 + 1;
                    ...
                    int i41 = i39 + 1;
                    int j8 = i40 | (this.K_S[i39] & 255);
                    byte[] tmp5 = new byte[j8];
                    System.arraycopy(this.K_S, i41, tmp5, 0, j8);
                    int i42 = i41 + j8;
                    this.g = tmp5;
                    int i43 = i42 + 1;
                    int i44 = i43 + 1;
                    ...
                    int i48 = i46 + 1;
                    int j9 = i47 | (this.K_S[i46] & 255);
                    byte[] tmp6 = new byte[j9];
                    System.arraycopy(this.K_S, i48, tmp6, 0, j9);
                    int i49 = i48 + j9;
                    ...
                    sig2.setPubKey(tmp6, this.p, tmp4, this.g);
                    sig2.update(this.H);
