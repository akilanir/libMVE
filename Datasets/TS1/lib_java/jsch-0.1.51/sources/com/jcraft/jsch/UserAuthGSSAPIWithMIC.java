...
/* loaded from: jsch-0.1.51.jar:com/jcraft/jsch/UserAuthGSSAPIWithMIC.class */
        ...
        while (true) {
            ...
            if (command == SSH_MSG_USERAUTH_GSSAPI_RESPONSE) {
                ...
                while (true) {
                    ...
                    if (!Util.array_equals(message, supported_oid[i2])) {
                        i2++;
                    } else {
                        ...
                        while (!context.isEstablished()) {
                            try {
                                ...
                                if (!context.isEstablished()) {
                                    ...
                                    if (command2 == SSH_MSG_USERAUTH_GSSAPI_ERROR || command2 == SSH_MSG_USERAUTH_GSSAPI_ERRTOK) {
                                        this.buf = session.read(this.buf);
