...
/* loaded from: jsch-0.1.51.jar:com/jcraft/jsch/KeyPairRSA.class */
public class KeyPairRSA extends KeyPair {
        ...
        try {
            ...
            if ((length9 & 128) != 0) {
                ...
                while (true) {
                    ...
                    int i16 = index16;
                    index16++;
                    length9 = (length9 << 8) + (plain[i16] & 255);
                }
            }
            ...
            if ((length10 & 128) != 0) {
                ...
                while (true) {
                    ...
                    int i18 = index18;
                    index18++;
                    length10 = (length10 << 8) + (plain[i18] & 255);
                }
            }
    ...
    public byte[] getSignature(byte[] data) {
        try {
            ...
            rsa.update(data);
            byte[] sig = rsa.sign();
            return Buffer.fromBytes(new byte[]{sshrsa, sig}).buffer;
        } catch (Exception e) {
            return null;
        }
    }
