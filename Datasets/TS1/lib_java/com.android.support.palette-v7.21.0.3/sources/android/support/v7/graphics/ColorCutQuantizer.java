...
/* loaded from: com.android.support.palette-v7.21.0.3.jar:android/support/v7/graphics/ColorCutQuantizer.class */
final class ColorCutQuantizer {
    ...
    private ColorCutQuantizer(ColorHistogram colorHistogram, int maxColors) {
        ...
        for (int color : rawColors) {
            if (!shouldIgnoreColor(color)) {
                int i2 = validColorCount;
                validColorCount++;
                this.mColors[i2] = color;
            }
        }
    ...
    /* loaded from: com.android.support.palette-v7.21.0.3.jar:android/support/v7/graphics/ColorCutQuantizer$Vbox.class */
    private class Vbox {
    ...
    public void modifySignificantOctet(int dimension, int lowerIndex, int upperIndex) {
        switch (dimension) {
