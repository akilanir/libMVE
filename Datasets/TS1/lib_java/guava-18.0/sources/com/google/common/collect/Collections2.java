...
public final class Collections2 {
    ...
    private static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public String toString() {
            ...
            return new StringBuilder(30 + valueOf.length()).append("orderedPermutationCollection(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static final class PermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public String toString() {
            String valueOf = String.valueOf(String.valueOf(this.inputList));
            return new StringBuilder(14 + valueOf.length()).append("permutations(").append(valueOf).append(")").toString();
        }
    }
