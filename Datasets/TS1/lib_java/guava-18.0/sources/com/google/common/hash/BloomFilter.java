...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    public static <T> BloomFilter<T> readFrom(InputStream in, Funnel<T> funnel) throws IOException {
        ...
        try {
            ...
            IOException ioException = new IOException(new StringBuilder(65 + valueOf.length()).append(valueOf).append(strategyOrdinal).append(" numHashFunctions: ").append(numHashFunctions).append(" dataLength: ").append(dataLength).toString());
