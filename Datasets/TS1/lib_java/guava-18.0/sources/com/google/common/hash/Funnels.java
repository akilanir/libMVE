...
public final class Funnels {
    ...
    private static class StringCharsetFunnel implements Funnel<CharSequence>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(22 + valueOf.length()).append("Funnels.stringFunnel(").append(valueOf).append(")").toString();
        }
    ...
    private static class SequentialFunnel<E> implements Funnel<Iterable<? extends E>>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(26 + valueOf.length()).append("Funnels.sequentialFunnel(").append(valueOf).append(")").toString();
        }
    ...
    private static class SinkAsStream extends OutputStream {
        ...
        public String toString() {
            ...
            return new StringBuilder(24 + valueOf.length()).append("Funnels.asOutputStream(").append(valueOf).append(")").toString();
        }
    }
}
