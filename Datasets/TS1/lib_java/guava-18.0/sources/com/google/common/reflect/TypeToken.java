...
public abstract class TypeToken<T> extends TypeCapture<T> implements Serializable {
    ...
    final TypeToken<T> rejectTypeVariables() {
        new TypeVisitor() { // from class: com.google.common.reflect.TypeToken.3
            ...
            void visitTypeVariable(TypeVariable<?> type) {
                ...
                throw new IllegalArgumentException(new StringBuilder(58 + valueOf.length()).append(valueOf).append("contains a type variable and is not safe for the operation").toString());
            }
    ...
    private static Type supertypeBound(WildcardType type) {
        ...
        throw new AssertionError(new StringBuilder(59 + valueOf.length()).append("There should be at most one upper bound for wildcard type: ").append(valueOf).toString());
    }
    ...
    private static Type subtypeBound(WildcardType type) {
        ...
        String valueOf = String.valueOf(String.valueOf(type));
        throw new AssertionError(new StringBuilder(46 + valueOf.length()).append("Wildcard should have at most one lower bound: ").append(valueOf).toString());
    }
    ...
    private TypeToken<? super T> getSupertypeFromUpperBounds(Class<? super T> cls, Type[] typeArr) {
        ...
        throw new IllegalArgumentException(new StringBuilder(23 + valueOf.length() + valueOf2.length()).append(valueOf).append(" isn't a super type of ").append(valueOf2).toString());
    }
    ...
    private TypeToken<? extends T> getSubtypeFromLowerBounds(Class<?> cls, Type[] typeArr) {
        ...
        String valueOf = String.valueOf(String.valueOf(cls));
        String valueOf2 = String.valueOf(String.valueOf(this));
        throw new IllegalArgumentException(new StringBuilder(21 + valueOf.length() + valueOf2.length()).append(valueOf).append(" isn't a subclass of ").append(valueOf2).toString());
    }
