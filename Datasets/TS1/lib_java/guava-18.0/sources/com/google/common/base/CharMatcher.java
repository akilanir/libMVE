...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static CharMatcher is(final char match) {
        ...
        String description = new StringBuilder(18 + valueOf.length()).append("CharMatcher.is('").append(valueOf).append("')").toString();
    ...
    public static CharMatcher isNot(final char match) {
        String valueOf = String.valueOf(String.valueOf(showCharacter(match)));
        String description = new StringBuilder(21 + valueOf.length()).append("CharMatcher.isNot('").append(valueOf).append("')").toString();
    ...
    private static CharMatcher isEither(final char match1, final char match2) {
        ...
        String description = new StringBuilder(21 + valueOf.length() + valueOf2.length()).append("CharMatcher.anyOf(\"").append(valueOf).append(valueOf2).append("\")").toString();
    ...
    public static CharMatcher inRange(char startInclusive, char endInclusive) {
        ...
        String description = new StringBuilder(27 + valueOf.length() + valueOf2.length()).append("CharMatcher.inRange('").append(valueOf).append("', '").append(valueOf2).append("')").toString();
    ...
    public static CharMatcher forPredicate(final Predicate<? super Character> predicate) {
        ...
        String description = new StringBuilder(26 + valueOf.length()).append("CharMatcher.forPredicate(").append(valueOf).append(")").toString();
    ...
    private static class NegatedMatcher extends CharMatcher {
        ...
        NegatedMatcher(CharMatcher original) {
            ...
            this(new StringBuilder(9 + valueOf.length()).append(valueOf).append(".negate()").toString(), original);
        }
    ...
    private static class And extends CharMatcher {
        ...
        And(CharMatcher a, CharMatcher b) {
            ...
            this(a, b, new StringBuilder(19 + valueOf.length() + valueOf2.length()).append("CharMatcher.and(").append(valueOf).append(", ").append(valueOf2).append(")").toString());
        }
    ...
    private static class Or extends CharMatcher {
        ...
        Or(CharMatcher a, CharMatcher b) {
            String valueOf = String.valueOf(String.valueOf(a));
            String valueOf2 = String.valueOf(String.valueOf(b));
            this(a, b, new StringBuilder(18 + valueOf.length() + valueOf2.length()).append("CharMatcher.or(").append(valueOf).append(", ").append(valueOf2).append(")").toString());
        }
