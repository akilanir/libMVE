...
public class CycleDetectingLockFactory {
    ...
    private static class ExampleStackTrace extends IllegalStateException {
        ...
        ExampleStackTrace(LockGraphNode node1, LockGraphNode node2) {
            ...
            super(new StringBuilder(4 + valueOf.length() + valueOf2.length()).append(valueOf).append(" -> ").append(valueOf2).toString());
    ...
    private static class LockGraphNode {
        ...
        void checkAcquiredLock(Policy policy, LockGraphNode acquiredLock) {
            ...
            if (valueOf.length() != 0) {
                str = "Attempted to acquire multiple locks with the same rank ".concat(valueOf);
            } else {
                str = r2;
                String str2 = new String("Attempted to acquire multiple locks with the same rank ");
            }
