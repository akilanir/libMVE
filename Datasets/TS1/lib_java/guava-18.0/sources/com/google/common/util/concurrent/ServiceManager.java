    ...
    public ServiceManager startAsync() {
        ...
        while (i$2.hasNext()) {
            ...
            try {
                ...
                logger2.log(level, new StringBuilder(24 + valueOf.length()).append("Unable to start Service ").append(valueOf).toString(), (Throwable) e);
            }
        }
        return this;
    }
    ...
    private static final class ServiceManagerState {
        ...
        void markReady() {
            ...
            try {
                ...
                throw new IllegalArgumentException(new StringBuilder(0 + valueOf.length() + valueOf2.length()).append(valueOf).append(valueOf2).toString());
            } finally {
                this.monitor.leave();
            }
        }
        ...
        void awaitHealthy(long timeout, TimeUnit unit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, timeout, unit)) {
                    ...
                    String valueOf2 = String.valueOf(String.valueOf(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.in(ImmutableSet.of(Service.State.NEW, Service.State.STARTING)))));
                    throw new TimeoutException(new StringBuilder(0 + valueOf.length() + valueOf2.length()).append(valueOf).append(valueOf2).toString());
                }
                checkHealthy();
                this.monitor.leave();
            } catch (Throwable th) {
        ...
        void awaitStopped(long timeout, TimeUnit unit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.stoppedGuard, timeout, unit)) {
                    ...
                    String valueOf2 = String.valueOf(String.valueOf(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.not(Predicates.in(ImmutableSet.of(Service.State.TERMINATED, Service.State.FAILED))))));
                    throw new TimeoutException(new StringBuilder(0 + valueOf.length() + valueOf2.length()).append(valueOf).append(valueOf2).toString());
                }
            } finally {
                this.monitor.leave();
        ...
        void fireFailedListeners(final Service service) {
            ...
            new ListenerCallQueue.Callback<Listener>(new StringBuilder(18 + valueOf.length()).append("failed({service=").append(valueOf).append("})").toString()) { // from class: com.google.common.util.concurrent.ServiceManager.ServiceManagerState.5
                /* JADX INFO: Access modifiers changed from: package-private */
                @Override // com.google.common.util.concurrent.ListenerCallQueue.Callback
                public void call(Listener listener) {
        ...
        void checkHealthy() {
            if (this.states.count(Service.State.RUNNING) != this.numberOfServices) {
                String valueOf = String.valueOf(String.valueOf(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.not(Predicates.equalTo(Service.State.RUNNING)))));
                IllegalStateException exception = new IllegalStateException(new StringBuilder(79 + valueOf.length()).append("Expected to be healthy after starting. The following services are not running: ").append(valueOf).toString());
                throw exception;
            }
        }
    }
        ...
        public void failed(Service.State from, Throwable failure) {
            ...
            if (state != null) {
                if (!(this.service instanceof NoOpService)) {
                    ...
                    logger.log(level, new StringBuilder(34 + valueOf.length() + valueOf2.length()).append("Service ").append(valueOf).append(" has failed in the ").append(valueOf2).append(" state.").toString(), failure);
                }
