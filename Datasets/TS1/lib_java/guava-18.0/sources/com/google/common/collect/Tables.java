...
public final class Tables {
    ...
    static abstract class AbstractCell<R, C, V> implements Table.Cell<R, C, V> {
        ...
        public String toString() {
            ...
            return new StringBuilder(4 + valueOf.length() + valueOf2.length() + valueOf3.length()).append("(").append(valueOf).append(",").append(valueOf2).append(")=").append(valueOf3).toString();
        }
    }
