...
public final class Functions {
    ...
    private static class FunctionForMapNoDefault<K, V> implements Function<K, V>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(8 + valueOf.length()).append("forMap(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static class ForMapWithDefault<K, V> implements Function<K, V>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(23 + valueOf.length() + valueOf2.length()).append("forMap(").append(valueOf).append(", defaultValue=").append(valueOf2).append(")").toString();
        }
    }
    ...
    private static class PredicateFunction<T> implements Function<T, Boolean>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(14 + valueOf.length()).append("forPredicate(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static class ConstantFunction<E> implements Function<Object, E>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(10 + valueOf.length()).append("constant(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static class SupplierFunction<T> implements Function<Object, T>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(13 + valueOf.length()).append("forSupplier(").append(valueOf).append(")").toString();
        }
    }
}
