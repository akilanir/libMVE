...
public final class Maps {
    ...
    static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        public String toString() {
            ...
            return new StringBuilder(4 + valueOf.length() + valueOf2.length()).append("(").append(valueOf).append(", ").append(valueOf2).append(")").toString();
        }
    }
    ...
    private static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(18 + valueOf.length()).append("Maps.asConverter(").append(valueOf).append(")").toString();
        }
    }
