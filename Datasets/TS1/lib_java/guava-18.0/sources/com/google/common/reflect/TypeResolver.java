...
public final class TypeResolver {
    ...
    public static void populateTypeMappings(final Map<TypeVariableKey, Type> mappings, Type from, final Type to) {
        ...
        new TypeVisitor() { // from class: com.google.common.reflect.TypeResolver.1
            ...
            void visitClass(Class<?> fromClass) {
                ...
                throw new IllegalArgumentException(new StringBuilder(21 + valueOf.length()).append("No type mapping from ").append(valueOf).toString());
            }
        }.visit(from);
    }
    ...
    public static <T> T expectArgument(Class<T> type, Object arg) {
        try {
            ...
            throw new IllegalArgumentException(new StringBuilder(10 + valueOf.length() + valueOf2.length()).append(valueOf).append(" is not a ").append(valueOf2).toString());
        }
    }
        ...
        Type capture(Type type) {
            ...
            if (type instanceof WildcardType) {
                ...
                if (lowerBounds.length == 0) {
                    ...
                    String name = new StringBuilder(33 + valueOf.length()).append("capture#").append(incrementAndGet).append("-of ? extends ").append(valueOf).toString();
