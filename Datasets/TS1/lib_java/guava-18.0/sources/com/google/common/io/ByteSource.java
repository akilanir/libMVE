...
public abstract class ByteSource {
    ...
    private final class AsCharSource extends CharSource {
        ...
        public String toString() {
            ...
            return new StringBuilder(15 + valueOf.length() + valueOf2.length()).append(valueOf).append(".asCharSource(").append(valueOf2).append(")").toString();
        }
    }
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        public String toString() {
            String valueOf = String.valueOf(String.valueOf(ByteSource.this.toString()));
            long j = this.offset;
            return new StringBuilder(50 + valueOf.length()).append(valueOf).append(".slice(").append(j).append(", ").append(this.length).append(")").toString();
        }
    }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            return new StringBuilder(17 + valueOf.length()).append("ByteSource.wrap(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static final class ConcatenatedByteSource extends ByteSource {
        ...
        public String toString() {
            ...
            return new StringBuilder(19 + valueOf.length()).append("ByteSource.concat(").append(valueOf).append(")").toString();
        }
    }
}
