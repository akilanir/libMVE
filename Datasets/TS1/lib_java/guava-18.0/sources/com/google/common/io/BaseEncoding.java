...
public abstract class BaseEncoding {
    ...
    static final class SeparatedBaseEncoding extends BaseEncoding {
        ...
        public String toString() {
            ...
            return new StringBuilder(31 + valueOf.length() + valueOf2.length()).append(valueOf).append(".withSeparator(\"").append(valueOf2).append("\", ").append(this.afterEveryChars).append(")").toString();
        }
    }
}
