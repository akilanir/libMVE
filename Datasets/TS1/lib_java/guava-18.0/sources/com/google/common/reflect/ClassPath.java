...
public final class ClassPath {
    ...
    public ImmutableSet<ClassInfo> getTopLevelClassesRecursive(String packageName) {
        ...
        String packagePrefix = new StringBuilder(1 + valueOf.length()).append(valueOf).append(".").toString();
        ImmutableSet.Builder<ClassInfo> builder = ImmutableSet.builder();
        Iterator i$ = getTopLevelClasses().iterator();
        while (i$.hasNext()) {
            ClassInfo classInfo = (ClassInfo) i$.next();
    ...
    static final class Scanner {
        ...
        private void scanDirectory(File directory, ClassLoader classloader, String packagePrefix, ImmutableSet<File> ancestors) throws IOException {
            ...
            if (files == null) {
                ...
                String valueOf = String.valueOf(String.valueOf(directory));
                logger.warning(new StringBuilder(22 + valueOf.length()).append("Cannot read directory ").append(valueOf).toString());
                return;
            }
            ...
            for (File f : files) {
                ...
                if (f.isDirectory()) {
                    String valueOf2 = String.valueOf(String.valueOf(packagePrefix));
                    String valueOf3 = String.valueOf(String.valueOf(name));
                    scanDirectory(f, classloader, new StringBuilder(1 + valueOf2.length() + valueOf3.length()).append(valueOf2).append(valueOf3).append("/").toString(), newAncestors);
                } else {
                    String valueOf4 = String.valueOf(packagePrefix);
                ...
                for (String path : ClassPath.CLASS_PATH_ATTRIBUTE_SEPARATOR.split(classpathAttribute)) {
                    try {
                        ...
                        if (valueOf.length() != 0) {
                            ...
                            str = r2;
                            String str2 = new String("Invalid Class-Path entry: ");
                        }
                        logger.warning(str);
                    }
                }
