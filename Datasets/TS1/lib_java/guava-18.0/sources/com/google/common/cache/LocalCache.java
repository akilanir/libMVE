        ...
        V waitForLoadingValue(ReferenceEntry<K, V> e, K key, ValueReference<K, V> valueReference) throws ExecutionException {
            ...
            try {
                ...
                if (value == null) {
                    ...
                    throw new CacheLoader.InvalidCacheLoadException(new StringBuilder(35 + valueOf.length()).append("CacheLoader returned null for key ").append(valueOf).append(".").toString());
                }
                long now = this.map.ticker.read();
                recordRead(e, now);
                ...
                try {
                    ...
                    for (K key2 : newLinkedHashSet) {
                        ...
                        if (value2 == null) {
                            ...
                            throw new CacheLoader.InvalidCacheLoadException(new StringBuilder(37 + valueOf.length()).append("loadAll failed to return a value for ").append(valueOf).toString());
                        }
                    ...
                    try {
                        try {
                            ...
                            if (loadAll == null) {
                                ...
                                throw new CacheLoader.InvalidCacheLoadException(new StringBuilder(31 + valueOf.length()).append(valueOf).append(" returned null map from loadAll").toString());
                            }
                            createStarted.stop();
                            boolean z2 = false;
                            ...
                            if (z2) {
                                ...
                                throw new CacheLoader.InvalidCacheLoadException(new StringBuilder(42 + valueOf2.length()).append(valueOf2).append(" returned null keys or values from loadAll").toString());
                            }
