...
public final class MediaType {
    ...
    public Optional<Charset> charset() {
        ImmutableSet<String> charsetValues = ImmutableSet.copyOf((Collection) this.parameters.get((ImmutableListMultimap<String, String>) CHARSET_ATTRIBUTE));
        switch (charsetValues.size()) {
            ...
            default:
                ...
                throw new IllegalStateException(new StringBuilder(33 + valueOf.length()).append("Multiple charset values defined: ").append(valueOf).toString());
        }
    }
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            throw new IllegalArgumentException(new StringBuilder(18 + valueOf.length()).append("Could not parse '").append(valueOf).append("'").toString(), e);
        }
    }
