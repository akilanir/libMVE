...
public final class Predicates {
    ...
    private static class NotPredicate<T> implements Predicate<T>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(16 + valueOf.length()).append("Predicates.not(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static class AndPredicate<T> implements Predicate<T>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(16 + valueOf.length()).append("Predicates.and(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static class OrPredicate<T> implements Predicate<T>, Serializable {
        ...
        public String toString() {
            String valueOf = String.valueOf(String.valueOf(Predicates.COMMA_JOINER.join(this.components)));
            return new StringBuilder(15 + valueOf.length()).append("Predicates.or(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static class InstanceOfPredicate implements Predicate<Object>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(23 + valueOf.length()).append("Predicates.instanceOf(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static class AssignableFromPredicate implements Predicate<Class<?>>, Serializable {
        ...
        public String toString() {
            String valueOf = String.valueOf(String.valueOf(this.clazz.getName()));
            return new StringBuilder(27 + valueOf.length()).append("Predicates.assignableFrom(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static class ContainsPatternPredicate implements Predicate<CharSequence>, Serializable {
        ...
        public String toString() {
            ...
            String valueOf = String.valueOf(String.valueOf(patternString));
            return new StringBuilder(21 + valueOf.length()).append("Predicates.contains(").append(valueOf).append(")").toString();
        }
    }
    ...
    private static class ContainsPatternFromStringPredicate extends ContainsPatternPredicate {
        ...
        public String toString() {
            ...
            return new StringBuilder(28 + valueOf.length()).append("Predicates.containsPattern(").append(valueOf).append(")").toString();
        }
    }
