        ...
        public V get(Object obj) {
            try {
                ...
                if (value == null) {
                    ...
                    throw new NullPointerException(new StringBuilder(24 + valueOf.length() + valueOf2.length()).append(valueOf).append(" returned null for key ").append(valueOf2).append(".").toString());
                }
                return value;
