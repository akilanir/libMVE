...
public final class Doubles {
    ...
    */
    ...
    private static Pattern fpPattern() {
        ...
        String completeHex = new StringBuilder(25 + valueOf.length()).append("0[xX]").append(valueOf).append("[pP][+-]?\\d++[fFdD]?").toString();
        String valueOf2 = String.valueOf(String.valueOf(completeDec));
        String valueOf3 = String.valueOf(String.valueOf(completeHex));
        String fpPattern = new StringBuilder(23 + valueOf2.length() + valueOf3.length()).append("[+-]?(?:NaN|Infinity|").append(valueOf2).append("|").append(valueOf3).append(")").toString();
