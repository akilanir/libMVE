...
public final class Suppliers {
    ...
    private static class SupplierComposition<F, T> implements Supplier<T>, Serializable {
        ...
        public String toString() {
            ...
            return new StringBuilder(21 + valueOf.length() + valueOf2.length()).append("Suppliers.compose(").append(valueOf).append(", ").append(valueOf2).append(")").toString();
        }
    }
    ...
    static class ExpiringMemoizingSupplier<T> implements Supplier<T>, Serializable {
        ...
        public String toString() {
            String valueOf = String.valueOf(String.valueOf(this.delegate));
            return new StringBuilder(62 + valueOf.length()).append("Suppliers.memoizeWithExpiration(").append(valueOf).append(", ").append(this.durationNanos).append(", NANOS)").toString();
        }
    }
    ...
    private static class ThreadSafeSupplier<T> implements Supplier<T>, Serializable {
        ...
        public String toString() {
            String valueOf = String.valueOf(String.valueOf(this.delegate));
            return new StringBuilder(32 + valueOf.length()).append("Suppliers.synchronizedSupplier(").append(valueOf).append(")").toString();
        }
    }
