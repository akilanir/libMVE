...
public final class UnsignedInts {
    ...
    public static int decode(String stringValue) {
        ...
        try {
            ...
            if (valueOf.length() != 0) {
                str = "Error parsing value: ".concat(valueOf);
            } else {
                str = r3;
                String str2 = new String("Error parsing value: ");
            }
            NumberFormatException decodeException = new NumberFormatException(str);
    ...
    public static int parseUnsignedInt(String string, int radix) {
        ...
        if ((result & INT_MASK) != result) {
            ...
            throw new NumberFormatException(new StringBuilder(69 + valueOf.length()).append("Input ").append(valueOf).append(" in base ").append(radix).append(" is not in the range of an unsigned integer").toString());
        }
        return (int) result;
    }
