...
/* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/compressors/gzip/GzipCompressorInputStream.class */
public class GzipCompressorInputStream extends CompressorInputStream {
    ...
    public static boolean matches(byte[] signature, int length) {
        if (length < 2 || signature[0] != 31 || signature[1] != -117) {
            return false;
        }
        return true;
    }
