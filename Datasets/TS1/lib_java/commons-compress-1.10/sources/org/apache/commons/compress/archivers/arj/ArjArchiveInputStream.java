...
/* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/arj/ArjArchiveInputStream.class */
    ...
    private LocalFileHeader readLocalFileHeader() throws IOException {
        ...
        while (true) {
            ...
            if (extendedHeaderSize > 0) {
                ...
                localFileHeader.extendedHeaders = (byte[][]) extendedHeaders.toArray((Object[]) new byte[extendedHeaders.size()]);
