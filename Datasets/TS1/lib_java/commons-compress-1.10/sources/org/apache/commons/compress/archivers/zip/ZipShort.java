...
/* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/zip/ZipShort.class */
public final class ZipShort implements Cloneable, Serializable {
    ...
    public byte[] getBytes() {
        byte[] result = {(byte) (this.value & 255), (byte) ((this.value & BYTE_1_MASK) >> 8)};
        return result;
    }
    ...
    public static void putShort(int value, byte[] buf, int offset) {
        ...
        buf[offset + 1] = (byte) ((value & BYTE_1_MASK) >> 8);
    }

    public static int getValue(byte[] bytes, int offset) {
        int value = (bytes[offset + 1] << 8) & BYTE_1_MASK;
