...
/* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/zip/ZipLong.class */
public final class ZipLong implements Cloneable, Serializable {
    ...
    public static long getValue(byte[] bytes, int offset) {
        ...
        return value + ((bytes[offset + 2] << 16) & BYTE_2_MASK) + ((bytes[offset + 1] << 8) & BYTE_1_MASK) + (bytes[offset] & 255);
    }
