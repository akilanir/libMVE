...
/* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/compressors/snappy/FramedSnappyCompressorInputStream.class */
public class FramedSnappyCompressorInputStream extends CompressorInputStream {
    ...
    private void readNextBlock() throws IOException {
        ...
        if (type == PADDING_CHUNK_TYPE || (type > MAX_UNSKIPPABLE_TYPE && type <= MAX_SKIPPABLE_TYPE)) {
            skipBlock();
            readNextBlock();
            return;
        }
        if (type >= 2 && type <= MAX_UNSKIPPABLE_TYPE) {
