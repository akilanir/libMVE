...
/*  JADX ERROR: NullPointerException in pass: ClassModifier
    ...
    */
/* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/zip/ZipArchiveOutputStream.class */
public class ZipArchiveOutputStream extends ArchiveOutputStream {
    ...
    public ZipArchiveOutputStream(File file) throws IOException {
        ...
        this.def = new Deflater(this.level, true);
        this.streamCompressor = StreamCompressor.create(_raf, this.def);
        this.out = o;
        this.raf = _raf;
    }
    ...
    private void writeCentralDirectoryInChunks() throws IOException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(70 * TarArchiveEntry.MILLIS_PER_SECOND);
        int count = 0;
    ...
    private void rewriteSizesAndCrc(boolean actuallyNeedsZip64) throws IOException {
        ...
        if (hasZip64Extra(this.entry.entry)) {
            ...
            this.raf.seek(this.entry.localDataStart + 12 + 4 + nameLen + 4);
    ...
    private void writeLocalFileHeader(ZipArchiveEntry ze, boolean phased) throws IOException {
        ...
        byte[] localHeader = createLocalFileHeader(ze, name, encodable, phased);
    ...
    private byte[] createLocalFileHeader(ZipArchiveEntry ze, ByteBuffer name, boolean encodable, boolean phased) {
        ...
        if (phased && !isZip64Required(this.entry.entry, this.zip64Mode)) {
    ...
    private byte[] createCentralFileHeader(ZipArchiveEntry ze, ByteBuffer name, long lfhOffset, boolean needsZip64Extra) throws IOException {
        ...
        System.arraycopy(ZERO, 0, buf, CFH_DISK_NUMBER_OFFSET, 2);
        ...
        ZipLong.putLong(Math.min(lfhOffset, 4294967295L), buf, CFH_LFH_OFFSET);
    ...
    /* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/zip/ZipArchiveOutputStream$UnicodeExtraFieldPolicy.class */
    ...
    /* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/zip/ZipArchiveOutputStream$CurrentEntry.class */
