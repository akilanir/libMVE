...
/* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/zip/Simple8BitZipEncoding.class */
class Simple8BitZipEncoding implements ZipEncoding {
    private final char[] highChars;
    private final List<Simple8BitChar> reverseMapping;

    /* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/zip/Simple8BitZipEncoding$Simple8BitChar.class */
    ...
    public Simple8BitZipEncoding(char[] highChars) {
        ...
        char[] arr$ = this.highChars;
        for (char highChar : arr$) {
            code = (byte) (code + 1);
    ...
    public char decodeByte(byte b) {
        ...
        return this.highChars[CpioConstants.C_IWUSR + b];
    }
