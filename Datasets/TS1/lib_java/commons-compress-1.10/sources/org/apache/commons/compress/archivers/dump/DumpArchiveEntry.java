...
/* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/dump/DumpArchiveEntry.class */
public class DumpArchiveEntry implements ArchiveEntry {
    ...
    public boolean equals(Object o) {
        ...
        if (this.header == null || rhs.header == null || this.ino != rhs.ino) {
            return false;
        }
    ...
    static DumpArchiveEntry parse(byte[] buffer) {
        ...
        long t = (1000 * DumpArchiveUtil.convert32(buffer, 48)) + (DumpArchiveUtil.convert32(buffer, 52) / TarArchiveEntry.MILLIS_PER_SECOND);
        entry.setAccessTime(new Date(t));
        long t2 = (1000 * DumpArchiveUtil.convert32(buffer, 56)) + (DumpArchiveUtil.convert32(buffer, 60) / TarArchiveEntry.MILLIS_PER_SECOND);
        entry.setLastModifiedDate(new Date(t2));
        long t3 = (1000 * DumpArchiveUtil.convert32(buffer, 64)) + (DumpArchiveUtil.convert32(buffer, 68) / TarArchiveEntry.MILLIS_PER_SECOND);
        entry.ctime = t3;
    ...
    /* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/dump/DumpArchiveEntry$TapeSegmentHeader.class */
    ...
    /* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/dump/DumpArchiveEntry$TYPE.class */
    public enum TYPE {
        WHITEOUT(14),
        SOCKET(12),
        LINK(10),
    ...
    /* loaded from: commons-compress-1.10.jar:org/apache/commons/compress/archivers/dump/DumpArchiveEntry$PERMISSION.class */
