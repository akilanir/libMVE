...
/* loaded from: com.android.support.palette-v7.23.4.0.jar:android/support/v7/graphics/ColorCutQuantizer.class */
final class ColorCutQuantizer {
    ...
    /* loaded from: com.android.support.palette-v7.23.4.0.jar:android/support/v7/graphics/ColorCutQuantizer$Vbox.class */
    private class Vbox {
    ...
    public static void modifySignificantOctet(int[] a, int dimension, int lower, int upper) {
        switch (dimension) {
            ...
            case -1:
                for (int i2 = lower; i2 <= upper; i2++) {
                    int color2 = a[i2];
                    a[i2] = (quantizedBlue(color2) << 10) | (quantizedGreen(color2) << QUANTIZE_WORD_WIDTH) | quantizedRed(color2);
                }
                break;
        }
    }
    ...
    private static int quantizeFromRgb888(int color) {
        ...
        return (r << 10) | (g << QUANTIZE_WORD_WIDTH) | b;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static int approximateToRgb888(int r, int g, int b) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int quantizedRed(int color) {
        return (color >> 10) & QUANTIZE_WORD_MASK;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static int quantizedGreen(int color) {
        return (color >> QUANTIZE_WORD_WIDTH) & QUANTIZE_WORD_MASK;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static int quantizedBlue(int color) {
