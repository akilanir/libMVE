...
/* loaded from: com.android.support.palette-v7.23.4.0.jar:android/support/v7/graphics/Palette.class */
public final class Palette {
    ...
    /* loaded from: com.android.support.palette-v7.23.4.0.jar:android/support/v7/graphics/Palette$Filter.class */
    public interface Filter {
        boolean isAllowed(int i, float[] fArr);
    }

    /* loaded from: com.android.support.palette-v7.23.4.0.jar:android/support/v7/graphics/Palette$PaletteAsyncListener.class */
    ...
    private float generateScore(Swatch swatch, Target target) {
        ...
        if (target.getPopulationWeight() > 0.0f) {
            populationScore = target.getPopulationWeight() * (swatch.getPopulation() / this.mMaxPopulation);
        }
    ...
    private int findMaxPopulation() {
        ...
        int count = this.mSwatches.size();
        for (int i = 0; i < count; i++) {
            max = Math.max(this.mSwatches.get(i).getPopulation(), max);
        }
        return max;
    }
    ...
    /* loaded from: com.android.support.palette-v7.23.4.0.jar:android/support/v7/graphics/Palette$Swatch.class */
    ...
    /* loaded from: com.android.support.palette-v7.23.4.0.jar:android/support/v7/graphics/Palette$Builder.class */
    public static final class Builder {
        private final List<Swatch> mSwatches;
        private final Bitmap mBitmap;
        private final List<Target> mTargets = new ArrayList();
        private int mMaxColors = Palette.DEFAULT_CALCULATE_NUMBER_COLORS;
        ...
        private Bitmap scaleBitmapDown(Bitmap bitmap) {
            ...
            if (this.mResizeArea > 0) {
                ...
                if (bitmapArea > this.mResizeArea) {
                    scaleRatio = this.mResizeArea / bitmapArea;
                }
