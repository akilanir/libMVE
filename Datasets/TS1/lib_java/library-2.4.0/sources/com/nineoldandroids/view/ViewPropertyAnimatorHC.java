...
/* loaded from: library-2.4.0.jar:com/nineoldandroids/view/ViewPropertyAnimatorHC.class */
class ViewPropertyAnimatorHC extends ViewPropertyAnimator {
    ...
    /* loaded from: library-2.4.0.jar:com/nineoldandroids/view/ViewPropertyAnimatorHC$PropertyBundle.class */
    private static class PropertyBundle {
        ...
        boolean cancel(int propertyConstant) {
            if ((this.mPropertyMask & propertyConstant) != 0 && this.mNameValuesHolder != null) {
                ...
                for (int i = ViewPropertyAnimatorHC.NONE; i < count; i++) {
    ...
    /* loaded from: library-2.4.0.jar:com/nineoldandroids/view/ViewPropertyAnimatorHC$NameValuesHolder.class */
    ...
    /* loaded from: library-2.4.0.jar:com/nineoldandroids/view/ViewPropertyAnimatorHC$AnimatorEventListener.class */
    private class AnimatorEventListener implements Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            if ((propertyMask & ViewPropertyAnimatorHC.TRANSFORM_MASK) != 0 && (v = (View) ViewPropertyAnimatorHC.this.mView.get()) != null) {
                v.invalidate();
            }
