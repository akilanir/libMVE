...
/* loaded from: library-2.4.0.jar:com/nineoldandroids/animation/FloatKeyframeSet.class */
class FloatKeyframeSet extends KeyframeSet {
    ...
    public FloatKeyframeSet mo3clone() {
        ...
        for (int i = 0; i < numKeyframes; i++) {
            newKeyframes[i] = (Keyframe.FloatKeyframe) keyframes.get(i).mo4clone();
        }
