...
/* loaded from: library-2.4.0.jar:com/nineoldandroids/animation/IntKeyframeSet.class */
class IntKeyframeSet extends KeyframeSet {
    ...
    @Override // com.nineoldandroids.animation.KeyframeSet
    /* renamed from: clone */
    public IntKeyframeSet mo3clone() {
        ...
        for (int i = 0; i < numKeyframes; i++) {
            newKeyframes[i] = (Keyframe.IntKeyframe) keyframes.get(i).mo4clone();
        }
