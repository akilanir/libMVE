...
/* loaded from: gson-2.5.jar:com/google/gson/Gson.class */
public final class Gson {
    ...
    private static TypeAdapter<AtomicLongArray> atomicLongArrayAdapter(final TypeAdapter<Number> longAdapter) {
        return new TypeAdapter<AtomicLongArray>() { // from class: com.google.gson.Gson.7
            ...
            public void write(JsonWriter out, AtomicLongArray value) throws IOException {
                ...
                for (int i = Gson.DEFAULT_JSON_NON_EXECUTABLE; i < length; i++) {
    ...
    /* loaded from: gson-2.5.jar:com/google/gson/Gson$FutureTypeAdapter.class */
