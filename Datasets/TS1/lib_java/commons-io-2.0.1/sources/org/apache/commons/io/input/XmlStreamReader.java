...
/* loaded from: commons-io-2.0.1.jar:org/apache/commons/io/input/XmlStreamReader.class */
public class XmlStreamReader extends Reader {
    ...
    private static final ByteOrderMark[] XML_GUESS_BYTES = {new ByteOrderMark(UTF_8, 60, 63, 120, 109), new ByteOrderMark(UTF_16BE, 0, 60, 0, 63), new ByteOrderMark(UTF_16LE, 60, 0, 63, 0), new ByteOrderMark(EBCDIC, 76, 111, 167, 148)};
