...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/ts/H265Reader.class */
final class H265Reader extends ElementaryStreamReader {
    ...
    private static MediaFormat parseMediaFormat(NalUnitTargetBuffer vps, NalUnitTargetBuffer sps, NalUnitTargetBuffer pps) {
        ...
        return MediaFormat.createVideoFormat(null, MimeTypes.VIDEO_H265, -1, -1, -1L, picWidthInLumaSamples, picHeightInLumaSamples, Collections.singletonList(csd), -1, pixelWidthHeightRatio);
    }
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/ts/H265Reader$SampleReader.class */
    private static final class SampleReader {
        ...
        public void startNalUnit(long position, int offset, int nalUnitType, long pesTimeUs) {
            ...
            this.nalUnitHasKeyframeData = nalUnitType >= 16 && nalUnitType <= H265Reader.CRA_NUT;
            this.lookingForFirstSliceFlag = this.nalUnitHasKeyframeData || nalUnitType <= H265Reader.RASL_R;
        }
