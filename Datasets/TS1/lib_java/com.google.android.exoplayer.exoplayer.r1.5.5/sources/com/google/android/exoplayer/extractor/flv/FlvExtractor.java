...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/flv/FlvExtractor.class */
public final class FlvExtractor implements Extractor, SeekMap {
    ...
    private final ParsableByteArray tagHeaderBuffer = new ParsableByteArray(FLV_TAG_HEADER_SIZE);
    ...
    private boolean readTagHeader(ExtractorInput input) throws IOException, InterruptedException {
        if (!input.readFully(this.tagHeaderBuffer.data, 0, FLV_TAG_HEADER_SIZE, true)) {
            return false;
        }
