...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/smoothstreaming/SmoothStreamingChunkSource.class */
public class SmoothStreamingChunkSource implements ChunkSource, SmoothStreamingTrackSelector.Output {
    ...
    private MediaFormat initManifestTrack(SmoothStreamingManifest manifest, int elementIndex, int trackIndex) {
        ...
        FragmentedMp4Extractor mp4Extractor = new FragmentedMp4Extractor(3);
        ...
        this.extractorWrappers.put(manifestTrackKey, new ChunkExtractorWrapper(mp4Extractor));
        return mediaFormat;
    }
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/smoothstreaming/SmoothStreamingChunkSource$ExposedTrack.class */
