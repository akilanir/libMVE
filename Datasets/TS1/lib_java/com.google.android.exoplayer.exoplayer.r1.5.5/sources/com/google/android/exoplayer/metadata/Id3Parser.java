...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/metadata/Id3Parser.class */
    ...
    public Map<String, Object> parse(byte[] data, int size) throws UnsupportedEncodingException, ParserException {
        ...
        while (true) {
            ...
            if (frameId0 == 84 && frameId1 == 88 && frameId2 == 88 && frameId3 == 88) {
                ...
                metadata.put(GeobMetadata.TYPE, new GeobMetadata(mimeType, filename, description2, objectData));
            } else {
