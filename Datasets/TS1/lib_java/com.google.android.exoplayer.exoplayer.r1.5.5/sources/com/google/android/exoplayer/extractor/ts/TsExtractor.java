...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/ts/TsExtractor.class */
public final class TsExtractor implements Extractor {
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/ts/TsExtractor$TsPayloadReader.class */
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/ts/TsExtractor$PatReader.class */
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/ts/TsExtractor$PmtReader.class */
                ...
                if (!TsExtractor.this.streamTypes.get(streamType)) {
                    switch (streamType) {
                        ...
                        case TsExtractor.TS_STREAM_TYPE_AAC /* 15 */:
                            pesPayloadReader = new AdtsReader(output.track(TsExtractor.TS_STREAM_TYPE_AAC), new DummyTrackOutput());
                            break;
                        case TsExtractor.TS_STREAM_TYPE_ID3 /* 21 */:
                            pesPayloadReader = TsExtractor.this.id3Reader;
                            break;
                        case TsExtractor.TS_STREAM_TYPE_H264 /* 27 */:
                            pesPayloadReader = new H264Reader(output.track(TsExtractor.TS_STREAM_TYPE_H264), new SeiReader(output.track(TsExtractor.TS_STREAM_TYPE_EIA608)), TsExtractor.this.idrKeyframesOnly);
                            break;
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/ts/TsExtractor$PesReader.class */
        ...
        private void parseHeaderExtension() {
            ...
            if (this.ptsFlag) {
                ...
                if (!this.seenFirstDts && this.dtsFlag) {
                    ...
                    this.pesScratch.skipBits(1);
                    this.pesScratch.skipBits(1);
                    TsExtractor.this.ptsTimestampAdjuster.adjustTimestamp(dts | (this.pesScratch.readBits(TsExtractor.TS_STREAM_TYPE_AAC) << TsExtractor.TS_STREAM_TYPE_AAC) | this.pesScratch.readBits(TsExtractor.TS_STREAM_TYPE_AAC));
