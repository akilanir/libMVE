...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/mp4/Atom.class */
abstract class Atom {
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/mp4/Atom$LeafAtom.class */
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.5.jar:com/google/android/exoplayer/extractor/mp4/Atom$ContainerAtom.class */
    ...
    public static String getAtomTypeString(int type) {
        return "" + ((char) (type >> 24)) + ((char) ((type >> 16) & NalUnitUtil.EXTENDED_SAR)) + ((char) ((type >> 8) & NalUnitUtil.EXTENDED_SAR)) + ((char) (type & NalUnitUtil.EXTENDED_SAR));
    }
}
