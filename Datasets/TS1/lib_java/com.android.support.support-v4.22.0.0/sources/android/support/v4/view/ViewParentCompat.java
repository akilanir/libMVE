...
/* loaded from: com.android.support.support-v4.22.0.0.jar:android/support/v4/view/ViewParentCompat.class */
public class ViewParentCompat {
    static final ViewParentCompatImpl IMPL;

    /* loaded from: com.android.support.support-v4.22.0.0.jar:android/support/v4/view/ViewParentCompat$ViewParentCompatImpl.class */
    interface ViewParentCompatImpl {
        boolean requestSendAccessibilityEvent(ViewParent viewParent, View view, AccessibilityEvent accessibilityEvent);
    }

    /* loaded from: com.android.support.support-v4.22.0.0.jar:android/support/v4/view/ViewParentCompat$ViewParentCompatStubImpl.class */
    ...
    /* loaded from: com.android.support.support-v4.22.0.0.jar:android/support/v4/view/ViewParentCompat$ViewParentCompatICSImpl.class */
