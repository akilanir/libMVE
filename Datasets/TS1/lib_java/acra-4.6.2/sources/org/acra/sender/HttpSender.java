...
/* loaded from: acra-4.6.2.jar:org/acra/sender/HttpSender.class */
public class HttpSender implements ReportSender {
    ...
    /* loaded from: acra-4.6.2.jar:org/acra/sender/HttpSender$Method.class */
    public enum Method {
        POST,
        PUT
    }

    /* loaded from: acra-4.6.2.jar:org/acra/sender/HttpSender$Type.class */
    public enum Type {
    ...
    public void send(Context context, CrashReportData report) throws ReportSenderException {
        ...
        try {
            ...
            String login = this.mUsername != null ? this.mUsername : ACRAConfiguration.isNull(ACRA.getConfig().formUriBasicAuthLogin()) ? null : ACRA.getConfig().formUriBasicAuthLogin();
            String password = this.mPassword != null ? this.mPassword : ACRAConfiguration.isNull(ACRA.getConfig().formUriBasicAuthPassword()) ? null : ACRA.getConfig().formUriBasicAuthPassword();
