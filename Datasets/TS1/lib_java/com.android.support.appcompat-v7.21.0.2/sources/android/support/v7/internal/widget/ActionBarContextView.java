...
/* loaded from: com.android.support.appcompat-v7.21.0.2.jar:android/support/v7/internal/widget/ActionBarContextView.class */
public class ActionBarContextView extends AbsActionBarView implements ViewPropertyAnimatorListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mCustomView != null) {
            ...
            int customWidthMode = lp2.width != -2 ? 1073741824 : RtlSpacingHelper.UNDEFINED;
            int customWidth = lp2.width >= 0 ? Math.min(lp2.width, availableWidth) : availableWidth;
            int customHeightMode = lp2.height != -2 ? 1073741824 : RtlSpacingHelper.UNDEFINED;
