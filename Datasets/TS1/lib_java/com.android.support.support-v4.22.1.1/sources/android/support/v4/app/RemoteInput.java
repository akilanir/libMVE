...
/* loaded from: com.android.support.support-v4.22.1.1.jar:android/support/v4/app/RemoteInput.class */
public class RemoteInput extends RemoteInputCompatBase.RemoteInput {
    ...
    /* loaded from: com.android.support.support-v4.22.1.1.jar:android/support/v4/app/RemoteInput$Impl.class */
    interface Impl {
    ...
    /* loaded from: com.android.support.support-v4.22.1.1.jar:android/support/v4/app/RemoteInput$Builder.class */
    ...
    /* loaded from: com.android.support.support-v4.22.1.1.jar:android/support/v4/app/RemoteInput$ImplBase.class */
    ...
    /* loaded from: com.android.support.support-v4.22.1.1.jar:android/support/v4/app/RemoteInput$ImplJellybean.class */
    ...
    /* loaded from: com.android.support.support-v4.22.1.1.jar:android/support/v4/app/RemoteInput$ImplApi20.class */
    ...
    static {
        ...
        FACTORY = new RemoteInputCompatBase.RemoteInput.Factory() { // from class: android.support.v4.app.RemoteInput.1
            ...
            public RemoteInput m26build(String resultKey, CharSequence label, CharSequence[] choices, boolean allowFreeFormInput, Bundle extras) {
                return new RemoteInput(resultKey, label, choices, allowFreeFormInput, extras);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public RemoteInput[] m25newArray(int size) {
