...
/* loaded from: commons-validator-1.4.0.jar:org/apache/commons/validator/routines/RegexValidator.class */
    ...
    public RegexValidator(String[] regexs, boolean caseSensitive) {
        ...
        for (int i = 0; i < regexs.length; i++) {
            if (regexs[i] == null || regexs[i].length() == 0) {
                throw new IllegalArgumentException(new StringBuffer().append("Regular expression[").append(i).append("] is missing").toString());
            }
