...
/* loaded from: commons-validator-1.4.0.jar:org/apache/commons/validator/routines/UrlValidator.class */
public class UrlValidator implements Serializable {
    ...
    public boolean isValid(String value) {
        ...
        if (((!"file".equals(scheme) || !"".equals(authority)) && !isValidAuthority(authority)) || !isValidPath(urlMatcher.group(PARSE_URL_PATH)) || !isValidQuery(urlMatcher.group(PARSE_URL_QUERY)) || !isValidFragment(urlMatcher.group(PARSE_URL_FRAGMENT))) {
            return false;
        }
        return true;
    }
    ...
    protected boolean isValidScheme(String scheme) {
        ...
        if (isOff(1L) && !this.allowedSchemes.contains(scheme)) {
            return false;
        }
        return true;
    }
    ...
    protected boolean isValidAuthority(String authority) {
        ...
        DomainValidator domainValidator = DomainValidator.getInstance(isOn(8L));
