...
/* loaded from: commons-validator-1.4.0.jar:org/apache/commons/validator/routines/CodeValidator.class */
public final class CodeValidator implements Serializable {
    ...
    public Object validate(String input) {
        ...
        if (this.minLength >= 0 && code.length() < this.minLength) {
            return null;
        }
        if (this.maxLength >= 0 && code.length() > this.maxLength) {
            return null;
        }
