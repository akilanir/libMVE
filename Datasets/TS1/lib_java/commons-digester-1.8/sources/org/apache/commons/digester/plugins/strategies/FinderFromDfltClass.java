...
/* loaded from: commons-digester-1.8.jar:org/apache/commons/digester/plugins/strategies/FinderFromDfltClass.class */
public class FinderFromDfltClass extends RuleFinder {
    ...
    public RuleLoader findLoader(Digester digester, Class pluginClass, Properties p) throws PluginException {
        String rulesClassName = new StringBuffer().append(pluginClass.getName()).append(this.rulesClassSuffix).toString();
