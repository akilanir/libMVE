...
/* loaded from: commons-digester-1.8.jar:org/apache/commons/digester/plugins/strategies/FinderFromDfltResource.class */
public class FinderFromDfltResource extends RuleFinder {
    ...
    public RuleLoader findLoader(Digester d, Class pluginClass, Properties p) throws PluginException {
        String resourceName = new StringBuffer().append(pluginClass.getName().replace('.', '/')).append(this.resourceSuffix).toString();
