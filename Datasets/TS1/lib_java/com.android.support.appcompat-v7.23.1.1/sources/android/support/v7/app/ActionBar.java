...
/* loaded from: com.android.support.appcompat-v7.23.1.1.jar:android/support/v7/app/ActionBar.class */
public abstract class ActionBar {
    ...
    /* loaded from: com.android.support.appcompat-v7.23.1.1.jar:android/support/v7/app/ActionBar$DisplayOptions.class */
    public @interface DisplayOptions {
    }

    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: com.android.support.appcompat-v7.23.1.1.jar:android/support/v7/app/ActionBar$NavigationMode.class */
    public @interface NavigationMode {
    }

    /* loaded from: com.android.support.appcompat-v7.23.1.1.jar:android/support/v7/app/ActionBar$OnMenuVisibilityListener.class */
    public interface OnMenuVisibilityListener {
        void onMenuVisibilityChanged(boolean z);
    }

    /* loaded from: com.android.support.appcompat-v7.23.1.1.jar:android/support/v7/app/ActionBar$OnNavigationListener.class */
    public interface OnNavigationListener {
        boolean onNavigationItemSelected(int i, long j);
    }

    /* loaded from: com.android.support.appcompat-v7.23.1.1.jar:android/support/v7/app/ActionBar$Tab.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.1.1.jar:android/support/v7/app/ActionBar$TabListener.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.1.1.jar:android/support/v7/app/ActionBar$LayoutParams.class */
