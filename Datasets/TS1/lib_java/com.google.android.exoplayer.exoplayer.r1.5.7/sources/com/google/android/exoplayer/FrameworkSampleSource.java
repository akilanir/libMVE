...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/FrameworkSampleSource.class */
public final class FrameworkSampleSource implements SampleSource, SampleSource.SampleSourceReader {
    ...
    private static MediaFormat createMediaFormat(android.media.MediaFormat format) {
        ...
        MediaFormat mediaFormat = new MediaFormat(null, mimeType, -1, maxInputSize, durationUs, width, height, rotationDegrees, -1.0f, channelCount, sampleRate, language, Long.MAX_VALUE, initializationData, false, -1, -1, encoderDelay, encoderPadding);
