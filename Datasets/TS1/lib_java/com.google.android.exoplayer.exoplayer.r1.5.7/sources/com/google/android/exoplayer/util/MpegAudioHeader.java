...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/util/MpegAudioHeader.class */
public final class MpegAudioHeader {
    ...
    public static int getFrameSize(int header) {
        ...
        if (layer == 3) {
            ...
            return (((12000 * bitrate2) / samplingRate) + padding) * 4;
        }
        if (version == 3) {
