...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/util/UriUtil.class */
public final class UriUtil {
    ...
    public static String resolve(String baseUri, String referenceUri) {
        ...
        if (refIndices[1] != 0) {
            ...
            return removeDotSegments(uri, baseLimit + refIndices[1], baseLimit + refIndices[2]);
        }
        if (refIndices[1] != refIndices[2] && referenceUri2.charAt(refIndices[1]) == '/') {
        ...
        return removeDotSegments(uri, baseIndices[1], baseLimit2 + refIndices[2]);
    }
