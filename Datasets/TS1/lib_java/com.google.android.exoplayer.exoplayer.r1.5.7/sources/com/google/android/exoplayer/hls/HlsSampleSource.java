...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/hls/HlsSampleSource.class */
public final class HlsSampleSource implements SampleSource, SampleSource.SampleSourceReader, Loader.Callback {
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/hls/HlsSampleSource$EventListener.class */
        ...
        for (int i2 = 0; i2 < extractorTrackCount; i2++) {
            ...
            if (i2 == primaryExtractorTrackIndex) {
                for (int j = 0; j < chunkSourceTrackCount; j++) {
                    ...
                    int i3 = trackIndex;
                    trackIndex++;
                    this.trackFormats[i3] = fixedTrackVariant == null ? format.copyAsAdaptive(null) : copyWithFixedTrackInfo(format, fixedTrackVariant.format, language);
                }
            } else {
                this.extractorTrackIndices[trackIndex] = i2;
                ...
                int i4 = trackIndex;
                trackIndex++;
                this.trackFormats[i4] = format.copyWithLanguage(language);
            }
        }
    }
