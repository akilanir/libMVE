...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/text/ttml/TtmlNode.class */
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String text) {
        return new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(text), -1L, -1L, null, null);
    }
    ...
    public long[] getEventTimesUs() {
        ...
        while (eventTimeIterator.hasNext()) {
            long eventTimeUs = eventTimeIterator.next().longValue();
            int i2 = i;
            i++;
            eventTimes[i2] = eventTimeUs;
        }
        return eventTimes;
    }
