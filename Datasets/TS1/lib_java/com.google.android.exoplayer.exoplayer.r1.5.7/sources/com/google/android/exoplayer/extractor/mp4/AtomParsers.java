...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/mp4/AtomParsers.class */
final class AtomParsers {
    ...
    private static int parseExpandableClassSize(ParsableByteArray data) {
        ...
        int i = currentByte & 127;
        while (true) {
            int size = i;
            if ((currentByte & 128) == 128) {
                currentByte = data.readUnsignedByte();
                i = (size << 7) | (currentByte & 127);
            } else {
                return size;
            }
        }
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/mp4/AtomParsers$TkhdData.class */
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/mp4/AtomParsers$StsdData.class */
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/mp4/AtomParsers$AvcCData.class */
