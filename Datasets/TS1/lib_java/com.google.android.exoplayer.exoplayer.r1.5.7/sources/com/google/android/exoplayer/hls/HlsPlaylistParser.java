...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/hls/HlsPlaylistParser.class */
public final class HlsPlaylistParser implements UriLoadable.Parser<HlsPlaylist> {
        ...
        while (iterator.hasNext()) {
            ...
            if (line.startsWith(MEDIA_TAG)) {
                ...
                if (CLOSED_CAPTIONS_TYPE.equals(type)) {
                    ...
                    Format format = new Format(subtitleName, MimeTypes.APPLICATION_M3U8, -1, -1, -1.0f, -1, -1, -1, HlsParserUtil.parseOptionalStringAttr(line, LANGUAGE_ATTR_REGEX), codecs);
                    ...
                    if (uri2 != null) {
                        ...
                        Format format2 = new Format(audioName, MimeTypes.APPLICATION_M3U8, -1, -1, -1.0f, -1, -1, -1, language, codecs);
                        audios.add(new Variant(uri2, format2));
                    } else {
                ...
                Format format3 = new Format(name, MimeTypes.APPLICATION_M3U8, width, height, -1.0f, -1, -1, bitrate, null, codecs);
                variants.add(new Variant(line, format3));
                bitrate = 0;
                codecs = null;
                name = null;
                width = -1;
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/hls/HlsPlaylistParser$LineIterator.class */
