...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/ts/TsExtractor.class */
public final class TsExtractor implements Extractor {
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/ts/TsExtractor$TsPayloadReader.class */
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/ts/TsExtractor$PatReader.class */
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/ts/TsExtractor$PmtReader.class */
    private class PmtReader extends TsPayloadReader {
        ...
        public void consume(ParsableByteArray data, boolean payloadUnitStartIndicator, ExtractorOutput output) {
            ...
            ElementaryStreamReader h264Reader;
            if (payloadUnitStartIndicator) {
                int pointerField = data.readUnsignedByte();
                data.skipBytes(pointerField);
                ...
                if (!TsExtractor.this.streamTypes.get(streamType)) {
                    switch (streamType) {
                        ...
                        case TsExtractor.TS_STREAM_TYPE_AAC /* 15 */:
                            pesPayloadReader = (TsExtractor.this.workaroundFlags & 2) != 0 ? null : new AdtsReader(output.track(TsExtractor.TS_STREAM_TYPE_AAC), new DummyTrackOutput());
                            break;
                        ...
                        case TsExtractor.TS_STREAM_TYPE_H264 /* 27 */:
                            if ((TsExtractor.this.workaroundFlags & 4) != 0) {
                                ...
                                h264Reader = new H264Reader(output.track(TsExtractor.TS_STREAM_TYPE_H264), new SeiReader(output.track(TsExtractor.TS_STREAM_TYPE_EIA608)), (TsExtractor.this.workaroundFlags & 1) != 0, (TsExtractor.this.workaroundFlags & 8) != 0);
                            }
                            pesPayloadReader = h264Reader;
                            break;
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/ts/TsExtractor$PesReader.class */
    private static final class PesReader extends TsPayloadReader {
        ...
        private boolean parseHeader() {
            ...
            this.payloadSize = ((packetLength + 6) - HEADER_SIZE) - this.extendedHeaderLength;
            return true;
        }
        ...
        private void parseHeaderExtension() {
            ...
            if (this.ptsFlag) {
                ...
                this.pesScratch.skipBits(1);
                long pts2 = pts | (this.pesScratch.readBits(TsExtractor.TS_STREAM_TYPE_AAC) << TsExtractor.TS_STREAM_TYPE_AAC) | this.pesScratch.readBits(TsExtractor.TS_STREAM_TYPE_AAC);
                this.pesScratch.skipBits(1);
                if (!this.seenFirstDts && this.dtsFlag) {
                    ...
                    this.pesScratch.skipBits(1);
                    this.pesScratch.skipBits(1);
                    this.ptsTimestampAdjuster.adjustTimestamp(dts | (this.pesScratch.readBits(TsExtractor.TS_STREAM_TYPE_AAC) << TsExtractor.TS_STREAM_TYPE_AAC) | this.pesScratch.readBits(TsExtractor.TS_STREAM_TYPE_AAC));
