...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/hls/HlsChunkSource.class */
public class HlsChunkSource implements HlsTrackSelector.Output {
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/hls/HlsChunkSource$EventListener.class */
    ...
    public HlsChunkSource(boolean isMaster, DataSource dataSource, String playlistUrl, HlsPlaylist playlist, HlsTrackSelector trackSelector, BandwidthMeter bandwidthMeter, PtsTimestampAdjusterProvider timestampAdjusterProvider, int adaptiveMode, long minBufferDurationToSwitchUpMs, long maxBufferDurationToSwitchDownMs) {
        ...
        this.masterPlaylist = new HlsMasterPlaylist(playlistUrl, variants, Collections.emptyList(), Collections.emptyList(), null, null);
    }
    ...
    public void getChunkOperation(TsChunk previousTsChunk, long playbackPositionUs, ChunkOperationHolder out) {
        ...
        if (lastPathSegment.endsWith(AAC_FILE_EXTENSION)) {
            ...
            Extractor extractor4 = new TsExtractor(timestampAdjuster2, workaroundFlags);
            ExposedTrack selectedTrack = this.tracks.get(this.selectedTrackIndex);
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/hls/HlsChunkSource$ExposedTrack.class */
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/hls/HlsChunkSource$MediaPlaylistChunk.class */
    ...
    /* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/hls/HlsChunkSource$EncryptionKeyChunk.class */
