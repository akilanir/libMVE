...
/* loaded from: com.google.android.exoplayer.exoplayer.r1.5.7.jar:com/google/android/exoplayer/extractor/ogg/VorbisBitArray.class */
    ...
    public int readBits(int numBits) {
        ...
        if (numBits - bitCount > 7) {
            ...
            for (int i = 0; i < numBytes; i++) {
                ...
                result = (int) (result | ((bArr[r3] & 255) << bitCount));
                bitCount += 8;
            }
        }
        if (numBits > bitCount) {
