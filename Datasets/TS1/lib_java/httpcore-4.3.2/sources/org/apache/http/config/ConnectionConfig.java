...
@Immutable
/* loaded from: httpcore-4.3.2.jar:org/apache/http/config/ConnectionConfig.class */
public class ConnectionConfig implements Cloneable {
    ...
    public ConnectionConfig m3clone() throws CloneNotSupportedException {
    ...
    /* loaded from: httpcore-4.3.2.jar:org/apache/http/config/ConnectionConfig$Builder.class */
