...
/* loaded from: httpcore-4.3.2.jar:org/apache/http/config/MessageConstraints.class */
public class MessageConstraints implements Cloneable {
    ...
    public MessageConstraints m5clone() throws CloneNotSupportedException {
    ...
    /* loaded from: httpcore-4.3.2.jar:org/apache/http/config/MessageConstraints$Builder.class */
