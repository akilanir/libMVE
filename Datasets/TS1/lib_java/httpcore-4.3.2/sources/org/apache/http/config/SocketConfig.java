...
@Immutable
/* loaded from: httpcore-4.3.2.jar:org/apache/http/config/SocketConfig.class */
public class SocketConfig implements Cloneable {
    ...
    public SocketConfig m7clone() throws CloneNotSupportedException {
    ...
    /* loaded from: httpcore-4.3.2.jar:org/apache/http/config/SocketConfig$Builder.class */
