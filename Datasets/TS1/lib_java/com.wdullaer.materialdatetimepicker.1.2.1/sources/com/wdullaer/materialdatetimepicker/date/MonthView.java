...
/* loaded from: com.wdullaer.materialdatetimepicker.1.2.1.jar:com/wdullaer/materialdatetimepicker/date/MonthView.class */
public abstract class MonthView extends View {
    ...
    /* loaded from: com.wdullaer.materialdatetimepicker.1.2.1.jar:com/wdullaer/materialdatetimepicker/date/MonthView$OnDayClickListener.class */
    ...
    public MonthView(Context context, AttributeSet attr) {
        ...
        this.mMonthTitleBGColor = res.getColor(R.color.mdtp_circle_background);
    ...
    protected void drawMonthDayLabels(Canvas canvas) {
        ...
        for (int i = 0; i < this.mNumDays; i++) {
            ...
            canvas.drawText(this.mDayLabelCalendar.getDisplayName(7, 1, Locale.getDefault()).toUpperCase(Locale.getDefault()).substring(0, 1), x, y, this.mMonthDayLabelPaint);
        }
    }
    ...
    /* loaded from: com.wdullaer.materialdatetimepicker.1.2.1.jar:com/wdullaer/materialdatetimepicker/date/MonthView$MonthViewTouchHelper.class */
