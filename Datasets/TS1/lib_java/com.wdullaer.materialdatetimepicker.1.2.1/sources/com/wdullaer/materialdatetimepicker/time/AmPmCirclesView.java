...
/* loaded from: com.wdullaer.materialdatetimepicker.1.2.1.jar:com/wdullaer/materialdatetimepicker/time/AmPmCirclesView.class */
public class AmPmCirclesView extends View {
    ...
    void setTheme(Context context, boolean themeDark) {
        Resources res = context.getResources();
        if (themeDark) {
            this.mUnselectedColor = res.getColor(R.color.mdtp_dark_gray);
