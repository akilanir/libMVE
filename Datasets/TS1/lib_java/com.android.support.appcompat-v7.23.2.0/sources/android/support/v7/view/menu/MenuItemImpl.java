...
/* loaded from: com.android.support.appcompat-v7.23.2.0.jar:android/support/v7/view/menu/MenuItemImpl.class */
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public SupportMenuItem m17setActionView(View view) {
    ...
    /* renamed from: setActionView, reason: merged with bridge method [inline-methods] */
    public SupportMenuItem m16setActionView(int resId) {
        Context context = this.mMenu.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        m17setActionView(inflater.inflate(resId, (ViewGroup) new LinearLayout(context), false));
        return this;
    }
    ...
    public SupportMenuItem m18setShowAsActionFlags(int actionEnum) {
