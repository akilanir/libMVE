...
/* loaded from: com.android.support.appcompat-v7.23.2.0.jar:android/support/v7/widget/AppCompatDrawableManager.class */
public final class AppCompatDrawableManager {
    ...
    private static final int[] TINT_COLOR_CONTROL_NORMAL = {R.drawable.abc_ic_search_api_mtrl_alpha, R.drawable.abc_ic_commit_search_api_mtrl_alpha};
    ...
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = {R.drawable.abc_tab_indicator_material, R.drawable.abc_textfield_search_material, R.drawable.abc_ratingbar_full_material};
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = {R.drawable.abc_btn_check_material, R.drawable.abc_btn_radio_material};

    /* loaded from: com.android.support.appcompat-v7.23.2.0.jar:android/support/v7/widget/AppCompatDrawableManager$InflateDelegate.class */
    ...
    private Drawable loadDrawableFromDelegates(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (this.mDelegates != null && !this.mDelegates.isEmpty()) {
            ...
            long key = (tv.assetCookie << 32) | tv.data;
    ...
    /* loaded from: com.android.support.appcompat-v7.23.2.0.jar:android/support/v7/widget/AppCompatDrawableManager$ColorFilterLruCache.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.2.0.jar:android/support/v7/widget/AppCompatDrawableManager$VdcInflateDelegate.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.2.0.jar:android/support/v7/widget/AppCompatDrawableManager$AvdcInflateDelegate.class */
