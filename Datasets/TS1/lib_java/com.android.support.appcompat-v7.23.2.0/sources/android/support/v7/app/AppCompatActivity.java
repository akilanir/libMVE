...
/* loaded from: com.android.support.appcompat-v7.23.2.0.jar:android/support/v7/app/AppCompatActivity.class */
public class AppCompatActivity extends FragmentActivity implements AppCompatCallback, TaskStackBuilder.SupportParentable, ActionBarDrawerToggle.DelegateProvider {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (keyCode == 19) {
            ...
            if (action == 0) {
                if (event.hasModifiers(2) && (actionBar = getSupportActionBar()) != null && actionBar.isShowing() && actionBar.requestFocus()) {
