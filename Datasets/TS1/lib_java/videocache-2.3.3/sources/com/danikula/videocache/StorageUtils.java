...
/* loaded from: videocache-2.3.3.jar:com/danikula/videocache/StorageUtils.class */
final class StorageUtils {
    ...
    private static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (appCacheDir == null) {
            ...
            Log.w("ProxyCache", "Can't define system cache directory! '" + cacheDirPath + "%s' will be used.");
