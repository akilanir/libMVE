...
/* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/ZonedChronology.class */
public final class ZonedChronology extends AssembledChronology {
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/ZonedChronology$ZonedDurationField.class */
    static class ZonedDurationField extends BaseDurationField {
        ...
        public long add(long j, int i) {
            return this.iField.add(j + getOffsetToAdd(j), i) - (this.iTimeField ? r0 : getOffsetFromLocalToSubtract(r0));
        }

        @Override // org.joda.time.DurationField
        public long add(long j, long j2) {
            return this.iField.add(j + getOffsetToAdd(j), j2) - (this.iTimeField ? r0 : getOffsetFromLocalToSubtract(r0));
        }
        ...
        private int getOffsetFromLocalToSubtract(long j) {
            ...
            if ((j ^ (j - offsetFromLocal)) < 0 && (j ^ offsetFromLocal) < 0) {
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/ZonedChronology$ZonedDateTimeField.class */
