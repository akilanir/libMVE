...
/* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/BuddhistChronology.class */
public final class BuddhistChronology extends AssembledChronology {
    ...
    public static BuddhistChronology getInstance(DateTimeZone dateTimeZone) {
        ...
        if (buddhistChronology == null) {
            ...
            BuddhistChronology putIfAbsent = cCache.putIfAbsent(dateTimeZone, buddhistChronology);
            if (putIfAbsent != null) {
                buddhistChronology = putIfAbsent;
            }
        }
