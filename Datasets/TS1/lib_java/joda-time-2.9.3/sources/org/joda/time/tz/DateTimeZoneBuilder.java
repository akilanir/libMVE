...
/* loaded from: joda-time-2.9.3.jar:org/joda/time/tz/DateTimeZoneBuilder.class */
public class DateTimeZoneBuilder {
    ...
    private boolean addTransition(ArrayList<Transition> arrayList, Transition transition) {
        ...
        if (transition.getMillis() + transition2.getWallOffset() != transition2.getMillis() + i) {
            arrayList.add(transition);
            return true;
        }
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/tz/DateTimeZoneBuilder$OfYear.class */
    private static final class OfYear {
        ...
        private long setDayOfMonth(Chronology chronology, long j) {
            ...
            if (this.iDayOfMonth >= 0) {
                add = chronology.dayOfMonth().set(j, this.iDayOfMonth);
            } else {
                add = chronology.dayOfMonth().add(chronology.monthOfYear().add(chronology.dayOfMonth().set(j, 1), 1), this.iDayOfMonth);
            }
            return add;
        }
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/tz/DateTimeZoneBuilder$Recurrence.class */
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/tz/DateTimeZoneBuilder$Rule.class */
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/tz/DateTimeZoneBuilder$Transition.class */
    private static final class Transition {
        ...
        Transition(long j, Rule rule, int i) {
            ...
            this.iWallOffset = i + rule.getSaveMillis();
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/tz/DateTimeZoneBuilder$RuleSet.class */
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/tz/DateTimeZoneBuilder$DSTZone.class */
    private static final class DSTZone extends DateTimeZone {
        ...
        public long previousTransition(long j) {
            ...
            Recurrence recurrence2 = this.iEndRecurrence;
            try {
                j2 = recurrence.previous(j4, i, recurrence2.getSaveMillis());
                if (j4 < 0 && j2 > 0) {
                    j2 = j4;
                }
            } catch (ArithmeticException e) {
            ...
            try {
                j3 = recurrence2.previous(j4, i, recurrence.getSaveMillis());
                if (j4 < 0 && j3 > 0) {
                    j3 = j4;
                }
            } catch (ArithmeticException e3) {
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/tz/DateTimeZoneBuilder$PrecalculatedZone.class */
