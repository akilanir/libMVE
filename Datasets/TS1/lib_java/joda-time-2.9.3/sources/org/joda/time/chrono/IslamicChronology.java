...
/* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/IslamicChronology.class */
public final class IslamicChronology extends BasicChronology {
    ...
    public static IslamicChronology getInstance(DateTimeZone dateTimeZone, LeapYearPatternType leapYearPatternType) {
        ...
        if (islamicChronologyArr == null) {
            ...
            IslamicChronology[] putIfAbsent = cCache.putIfAbsent(dateTimeZone, islamicChronologyArr);
            if (putIfAbsent != null) {
    ...
    int getYear(long j) {
        ...
        int i = (int) ((j3 * 30) + 1);
        long j5 = isLeapYear(i) ? MILLIS_PER_LONG_YEAR : MILLIS_PER_SHORT_YEAR;
        while (true) {
            long j6 = j5;
            if (j4 >= j6) {
                j4 -= j6;
                i++;
                j5 = isLeapYear(i) ? MILLIS_PER_LONG_YEAR : MILLIS_PER_SHORT_YEAR;
            } else {
                return i;
            }
        }
    ...
    long getTotalMillisByYearMonth(int i, int i2) {
        if ((i2 - 1) % 2 == 1) {
            return ((r7 / 2) * MILLIS_PER_MONTH_PAIR) + MILLIS_PER_LONG_MONTH;
        }
        return (r7 / 2) * MILLIS_PER_MONTH_PAIR;
    }
    ...
    long calculateFirstDayOfYearMillis(int i) {
        ...
        long j = MILLIS_YEAR_1 + ((r8 / 30) * MILLIS_PER_CYCLE);
        int i2 = ((i - 1) % 30) + 1;
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/IslamicChronology$LeapYearPatternType.class */
