...
/* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/GJChronology.class */
public final class GJChronology extends AssembledChronology {
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/GJChronology$CutoverField.class */
    private class CutoverField extends BaseDateTimeField {
        ...
        public long roundFloor(long j) {
            ...
            if (j >= this.iCutover) {
                ...
                if (roundFloor < this.iCutover && roundFloor + GJChronology.this.iGapDuration < this.iCutover) {
                    roundFloor = gregorianToJulian(roundFloor);
                }
            } else {
        ...
        public long roundCeiling(long j) {
            ...
            if (j >= this.iCutover) {
                ...
                if (roundCeiling >= this.iCutover && roundCeiling - GJChronology.this.iGapDuration >= this.iCutover) {
                    roundCeiling = julianToGregorian(roundCeiling);
                }
            }
            return roundCeiling;
        }
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/GJChronology$ImpreciseCutoverField.class */
        ...
        public long add(long j, int i) {
            ...
            if (j >= this.iCutover) {
                ...
                if (add < this.iCutover && add + GJChronology.this.iGapDuration < this.iCutover) {
                    ...
                    add = gregorianToJulian(add);
                }
            } else {
                add = this.iJulianField.add(j, i);
                if (add >= this.iCutover && add - GJChronology.this.iGapDuration >= this.iCutover) {
                    add = julianToGregorian(add);
                }
            }
            return add;
        }
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/GJChronology$LinkedDurationField.class */
