...
/* loaded from: joda-time-2.9.3.jar:org/joda/time/chrono/BasicWeekyearDateTimeField.class */
final class BasicWeekyearDateTimeField extends ImpreciseDateTimeField {
    ...
    public long set(long j, int i) {
        ...
        return this.iChronology.dayOfWeek().set(year + ((weekOfWeekyear - this.iChronology.getWeekOfWeekyear(year)) * 604800000), dayOfWeek);
    }
