...
/* loaded from: joda-time-2.9.3.jar:org/joda/time/base/AbstractInterval.class */
public abstract class AbstractInterval implements ReadableInterval {
    ...
    public int hashCode() {
        long startMillis = getStartMillis();
        long endMillis = getEndMillis();
        return (31 * ((31 * ((31 * 97) + ((int) (startMillis ^ (startMillis >>> 32))))) + ((int) (endMillis ^ (endMillis >>> 32))))) + getChronology().hashCode();
    }
