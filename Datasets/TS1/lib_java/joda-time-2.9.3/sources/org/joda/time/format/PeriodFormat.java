...
/* loaded from: joda-time-2.9.3.jar:org/joda/time/format/PeriodFormat.class */
public class PeriodFormat {
    ...
    public static PeriodFormatter wordBased(Locale locale) {
        ...
        if (periodFormatter == null) {
            ...
            periodFormatter = new PeriodFormatter(dynamicWordBased, dynamicWordBased, locale, null);
            PeriodFormatter putIfAbsent = FORMATTERS.putIfAbsent(locale, periodFormatter);
            if (putIfAbsent != null) {
                periodFormatter = putIfAbsent;
            }
        }
    ...
    /* loaded from: joda-time-2.9.3.jar:org/joda/time/format/PeriodFormat$DynamicWordBased.class */
