...
/* loaded from: com.mcxiaoke.volley.library.1.0.19.jar:com/android/volley/toolbox/DiskBasedCache.class */
public class DiskBasedCache implements Cache {
        ...
        try {
            try {
                try {
                    ...
                    Cache.Entry cacheEntry = entry.toCacheEntry(data);
                    if (cis != null) {
                        try {
                            cis.close();
                        } catch (IOException e) {
                ...
                VolleyLog.d("%s: %s", file.getAbsolutePath(), e4.toString());
                remove(key);
                if (cis != null) {
                    try {
                        cis.close();
    ...
    private static byte[] streamToBytes(InputStream in, int length) throws IOException {
        ...
        while (true) {
            pos = i;
            if (pos >= length || (count = in.read(bytes, pos, length - pos)) == -1) {
                break;
            }
            i = pos + count;
        }
    ...
    /* loaded from: com.mcxiaoke.volley.library.1.0.19.jar:com/android/volley/toolbox/DiskBasedCache$CacheHeader.class */
    ...
    /* loaded from: com.mcxiaoke.volley.library.1.0.19.jar:com/android/volley/toolbox/DiskBasedCache$CountingInputStream.class */
