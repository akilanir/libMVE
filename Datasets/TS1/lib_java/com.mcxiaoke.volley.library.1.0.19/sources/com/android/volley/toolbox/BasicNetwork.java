...
/* loaded from: com.mcxiaoke.volley.library.1.0.19.jar:com/android/volley/toolbox/BasicNetwork.class */
        ...
        while (true) {
            ...
            try {
                ...
                if (statusCode == 304) {
                    ...
                    if (entry == null) {
                        return new NetworkResponse(304, null, responseHeaders2, true, SystemClock.elapsedRealtime() - requestStart);
                    }
                    entry.responseHeaders.putAll(responseHeaders2);
                    return new NetworkResponse(304, entry.data, entry.responseHeaders, true, SystemClock.elapsedRealtime() - requestStart);
                }
                if (statusCode == 301 || statusCode == 302) {
                    String newUrl = responseHeaders2.get("Location");
                ...
                return new NetworkResponse(statusCode, responseContents, responseHeaders2, false, SystemClock.elapsedRealtime() - requestStart);
                ...
                if (0 != 0) {
                    ...
                    if (0 != 0) {
                        NetworkResponse networkResponse = new NetworkResponse(statusCode2, null, responseHeaders, false, SystemClock.elapsedRealtime() - requestStart);
