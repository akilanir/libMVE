...
/* loaded from: internal_impl-23.0.0.jar:android/support/v4/app/NotificationCompatApi20.class */
class NotificationCompatApi20 {
    NotificationCompatApi20() {
    }

    /* loaded from: internal_impl-23.0.0.jar:android/support/v4/app/NotificationCompatApi20$Builder.class */
    ...
    public static void addAction(Notification.Builder b, NotificationCompatBase.Action action) {
        ...
        if (action.getRemoteInputs() != null) {
            ...
            for (RemoteInput remoteInput : arr$) {
