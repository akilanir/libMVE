...
/*  JADX ERROR: NullPointerException in pass: ClassModifier
    ...
    */
/* loaded from: okhttp-3.2.0.jar:okhttp3/internal/DiskLruCache.class */
public final class DiskLruCache implements Closeable, Flushable {
    ...
    static {
        ...
        NULL_SINK = new Sink() { // from class: okhttp3.internal.DiskLruCache.4
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        ...
        return Okio.buffer(new FaultHidingSink(fileSink) { // from class: okhttp3.internal.DiskLruCache.2
            static final /* synthetic */ boolean $assertionsDisabled;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Failed to check method for inline after forced processokhttp3.internal.DiskLruCache.Entry.access$1702(okhttp3.internal.DiskLruCache$Entry, long):long */
    ...
    /* loaded from: okhttp-3.2.0.jar:okhttp3/internal/DiskLruCache$Snapshot.class */
    ...
    /* loaded from: okhttp-3.2.0.jar:okhttp3/internal/DiskLruCache$Editor.class */
        ...
        public Sink newSink(int index) throws IOException {
            ...
            synchronized (DiskLruCache.this) {
                ...
                try {
                    ...
                    faultHidingSink = new FaultHidingSink(sink) { // from class: okhttp3.internal.DiskLruCache.Editor.1
                        @Override // okhttp3.internal.FaultHidingSink
                        protected void onException(IOException e) {
                            synchronized (DiskLruCache.this) {
    ...
    /* loaded from: okhttp-3.2.0.jar:okhttp3/internal/DiskLruCache$Entry.class */
    private final class Entry {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x0002: MOVE_MULTI
            ...
            */
        static /* synthetic */ long access$1702(okhttp3.internal.DiskLruCache.Entry r6, long r7) {
            /*
                r0 = r6
                r1 = r7
                ...
                return r-1
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.DiskLruCache.Entry.access$1702(okhttp3.internal.DiskLruCache$Entry, long):long");
        }
