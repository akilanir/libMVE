...
/* loaded from: okhttp-3.2.0.jar:okhttp3/internal/http/HttpEngine.class */
public final class HttpEngine {
    ...
    public HttpEngine(OkHttpClient client, Request request, boolean bufferRequestBody, boolean callerWritesRequestBody, boolean forWebSocket, StreamAllocation streamAllocation, RetryableSink requestBodyOut, Response priorResponse) {
        ...
        this.streamAllocation = streamAllocation != null ? streamAllocation : new StreamAllocation(client.connectionPool(), createAddress(client, request));
    ...
    /* loaded from: okhttp-3.2.0.jar:okhttp3/internal/http/HttpEngine$NetworkInterceptorChain.class */
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        if (cacheRequest != null && (cacheBodyUnbuffered = cacheRequest.body()) != null) {
            ...
            Source cacheWritingSource = new Source() { // from class: okhttp3.internal.http.HttpEngine.2
    ...
    public Request followUpRequest() throws IOException {
        ...
        switch (responseCode) {
            ...
            case 302:
            case 303:
                if (!this.client.followRedirects() || (location = this.userResponse.header("Location")) == null || (url = this.userRequest.url().resolve(location)) == null) {
                    return null;
                }
                boolean sameScheme = url.scheme().equals(this.userRequest.url().scheme());
