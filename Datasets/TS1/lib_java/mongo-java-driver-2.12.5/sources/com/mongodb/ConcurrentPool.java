...
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ConcurrentPool.class */
class ConcurrentPool<T> {
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ConcurrentPool$ItemFactory.class */
