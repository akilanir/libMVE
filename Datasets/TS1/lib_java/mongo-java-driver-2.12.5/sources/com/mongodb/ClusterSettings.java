...
@Immutable
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ClusterSettings.class */
final class ClusterSettings {
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ClusterSettings$Builder.class */
    ...
    public int hashCode() {
        ...
        return (31 * ((31 * ((31 * result) + this.mode.hashCode())) + this.requiredClusterType.hashCode())) + (this.requiredReplicaSetName != null ? this.requiredReplicaSetName.hashCode() : 0);
    }
