...
@Immutable
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/MongoAuthority.class */
class MongoAuthority {
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/MongoAuthority$Type.class */
    enum Type {
        Direct,
        Set
    }
    ...
    public int hashCode() {
        ...
        return (31 * ((31 * result) + this.serverAddresses.hashCode())) + this.type.hashCode();
    }
