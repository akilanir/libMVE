...
@Immutable
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ClusterDescription.class */
class ClusterDescription {
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ClusterDescription$Predicate.class */
    ...
    public boolean equals(Object o) {
        ...
        if (!this.all.equals(that.all) || this.connectionMode != that.connectionMode) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        return (31 * result) + this.connectionMode.hashCode();
    }
