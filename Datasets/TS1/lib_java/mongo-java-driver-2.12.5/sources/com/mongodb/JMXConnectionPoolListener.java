...
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/JMXConnectionPoolListener.class */
class JMXConnectionPoolListener implements ConnectionPoolListener {
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/JMXConnectionPoolListener$ClusterIdServerAddressPair.class */
    private static final class ClusterIdServerAddressPair {
        ...
        public boolean equals(Object o) {
            ...
            if (!this.clusterId.equals(that.clusterId) || !this.serverAddress.equals(that.serverAddress)) {
                return false;
            }
            return true;
        }
