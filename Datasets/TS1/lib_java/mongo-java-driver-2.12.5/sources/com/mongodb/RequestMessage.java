...
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/RequestMessage.class */
abstract class RequestMessage {
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/RequestMessage$OpCode.class */
    enum OpCode {
        OP_REPLY(1),
        OP_MSG(1000),
        OP_UPDATE(2001),
