...
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ConnectionPoolEvent.class */
class ConnectionPoolEvent extends ClusterEvent {
    ...
    public boolean equals(Object o) {
        ...
        if (!getClusterId().equals(that.getClusterId()) || !this.serverAddress.equals(that.serverAddress)) {
            return false;
        }
        return true;
    }
