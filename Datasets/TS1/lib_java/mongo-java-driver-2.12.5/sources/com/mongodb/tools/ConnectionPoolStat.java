...
@Deprecated
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/tools/ConnectionPoolStat.class */
public class ConnectionPoolStat {
    private final MBeanServerConnection mBeanConnection;

    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/tools/ConnectionPoolStat$Position.class */
    enum Position {
        REGULAR,
        LAST
    }

    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/tools/ConnectionPoolStat$StringType.class */
    enum StringType {
        REGULAR,
        JSON
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (args[pos].equals("--help")) {
                ...
                int i = pos;
                pos++;
                sleepTime = getIntegerArg(args[i], "sleep time") * 1000;
                break;
            }
            pos++;
        }
