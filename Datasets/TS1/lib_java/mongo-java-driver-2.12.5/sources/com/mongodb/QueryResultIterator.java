...
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/QueryResultIterator.class */
class QueryResultIterator implements Cursor {
    ...
    private void initFromCursorDocument(DBObject cursorDocument) {
        ...
        if (cursor != null) {
            ...
            List<DBObject> result = (List) cursorDocument.get("result");
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/QueryResultIterator$OptionalFinalizer.class */
