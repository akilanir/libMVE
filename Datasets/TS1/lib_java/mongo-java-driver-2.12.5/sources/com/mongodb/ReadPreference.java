...
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ReadPreference.class */
public abstract class ReadPreference {
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ReadPreference$PrimaryReadPreference.class */
    ...
    @Deprecated
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ReadPreference$TaggedReadPreference.class */
    public static class TaggedReadPreference extends ReadPreference {
        ...
        private DBObject[] getRemainingMaps(List<DBObject> maps) {
            ...
            return (DBObject[]) maps.subList(1, maps.size() - 1).toArray(new DBObject[maps.size() - 1]);
        }
    }
