...
@Deprecated
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/MongoOptions.class */
public class MongoOptions {
    ...
    public boolean equals(Object o) {
        ...
        if (options.requiredReplicaSetName != null) {
            return false;
        }
        return true;
    }
