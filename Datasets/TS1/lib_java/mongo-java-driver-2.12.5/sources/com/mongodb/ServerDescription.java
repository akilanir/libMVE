...
@Immutable
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ServerDescription.class */
class ServerDescription {
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/ServerDescription$Builder.class */
    ...
    public boolean isCompatibleWithDriver() {
        ...
        if (this.minWireVersion > 2 || this.maxWireVersion < 0) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        return (31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * result) + this.type.hashCode())) + this.hosts.hashCode())) + this.passives.hashCode())) + this.arbiters.hashCode())) + (this.primary != null ? this.primary.hashCode() : 0))) + this.maxDocumentSize)) + this.maxMessageSize)) + this.maxWriteBatchSize)) + this.tags.hashCode())) + (this.setName != null ? this.setName.hashCode() : 0))) + (this.ok ? 1 : 0))) + this.state.hashCode())) + this.version.hashCode())) + this.minWireVersion)) + this.maxWireVersion)) + (this.exception == null ? 0 : this.exception.getClass().hashCode()))) + (this.exception == null ? 0 : this.exception.getMessage().hashCode());
    }
