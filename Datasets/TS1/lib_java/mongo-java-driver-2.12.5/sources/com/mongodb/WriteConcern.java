...
/* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/WriteConcern.class */
public class WriteConcern implements Serializable {
    ...
    public int hashCode() {
        ...
        return (31 * ((31 * ((31 * ((31 * result) + this._wtimeout)) + (this._fsync ? 1 : 0))) + (this._j ? 1 : 0))) + (this._continueOnError ? 1 : 0);
    }
    ...
    /* loaded from: mongo-java-driver-2.12.5.jar:com/mongodb/WriteConcern$Majority.class */
