...
/* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/HeaderScrollingViewBehavior.class */
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    final int getOverlapPixelsForOffset(View header) {
        ...
        return MathUtils.constrain(Math.round(getOverlapRatioForOffset(header) * this.mOverlayTop), 0, this.mOverlayTop);
    }
