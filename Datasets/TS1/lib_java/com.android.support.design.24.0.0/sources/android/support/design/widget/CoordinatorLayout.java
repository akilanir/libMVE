...
/* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/CoordinatorLayout.class */
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/CoordinatorLayout$DefaultBehavior.class */
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (keylineArrayRes != 0) {
            ...
            for (int i = 0; i < count; i++) {
                this.mKeylines[i] = (int) (r0[r1] * density);
            }
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:6:0x001f A[PHI: r12
      0x001f: PHI (r12v1 'cancelSuper' boolean) = (r12v0 'cancelSuper' boolean), (r12v3 'cancelSuper' boolean) binds: [B:3:0x0011, B:5:0x001c] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // android.view.View
    /*
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        /*
            ...
            r13 = r0
            r0 = r10
            int r0 = android.support.v4.view.MotionEventCompat.getActionMasked(r0)
            r14 = r0
            r0 = r9
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = ViewCompat.resolveSizeAndState(widthUsed, widthMeasureSpec, childState & (-16777216));
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/CoordinatorLayout$OnPreDrawListener.class */
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/CoordinatorLayout$ViewElevationComparator.class */
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/CoordinatorLayout$Behavior.class */
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/CoordinatorLayout$LayoutParams.class */
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveAnchorView(View forChild, CoordinatorLayout parent) {
            ...
            if (this.mAnchorView != null) {
                ...
                while (true) {
                    CoordinatorLayout coordinatorLayout = parent2;
                    if (coordinatorLayout == parent || coordinatorLayout == null) {
                        break;
                    }
                    if (coordinatorLayout == forChild) {
                        if (parent.isInEditMode()) {
                            this.mAnchorDirectChild = null;
                            this.mAnchorView = null;
                            return;
                    ...
                    if (coordinatorLayout instanceof View) {
                        directChild = coordinatorLayout;
                    }
                    parent2 = coordinatorLayout.getParent();
                }
        ...
        private boolean verifyAnchorView(View forChild, CoordinatorLayout parent) {
            ...
            while (true) {
                CoordinatorLayout coordinatorLayout = parent2;
                if (coordinatorLayout != parent) {
                    if (coordinatorLayout == null || coordinatorLayout == forChild) {
                        break;
                    }
                    if (coordinatorLayout instanceof View) {
                        directChild = coordinatorLayout;
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/CoordinatorLayout$ApplyInsetsListener.class */
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/CoordinatorLayout$HierarchyChangeListener.class */
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [android.os.Parcelable, android.support.design.widget.CoordinatorLayout$SavedState] */
    @Override // android.view.View
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/CoordinatorLayout$SavedState.class */
    protected static class SavedState extends AbsSavedState {
        ...
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: android.support.design.widget.CoordinatorLayout.SavedState.1
            ...
            public SavedState m16createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public SavedState[] m15newArray(int size) {
