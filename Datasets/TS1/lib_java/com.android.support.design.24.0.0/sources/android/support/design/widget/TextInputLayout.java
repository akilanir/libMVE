...
/* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/TextInputLayout.class */
public class TextInputLayout extends LinearLayout {
    ...
    private void setEditText(EditText editText) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextGravity(48 | (editTextGravity & 8388615));
    ...
    private void addIndicator(TextView indicator, int index) {
        if (this.mIndicatorArea == null) {
            ...
            this.mIndicatorArea.addView(space, spacerLp);
            if (this.mEditText != null) {
                adjustIndicatorPadding();
            }
        }
    ...
    public void setError(@Nullable final CharSequence error) {
        ...
        boolean animate = ViewCompat.isLaidOut(this) && !TextUtils.equals(this.mErrorView.getText(), error);
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/TextInputLayout$SavedState.class */
    static class SavedState extends AbsSavedState {
        ...
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: android.support.design.widget.TextInputLayout.SavedState.1
            ...
            public SavedState m28createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public SavedState[] m27newArray(int size) {
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [android.os.Parcelable, android.support.design.widget.TextInputLayout$SavedState] */
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/TextInputLayout$TextInputAccessibilityDelegate.class */
