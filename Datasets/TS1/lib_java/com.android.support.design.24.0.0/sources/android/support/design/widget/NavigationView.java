...
/* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/NavigationView.class */
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/NavigationView$OnNavigationItemSelectedListener.class */
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        itemTextColor = a.hasValue(android.support.design.R.styleable.NavigationView_itemTextColor) ? a.getColorStateList(android.support.design.R.styleable.NavigationView_itemTextColor) : itemTextColor;
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [android.os.Parcelable, android.support.design.widget.NavigationView$SavedState] */
    ...
    public void setCheckedItem(@IdRes int id) {
        MenuItemImpl findItem = this.mMenu.findItem(id);
        if (findItem != null) {
            this.mPresenter.setCheckedItem(findItem);
        }
    }
    ...
    /* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/NavigationView$SavedState.class */
    public static class SavedState extends AbsSavedState {
        ...
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: android.support.design.widget.NavigationView.SavedState.1
            ...
            public SavedState m22createFromParcel(Parcel parcel, ClassLoader loader) {
                return new SavedState(parcel, loader);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public SavedState[] m21newArray(int size) {
