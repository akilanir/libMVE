...
/* loaded from: com.android.support.design.24.0.0.jar:android/support/design/widget/ValueAnimatorCompatImplEclairMr1.class */
class ValueAnimatorCompatImplEclairMr1 extends ValueAnimatorCompat.Impl {
    ...
    public void update() {
        if (this.mIsRunning) {
            ...
            float linearFraction = MathUtils.constrain(elapsed / this.mDuration, 0.0f, 1.0f);
