...
/* loaded from: com.android.support.design.23.0.1.jar:android/support/design/widget/AppBarLayout.class */
public class AppBarLayout extends LinearLayout {
    ...
    /* loaded from: com.android.support.design.23.0.1.jar:android/support/design/widget/AppBarLayout$OnOffsetChangedListener.class */
    ...
    /* loaded from: com.android.support.design.23.0.1.jar:android/support/design/widget/AppBarLayout$LayoutParams.class */
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        /* loaded from: com.android.support.design.23.0.1.jar:android/support/design/widget/AppBarLayout$LayoutParams$ScrollFlags.class */
    ...
    /* loaded from: com.android.support.design.23.0.1.jar:android/support/design/widget/AppBarLayout$Behavior.class */
    public static class Behavior extends ViewOffsetBehavior<AppBarLayout> {
        ...
        /* loaded from: com.android.support.design.23.0.1.jar:android/support/design/widget/AppBarLayout$Behavior$FlingRunnable.class */
            ...
            if (pendingAction != 0) {
                ...
                if ((pendingAction & 2) != 0) {
                    ...
                    if (animate) {
                        ...
                        setAppBarTopBottomOffset(parent, abl, offset2);
                    }
        ...
        private boolean canDragAppBarLayout() {
            View view;
            return (this.mLastNestedScrollingChildRef == null || (view = this.mLastNestedScrollingChildRef.get()) == null || !view.isShown() || ViewCompat.canScrollVertically(view, -1)) ? false : true;
        }
        ...
        /* loaded from: com.android.support.design.23.0.1.jar:android/support/design/widget/AppBarLayout$Behavior$SavedState.class */
    ...
    /* loaded from: com.android.support.design.23.0.1.jar:android/support/design/widget/AppBarLayout$ScrollingViewBehavior.class */
