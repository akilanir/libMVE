...
/* loaded from: msgpack-0.6.12.jar:org/apache/harmony/beans/BeansUtils.class */
public class BeansUtils {
    ...
    public static String idOfClass(Class<?> clazz) {
        ...
        return clazzName.substring(clazzName.lastIndexOf(46) + 1) + sb.toString();
    }
}
