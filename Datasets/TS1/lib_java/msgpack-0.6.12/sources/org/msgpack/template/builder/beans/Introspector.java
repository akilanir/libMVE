...
/* loaded from: msgpack-0.6.12.jar:org/msgpack/template/builder/beans/Introspector.class */
    ...
    private static BeanInfo getExplicitBeanInfo(Class<?> beanClass) {
        ...
        try {
            ...
            for (int i = 0; i < searchPath.length; i++) {
                try {
                    theBeanInfo = loadBeanInfo(searchPath[i] + TemplatePrecompiler.DEFAULT_DEST + beanInfoName, beanClass);
