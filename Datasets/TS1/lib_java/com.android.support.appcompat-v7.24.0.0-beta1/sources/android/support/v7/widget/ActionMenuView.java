...
/* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/ActionMenuView.class */
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/ActionMenuView$ActionMenuChildView.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/ActionMenuView$OnMenuItemClickListener.class */
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (isLayoutRtl) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (v3.getVisibility() != 8 && !lp.isOverflowButton) {
                    ...
                    startRight = startRight2 - ((width2 + lp.leftMargin) + spacerSize);
                }
            }
            return;
        }
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (v4.getVisibility() != 8 && !lp2.isOverflowButton) {
                ...
                startLeft = startLeft2 + width3 + lp2.rightMargin + spacerSize;
            }
        }
    }
    ...
    protected boolean hasSupportDividerBeforeChildAt(int childIndex) {
        ...
        if (childIndex > 0 && (childAt2 instanceof ActionMenuChildView)) {
            result |= ((ActionMenuChildView) childAt2).needsDividerBefore();
        }
        return result;
    }
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/ActionMenuView$MenuBuilderCallback.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/ActionMenuView$ActionMenuPresenterCallback.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/ActionMenuView$LayoutParams.class */
