...
/* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/app/TwilightCalculator.class */
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latiude, double longitude) {
        ...
        double solarTransitJ2000 = n + J0 + arcLongitude + (0.0053d * Math.sin(meanAnomaly)) + ((-0.0069d) * Math.sin(2.0d * solarLng));
