...
/* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/Toolbar.class */
public class Toolbar extends ViewGroup {
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/Toolbar$OnMenuItemClickListener.class */
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int dimensionPixelOffset = a.hasValue(R.styleable.Toolbar_titleMargins) ? a.getDimensionPixelOffset(R.styleable.Toolbar_titleMargins, titleMargin) : titleMargin;
    ...
    /* JADX WARN: Type inference failed for: r4v0, types: [android.os.Parcelable] */
    /* JADX WARN: Type inference failed for: r6v0, types: [android.view.Menu] */
    @Override // android.view.View
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        ?? peekMenu = this.mMenuView != null ? this.mMenuView.peekMenu() : null;
        if (ss.expandedMenuItemId != 0 && this.mExpandedMenuPresenter != null && peekMenu != 0 && (item = peekMenu.findItem(ss.expandedMenuItemId)) != null) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int measuredWidth = ViewCompat.resolveSizeAndState(Math.max(width3, getSuggestedMinimumWidth()), widthMeasureSpec, childState & (-16777216));
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (layoutTitle || layoutSubtitle) {
            ...
            if (isRtl) {
                ...
                if (layoutSubtitle) {
                    ...
                    int i = subtitleBottom + lp4.bottomMargin;
                }
                if (titleHasWidth) {
                ...
                if (layoutSubtitle) {
                    ...
                    int i2 = subtitleBottom2 + lp6.bottomMargin;
                }
                if (titleHasWidth) {
        ...
        for (int i5 = 0; i5 < centerViewsCount; i5++) {
            centerLeft = layoutChildLeft(this.mTempViews.get(i5), centerLeft, collapsingMargins, alignmentHeight);
        }
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/Toolbar$LayoutParams.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/Toolbar$SavedState.class */
    public static class SavedState extends AbsSavedState {
        ...
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: android.support.v7.widget.Toolbar.SavedState.1
            ...
            public SavedState m50createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public SavedState[] m49newArray(int size) {
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/Toolbar$ExpandedActionViewMenuPresenter.class */
