...
/* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/ToolbarWidgetWrapper.class */
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setNavigationIcon(int resId) {
        setNavigationIcon(resId != 0 ? this.mDrawableManager.getDrawable(getContext(), resId) : null);
    }
