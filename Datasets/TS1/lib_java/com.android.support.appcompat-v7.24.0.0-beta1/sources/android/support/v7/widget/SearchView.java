...
/* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/SearchView.class */
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/SearchView$OnCloseListener.class */
    public interface OnCloseListener {
        boolean onClose();
    }

    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/SearchView$OnQueryTextListener.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/SearchView$OnSuggestionListener.class */
    ...
    @TargetApi(ActionBar.DISPLAY_SHOW_TITLE)
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/SearchView$SavedState.class */
    static class SavedState extends AbsSavedState {
        ...
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: android.support.v7.widget.SearchView.SavedState.1
            ...
            public SavedState m44createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public SavedState[] m43newArray(int size) {
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [android.os.Parcelable, android.support.v7.widget.SearchView$SavedState] */
    @Override // android.view.View
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/SearchView$UpdatableTouchDelegate.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/SearchView$SearchAutoComplete.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.24.0.0-beta1.jar:android/support/v7/widget/SearchView$AutoCompleteTextViewReflector.class */
