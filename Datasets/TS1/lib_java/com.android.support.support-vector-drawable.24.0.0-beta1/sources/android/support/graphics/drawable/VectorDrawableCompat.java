...
@TargetApi(21)
/* loaded from: com.android.support.support-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/VectorDrawableCompat.class */
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void draw(Canvas canvas) {
        ...
        int scaledWidth = Math.min(MAX_CACHED_BITMAP_SIZE, (int) (this.mTmpBounds.width() * canvasScaleX));
        int scaledHeight = Math.min(MAX_CACHED_BITMAP_SIZE, (int) (this.mTmpBounds.height() * canvasScaleY));
    ...
    private void inflateInternal(Resources res, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            } else if (eventType2 == 3 && SHAPE_GROUP.equals(parser.getName())) {
                groupStack.pop();
            }
    ...
    /* loaded from: com.android.support.support-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/VectorDrawableCompat$VectorDrawableDelegateState.class */
    ...
    /* loaded from: com.android.support.support-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/VectorDrawableCompat$VectorDrawableCompatState.class */
    ...
    /* loaded from: com.android.support.support-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/VectorDrawableCompat$VPathRenderer.class */
    ...
    /* loaded from: com.android.support.support-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/VectorDrawableCompat$VGroup.class */
    ...
    /* loaded from: com.android.support.support-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/VectorDrawableCompat$VPath.class */
    ...
    /* loaded from: com.android.support.support-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/VectorDrawableCompat$VClipPath.class */
    ...
    /* loaded from: com.android.support.support-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/VectorDrawableCompat$VFullPath.class */
