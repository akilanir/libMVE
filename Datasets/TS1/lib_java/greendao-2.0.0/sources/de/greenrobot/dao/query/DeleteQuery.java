...
/* loaded from: greendao-2.0.0.jar:de/greenrobot/dao/query/DeleteQuery.class */
public class DeleteQuery<T> extends AbstractQuery<T> {
    ...
    /* loaded from: greendao-2.0.0.jar:de/greenrobot/dao/query/DeleteQuery$QueryData.class */
