...
/* loaded from: greendao-2.0.0.jar:de/greenrobot/dao/query/LazyList.class */
public class LazyList<E> implements List<E>, Closeable {
    ...
    /* loaded from: greendao-2.0.0.jar:de/greenrobot/dao/query/LazyList$LazyIterator.class */
    ...
    public E get(int location) {
        ...
        this.lock.lock();
        try {
            E loadEntity = loadEntity(location);
            this.lock.unlock();
            return loadEntity;
        } finally {
            this.lock.unlock();
