...
/* loaded from: javassist-3.18.1-GA.jar:javassist/scopedpool/SoftValueHashMap.class */
public class SoftValueHashMap extends AbstractMap implements Map {
    private Map hash;
    private ReferenceQueue queue;

    /* loaded from: javassist-3.18.1-GA.jar:javassist/scopedpool/SoftValueHashMap$SoftValueRef.class */
