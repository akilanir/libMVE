...
/* loaded from: javassist-3.18.1-GA.jar:javassist/CtClassType.class */
    ...
    public ClassFile getClassFile2() {
        ...
        try {
            try {
                ...
                ClassFile cf = new ClassFile(new DataInputStream(fin3));
    ...
    static boolean hasAnnotationType(Class clz, ClassPool cp, AnnotationsAttribute a1, AnnotationsAttribute a2) {
        ...
        if (anno1 != null) {
            for (Annotation annotation : anno1) {
                if (annotation.getTypeName().equals(typeName)) {
                    return true;
                }
            }
        }
        if (anno2 != null) {
            for (Annotation annotation2 : anno2) {
                if (annotation2.getTypeName().equals(typeName)) {
                    return true;
                }
            }
            return false;
