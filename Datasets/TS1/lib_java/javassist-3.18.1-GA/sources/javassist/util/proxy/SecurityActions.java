...
/* loaded from: javassist-3.18.1-GA.jar:javassist/util/proxy/SecurityActions.class */
class SecurityActions {
    ...
    static Method[] getDeclaredMethods(final Class clazz) {
        ...
        return (Method[]) AccessController.doPrivileged(new PrivilegedAction() { // from class: javassist.util.proxy.SecurityActions.1
    ...
    static Constructor[] getDeclaredConstructors(final Class clazz) {
        ...
        return (Constructor[]) AccessController.doPrivileged(new PrivilegedAction() { // from class: javassist.util.proxy.SecurityActions.2
            @Override // java.security.PrivilegedAction
            public Object run() {
                return clazz.getDeclaredConstructors();
            }
