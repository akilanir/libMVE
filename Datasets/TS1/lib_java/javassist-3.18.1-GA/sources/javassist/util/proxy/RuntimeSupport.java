...
/* loaded from: javassist-3.18.1-GA.jar:javassist/util/proxy/RuntimeSupport.class */
public class RuntimeSupport {
    public static MethodHandler default_interceptor = new DefaultMethodHandler();

    /* loaded from: javassist-3.18.1-GA.jar:javassist/util/proxy/RuntimeSupport$DefaultMethodHandler.class */
