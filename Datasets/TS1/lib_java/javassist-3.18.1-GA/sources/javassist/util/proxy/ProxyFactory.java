...
/* loaded from: javassist-3.18.1-GA.jar:javassist/util/proxy/ProxyFactory.class */
public class ProxyFactory {
    ...
    private static Comparator sorter = new Comparator() { // from class: javassist.util.proxy.ProxyFactory.3
    ...
    /* loaded from: javassist-3.18.1-GA.jar:javassist/util/proxy/ProxyFactory$ClassLoaderProvider.class */
    public interface ClassLoaderProvider {
        ClassLoader get(ProxyFactory proxyFactory);
    }

    /* loaded from: javassist-3.18.1-GA.jar:javassist/util/proxy/ProxyFactory$UniqueName.class */
    ...
    /* loaded from: javassist-3.18.1-GA.jar:javassist/util/proxy/ProxyFactory$ProxyDetails.class */
    ...
    /* loaded from: javassist-3.18.1-GA.jar:javassist/util/proxy/ProxyFactory$Find2MethodsArgs.class */
