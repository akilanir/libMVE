...
/* loaded from: javassist-3.18.1-GA.jar:javassist/SerialVersionUID.class */
public class SerialVersionUID {
    ...
    static long calculateDefault(CtClass clazz) throws CannotCompileException {
        try {
            ...
            Arrays.sort(fields, new Comparator() { // from class: javassist.SerialVersionUID.1
            ...
            Arrays.sort(constructors, new Comparator() { // from class: javassist.SerialVersionUID.2
                @Override // java.util.Comparator
                public int compare(Object o1, Object o2) {
            ...
            Arrays.sort(methods, new Comparator() { // from class: javassist.SerialVersionUID.3
                @Override // java.util.Comparator
                public int compare(Object o1, Object o2) {
