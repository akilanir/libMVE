...
/* loaded from: javassist-3.18.1-GA.jar:javassist/bytecode/LineNumberAttribute.class */
public class LineNumberAttribute extends AttributeInfo {
    public static final String tag = "LineNumberTable";

    /* loaded from: javassist-3.18.1-GA.jar:javassist/bytecode/LineNumberAttribute$Pc.class */
