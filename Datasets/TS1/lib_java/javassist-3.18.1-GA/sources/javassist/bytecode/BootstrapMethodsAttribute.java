...
/* loaded from: javassist-3.18.1-GA.jar:javassist/bytecode/BootstrapMethodsAttribute.class */
public class BootstrapMethodsAttribute extends AttributeInfo {
    public static final String tag = "BootstrapMethods";

    /* loaded from: javassist-3.18.1-GA.jar:javassist/bytecode/BootstrapMethodsAttribute$BootstrapMethod.class */
