...
/* loaded from: javassist-3.18.1-GA.jar:javassist/bytecode/annotation/Annotation.class */
public class Annotation {
    ConstPool pool;
    int typeIndex;
    LinkedHashMap members;

    /* loaded from: javassist-3.18.1-GA.jar:javassist/bytecode/annotation/Annotation$Pair.class */
    static class Pair {
        int name;
        MemberValue value;
