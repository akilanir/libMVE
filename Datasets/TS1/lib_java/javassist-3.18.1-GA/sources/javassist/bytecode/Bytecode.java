...
/* loaded from: javassist-3.18.1-GA.jar:javassist/bytecode/Bytecode.class */
public class Bytecode extends ByteVector implements Cloneable, Opcode {
    ...
    public /* bridge */ /* synthetic */ void add(int x0, int x1, int x2, int x3) {
        super.add(x0, x1, x2, x3);
    }

    @Override // javassist.bytecode.ByteVector
    public /* bridge */ /* synthetic */ void add(int x0, int x1) {
        super.add(x0, x1);
    }
    ...
    public void addInvokespecial(CtClass clazz, String name, String desc) {
        addInvokespecial(this.constPool.addClassInfo(clazz), name, desc);
    }
    ...
    public void addInvokestatic(CtClass clazz, String name, String desc) {
        addInvokestatic(this.constPool.addClassInfo(clazz), name, desc);
    }
