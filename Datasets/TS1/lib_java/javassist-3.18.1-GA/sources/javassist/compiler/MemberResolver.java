...
/* loaded from: javassist-3.18.1-GA.jar:javassist/compiler/MemberResolver.class */
public class MemberResolver implements TokenId {
    ...
    /* loaded from: javassist-3.18.1-GA.jar:javassist/compiler/MemberResolver$Method.class */
    ...
    private Method lookupMethod(CtClass clazz, String methodName, int[] argTypes, int[] argDims, String[] argClassNames, boolean onlyExact) throws CompileError {
        ...
        if (cf != null) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                if (minfo.getName().equals(methodName) && (res = compareSignature(minfo.getDescriptor(), argTypes, argDims, argClassNames)) != NO) {
