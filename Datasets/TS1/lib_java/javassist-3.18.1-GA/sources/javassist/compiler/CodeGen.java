...
/* loaded from: javassist-3.18.1-GA.jar:javassist/compiler/CodeGen.class */
public abstract class CodeGen extends Visitor implements Opcode, TokenId {
    ...
    /* loaded from: javassist-3.18.1-GA.jar:javassist/compiler/CodeGen$ReturnHook.class */
    ...
    private boolean booleanExpr(boolean branchIf, ASTree expr) throws CompileError {
        ...
        if (op == 358) {
            ...
            if (z || op == 368) {
                ...
                booleanExpr(!isAndAnd, bexpr2.oprand1());
                int pc = this.bytecode.currentPc();
                this.bytecode.addIndex(0);
                booleanExpr(isAndAnd, bexpr2.oprand2());
