...
/* loaded from: javassist-3.18.1-GA.jar:javassist/CtBehavior.class */
public abstract class CtBehavior extends CtMember {
    ...
    private void insertGoto(CodeIterator iterator, int subr, int pos) throws BadBytecode {
        ...
        int pos2 = iterator.insertGapAt(pos, wide ? 4 : 2, false).position;
        ...
        if (wide) {
            ...
            int pos3 = iterator.insertGapAt(pos2, 2, false).position;
            iterator.writeByte(Opcode.GOTO_W, pos3);
            iterator.write32bit(iterator.getMark() - pos3, pos3 + 1);
        }
    }
