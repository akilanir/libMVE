...
/* loaded from: javassist-3.18.1-GA.jar:javassist/ClassPool.class */
public class ClassPool {
        ...
        try {
            AccessController.doPrivileged(new PrivilegedExceptionAction() { // from class: javassist.ClassPool.1
                ...
                public Object run() throws Exception {
                    ...
                    Method unused = ClassPool.defineClass1 = cl.getDeclaredMethod("defineClass", String.class, byte[].class, Integer.TYPE, Integer.TYPE);
                    Method unused2 = ClassPool.defineClass2 = cl.getDeclaredMethod("defineClass", String.class, byte[].class, Integer.TYPE, Integer.TYPE, ProtectionDomain.class);
                    Method unused3 = ClassPool.definePackage = cl.getDeclaredMethod("definePackage", String.class, String.class, String.class, String.class, String.class, String.class, String.class, URL.class);
                    return null;
                }
            });
            doPruning = false;
    ...
    private static synchronized Object toClass2(Method method, ClassLoader loader, Object[] args) throws Exception {
        ...
        try {
            Object invoke = method.invoke(loader, args);
