...
/* loaded from: jp.wasabeef.glide-transformations.2.0.1.jar:jp/wasabeef/glide/transformations/gpu/ContrastFilterTransformation.class */
public class ContrastFilterTransformation extends GPUFilterTransformation {
    ...
    public ContrastFilterTransformation(Context context, BitmapPool pool, float contrast) {
        ...
        filter.setContrast(this.mContrast);
    }
