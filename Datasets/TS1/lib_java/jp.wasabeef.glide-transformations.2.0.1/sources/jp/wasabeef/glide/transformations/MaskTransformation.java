...
/* loaded from: jp.wasabeef.glide-transformations.2.0.1.jar:jp/wasabeef/glide/transformations/MaskTransformation.class */
public class MaskTransformation implements Transformation<Bitmap> {
    ...
    public Resource<Bitmap> transform(Resource<Bitmap> resource, int outWidth, int outHeight) {
        ...
        Bitmap result = this.mBitmapPool.get(width, height, Bitmap.Config.ARGB_8888);
        if (result == null) {
