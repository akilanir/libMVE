...
/* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/engine/EngineRunnable.class */
class EngineRunnable implements Runnable, Prioritized {
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/engine/EngineRunnable$EngineRunnableManager.class */
    interface EngineRunnableManager extends ResourceCallback {
        void submitForSource(EngineRunnable engineRunnable);
    }

    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/engine/EngineRunnable$Stage.class */
    private enum Stage {
        CACHE,
        SOURCE
    }
