...
/* loaded from: glide-3.7.0.jar:com/bumptech/glide/BitmapRequestBuilder.class */
public class BitmapRequestBuilder<ModelType, TranscodeType> extends GenericRequestBuilder<ModelType, ImageVideoWrapper, Bitmap, TranscodeType> implements BitmapOptions {
    ...
    @Override // com.bumptech.glide.GenericRequestBuilder
    /* renamed from: clone */
    public BitmapRequestBuilder<ModelType, TranscodeType> mo0clone() {
        return (BitmapRequestBuilder) super.mo0clone();
    }
