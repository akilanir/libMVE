...
/* loaded from: glide-3.7.0.jar:com/bumptech/glide/request/target/AppWidgetTarget.class */
public class AppWidgetTarget extends SimpleTarget<Bitmap> {
    ...
    public AppWidgetTarget(Context context, RemoteViews remoteViews, int viewId, int... widgetIds) {
        this(context, remoteViews, viewId, Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL, widgetIds);
    }
    ...
    public AppWidgetTarget(Context context, RemoteViews remoteViews, int viewId, ComponentName componentName) {
        this(context, remoteViews, viewId, Target.SIZE_ORIGINAL, Target.SIZE_ORIGINAL, componentName);
    }
