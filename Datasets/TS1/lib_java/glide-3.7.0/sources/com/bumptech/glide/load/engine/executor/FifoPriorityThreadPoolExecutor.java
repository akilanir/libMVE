...
/* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/engine/executor/FifoPriorityThreadPoolExecutor.class */
public class FifoPriorityThreadPoolExecutor extends ThreadPoolExecutor {
    private static final String TAG = "PriorityExecutor";
    private final AtomicInteger ordering;
    private final UncaughtThrowableStrategy uncaughtThrowableStrategy;

    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/engine/executor/FifoPriorityThreadPoolExecutor$UncaughtThrowableStrategy.class */
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/engine/executor/FifoPriorityThreadPoolExecutor$DefaultThreadFactory.class */
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/engine/executor/FifoPriorityThreadPoolExecutor$LoadTask.class */
