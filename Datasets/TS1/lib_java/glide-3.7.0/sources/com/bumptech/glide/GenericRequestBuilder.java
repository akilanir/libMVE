...
/* loaded from: glide-3.7.0.jar:com/bumptech/glide/GenericRequestBuilder.class */
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
    ...
    public GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> mo0clone() {
        try {
            ...
            clone.loadProvider = this.loadProvider != null ? this.loadProvider.m46clone() : null;
            return clone;
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/GenericRequestBuilder$2.class */
