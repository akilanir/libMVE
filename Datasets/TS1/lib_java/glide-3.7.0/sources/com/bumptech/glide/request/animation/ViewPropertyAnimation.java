...
/* loaded from: glide-3.7.0.jar:com/bumptech/glide/request/animation/ViewPropertyAnimation.class */
public class ViewPropertyAnimation<R> implements GlideAnimation<R> {
    private final Animator animator;

    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/request/animation/ViewPropertyAnimation$Animator.class */
