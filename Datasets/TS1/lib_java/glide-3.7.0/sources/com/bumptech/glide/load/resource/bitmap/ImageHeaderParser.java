...
/* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/resource/bitmap/ImageHeaderParser.class */
public class ImageHeaderParser {
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/resource/bitmap/ImageHeaderParser$ImageType.class */
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/resource/bitmap/ImageHeaderParser$RandomAccessReader.class */
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/load/resource/bitmap/ImageHeaderParser$StreamReader.class */
    private static class StreamReader {
        ...
        public int read(byte[] buffer) throws IOException {
            ...
            while (true) {
                toRead = length;
                if (toRead <= 0 || (read = this.is.read(buffer, buffer.length - toRead, toRead)) == -1) {
                    break;
                }
                length = toRead - read;
            }
