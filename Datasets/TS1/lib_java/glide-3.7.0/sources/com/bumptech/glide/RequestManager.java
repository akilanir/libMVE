...
/* loaded from: glide-3.7.0.jar:com/bumptech/glide/RequestManager.class */
public class RequestManager implements LifecycleListener {
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/RequestManager$DefaultOptions.class */
    ...
    public DrawableTypeRequest<Uri> fromMediaStore() {
        ModelLoader<Uri, InputStream> genericStreamLoader = Glide.buildStreamModelLoader(Uri.class, this.context);
        ModelLoader<Uri, InputStream> mediaStoreLoader = new MediaStoreStreamLoader(this.context, genericStreamLoader);
        ModelLoader<Uri, ParcelFileDescriptor> fileDescriptorModelLoader = Glide.buildFileDescriptorModelLoader(Uri.class, this.context);
        return (DrawableTypeRequest) this.optionsApplier.apply(new DrawableTypeRequest(Uri.class, mediaStoreLoader, fileDescriptorModelLoader, this.context, this.glide, this.requestTracker, this.lifecycle, this.optionsApplier));
    }
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/RequestManager$VideoModelRequest.class */
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/RequestManager$ImageModelRequest.class */
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/RequestManager$GenericModelRequest.class */
    public final class GenericModelRequest<A, T> {
        ...
        /* loaded from: glide-3.7.0.jar:com/bumptech/glide/RequestManager$GenericModelRequest$GenericTypeRequest.class */
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/RequestManager$OptionsApplier.class */
    ...
    /* loaded from: glide-3.7.0.jar:com/bumptech/glide/RequestManager$RequestManagerConnectivityListener.class */
