...
/* loaded from: com.mikepenz.google-material-typeface.1.2.0.1.jar:com/mikepenz/google_material_typeface_library/GoogleMaterial.class */
public class GoogleMaterial implements ITypeface {
    ...
    public Typeface getTypeface(Context context) {
        if (typeface == null) {
            try {
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/google_material_design.ttf");
            } catch (Exception e) {
                return null;
            }
        }
    ...
    /* loaded from: com.mikepenz.google-material-typeface.1.2.0.1.jar:com/mikepenz/google_material_typeface_library/GoogleMaterial$Icon.class */
