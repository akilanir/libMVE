...
/* loaded from: acra-4.5.0.jar:org/acra/ACRA.class */
public class ACRA {
    ...
    /* loaded from: acra-4.5.0.jar:org/acra/ACRA$2.class */
    ...
    static void checkCrashResources() throws ACRAConfigurationException {
        ...
        switch (AnonymousClass2.$SwitchMap$org$acra$ReportingInteractionMode[conf.mode().ordinal()]) {
            case 1:
