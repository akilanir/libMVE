...
/* loaded from: acra-4.5.0.jar:org/acra/ACRAConfiguration.class */
public class ACRAConfiguration implements ReportsCrashes {
    ...
    public ReportField[] customReportContent() {
        ...
        ReportField[] defaultValue = new ReportField[0];
        return defaultValue;
    }
    ...
    public String[] logcatArguments() {
        ...
        String[] defaultValues = {"-t", Integer.toString(100), "-v", "time"};
