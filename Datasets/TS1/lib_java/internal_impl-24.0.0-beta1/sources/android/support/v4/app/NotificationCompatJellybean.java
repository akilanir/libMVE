...
/* loaded from: internal_impl-24.0.0-beta1.jar:android/support/v4/app/NotificationCompatJellybean.class */
class NotificationCompatJellybean {
    ...
    /* loaded from: internal_impl-24.0.0-beta1.jar:android/support/v4/app/NotificationCompatJellybean$Builder.class */
    ...
    public static NotificationCompatBase.Action getAction(Notification notif, int actionIndex, NotificationCompatBase.Action.Factory factory, RemoteInputCompatBase.RemoteInput.Factory remoteInputFactory) {
        ...
        synchronized (sActionsLock) {
            try {
                ...
                if (extras != null && (actionExtrasMap = extras.getSparseParcelableArray(EXTRA_ACTION_EXTRAS)) != null) {
