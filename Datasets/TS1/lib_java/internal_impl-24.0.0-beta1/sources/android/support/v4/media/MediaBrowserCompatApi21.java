...
/* loaded from: internal_impl-24.0.0-beta1.jar:android/support/v4/media/MediaBrowserCompatApi21.class */
class MediaBrowserCompatApi21 {
    static final String NULL_MEDIA_ITEM_ID = "android.support.v4.media.MediaBrowserCompat.NULL_MEDIA_ITEM";

    /* loaded from: internal_impl-24.0.0-beta1.jar:android/support/v4/media/MediaBrowserCompatApi21$ConnectionCallback.class */
    ...
    /* loaded from: internal_impl-24.0.0-beta1.jar:android/support/v4/media/MediaBrowserCompatApi21$SubscriptionCallback.class */
    ...
    /* loaded from: internal_impl-24.0.0-beta1.jar:android/support/v4/media/MediaBrowserCompatApi21$ConnectionCallbackProxy.class */
    ...
    /* loaded from: internal_impl-24.0.0-beta1.jar:android/support/v4/media/MediaBrowserCompatApi21$SubscriptionCallbackProxy.class */
    static class SubscriptionCallbackProxy<T extends SubscriptionCallback> extends MediaBrowser.SubscriptionCallback {
        ...
        static List<Parcel> itemListToParcelList(List<MediaBrowser.MediaItem> itemList) {
            if (itemList != null) {
                if (itemList.size() == 1 && itemList.get(0).getMediaId().equals(MediaBrowserCompatApi21.NULL_MEDIA_ITEM_ID)) {
                    return null;
                }
