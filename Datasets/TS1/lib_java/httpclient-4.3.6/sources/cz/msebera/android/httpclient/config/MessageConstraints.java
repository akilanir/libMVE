...
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/config/MessageConstraints.class */
public class MessageConstraints implements Cloneable {
    ...
    public MessageConstraints m17clone() throws CloneNotSupportedException {
    ...
    /* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/config/MessageConstraints$Builder.class */
