...
@ThreadSafe
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/client/SystemDefaultCredentialsProvider.class */
public class SystemDefaultCredentialsProvider implements CredentialsProvider {
    ...
    private static PasswordAuthentication getSystemCreds(AuthScope authscope, Authenticator.RequestorType requestorType) {
        ...
        String protocol = port == 443 ? "https" : HttpHost.DEFAULT_SCHEME_NAME;
