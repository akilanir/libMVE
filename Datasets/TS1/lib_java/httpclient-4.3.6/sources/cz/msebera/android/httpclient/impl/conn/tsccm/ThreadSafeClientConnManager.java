...
@Deprecated
@ThreadSafe
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/conn/tsccm/ThreadSafeClientConnManager.class */
    ...
    public void releaseConnection(ManagedClientConnection conn, long validDuration, TimeUnit timeUnit) {
        ...
        synchronized (hca) {
            ...
            try {
                ...
                hca.detach();
                this.pool.freeEntry(entry, reusable3, validDuration, timeUnit);
                throw th;
            }
        }
    }
