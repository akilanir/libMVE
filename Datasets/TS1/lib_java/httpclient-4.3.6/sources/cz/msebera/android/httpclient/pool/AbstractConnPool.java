...
@ThreadSafe
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/pool/AbstractConnPool.class */
public abstract class AbstractConnPool<T, C, E extends PoolEntry<T, C>> implements ConnPool<T, E>, ConnPoolControl<T> {
    ...
    private RouteSpecificPool<T, C, E> getPool(final T route) {
        ...
        if (pool == null) {
            pool = new RouteSpecificPool<T, C, E>(route) { // from class: cz.msebera.android.httpclient.pool.AbstractConnPool.1
                /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v18, types: [cz.msebera.android.httpclient.pool.PoolEntry] */
    /* JADX WARN: Type inference failed for: r0v9, types: [cz.msebera.android.httpclient.pool.RouteSpecificPool] */
    /* JADX WARN: Type inference failed for: r8v0, types: [cz.msebera.android.httpclient.pool.AbstractConnPool, cz.msebera.android.httpclient.pool.AbstractConnPool<T, C, E extends cz.msebera.android.httpclient.pool.PoolEntry<T, C>>] */
