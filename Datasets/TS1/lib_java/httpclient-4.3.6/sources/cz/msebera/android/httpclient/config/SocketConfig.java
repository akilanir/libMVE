...
@Immutable
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/config/SocketConfig.class */
public class SocketConfig implements Cloneable {
    ...
    public SocketConfig m19clone() throws CloneNotSupportedException {
    ...
    /* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/config/SocketConfig$Builder.class */
