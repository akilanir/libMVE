...
@Immutable
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/entity/ContentType.class */
public final class ContentType implements Serializable {
    ...
    private static ContentType create(HeaderElement helem) {
        ...
        return new ContentType(mimeType, (params == null || params.length <= 0) ? null : params);
    }
