...
@Immutable
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/pool/BasicConnFactory.class */
public class BasicConnFactory implements ConnFactory<HttpHost, HttpClientConnection> {
    ...
    protected HttpClientConnection create(Socket socket, HttpParams params) throws IOException {
        int bufsize = params.getIntParameter(CoreConnectionPNames.SOCKET_BUFFER_SIZE, CacheConfig.DEFAULT_MAX_OBJECT_SIZE_BYTES);
