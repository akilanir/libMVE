...
@NotThreadSafe
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/auth/NTLMEngineImpl.class */
final class NTLMEngineImpl implements NTLMEngine {
    ...
    /* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/auth/NTLMEngineImpl$CipherGen.class */
    ...
    /* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/auth/NTLMEngineImpl$NTLMMessage.class */
    ...
    /* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/auth/NTLMEngineImpl$Type1Message.class */
    static class Type1Message extends NTLMMessage {
        ...
        Type1Message(String domain, String host) throws NTLMEngineException {
            try {
                ...
                this.domainBytes = unqualifiedDomain != null ? unqualifiedDomain.toUpperCase(Locale.ENGLISH).getBytes("ASCII") : null;
            } catch (UnsupportedEncodingException e) {
    ...
    /* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/auth/NTLMEngineImpl$Type2Message.class */
    ...
    /* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/auth/NTLMEngineImpl$Type3Message.class */
    ...
    /* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/auth/NTLMEngineImpl$MD4.class */
    static class MD4 {
    ...
    /* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/auth/NTLMEngineImpl$HMACMD5.class */
