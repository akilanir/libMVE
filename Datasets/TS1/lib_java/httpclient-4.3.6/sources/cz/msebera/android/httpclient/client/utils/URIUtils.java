...
@Immutable
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/client/utils/URIUtils.class */
public class URIUtils {
    ...
    private static URI normalizeSyntax(URI uri) {
        ...
        Iterator<String> it = outputSegments.iterator();
        while (it.hasNext()) {
            String outputSegment = it.next();
