...
@Deprecated
/* loaded from: httpclient-4.3.6.jar:cz/msebera/android/httpclient/impl/conn/tsccm/ConnPoolByRoute.class */
public class ConnPoolByRoute extends AbstractConnPool {
    ...
    /* JADX WARN: Removed duplicated region for block: B:11:0x004a A[Catch: all -> 0x00a0, TryCatch #0 {all -> 0x00a0, blocks: (B:5:0x000f, B:7:0x0016, B:9:0x0020, B:10:0x0042, B:22:0x0090, B:11:0x004a, B:13:0x0056, B:15:0x0060, B:16:0x0069, B:17:0x0079, B:19:0x0083), top: B:29:0x000f }] */
    /*
    ...
    */
    protected void notifyWaitingThread(cz.msebera.android.httpclient.impl.conn.tsccm.RouteSpecificPool r5) {
        /*
            ...
            if (r0 == 0) goto L4a
            r0 = r5
            boolean r0 = r0.hasThread()     // Catch: java.lang.Throwable -> La0
            if (r0 == 0) goto L4a
            r0 = r4
            cz.msebera.android.httpclient.extras.HttpClientAndroidLog r0 = r0.log     // Catch: java.lang.Throwable -> La0
            ...
            r2 = r5
            cz.msebera.android.httpclient.conn.routing.HttpRoute r2 = r2.getRoute()     // Catch: java.lang.Throwable -> La0
            java.lang.StringBuilder r1 = r1.append(r2)     // Catch: java.lang.Throwable -> La0
            java.lang.String r2 = "]"
            java.lang.StringBuilder r1 = r1.append(r2)     // Catch: java.lang.Throwable -> La0
        ...
        L42:
            r0 = r5
            cz.msebera.android.httpclient.impl.conn.tsccm.WaitingThread r0 = r0.nextThread()     // Catch: java.lang.Throwable -> La0
            r6 = r0
            goto L8c
        L4a:
            r0 = r4
            java.util.Queue<cz.msebera.android.httpclient.impl.conn.tsccm.WaitingThread> r0 = r0.waitingThreads     // Catch: java.lang.Throwable -> La0
        ...
        L69:
            r0 = r4
            java.util.Queue<cz.msebera.android.httpclient.impl.conn.tsccm.WaitingThread> r0 = r0.waitingThreads     // Catch: java.lang.Throwable -> La0
            java.lang.Object r0 = r0.remove()     // Catch: java.lang.Throwable -> La0
            cz.msebera.android.httpclient.impl.conn.tsccm.WaitingThread r0 = (cz.msebera.android.httpclient.impl.conn.tsccm.WaitingThread) r0     // Catch: java.lang.Throwable -> La0
            r6 = r0
            goto L8c
        L79:
            r0 = r4
        ...
        L8c:
            ...
            if (r0 == 0) goto L94
            r0 = r6
            r0.wakeup()     // Catch: java.lang.Throwable -> La0
        L94:
            r0 = r4
            java.util.concurrent.locks.Lock r0 = r0.poolLock
            r0.unlock()
    ...
    public void shutdown() {
        ...
        try {
            ...
            while (iter2.hasNext()) {
                BasicPoolEntry entry2 = iter2.next();
                iter2.remove();
                if (this.log.isDebugEnabled()) {
