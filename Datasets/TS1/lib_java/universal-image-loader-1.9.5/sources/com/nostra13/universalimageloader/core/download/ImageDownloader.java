...
/* loaded from: universal-image-loader-1.9.5.jar:com/nostra13/universalimageloader/core/download/ImageDownloader.class */
public interface ImageDownloader {
    InputStream getStream(String str, Object obj) throws IOException;

    /* loaded from: universal-image-loader-1.9.5.jar:com/nostra13/universalimageloader/core/download/ImageDownloader$Scheme.class */
    public enum Scheme {
        HTTP("http"),
        HTTPS("https"),
        FILE("file"),
