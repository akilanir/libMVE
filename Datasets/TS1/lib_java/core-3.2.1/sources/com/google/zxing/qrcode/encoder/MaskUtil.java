...
/* loaded from: core-3.2.1.jar:com/google/zxing/qrcode/encoder/MaskUtil.class */
final class MaskUtil {
    ...
    static int applyMaskPenaltyRule4(ByteMatrix matrix) {
        ...
        int fivePercentVariances = (Math.abs((numDarkCells * 2) - numTotalCells) * N4) / numTotalCells;
    ...
    static boolean getDataMaskBit(int maskPattern, int x, int y) {
        int intermediate;
        switch (maskPattern) {
            case com.google.zxing.aztec.encoder.Encoder.DEFAULT_AZTEC_LAYERS /* 0 */:
                intermediate = (y + x) & 1;
                break;
            case 1:
                intermediate = y & 1;
