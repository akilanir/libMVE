...
/* loaded from: core-3.2.1.jar:com/google/zxing/pdf417/PDF417Writer.class */
public final class PDF417Writer implements Writer {
    ...
    private static BitMatrix bitMatrixFrombitArray(byte[][] input, int margin) {
        BitMatrix output = new BitMatrix(input[0].length + (DEFAULT_ERROR_CORRECTION_LEVEL * margin), input.length + (DEFAULT_ERROR_CORRECTION_LEVEL * margin));
        output.clear();
        int y = 0;
