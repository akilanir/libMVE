...
/* loaded from: core-3.2.1.jar:com/google/zxing/pdf417/decoder/DetectionResult.class */
final class DetectionResult {
    ...
    private void adjustRowNumbers(int barcodeColumn, int codewordsRow, Codeword[] codewords) {
        ...
        if (codewordsRow > 1) {
            otherCodewords[8] = codewords[codewordsRow - ADJUST_ROW_NUMBER_SKIP];
            otherCodewords[10] = previousColumnCodewords[codewordsRow - ADJUST_ROW_NUMBER_SKIP];
            otherCodewords[11] = nextColumnCodewords[codewordsRow - ADJUST_ROW_NUMBER_SKIP];
        }
        ...
        if (codewordsRow < codewords.length - ADJUST_ROW_NUMBER_SKIP) {
