...
/* loaded from: core-3.2.1.jar:com/google/zxing/pdf417/encoder/PDF417ErrorCorrection.class */
final class PDF417ErrorCorrection {
    ...
    static String generateErrorCorrection(CharSequence dataCodewords, int errorCorrectionLevel) {
        ...
        for (int i = 0; i < sld; i++) {
            ...
            for (int j = k - 1; j >= 1; j--) {
                int t2 = (t1 * EC_COEFFICIENTS[errorCorrectionLevel][j]) % PDF417Common.NUMBER_OF_CODEWORDS;
                int t3 = PDF417Common.NUMBER_OF_CODEWORDS - t2;
                e[j] = (char) ((e[j - 1] + t3) % PDF417Common.NUMBER_OF_CODEWORDS);
            }
            int t22 = (t1 * EC_COEFFICIENTS[errorCorrectionLevel][0]) % PDF417Common.NUMBER_OF_CODEWORDS;
            int t32 = PDF417Common.NUMBER_OF_CODEWORDS - t22;
            e[0] = (char) (t32 % PDF417Common.NUMBER_OF_CODEWORDS);
        }
        StringBuilder sb = new StringBuilder(k);
        for (int j2 = k - 1; j2 >= 0; j2--) {
            if (e[j2] != 0) {
                e[j2] = (char) (PDF417Common.NUMBER_OF_CODEWORDS - e[j2]);
            }
            sb.append(e[j2]);
        }
        return sb.toString();
