...
/* loaded from: apache-mime4j-core-0.7.2.jar:org/apache/james/mime4j/codec/EncoderUtil.class */
public class EncoderUtil {
    ...
    /* loaded from: apache-mime4j-core-0.7.2.jar:org/apache/james/mime4j/codec/EncoderUtil$Encoding.class */
    public enum Encoding {
        B,
        Q
    }

    /* loaded from: apache-mime4j-core-0.7.2.jar:org/apache/james/mime4j/codec/EncoderUtil$Usage.class */
    public enum Usage {
        TEXT_TOKEN,
        WORD_ENTITY
    }
    ...
    public static String encodeEncodedWord(String text, Usage usage, int usedCharacters, Charset charset, Encoding encoding) {
        ...
        String prefix2 = ENC_WORD_PREFIX + charset.name() + "?Q?";
