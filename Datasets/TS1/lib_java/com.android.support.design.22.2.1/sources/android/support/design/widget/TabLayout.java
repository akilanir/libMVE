...
/* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/TabLayout.class */
public class TabLayout extends HorizontalScrollView {
    ...
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/TabLayout$Mode.class */
    public @interface Mode {
    }

    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/TabLayout$OnTabSelectedListener.class */
    ...
    @Retention(RetentionPolicy.SOURCE)
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/TabLayout$TabGravity.class */
    ...
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/TabLayout$Tab.class */
    ...
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/TabLayout$TabView.class */
    class TabView extends LinearLayout implements View.OnLongClickListener {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (measuredWidth < TabLayout.this.mTabMinWidth || measuredWidth > TabLayout.this.mTabMaxWidth) {
                int widthMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(MathUtils.constrain(measuredWidth, TabLayout.this.mTabMinWidth, TabLayout.this.mTabMaxWidth), 1073741824);
        ...
        final void update() {
            ...
            if (this.mCustomView == null) {
                if (this.mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext()).inflate(R.layout.layout_tab_icon, (ViewGroup) this, false);
                    addView(iconView, 0);
    ...
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/TabLayout$SlidingTabStrip.class */
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (View.MeasureSpec.getMode(widthMeasureSpec) == 1073741824 && TabLayout.this.mMode == 1 && TabLayout.this.mTabGravity == 1) {
                ...
                if (largestTabWidth > 0) {
                    int gutter = TabLayout.this.dpToPx(TabLayout.FIXED_WRAP_GUTTER_MIN);
    ...
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/TabLayout$TabLayoutOnPageChangeListener.class */
    ...
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/TabLayout$ViewPagerOnTabSelectedListener.class */
