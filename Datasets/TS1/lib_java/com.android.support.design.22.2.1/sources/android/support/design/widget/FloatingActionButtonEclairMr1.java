...
/* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/FloatingActionButtonEclairMr1.class */
class FloatingActionButtonEclairMr1 extends FloatingActionButtonImpl {
    ...
    void hide() {
        ...
        Animation anim = android.view.animation.AnimationUtils.loadAnimation(this.mView.getContext(), android.support.design.R.anim.fab_out);
    ...
    @Override // android.support.design.widget.FloatingActionButtonImpl
    void show() {
        Animation anim = android.view.animation.AnimationUtils.loadAnimation(this.mView.getContext(), android.support.design.R.anim.fab_in);
        anim.setDuration(200L);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        this.mView.startAnimation(anim);
    }
    ...
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/FloatingActionButtonEclairMr1$BaseShadowAnimation.class */
    ...
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/FloatingActionButtonEclairMr1$ResetElevationAnimation.class */
    ...
    /* loaded from: com.android.support.design.22.2.1.jar:android/support/design/widget/FloatingActionButtonEclairMr1$ElevateToTranslationZAnimation.class */
