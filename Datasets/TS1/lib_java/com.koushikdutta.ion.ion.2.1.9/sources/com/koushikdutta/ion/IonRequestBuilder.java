...
/* loaded from: com.koushikdutta.ion.ion.2.1.9.jar:com/koushikdutta/ion/IonRequestBuilder.class */
class IonRequestBuilder implements Builders.Any.B, Builders.Any.F, Builders.Any.M, Builders.Any.U, LoadBuilder<Builders.Any.B> {
    ...
    /* loaded from: com.koushikdutta.ion.ion.2.1.9.jar:com/koushikdutta/ion/IonRequestBuilder$LoadRequestCallback.class */
    ...
    Future<AsyncHttpRequest> recursiveResolveRequest(AsyncHttpRequest request) {
        SimpleFuture<AsyncHttpRequest> ret = new SimpleFuture<>();
        Runnable resolver = new AnonymousClass3(request, ret);
        resolver.run();
        return ret;
    }

    /* renamed from: com.koushikdutta.ion.IonRequestBuilder$3, reason: invalid class name */
    /* loaded from: com.koushikdutta.ion.ion.2.1.9.jar:com/koushikdutta/ion/IonRequestBuilder$3.class */
    class AnonymousClass3 implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            Future<AsyncHttpRequest> resolved = IonRequestBuilder.this.resolveRequest(this.inRequest);
            if (resolved == null) {
                this.val$ret.setComplete(this.inRequest);
            } else {
                resolved.setCallback(new FutureCallback<AsyncHttpRequest>() { // from class: com.koushikdutta.ion.IonRequestBuilder.3.1
                    public void onCompleted(Exception e, AsyncHttpRequest result) {
                        if (e != null) {
                            AnonymousClass3.this.val$ret.setComplete(e);
                        } else {
                            AnonymousClass3.this.inRequest = result;
    ...
    <T> void resolveAndLoadRequest(final AsyncHttpRequest request, final EmitterTransform<T> ret) {
        recursiveResolveRequest(request).setCallback(new FutureCallback<AsyncHttpRequest>() { // from class: com.koushikdutta.ion.IonRequestBuilder.4
            public void onCompleted(Exception e, AsyncHttpRequest result) {
                if (e != null) {
                    ret.setComplete(e);
                    return;
    ...
    /* loaded from: com.koushikdutta.ion.ion.2.1.9.jar:com/koushikdutta/ion/IonRequestBuilder$EmitterTransform.class */
    ...
    /* loaded from: com.koushikdutta.ion.ion.2.1.9.jar:com/koushikdutta/ion/IonRequestBuilder$5.class */
    ...
    /* loaded from: com.koushikdutta.ion.ion.2.1.9.jar:com/koushikdutta/ion/IonRequestBuilder$6.class */
