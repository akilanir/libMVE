...
/* loaded from: com.koushikdutta.ion.ion.2.1.9.jar:com/koushikdutta/ion/IonDrawable.class */
class IonDrawable extends LayerDrawable {
    ...
    /* loaded from: com.koushikdutta.ion.ion.2.1.9.jar:com/koushikdutta/ion/IonDrawable$IonDrawableCallback.class */
    ...
    /* loaded from: com.koushikdutta.ion.ion.2.1.9.jar:com/koushikdutta/ion/IonDrawable$IonGifDecoder.class */
    class IonGifDecoder {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.fadeIn) {
            ...
            destAlpha = Math.min(destAlpha2, this.alpha);
        }
