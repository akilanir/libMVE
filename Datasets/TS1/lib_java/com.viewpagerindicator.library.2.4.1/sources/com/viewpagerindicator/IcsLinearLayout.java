...
/* loaded from: com.viewpagerindicator.library.2.4.1.jar:com/viewpagerindicator/IcsLinearLayout.class */
class IcsLinearLayout extends LinearLayout {
    ...
    private void drawDividersVertical(Canvas canvas) {
        int bottom;
        int count = getChildCount();
        for (int i = LL_DIVIDER; i < count; i += LL_SHOW_DIVIDER) {
    ...
    private boolean hasDividerBeforeChildAt(int childIndex) {
        if (childIndex != 0 && childIndex != getChildCount() && (this.mShowDividers & LL_DIVIDER_PADDING) != 0) {
            boolean hasVisibleViewBefore = LL_DIVIDER;
