...
/* loaded from: jackson-core-2.5.1.jar:com/fasterxml/jackson/core/json/UTF8StreamJsonParser.class */
public class UTF8StreamJsonParser extends ParserBase {
    ...
    protected JsonToken _parseNegNumber() throws IOException {
        ...
        int intLen = 1;
        int end = (this._inputPtr + outBuf.length) - outPtr2;
        if (end > this._inputEnd) {
            end = this._inputEnd;
        }
        while (this._inputPtr < end) {
    ...
    protected final Name parseEscapedName(int[] quads, int qlen, int currQuad, int ch, int currQuadBytes) throws IOException {
        ...
        if (currQuadBytes > 0) {
            ...
            int i5 = qlen;
            qlen++;
            quads[i5] = pad(currQuad, currQuadBytes);
        }
    ...
    protected Name _parseAposName() throws IOException {
        ...
        if (currQuadBytes > 0) {
            ...
            int i6 = qlen;
            qlen++;
            quads[i6] = pad(currQuad, currQuadBytes);
        }
        Name name = this._symbols.findName(quads, qlen);
        if (name == null) {
            name = addName(quads, qlen, currQuadBytes);
    ...
    private final Name findName(int q1, int lastQuadBytes) throws JsonParseException {
        ...
        Name name = this._symbols.findName(q12);
        if (name != null) {
            return name;
        }
    ...
    private final Name findName(int q1, int q2, int lastQuadBytes) throws JsonParseException {
        ...
        Name name = this._symbols.findName(q1, q22);
        if (name != null) {
            return name;
        }
        this._quadBuffer[0] = q1;
        ...
        while (ix < byteLen) {
            ...
            if (ch2 > 127) {
                ...
                if (needed > 2) {
                    ...
                    int i = cix;
                    cix++;
                    cbuf[i] = (char) (GeneratorBase.SURR1_FIRST + (ch3 >> 10));
                    ch2 = 56320 | (ch3 & 1023);
                }
            }
            if (cix >= cbuf.length) {
