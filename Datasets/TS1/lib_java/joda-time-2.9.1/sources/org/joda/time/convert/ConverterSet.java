...
/* loaded from: joda-time-2.9.1.jar:org/joda/time/convert/ConverterSet.class */
class ConverterSet {
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/convert/ConverterSet$Entry.class */
    static class Entry {
        final Class<?> iType;
