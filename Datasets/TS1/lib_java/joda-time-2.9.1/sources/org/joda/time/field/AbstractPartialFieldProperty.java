...
/* loaded from: joda-time-2.9.1.jar:org/joda/time/field/AbstractPartialFieldProperty.class */
public abstract class AbstractPartialFieldProperty {
    ...
    public int hashCode() {
        return (13 * ((13 * ((13 * 19) + get())) + getFieldType().hashCode())) + getReadablePartial().getChronology().hashCode();
    }
