...
/* loaded from: joda-time-2.9.1.jar:org/joda/time/DateTimeFieldType.class */
public abstract class DateTimeFieldType implements Serializable {
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/DateTimeFieldType$StandardDateTimeFieldType.class */
    private static class StandardDateTimeFieldType extends DateTimeFieldType {
        ...
        public DateTimeField getField(Chronology chronology) {
            ...
            switch (this.iOrdinal) {
                ...
                case DateTimeFieldType.HALFDAY_OF_DAY /* 13 */:
                    return chronology2.halfdayOfDay();
                case DateTimeFieldType.HOUR_OF_HALFDAY /* 14 */:
                    return chronology2.hourOfHalfday();
                case DateTimeFieldType.CLOCKHOUR_OF_HALFDAY /* 15 */:
                    return chronology2.clockhourOfHalfday();
                case DateTimeFieldType.CLOCKHOUR_OF_DAY /* 16 */:
                    return chronology2.clockhourOfDay();
                case DateTimeFieldType.HOUR_OF_DAY /* 17 */:
                    return chronology2.hourOfDay();
                case DateTimeFieldType.MINUTE_OF_DAY /* 18 */:
                    return chronology2.minuteOfDay();
                case DateTimeFieldType.MINUTE_OF_HOUR /* 19 */:
                    return chronology2.minuteOfHour();
                case DateTimeFieldType.SECOND_OF_DAY /* 20 */:
                    return chronology2.secondOfDay();
                case DateTimeFieldType.SECOND_OF_MINUTE /* 21 */:
                    return chronology2.secondOfMinute();
                case DateTimeFieldType.MILLIS_OF_DAY /* 22 */:
                    return chronology2.millisOfDay();
                case DateTimeFieldType.MILLIS_OF_SECOND /* 23 */:
