...
/* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder.class */
public class DateTimeFormatterBuilder {
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$CharacterLiteral.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$StringLiteral.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$NumberFormatter.class */
        ...
        public int parseInto(DateTimeParserBucket dateTimeParserBucket, CharSequence charSequence, int i) {
            ...
            if (i3 >= 9) {
                if (z2) {
                    ...
                    int i6 = i + i3;
                    i2 = i6;
                    charAt = Integer.parseInt(charSequence.subSequence(i, i6).toString());
                }
            } else {
                int i7 = i;
                if (z || z2) {
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$UnpaddedNumber.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$PaddedNumber.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$FixedNumber.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$TwoDigitYear.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$TextField.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$Fraction.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$TimeZoneOffset.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$TimeZoneName.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$TimeZoneId.class */
    enum TimeZoneId implements InternalPrinter, InternalParser {
        ...
        private static int prefixedStartPosition(CharSequence charSequence, int i) {
            ...
            while (i2 <= size) {
                int i3 = (i2 + size) >>> 1;
                int csCompare = DateTimeFormatterBuilder.csCompare(charSequence, i, ALL_IDS.get(i3));
                if (csCompare > 0) {
                    size = i3 - 1;
                } else if (csCompare < 0) {
                    i2 = i3 + 1;
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$Composite.class */
    ...
    /* loaded from: joda-time-2.9.1.jar:org/joda/time/format/DateTimeFormatterBuilder$MatchingParser.class */
