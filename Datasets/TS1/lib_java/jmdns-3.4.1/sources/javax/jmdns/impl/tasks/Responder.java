...
/* loaded from: jmdns-3.4.1.jar:javax/jmdns/impl/tasks/Responder.class */
public class Responder extends DNSTask {
    ...
    public void start(Timer timer) {
        ...
        int delay = (!iAmTheOnlyOne || this._in.isTruncated()) ? (20 + JmDNSImpl.getRandom().nextInt(96)) - this._in.elapseSinceArrival() : 0;
        if (delay < 0) {
            delay = 0;
        }
        if (logger.isLoggable(Level.FINEST)) {
