...
/* loaded from: eventbus-3.0.0.jar:org/greenrobot/eventbus/util/ErrorDialogFragmentFactory.class */
public abstract class ErrorDialogFragmentFactory<T> {
    ...
    /* loaded from: eventbus-3.0.0.jar:org/greenrobot/eventbus/util/ErrorDialogFragmentFactory$Support.class */
    ...
    @TargetApi(11)
    /* loaded from: eventbus-3.0.0.jar:org/greenrobot/eventbus/util/ErrorDialogFragmentFactory$Honeycomb.class */
