...
/* loaded from: eventbus-3.0.0.jar:org/greenrobot/eventbus/util/AsyncExecutor.class */
public class AsyncExecutor {
    ...
    /* loaded from: eventbus-3.0.0.jar:org/greenrobot/eventbus/util/AsyncExecutor$RunnableEx.class */
    public interface RunnableEx {
        void run() throws Exception;
    }

    /* loaded from: eventbus-3.0.0.jar:org/greenrobot/eventbus/util/AsyncExecutor$Builder.class */
