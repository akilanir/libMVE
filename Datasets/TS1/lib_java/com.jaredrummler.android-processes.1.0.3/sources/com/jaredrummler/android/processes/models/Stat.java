...
/* loaded from: com.jaredrummler.android-processes.1.0.3.jar:com/jaredrummler/android/processes/models/Stat.class */
public final class Stat extends ProcFile {
    ...
    public static Stat get(int pid) throws IOException {
        return new Stat(String.format("/proc/%d/stat", Integer.valueOf(pid)));
    }
