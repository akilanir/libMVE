...
/* loaded from: com.android.support.recyclerview-v7.23.2.1.jar:android/support/v7/util/SortedList.class */
public class SortedList<T> {
    ...
    /* loaded from: com.android.support.recyclerview-v7.23.2.1.jar:android/support/v7/util/SortedList$Callback.class */
    ...
    public T get(int index) throws IndexOutOfBoundsException {
        ...
        if (this.mOldData != null && index >= this.mMergedSize) {
    ...
    /* loaded from: com.android.support.recyclerview-v7.23.2.1.jar:android/support/v7/util/SortedList$BatchedCallback.class */
