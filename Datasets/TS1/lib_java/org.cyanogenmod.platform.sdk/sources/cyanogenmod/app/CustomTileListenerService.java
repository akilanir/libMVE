...
/* loaded from: org.cyanogenmod.platform.sdk.jar:cyanogenmod/app/CustomTileListenerService.class */
public class CustomTileListenerService extends Service {
    ...
    public void unregisterAsSystemService() throws RemoteException {
        if (isBound()) {
            ICMStatusBarManager statusBarInterface = this.mStatusBarService;
            statusBarInterface.unregisterListener(this.mWrapper, this.mCurrentUser);
            this.mWrapper = null;
            this.mStatusBarService = null;
        }
    }

    /* loaded from: org.cyanogenmod.platform.sdk.jar:cyanogenmod/app/CustomTileListenerService$ICustomTileListenerWrapper.class */
