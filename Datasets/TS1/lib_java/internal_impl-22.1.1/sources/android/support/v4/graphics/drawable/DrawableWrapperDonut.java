...
/* loaded from: internal_impl-22.1.1.jar:android/support/v4/graphics/drawable/DrawableWrapperDonut.class */
class DrawableWrapperDonut extends Drawable implements Drawable.Callback, DrawableWrapper {
    ...
    private boolean updateTint(int[] state) {
        int color;
        if (this.mTintList != null && this.mTintMode != null && (color = this.mTintList.getColorForState(state, this.mTintList.getDefaultColor())) != this.mCurrentColor) {
