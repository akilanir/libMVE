...
/* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/core/ParameterFactory.class */
class ParameterFactory {
    ...
    public Parameter getInstance(Constructor factory, Annotation label, Annotation entry, int index) throws Exception {
        ...
        if (entry != null) {
            return (Parameter) builder.newInstance(factory, label, entry, this.format, Integer.valueOf(index));
        }
        return (Parameter) builder.newInstance(factory, label, this.format, Integer.valueOf(index));
    }
    ...
    /* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/core/ParameterFactory$ParameterBuilder.class */
