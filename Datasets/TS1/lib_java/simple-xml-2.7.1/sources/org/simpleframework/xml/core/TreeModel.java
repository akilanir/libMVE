...
/* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/core/TreeModel.class */
class TreeModel implements Model {
    ...
    /* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/core/TreeModel$OrderList.class */
    ...
    private void validateModels(Class type) throws Exception {
        ...
        while (i$.hasNext()) {
            ModelList list = i$.next();
            int count = 1;
            Iterator i$2 = list.iterator();
            while (i$2.hasNext()) {
                Model model = i$2.next();
                if (model != null) {
