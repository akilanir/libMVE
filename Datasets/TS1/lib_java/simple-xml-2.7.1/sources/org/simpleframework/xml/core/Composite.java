...
/* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/core/Composite.class */
class Composite implements Converter {
    ...
    private void validateElements(InputNode node, Section section) throws Exception {
        ...
        InputNode next = node.getNext();
        while (true) {
            InputNode next2 = next;
            if (next2 != null) {
                String name = next2.getName();
                Section child = section.getSection(name);
                if (child != null) {
                    validateSection(next2, child);
                } else {
                    validateElement(next2, section, map);
                }
                next = node.getNext();
            } else {
                validate(node, map);
    ...
    private void writeElements(OutputNode node, Object source, Section section) throws Exception {
        for (String name : section) {
            ...
            if (child != null) {
                ...
                Class expect = this.context.getType(this.type, source);
                Object value = this.criteria.get(label);
                if (value != null) {
                    continue;
                } else {
                    if (label == null) {
    ...
    /* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/core/Composite$Builder.class */
    ...
    /* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/core/Composite$Injector.class */
