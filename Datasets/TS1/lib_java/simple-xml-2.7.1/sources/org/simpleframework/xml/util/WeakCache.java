...
/* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/util/WeakCache.class */
public class WeakCache<T> implements Cache<T> {
    ...
    public boolean isEmpty() {
        ...
        while (i$.hasNext()) {
            WeakCache<T>.Segment segment = i$.next();
            if (!segment.isEmpty()) {
                return false;
            }
        }
    ...
    /* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/util/WeakCache$SegmentList.class */
    ...
    /* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/util/WeakCache$Segment.class */
