...
/* loaded from: simple-xml-2.7.1.jar:org/simpleframework/xml/core/Persister.class */
public class Persister implements Serializer {
    ...
    public <T> T read(Class<? extends T> cls, File file, boolean z) throws Exception {
        ...
        try {
            T t = (T) read((Class) cls, (InputStream) fileInputStream, z);
    ...
    public <T> T read(Class<? extends T> cls, InputNode inputNode, boolean z) throws Exception {
        try {
            T t = (T) read((Class) cls, inputNode, this.manager.open(z));
            this.manager.close();
            return t;
        } catch (Throwable th) {
            this.manager.close();
    ...
    public <T> T read(T t, File file, boolean z) throws Exception {
        FileInputStream fileInputStream = new FileInputStream(file);
        try {
            T t2 = (T) read((Persister) t, (InputStream) fileInputStream, z);
            fileInputStream.close();
            return t2;
        } catch (Throwable th) {
            fileInputStream.close();
    ...
    public <T> T read(T t, InputNode inputNode, boolean z) throws Exception {
        try {
            T t2 = (T) read((Persister) t, inputNode, this.manager.open(z));
            this.manager.close();
            return t2;
        } catch (Throwable th) {
            this.manager.close();
    ...
    public boolean validate(Class type, InputNode node, boolean strict) throws Exception {
        ...
        try {
            boolean validate = validate(type, node, session);
            this.manager.close();
            return validate;
        } catch (Throwable th) {
            this.manager.close();
