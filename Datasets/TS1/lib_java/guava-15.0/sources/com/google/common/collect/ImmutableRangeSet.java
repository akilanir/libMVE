...
@Beta
/* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableRangeSet.class */
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableRangeSet$ComplementRanges.class */
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        return (ImmutableList<Range<C>>) new ImmutableList<Range<C>>() { // from class: com.google.common.collect.ImmutableRangeSet.1
            ...
            public Range<C> get(int index) {
                ...
                return (index == 0 || index == i2 - 1) ? ((Range) ImmutableRangeSet.this.ranges.get(index + i3)).intersection(range) : (Range) ImmutableRangeSet.this.ranges.get(index + i3);
            }
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableRangeSet$AsSet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableRangeSet$AsSetSerializedForm.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableRangeSet$Builder.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableRangeSet$SerializedForm.class */
