...
/* loaded from: guava-15.0.jar:com/google/common/collect/ConcurrentHashMultiset.class */
public final class ConcurrentHashMultiset<E> extends AbstractMultiset<E> implements Serializable {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ConcurrentHashMultiset$FieldSettersHolder.class */
    ...
    public Set<Multiset.Entry<E>> entrySet() {
        ...
        if (result == null) {
            ConcurrentHashMultiset<E>.EntrySet entrySet = new EntrySet();
            result = entrySet;
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ConcurrentHashMultiset$EntrySet.class */
