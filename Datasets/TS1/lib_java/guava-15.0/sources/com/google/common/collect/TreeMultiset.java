...
/* loaded from: guava-15.0.jar:com/google/common/collect/TreeMultiset.class */
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeMultiset$Aggregate.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeMultiset$4.class */
    ...
    public boolean setCount(@Nullable E element, int oldCount, int newCount) {
        Preconditions.checkArgument(newCount >= 0);
        Preconditions.checkArgument(oldCount >= 0);
        Preconditions.checkArgument(this.range.contains(element));
        AvlNode<E> root = this.rootReference.get();
        if (root == null) {
            if (oldCount == 0) {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeMultiset$Reference.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeMultiset$AvlNode.class */
