...
/* loaded from: guava-15.0.jar:com/google/common/io/BaseEncoding.class */
public abstract class BaseEncoding {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/BaseEncoding$DecodingException.class */
    ...
    public final OutputSupplier<OutputStream> encodingStream(final OutputSupplier<? extends Writer> writerSupplier) {
        ...
        return new OutputSupplier<OutputStream>() { // from class: com.google.common.io.BaseEncoding.1
    ...
    public final ByteSink encodingSink(final CharSink encodedSink) {
        ...
        return new ByteSink() { // from class: com.google.common.io.BaseEncoding.2
    ...
    public final InputSupplier<InputStream> decodingStream(final InputSupplier<? extends Reader> readerSupplier) {
        ...
        return new InputSupplier<InputStream>() { // from class: com.google.common.io.BaseEncoding.3
            /* JADX WARN: Can't rename method to resolve collision */
    ...
    public final ByteSource decodingSource(final CharSource encodedSource) {
        ...
        return new ByteSource() { // from class: com.google.common.io.BaseEncoding.4
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/BaseEncoding$Alphabet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/BaseEncoding$StandardBaseEncoding.class */
    ...
    static GwtWorkarounds.CharInput ignoringInput(final GwtWorkarounds.CharInput delegate, final CharMatcher toIgnore) {
        ...
        return new GwtWorkarounds.CharInput() { // from class: com.google.common.io.BaseEncoding.5
    ...
    static GwtWorkarounds.CharOutput separatingOutput(final GwtWorkarounds.CharOutput delegate, final String separator, final int afterEveryChars) {
        ...
        return new GwtWorkarounds.CharOutput() { // from class: com.google.common.io.BaseEncoding.6
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/BaseEncoding$SeparatedBaseEncoding.class */
