...
/* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Callables.class */
    ...
    static <T> Callable<T> threadRenaming(final Callable<T> callable, final Supplier<String> nameSupplier) {
        ...
        return new Callable<T>() { // from class: com.google.common.util.concurrent.Callables.2
            ...
            public T call() throws Exception {
                ...
                boolean trySetName = Callables.trySetName((String) nameSupplier.get(), currentThread);
                try {
                    T t = (T) callable.call();
                    if (trySetName) {
