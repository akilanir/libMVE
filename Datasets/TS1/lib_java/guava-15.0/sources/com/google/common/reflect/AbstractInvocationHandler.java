...
@Beta
/* loaded from: guava-15.0.jar:com/google/common/reflect/AbstractInvocationHandler.class */
public abstract class AbstractInvocationHandler implements InvocationHandler {
    ...
    public final Object invoke(Object proxy, Method method, @Nullable Object[] args) throws Throwable {
        ...
        if (args.length == 1 && method.getName().equals("equals") && method.getParameterTypes()[0] == Object.class) {
            Object arg = args[0];
            return Boolean.valueOf(proxy.getClass().isInstance(arg) && equals(Proxy.getInvocationHandler(arg)));
        }
