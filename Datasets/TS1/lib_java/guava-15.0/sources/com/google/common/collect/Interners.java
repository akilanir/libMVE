...
@Beta
/* loaded from: guava-15.0.jar:com/google/common/collect/Interners.class */
public final class Interners {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/Interners$WeakInterner.class */
    private static class WeakInterner<E> implements Interner<E> {
        private final MapMakerInternalMap<E, Dummy> map;

        /* loaded from: guava-15.0.jar:com/google/common/collect/Interners$WeakInterner$Dummy.class */
        private enum Dummy {
            VALUE
        }
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/Interners$InternerFunction.class */
