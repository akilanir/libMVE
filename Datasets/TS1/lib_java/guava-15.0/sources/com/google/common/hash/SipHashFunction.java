...
/* loaded from: guava-15.0.jar:com/google/common/hash/SipHashFunction.class */
final class SipHashFunction extends AbstractStreamingHashFunction implements Serializable {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/hash/SipHashFunction$SipHasher.class */
    private static final class SipHasher extends AbstractStreamingHashFunction.AbstractStreamingHasher {
        ...
        SipHasher(int c, int d, long k0, long k1) {
            ...
            this.finalM = SipHashFunction.serialVersionUID;
            this.c = c;
            this.d = d;
            this.v0 ^= k0;
            this.v1 ^= k1;
