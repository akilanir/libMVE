...
@GwtCompatible
/* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable.class */
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$TableSet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$CellIterator.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$Row.class */
    class Row extends Maps.ImprovedAbstractMap<C, V> {
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$Row$RowEntrySet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$Column.class */
    private class Column extends Maps.ImprovedAbstractMap<R, V> {
        ...
        boolean removeIf(Predicate<? super Map.Entry<R, V>> predicate) {
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$Column$EntrySet.class */
        private class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public boolean retainAll(Collection<?> c) {
                return Column.this.removeIf(Predicates.not(Predicates.in(c)));
            }
        }

        /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$Column$EntrySetIterator.class */
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$Column$KeySet.class */
        private class KeySet extends Maps.KeySet<R, V> {
            ...
            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection<?> c) {
                return Column.this.removeIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.in(c))));
            }
        }
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$Column$Values.class */
        private class Values extends Maps.Values<R, V> {
            ...
            public boolean removeAll(Collection<?> c) {
                return Column.this.removeIf(Maps.valuePredicateOnEntries(Predicates.in(c)));
            }

            @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
            public boolean retainAll(Collection<?> c) {
                return Column.this.removeIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.in(c))));
            }
        }
    }
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$ColumnKeySet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$ColumnKeyIterator.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$RowMap.class */
    class RowMap extends Maps.ImprovedAbstractMap<R, Map<C, V>> {
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$RowMap$EntrySet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$ColumnMap.class */
    private class ColumnMap extends Maps.ImprovedAbstractMap<C, Map<R, V>> {
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$ColumnMap$ColumnMapEntrySet.class */
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/StandardTable$ColumnMap$ColumnMapValues.class */
