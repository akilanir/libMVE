...
@Beta
/* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Service.class */
public interface Service {

    @Beta
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Service$State.class */
    public enum State {
    ...
    @Beta
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Service$Listener.class */
