...
/* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableMapKeySet.class */
final class ImmutableMapKeySet<K, V> extends ImmutableSet<K> {
    ...
    @GwtIncompatible("serialization")
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableMapKeySet$KeySetSerializedForm.class */
