...
/* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableEnumMap.class */
final class ImmutableEnumMap<K extends Enum<K>, V> extends ImmutableMap<K, V> {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableEnumMap$EnumSerializedForm.class */
