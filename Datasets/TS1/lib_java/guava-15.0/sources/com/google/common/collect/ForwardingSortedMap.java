...
@GwtCompatible
/* loaded from: guava-15.0.jar:com/google/common/collect/ForwardingSortedMap.class */
public abstract class ForwardingSortedMap<K, V> extends ForwardingMap<K, V> implements SortedMap<K, V> {
    ...
    @Beta
    /* loaded from: guava-15.0.jar:com/google/common/collect/ForwardingSortedMap$StandardKeySet.class */
    ...
    protected V standardRemove(@Nullable Object obj) {
        try {
            Iterator<Map.Entry<Object, V>> entryIterator = tailMap(obj).entrySet().iterator();
            if (entryIterator.hasNext()) {
                Map.Entry<Object, V> ceilingEntry = entryIterator.next();
                if (unsafeCompare(ceilingEntry.getKey(), obj) == 0) {
