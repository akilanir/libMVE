...
@GwtCompatible
/* loaded from: guava-15.0.jar:com/google/common/collect/FilteredEntryMultimap.class */
class FilteredEntryMultimap<K, V> extends AbstractMultimap<K, V> implements FilteredMultimap<K, V> {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/FilteredEntryMultimap$ValuePredicate.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/FilteredEntryMultimap$AsMap.class */
    class AsMap extends Maps.ImprovedAbstractMap<K, Collection<V>> {
        ...
        Set<K> createKeySet() {
            return new Maps.KeySet<K, Collection<V>>(this) { // from class: com.google.common.collect.FilteredEntryMultimap.AsMap.1
                ...
                public boolean removeAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeIf(Maps.keyPredicateOnEntries(Predicates.in(c)));
                }

                @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
                public boolean retainAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.in(c))));
                }
        ...
        Collection<Collection<V>> createValues() {
            return new Maps.Values<K, Collection<V>>(this) { // from class: com.google.common.collect.FilteredEntryMultimap.AsMap.3
                ...
                @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
                public boolean removeAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeIf(Maps.valuePredicateOnEntries(Predicates.in(c)));
                }

                @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
                public boolean retainAll(Collection<?> c) {
                    return FilteredEntryMultimap.this.removeIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.in(c))));
                }
            };
        }
    }
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/FilteredEntryMultimap$Keys.class */
        ...
        public Set<Multiset.Entry<K>> entrySet() {
            return new Multisets.EntrySet<K>() { // from class: com.google.common.collect.FilteredEntryMultimap.Keys.1
                ...
                private boolean removeIf(final Predicate<? super Multiset.Entry<K>> predicate) {
                    return FilteredEntryMultimap.this.removeIf(new Predicate<Map.Entry<K, Collection<V>>>() { // from class: com.google.common.collect.FilteredEntryMultimap.Keys.1.1
                        @Override // com.google.common.base.Predicate
