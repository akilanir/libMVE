...
/* loaded from: guava-15.0.jar:com/google/common/collect/RegularImmutableBiMap.class */
class RegularImmutableBiMap<K, V> extends ImmutableBiMap<K, V> {
    ...
    RegularImmutableBiMap(int n, ImmutableMapEntry.TerminalEntry<?, ?>[] entriesToAdd) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            ImmutableMapEntry<K, V> immutableMapEntry = nextInKeyBucket;
            while (true) {
                ImmutableMapEntry<K, V> keyEntry = immutableMapEntry;
                if (keyEntry == null) {
                    break;
                }
                checkNoConflict(!key.equals(keyEntry.getKey()), "key", terminalEntry, keyEntry);
                immutableMapEntry = keyEntry.getNextInKeyBucket();
            }
            ImmutableMapEntry<K, V> nextInValueBucket = valueTable[valueBucket];
            ImmutableMapEntry<K, V> immutableMapEntry2 = nextInValueBucket;
            while (true) {
                ImmutableMapEntry<K, V> valueEntry = immutableMapEntry2;
                if (valueEntry == null) {
                    break;
                }
                checkNoConflict(!value.equals(valueEntry.getValue()), "value", terminalEntry, valueEntry);
                immutableMapEntry2 = valueEntry.getNextInValueBucket();
            }
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/RegularImmutableBiMap$NonTerminalBiMapEntry.class */
    ...
    public V get(@Nullable Object key) {
        ...
        ImmutableMapEntry<K, V> immutableMapEntry = this.keyTable[bucket];
        while (true) {
            ImmutableMapEntry<K, V> entry = immutableMapEntry;
            if (entry != null) {
                if (!key.equals(entry.getKey())) {
                    immutableMapEntry = entry.getNextInKeyBucket();
                } else {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/RegularImmutableBiMap$Inverse.class */
    private final class Inverse extends ImmutableBiMap<V, K> {
        ...
        public K get(@Nullable Object value) {
            if (value != null) {
                ...
                ImmutableMapEntry<K, V> immutableMapEntry = RegularImmutableBiMap.this.valueTable[bucket];
                while (true) {
                    ImmutableMapEntry<K, V> entry = immutableMapEntry;
                    if (entry != null) {
                        if (!value.equals(entry.getValue())) {
                            immutableMapEntry = entry.getNextInValueBucket();
                        } else {
                            return entry.getKey();
                        }
                    } else {
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/RegularImmutableBiMap$Inverse$InverseEntrySet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/RegularImmutableBiMap$InverseSerializedForm.class */
