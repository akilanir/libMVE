...
/* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeMap.class */
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeMap$RangeMapEntry.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeMap$AsMapOfRanges.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeMap$SubRangeMap.class */
    private class SubRangeMap implements RangeMap<K, V> {
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeMap$SubRangeMap$SubRangeMapAsMap.class */
        class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
            ...
            /* JADX INFO: Access modifiers changed from: private */
            public boolean removeIf(Predicate<? super Map.Entry<Range<K>, V>> predicate) {
                ...
                return new Maps.EntrySet<Range<K>, V>() { // from class: com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.2
                    ...
                    public Iterator<Map.Entry<Range<K>, V>> iterator() {
                        if (!SubRangeMap.this.subRange.isEmpty()) {
                            final Iterator<V> it = TreeRangeMap.this.entriesByLowerBound.tailMap((Cut) Objects.firstNonNull(TreeRangeMap.this.entriesByLowerBound.floorKey(SubRangeMap.this.subRange.lowerBound), SubRangeMap.this.subRange.lowerBound), true).values().iterator();
