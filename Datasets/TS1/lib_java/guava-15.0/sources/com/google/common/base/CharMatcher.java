...
/* loaded from: guava-15.0.jar:com/google/common/base/CharMatcher.class */
public abstract class CharMatcher implements Predicate<Character> {
    ...
    static {
        ...
        WHITESPACE = new FastMatcher("CharMatcher.WHITESPACE") { // from class: com.google.common.base.CharMatcher.15
            @Override // com.google.common.base.CharMatcher
            public boolean matches(char c) {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/base/CharMatcher$RangesMatcher.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/base/CharMatcher$NegatedMatcher.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/base/CharMatcher$And.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/base/CharMatcher$Or.class */
    ...
    CharMatcher precomputedInternal() {
        ...
        String negatedDescription = this.description.endsWith(".negate()") ? this.description.substring(0, this.description.length() - ".negate()".length()) : this.description + ".negate()";
        return new NegatedFastMatcher(toString(), precomputedPositive(negatedCharacters, table, negatedDescription));
    }

    /* loaded from: guava-15.0.jar:com/google/common/base/CharMatcher$FastMatcher.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/base/CharMatcher$NegatedFastMatcher.class */
    ...
    @GwtIncompatible("java.util.BitSet")
    /* loaded from: guava-15.0.jar:com/google/common/base/CharMatcher$BitSetMatcher.class */
