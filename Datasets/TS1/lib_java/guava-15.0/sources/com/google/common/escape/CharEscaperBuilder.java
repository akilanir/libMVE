...
@Beta
@GwtCompatible
/* loaded from: guava-15.0.jar:com/google/common/escape/CharEscaperBuilder.class */
public final class CharEscaperBuilder {
    private int max = -1;
    private final Map<Character, String> map = new HashMap();

    /* loaded from: guava-15.0.jar:com/google/common/escape/CharEscaperBuilder$CharArrayDecorator.class */
