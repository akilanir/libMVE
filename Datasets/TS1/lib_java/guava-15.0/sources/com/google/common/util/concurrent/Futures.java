...
@Beta
/* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures.class */
public final class Futures {
    ...
    private static final Ordering<Constructor<?>> WITH_STRING_PARAM_FIRST = Ordering.natural().onResultOf(new Function<Constructor<?>, Boolean>() { // from class: com.google.common.util.concurrent.Futures.5
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$FutureCombiner.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$ImmediateFuture.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$ImmediateSuccessfulFuture.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$ImmediateSuccessfulCheckedFuture.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$ImmediateFailedFuture.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$ImmediateCancelledFuture.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$ImmediateFailedCheckedFuture.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$FallbackFuture.class */
    ...
    public static <I, O> ListenableFuture<O> transform(ListenableFuture<I> input, final Function<? super I, ? extends O> function, Executor executor) {
        ...
        AsyncFunction<I, O> wrapperFunction = new AsyncFunction<I, O>() { // from class: com.google.common.util.concurrent.Futures.1
            @Override // com.google.common.util.concurrent.AsyncFunction
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$ChainingListenableFuture.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$NonCancellationPropagatingFuture.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$CombinedFuture.class */
    private static class CombinedFuture<V, C> extends AbstractFuture<C> {
        ...
        private void setExceptionAndMaybeLog(Throwable throwable) {
            ...
            if ((throwable instanceof Error) || (this.allMustSucceed && !result)) {
    ...
    private static <V> ListenableFuture<List<V>> listFuture(ImmutableList<ListenableFuture<? extends V>> futures, boolean allMustSucceed, Executor listenerExecutor) {
        return new CombinedFuture(futures, allMustSucceed, listenerExecutor, new FutureCombiner<V, List<V>>() { // from class: com.google.common.util.concurrent.Futures.6
    ...
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/Futures$MappingCheckedFuture.class */
