...
@Beta
/* loaded from: guava-15.0.jar:com/google/common/reflect/TypeToken.class */
public abstract class TypeToken<T> extends TypeCapture<T> implements Serializable {
    private final Type runtimeType;
    private transient TypeResolver typeResolver;

    /* loaded from: guava-15.0.jar:com/google/common/reflect/TypeToken$TypeFilter.class */
    ...
    public final <X> TypeToken<T> where(TypeParameter<X> typeParam, TypeToken<X> typeArg) {
        TypeResolver resolver = new TypeResolver().where(ImmutableMap.of(typeParam.typeVariable, typeArg.runtimeType));
    ...
    /* loaded from: guava-15.0.jar:com/google/common/reflect/TypeToken$TypeSet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/reflect/TypeToken$InterfaceSet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/reflect/TypeToken$ClassSet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/reflect/TypeToken$SimpleTypeToken.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/reflect/TypeToken$TypeCollector.class */
    private static abstract class TypeCollector<K> {
        ...
        /* loaded from: guava-15.0.jar:com/google/common/reflect/TypeToken$TypeCollector$ForwardingTypeCollector.class */
