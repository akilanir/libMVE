...
/* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap.class */
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$BiEntry.class */
    ...
    private void init(int expectedSize) {
        Preconditions.checkArgument(expectedSize >= 0, "expectedSize must be >= 0 but was %s", Integer.valueOf(expectedSize));
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$Itr.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$KeySet.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$EntrySet.class */
    private final class EntrySet extends Maps.EntrySet<K, V> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return new HashBiMap<K, V>.Itr<Map.Entry<K, V>>() { // from class: com.google.common.collect.HashBiMap.EntrySet.1
                ...
                /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$EntrySet$1$MapEntry.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$Inverse.class */
    private final class Inverse extends AbstractMap<V, K> implements BiMap<V, K>, Serializable {
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$Inverse$InverseKeySet.class */
        ...
        /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$Inverse$1.class */
        class AnonymousClass1 extends Maps.EntrySet<V, K> {
            ...
            public Iterator<Map.Entry<V, K>> iterator() {
                return new HashBiMap<K, V>.Itr<Map.Entry<V, K>>() { // from class: com.google.common.collect.HashBiMap.Inverse.1.1
                    ...
                    /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$Inverse$1$1$InverseEntry.class */
                    class InverseEntry extends AbstractMapEntry<V, K> {
                        ...
                        public K setValue(K key) {
                            ...
                            if (keyHash != this.delegate.keyHash || !Objects.equal(key, oldKey)) {
                                ...
                                HashBiMap.this.insert(newEntry);
                                C00111.this.expectedModCount = HashBiMap.this.modCount;
                                return oldKey;
                            }
                            return key;
                        }
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/HashBiMap$InverseSerializedForm.class */
