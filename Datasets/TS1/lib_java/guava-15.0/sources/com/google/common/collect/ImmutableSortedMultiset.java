...
/* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableSortedMultiset.class */
public abstract class ImmutableSortedMultiset<E> extends ImmutableSortedMultisetFauxverideShim<E> implements SortedMultiset<E> {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableSortedMultiset$Builder.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableSortedMultiset$SerializedForm.class */
    private static final class SerializedForm implements Serializable {
        ...
        Object readResolve() {
            ...
            for (int i = 0; i < n; i++) {
                builder.addCopies((Builder<Object>) this.elements[i], this.counts[i]);
            }
