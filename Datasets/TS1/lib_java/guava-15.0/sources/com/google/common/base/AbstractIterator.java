...
@GwtCompatible
/* loaded from: guava-15.0.jar:com/google/common/base/AbstractIterator.class */
abstract class AbstractIterator<T> implements Iterator<T> {
    private State state = State.NOT_READY;
    private T next;

    /* loaded from: guava-15.0.jar:com/google/common/base/AbstractIterator$State.class */
    private enum State {
        READY,
        NOT_READY,
        DONE,
    ...
    /* loaded from: guava-15.0.jar:com/google/common/base/AbstractIterator$1.class */
