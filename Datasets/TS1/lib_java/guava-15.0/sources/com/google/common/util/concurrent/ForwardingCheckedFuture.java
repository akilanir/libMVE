...
@Beta
/* loaded from: guava-15.0.jar:com/google/common/util/concurrent/ForwardingCheckedFuture.class */
public abstract class ForwardingCheckedFuture<V, X extends Exception> extends ForwardingListenableFuture<V> implements CheckedFuture<V, X> {
    ...
    @Beta
    /* loaded from: guava-15.0.jar:com/google/common/util/concurrent/ForwardingCheckedFuture$SimpleForwardingCheckedFuture.class */
