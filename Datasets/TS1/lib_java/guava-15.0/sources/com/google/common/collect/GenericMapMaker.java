...
@Deprecated
/* loaded from: guava-15.0.jar:com/google/common/collect/GenericMapMaker.class */
public abstract class GenericMapMaker<K0, V0> {
    ...
    @GwtIncompatible("To be supported")
    /* loaded from: guava-15.0.jar:com/google/common/collect/GenericMapMaker$NullListener.class */
