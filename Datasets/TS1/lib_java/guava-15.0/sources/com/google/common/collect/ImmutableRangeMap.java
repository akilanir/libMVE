...
/* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableRangeMap.class */
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V> {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableRangeMap$Builder.class */
