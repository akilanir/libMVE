...
/* loaded from: guava-15.0.jar:com/google/common/hash/Murmur3_128HashFunction.class */
final class Murmur3_128HashFunction extends AbstractStreamingHashFunction implements Serializable {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/hash/Murmur3_128HashFunction$Murmur3_128Hasher.class */
        ...
        protected void processRemaining(ByteBuffer bb) {
            ...
            switch (bb.remaining()) {
                ...
                case Ascii.ACK /* 6 */:
                    ...
                    return;
                case Ascii.BEL /* 7 */:
                    k12 = Murmur3_128HashFunction.serialVersionUID ^ (UnsignedBytes.toInt(bb.get(6)) << 48);
                    k12 ^= UnsignedBytes.toInt(bb.get(5)) << 40;
                    k12 ^= UnsignedBytes.toInt(bb.get(4)) << 32;
                    k12 ^= UnsignedBytes.toInt(bb.get(3)) << 24;
                    k12 ^= UnsignedBytes.toInt(bb.get(2)) << 16;
                    ...
                    return;
                case 8:
                    k1 = Murmur3_128HashFunction.serialVersionUID ^ bb.getLong();
                    this.h1 ^= mixK1(k1);
                    this.h2 ^= mixK2(k2);
                    return;
                case Ascii.HT /* 9 */:
                ...
                case Ascii.SO /* 14 */:
                    ...
                    return;
                case Ascii.SI /* 15 */:
                    k2 = Murmur3_128HashFunction.serialVersionUID ^ (UnsignedBytes.toInt(bb.get(14)) << 48);
                    k2 ^= UnsignedBytes.toInt(bb.get(13)) << 40;
                    k2 ^= UnsignedBytes.toInt(bb.get(12)) << 32;
                    k2 ^= UnsignedBytes.toInt(bb.get(11)) << 24;
                    k2 ^= UnsignedBytes.toInt(bb.get(10)) << 16;
