...
/* loaded from: guava-15.0.jar:com/google/common/io/GwtWorkarounds.class */
final class GwtWorkarounds {

    /* loaded from: guava-15.0.jar:com/google/common/io/GwtWorkarounds$ByteInput.class */
    interface ByteInput {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/GwtWorkarounds$ByteOutput.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/GwtWorkarounds$CharInput.class */
    interface CharInput {
        int read() throws IOException;
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/GwtWorkarounds$CharOutput.class */
