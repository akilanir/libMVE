...
@Beta
/* loaded from: guava-15.0.jar:com/google/common/io/ByteStreams.class */
public final class ByteStreams {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/ByteStreams$ByteArrayDataInputStream.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/ByteStreams$ByteArrayDataOutputStream.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/io/ByteStreams$LimitedInputStream.class */
    ...
    public static <T> T readBytes(InputSupplier<? extends InputStream> inputSupplier, ByteProcessor<T> byteProcessor) throws IOException {
        ...
        try {
            try {
                T t = (T) readBytes((InputStream) create.register(inputSupplier.getInput()), byteProcessor);
                create.close();
                return t;
            } finally {
            }
    ...
    public static InputSupplier<InputStream> join(Iterable<? extends InputSupplier<? extends InputStream>> suppliers) {
        ...
        Iterable<ByteSource> sources = Iterables.transform(suppliers, new Function<InputSupplier<? extends InputStream>, ByteSource>() { // from class: com.google.common.io.ByteStreams.2
