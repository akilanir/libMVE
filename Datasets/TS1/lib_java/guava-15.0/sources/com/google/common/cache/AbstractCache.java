...
@Beta
@GwtCompatible
/* loaded from: guava-15.0.jar:com/google/common/cache/AbstractCache.class */
public abstract class AbstractCache<K, V> implements Cache<K, V> {

    @Beta
    /* loaded from: guava-15.0.jar:com/google/common/cache/AbstractCache$StatsCounter.class */
    ...
    public ImmutableMap<K, V> getAllPresent(Iterable<?> keys) {
        ...
        for (Object key : keys) {
            if (!newLinkedHashMap.containsKey(key)) {
                newLinkedHashMap.put(key, getIfPresent(key));
            }
        }
    ...
    @Beta
    /* loaded from: guava-15.0.jar:com/google/common/cache/AbstractCache$SimpleStatsCounter.class */
