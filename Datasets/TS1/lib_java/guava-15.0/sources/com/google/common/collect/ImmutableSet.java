...
/* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableSet.class */
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    public static <E> ImmutableSet<E> copyOf(Collection<? extends E> elements) {
        if ((elements instanceof ImmutableSet) && !(elements instanceof ImmutableSortedSet)) {
            ...
            ImmutableSet<E> result = ImmutableEnumSet.asImmutable(enumSet);
            return result;
        }
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableSet$SerializedForm.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/ImmutableSet$Builder.class */
