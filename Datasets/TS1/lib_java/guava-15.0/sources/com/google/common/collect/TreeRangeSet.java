...
/* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeSet.class */
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeSet$AsRanges.class */
    ...
    @VisibleForTesting
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeSet$RangesByUpperBound.class */
    static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            Iterator<Range<C>> it;
            if (!this.upperBoundWindow.hasLowerBound() || (lowerEntry = this.rangesByLowerBound.lowerEntry(this.upperBoundWindow.lowerEndpoint())) == null) {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeSet$ComplementRangesByLowerBound.class */
    private static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            final Cut cut = (Cut) Objects.firstNonNull(higherKey, Cut.aboveAll());
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeSet$Complement.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeSet$SubRangeSetRangesByLowerBound.class */
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/TreeRangeSet$SubRangeSet.class */
