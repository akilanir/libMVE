...
@GwtCompatible
/* loaded from: guava-15.0.jar:com/google/common/base/Joiner.class */
public class Joiner {
    ...
    public Joiner useForNull(final String nullText) {
        ...
        return new Joiner(this) { // from class: com.google.common.base.Joiner.1
            ...
            public Joiner useForNull(String nullText2) {
                Preconditions.checkNotNull(nullText2);
    ...
    /* loaded from: guava-15.0.jar:com/google/common/base/Joiner$MapJoiner.class */
