...
/* loaded from: guava-15.0.jar:com/google/common/collect/RegularImmutableMap.class */
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/RegularImmutableMap$NonTerminalMapEntry.class */
    ...
    public V get(@Nullable Object key) {
        ...
        ImmutableMapEntry<K, V> immutableMapEntry = this.table[index];
        while (true) {
    ...
    /* loaded from: guava-15.0.jar:com/google/common/collect/RegularImmutableMap$EntrySet.class */
