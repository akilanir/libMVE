...
/* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/v8dtoa/CachedPowers.class */
public class CachedPowers {
    ...
    /* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/v8dtoa/CachedPowers$CachedPower.class */
    ...
    static int getCachedPower(int e, int alpha, int gamma, DiyFp c_mk) {
        ...
        int index = (((GRISU_CACHE_OFFSET + ((int) k)) - 1) / 8) + 1;
