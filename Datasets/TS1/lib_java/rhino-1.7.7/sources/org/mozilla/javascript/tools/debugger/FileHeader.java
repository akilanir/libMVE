...
/* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/tools/debugger/FileHeader.class */
    ...
    public void paint(Graphics g) {
        ...
        for (int i = startLine; i < endLine; i++) {
            ...
            if (pos == this.fileWindow.currentPos) {
                ...
                int y2 = y + (ascent - 10);
                arrow.addPoint(x, y2 + 3);
                arrow.addPoint(x + 5, y2 + 3);
                int x2 = x + 5;
                while (x2 <= x + 10) {
                ...
                int x3 = x + 9;
                while (x3 >= x + 5) {
                    arrow.addPoint(x3, y2);
                    x3--;
                    y2++;
                }
                arrow.addPoint(x + 5, y2 + 7);
                arrow.addPoint(x, y2 + 7);
