...
/* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/tools/debugger/FindFunction.class */
class FindFunction extends JDialog implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (!cmd.equals("Select") || this.list.getSelectedIndex() < 0) {
            return;
        }
        try {
    ...
    /* compiled from: SwingGui.java */
    /* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/tools/debugger/FindFunction$MouseHandler.class */
