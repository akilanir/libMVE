...
/* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/Context.class */
public class Context {
    ...
    /* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/Context$ClassShutterSetter.class */
    ...
    public static Object call(ContextFactory factory, final Callable callable, final Scriptable scope, final Scriptable thisObj, final Object[] args) {
        ...
        return call(factory, new ContextAction() { // from class: org.mozilla.javascript.Context.1
    ...
    public final String getImplementationVersion() {
        ...
        if (implementationVersion == null) {
            try {
                Enumeration<URL> urls = Context.class.getClassLoader().getResources("META-INF/MANIFEST.MF");
    ...
    static String getSourcePositionFromStack(int[] linep) {
        ...
        for (StackTraceElement st : stackTrace) {
            ...
            if (file != null && !file.endsWith(".java") && (line = st.getLineNumber()) >= 0) {
                linep[0] = line;
                return file;
            }
        }
