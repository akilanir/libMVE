...
/* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/tools/debugger/treetable/TreeTableModelAdapter.class */
public class TreeTableModelAdapter extends AbstractTableModel {
    ...
    public TreeTableModelAdapter(TreeTableModel treeTableModel, JTree tree) {
        ...
        tree.addTreeExpansionListener(new TreeExpansionListener() { // from class: org.mozilla.javascript.tools.debugger.treetable.TreeTableModelAdapter.1
