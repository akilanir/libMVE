...
/* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/tools/idswitch/CodePrinter.class */
class CodePrinter {
    ...
    public void qchar(int c) {
        ...
        this.buffer[pos] = '\'';
        int pos2 = put_string_literal_char(pos + 1, c, false);
        this.buffer[pos2] = '\'';
        this.offset = pos2 + 1;
    }
    ...
    public void qstring(String s) {
        ...
        int pos2 = pos + 1;
        for (int i = 0; i != l; i++) {
            pos2 = put_string_literal_char(pos2, s.charAt(i), true);
        }
        this.buffer[pos2] = '\"';
        this.offset = pos2 + 1;
    }
