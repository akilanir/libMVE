...
/* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/NativeNumber.class */
final class NativeNumber extends IdScriptableObject {
    ...
    protected void fillConstructorProperties(IdFunctionObject ctor) {
        ...
        ctor.defineProperty("MAX_SAFE_INTEGER", ScriptRuntime.wrapNumber(MAX_SAFE_INTEGER), 7);
    ...
    private Object isNaN(Number val) {
        ...
        return Boolean.valueOf(ScriptRuntime.toBoolean(Boolean.valueOf(isDoubleNan(nd))));
    }
    ...
    private boolean isInteger(Number val) {
        Double nd = doubleVal(val);
        return ScriptRuntime.toBoolean(Boolean.valueOf(isDoubleInteger(nd)));
    }
    ...
    private boolean isSafeInteger(Number val) {
        Double nd = doubleVal(val);
        return ScriptRuntime.toBoolean(Boolean.valueOf(isDoubleSafeInteger(nd)));
    }
