...
/* loaded from: rhino-1.7.7.jar:org/mozilla/javascript/typedarrays/NativeTypedArrayView.class */
public abstract class NativeTypedArrayView<T> extends NativeArrayBufferView implements List<T>, RandomAccess, ExternalArrayData {
    ...
    private NativeTypedArrayView js_constructor(Context cx, Scriptable scope, Object[] args) {
        ...
        if (args[0] instanceof NativeTypedArrayView) {
            ...
            NativeTypedArrayView v = construct(makeArrayBuffer(cx, scope, src.length * getBytesPerElement()), 0, src.length);
        ...
        if (args[0] instanceof NativeArray) {
            List l = (List) args[0];
            NativeTypedArrayView v2 = construct(makeArrayBuffer(cx, scope, l.size() * getBytesPerElement()), 0, l.size());
            int p = 0;
            for (Object o : l) {
                v2.js_set(p, o);
                p++;
    ...
    private Object js_subarray(Context cx, Scriptable scope, int s, int e) {
        ...
        int byteOff = Math.min(start2 * getBytesPerElement(), this.arrayBuffer.getLength());
    ...
    public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
        ...
        switch (id) {
            ...
            case 4:
                if (args.length > 0) {
                    NativeTypedArrayView self2 = realThis(thisObj, f);
