...
/* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/nineoldandroids/animation/AnimatorSet.class */
public final class AnimatorSet extends Animator {
    ...
    public void start() {
        ...
        if (this.mStartDelay <= 0) {
            ...
            this.mDelayAnim.addListener(new AnimatorListenerAdapter() { // from class: com.actionbarsherlock.internal.nineoldandroids.animation.AnimatorSet.1
    ...
    @Override // com.actionbarsherlock.internal.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo2clone() {
        AnimatorSet anim = (AnimatorSet) super.mo2clone();
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/nineoldandroids/animation/AnimatorSet$DependencyListener.class */
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/nineoldandroids/animation/AnimatorSet$AnimatorSetListener.class */
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/nineoldandroids/animation/AnimatorSet$Dependency.class */
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/nineoldandroids/animation/AnimatorSet$Node.class */
    private static class Node implements Cloneable {
        ...
        public Node m3clone() {
            try {
                ...
                node.animation = this.animation.mo2clone();
                return node;
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/nineoldandroids/animation/AnimatorSet$Builder.class */
