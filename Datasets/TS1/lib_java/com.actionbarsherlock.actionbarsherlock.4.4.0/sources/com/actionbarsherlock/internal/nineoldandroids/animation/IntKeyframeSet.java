...
/* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/nineoldandroids/animation/IntKeyframeSet.class */
class IntKeyframeSet extends KeyframeSet {
    ...
    @Override // com.actionbarsherlock.internal.nineoldandroids.animation.KeyframeSet
    /* renamed from: clone */
    public IntKeyframeSet mo4clone() {
        ...
        for (int i = 0; i < numKeyframes; i++) {
            newKeyframes[i] = (Keyframe.IntKeyframe) keyframes.get(i).mo5clone();
        }
