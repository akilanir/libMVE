...
/* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/widget/ActionBarView.class */
public class ActionBarView extends AbsActionBarView {
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        this.mNavItemSelectedListener = new IcsAdapterView.OnItemSelectedListener() { // from class: com.actionbarsherlock.internal.widget.ActionBarView.1
        ...
        this.mExpandedActionViewUpListener = new View.OnClickListener() { // from class: com.actionbarsherlock.internal.widget.ActionBarView.2
        ...
        this.mUpClickListener = new View.OnClickListener() { // from class: com.actionbarsherlock.internal.widget.ActionBarView.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
        ...
        if (this.mLogo == null) {
            if (Build.VERSION.SDK_INT < 11) {
                if ((context instanceof Activity) && (resId = ResourcesCompat.loadLogoFromManifest((Activity) context)) != 0) {
        ...
        int homeResId = a.getResourceId(14, R.layout.abs__action_bar_home);
        ...
        this.mSubtitleStyleRes = a.getResourceId(4, 0);
        ...
        this.mContentHeight = a.getLayoutDimension(3, 0);
        a.recycle();
    ...
    public void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleLayout = (LinearLayout) inflater.inflate(R.layout.abs__action_bar_title_item, (ViewGroup) this, false);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (customView != null) {
            ...
            int customNavHeight = Math.max(0, (lp2.height >= 0 ? Math.min(lp2.height, height) : height) - verticalMargin);
        ...
        if (customView != null) {
            ...
            switch (vgravity) {
                case 16:
                    ...
                    int paddedBottom = (getBottom() - getTop()) - getPaddingBottom();
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/widget/ActionBarView$SavedState.class */
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/widget/ActionBarView$HomeView.class */
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/widget/ActionBarView$ExpandedActionViewMenuPresenter.class */
