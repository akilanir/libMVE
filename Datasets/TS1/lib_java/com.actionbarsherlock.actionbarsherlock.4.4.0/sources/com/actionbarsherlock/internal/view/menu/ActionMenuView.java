...
/* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/view/menu/ActionMenuView.class */
public class ActionMenuView extends IcsLinearLayout implements MenuBuilder.ItemInvoker, MenuView {
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/view/menu/ActionMenuView$ActionMenuChildView.class */
        ...
        if (needsExpansion) {
            ...
            for (int i5 = 0; i5 < childCount; i5++) {
                ...
                if (lp5.expanded) {
                    ...
                    child4.measure(View.MeasureSpec.makeMeasureSpec(width, 1073741824), heightSpec);
                }
            }
        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (v3.getVisibility() != 8 && !lp.isOverflowButton) {
                ...
                startLeft = startLeft2 + width2 + lp.rightMargin + spacerSize;
            }
        }
    }
    ...
    @Override // com.actionbarsherlock.internal.view.menu.MenuView
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/view/menu/ActionMenuView$LayoutParams.class */
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(LayoutParams other) {
            super((ViewGroup.MarginLayoutParams) other);
