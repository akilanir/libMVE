...
/* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/view/menu/MenuBuilder.class */
public class MenuBuilder implements Menu {
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/view/menu/MenuBuilder$Callback.class */
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/internal/view/menu/MenuBuilder$ItemInvoker.class */
    ...
    private static int getOrdering(int categoryOrder) {
        int index = (categoryOrder & Menu.CATEGORY_MASK) >> 16;
        if (index < 0 || index >= sCategoryToOrder.length) {
            throw new IllegalArgumentException("order does not contain a valid category.");
        }
        return (sCategoryToOrder[index] << 16) | (categoryOrder & Menu.USER_MASK);
    }
    ...
    private void setShortcutsVisibleInner(boolean shortcutsVisible) {
        this.mShortcutsVisible = shortcutsVisible && this.mResources.getConfiguration().keyboard != 1 && this.mResources.getBoolean(R.bool.abs__config_showMenuShortcutsWhenKeyboardPresent);
    }
        ...
        for (MenuItemImpl nonActionItem : nonActionItems) {
            if (nonActionItem.isVisible()) {
                ...
                if (nonActionItem.hasSubMenu()) {
                    ...
                    Iterator i$ = subMenu.getVisibleItems().iterator();
                    while (i$.hasNext()) {
                        MenuItemImpl subItem = i$.next();
