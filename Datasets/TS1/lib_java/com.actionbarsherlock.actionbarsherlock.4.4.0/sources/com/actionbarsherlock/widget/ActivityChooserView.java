...
/* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/ActivityChooserView.class */
class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetOberver = new DataSetObserver() { // from class: com.actionbarsherlock.widget.ActivityChooserView.1
        ...
        this.mOnGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.actionbarsherlock.widget.ActivityChooserView.2
        ...
        inflater.inflate(R.layout.abs__activity_chooser_view, (ViewGroup) this, true);
        ...
        this.mAdapter.registerDataSetObserver(new DataSetObserver() { // from class: com.actionbarsherlock.widget.ActivityChooserView.3
            @Override // android.database.DataSetObserver
            public void onChanged() {
                super.onChanged();
    ...
    public void showPopupUnchecked(int maxActivityCount) {
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(this.mContext.getString(R.string.abs__activitychooserview_choose_application));
        }
    }
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/ActivityChooserView$Callbacks.class */
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/ActivityChooserView$SetActivated.class */
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/ActivityChooserView$ActivityChooserViewAdapter.class */
            ...
            switch (itemViewType) {
                case 0:
                    if (convertView == null || convertView.getId() != R.id.abs__list_item) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(R.layout.abs__activity_chooser_view_list_item, parent, false);
                    }
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(R.layout.abs__activity_chooser_view_list_item, parent, false);
                        convertView.setId(1);
                        TextView titleView2 = (TextView) convertView.findViewById(R.id.abs__title);
                        titleView2.setText(ActivityChooserView.this.mContext.getString(R.string.abs__activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
