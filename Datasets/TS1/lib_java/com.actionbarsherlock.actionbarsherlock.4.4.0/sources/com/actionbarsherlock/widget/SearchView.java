...
/* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/SearchView.class */
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/SearchView$OnCloseListener.class */
    public interface OnCloseListener {
        boolean onClose();
    }

    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/SearchView$OnQueryTextListener.class */
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/SearchView$OnSuggestionListener.class */
    ...
    public SearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mShowImeRunnable = new Runnable() { // from class: com.actionbarsherlock.widget.SearchView.1
        ...
        this.mUpdateDrawableStateRunnable = new Runnable() { // from class: com.actionbarsherlock.widget.SearchView.2
            @Override // java.lang.Runnable
            public void run() {
                SearchView.this.updateFocusedState();
            }
        };
        this.mReleaseCursorRunnable = new Runnable() { // from class: com.actionbarsherlock.widget.SearchView.3
            @Override // java.lang.Runnable
            public void run() {
        ...
        this.mOnClickListener = new View.OnClickListener() { // from class: com.actionbarsherlock.widget.SearchView.7
        ...
        this.mTextKeyListener = new View.OnKeyListener() { // from class: com.actionbarsherlock.widget.SearchView.8
        ...
        this.mOnEditorActionListener = new TextView.OnEditorActionListener() { // from class: com.actionbarsherlock.widget.SearchView.9
        ...
        this.mOnItemClickListener = new AdapterView.OnItemClickListener() { // from class: com.actionbarsherlock.widget.SearchView.10
            @Override // android.widget.AdapterView.OnItemClickListener
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                SearchView.this.onItemClicked(position, 0, null);
            }
        };
        this.mOnItemSelectedListener = new AdapterView.OnItemSelectedListener() { // from class: com.actionbarsherlock.widget.SearchView.11
        ...
        this.mTextWatcher = new TextWatcher() { // from class: com.actionbarsherlock.widget.SearchView.12
        ...
        inflater.inflate(R.layout.abs__search_view, (ViewGroup) this, true);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.actionbarsherlock.widget.SearchView.4
        ...
        a.recycle();
        TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.SherlockView, 0, 0);
        ...
        if (this.mDropDownAnchor != null) {
            if (Build.VERSION.SDK_INT >= 11) {
                this.mDropDownAnchor.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.actionbarsherlock.widget.SearchView.5
                ...
                this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.actionbarsherlock.widget.SearchView.6
    ...
    public void setQueryRefinementEnabled(boolean enable) {
        ...
        if (this.mSuggestionsAdapter instanceof SuggestionsAdapter) {
            this.mSuggestionsAdapter.setQueryRefinement(enable ? 2 : 1);
        }
    }
    ...
    private boolean hasVoiceSearch() {
        if (this.mSearchable != null && this.mSearchable.getVoiceSearchEnabled()) {
            ...
            if (testIntent != null) {
                ResolveInfo ri = getContext().getPackageManager().resolveActivity(testIntent, Menu.CATEGORY_CONTAINER);
                return ri != null;
            }
            return false;
        }
    ...
    public void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(R.dimen.abs__dropdownitem_icon_width) + res.getDimensionPixelSize(R.dimen.abs__dropdownitem_text_padding_left) : 0;
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/SearchView$SearchAutoComplete.class */
    ...
    private static void setText(AutoCompleteTextView view, CharSequence text, boolean filter) {
        try {
            ...
            method.setAccessible(true);
            method.invoke(view, text, Boolean.valueOf(filter));
        } catch (Exception e) {
            view.setText(text);
        }
    }
