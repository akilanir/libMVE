...
/* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/SuggestionsAdapter.class */
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchable, WeakHashMap<String, Drawable.ConstantState> outsideDrawablesCache) {
        super(context, R.layout.abs__search_dropdown_item_icons_2line, (Cursor) null, true);
        this.mClosed = false;
    ...
    /* loaded from: com.actionbarsherlock.actionbarsherlock.4.4.0.jar:com/actionbarsherlock/widget/SuggestionsAdapter$ChildViewCache.class */
    ...
    public CharSequence convertToString(Cursor cursor) {
        String query;
        if (cursor != null && (query = getColumnString(cursor, "suggest_intent_query")) != null) {
            return query;
        }
        return null;
    }
