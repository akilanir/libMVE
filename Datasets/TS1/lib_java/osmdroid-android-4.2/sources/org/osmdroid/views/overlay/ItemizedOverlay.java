...
/* loaded from: osmdroid-android-4.2.jar:org/osmdroid/views/overlay/ItemizedOverlay.class */
public abstract class ItemizedOverlay<Item extends OverlayItem> extends Overlay implements Overlay.Snappable {
    ...
    /* loaded from: osmdroid-android-4.2.jar:org/osmdroid/views/overlay/ItemizedOverlay$OnFocusChangeListener.class */
    ...
    protected void draw(Canvas c, MapView mapView, boolean shadow) {
        ...
        for (int i = size; i >= 0; i--) {
            ...
            onDrawItem(c, item, this.mCurScreenCoords, mapView.getMapOrientation());
        }
    }
    ...
    /* loaded from: osmdroid-android-4.2.jar:org/osmdroid/views/overlay/ItemizedOverlay$1.class */
