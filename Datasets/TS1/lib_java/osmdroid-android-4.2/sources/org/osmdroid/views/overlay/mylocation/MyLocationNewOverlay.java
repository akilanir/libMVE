...
/* loaded from: osmdroid-android-4.2.jar:org/osmdroid/views/overlay/mylocation/MyLocationNewOverlay.class */
public class MyLocationNewOverlay extends Overlay implements IMyLocationConsumer, IOverlayMenuProvider, Overlay.Snappable {
    ...
    public void onLocationChanged(final Location location, IMyLocationProvider source) {
        if (location != null) {
            this.mMapView.post(new Runnable() { // from class: org.osmdroid.views.overlay.mylocation.MyLocationNewOverlay.1
