...
/* loaded from: osmdroid-android-4.2.jar:org/osmdroid/views/overlay/OverlayItem.class */
public class OverlayItem {
    ...
    /* loaded from: osmdroid-android-4.2.jar:org/osmdroid/views/overlay/OverlayItem$HotspotPlace.class */
    ...
    public OverlayItem(String aTitle, String aSnippet, GeoPoint aGeoPoint) {
        this(null, aTitle, aSnippet, aGeoPoint);
    }

    public OverlayItem(String aUid, String aTitle, String aDescription, GeoPoint aGeoPoint) {
        this.mTitle = aTitle;
