...
/* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/util/TokenBuffer.class */
public class TokenBuffer extends JsonGenerator {
    ...
    public final JsonWriteContext m159getOutputContext() {
    ...
    public void copyCurrentEvent(JsonParser p) throws IOException {
        ...
        switch (AnonymousClass1.$SwitchMap$com$fasterxml$jackson$core$JsonToken[p.getCurrentToken().ordinal()]) {
            case 1:
                writeStartObject();
                return;
            case 2:
    ...
    /* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/util/TokenBuffer$1.class */
    ...
    /* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/util/TokenBuffer$Parser.class */
    ...
    /* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/util/TokenBuffer$Segment.class */
