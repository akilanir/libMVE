...
/* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/jsontype/impl/StdSubtypeResolver.class */
public class StdSubtypeResolver extends SubtypeResolver implements Serializable {
    ...
    public Collection<NamedType> collectAndResolveSubtypesByTypeId(MapperConfig<?> config, AnnotatedMember property, JavaType baseType) {
        ...
        if (st != null) {
            for (NamedType nt : st) {
                AnnotatedClass ac2 = AnnotatedClass.constructWithoutSuperTypes(nt.getType(), ai, config);
