...
/* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/deser/DefaultDeserializationContext.class */
public abstract class DefaultDeserializationContext extends DeserializationContext implements Serializable {
        ...
        for (Map.Entry<ObjectIdGenerator.IdKey, ReadableObjectId> entry : this._objectIds.entrySet()) {
            ...
            if (roid.hasReferringProperties() && !tryToResolveUnresolvedObjectId(roid)) {
                ...
                while (iterator.hasNext()) {
                    ...
                    unresolvedForwardReference.addUnresolvedId(key, referring.getBeanType(), referring.getLocation());
                }
            }
        }
        if (unresolvedForwardReference != null) {
    ...
    /* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/deser/DefaultDeserializationContext$Impl.class */
