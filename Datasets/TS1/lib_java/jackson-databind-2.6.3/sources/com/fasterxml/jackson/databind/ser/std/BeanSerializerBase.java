...
/* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/ser/std/BeanSerializerBase.class */
public abstract class BeanSerializerBase extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (!prop.hasSerializer()) {
                ...
                if (ser == null) {
                    ...
                    if (type.isContainerType() && (typeSer = (TypeSerializer) type.mo4getContentType().getTypeHandler()) != null && (ser instanceof ContainerSerializer)) {
    ...
    /* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/ser/std/BeanSerializerBase$1.class */
