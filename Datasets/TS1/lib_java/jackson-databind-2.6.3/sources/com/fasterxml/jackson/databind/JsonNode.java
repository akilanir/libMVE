...
/* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/JsonNode.class */
public abstract class JsonNode extends JsonSerializable.Base implements TreeNode, Iterable<JsonNode> {
    public abstract <T extends JsonNode> T deepCopy();

    @Override // 
    /* renamed from: get, reason: merged with bridge method [inline-methods] */
    public abstract JsonNode mo10get(int i);

    @Override // 
    /* renamed from: path, reason: merged with bridge method [inline-methods] */
    public abstract JsonNode mo9path(String str);

    @Override // 
    /* renamed from: path, reason: merged with bridge method [inline-methods] */
    public abstract JsonNode mo8path(int i);
    ...
    public final JsonNode m7at(JsonPointer ptr) {
        if (ptr.matches()) {
            return this;
        }
        JsonNode n = _at(ptr);
        ...
        return n.m7at(ptr.tail());
    }

    /* renamed from: at, reason: merged with bridge method [inline-methods] */
    public final JsonNode m6at(String jsonPtrExpr) {
        return m7at(JsonPointer.compile(jsonPtrExpr));
    }
    ...
    public boolean has(String fieldName) {
        return mo11get(fieldName) != null;
    }

    public boolean has(int index) {
        return mo10get(index) != null;
    }

    public boolean hasNonNull(String fieldName) {
        JsonNode n = mo11get(fieldName);
        return (n == null || n.isNull()) ? false : true;
    }

    public boolean hasNonNull(int index) {
        JsonNode n = mo10get(index);
        return (n == null || n.isNull()) ? false : true;
    }
