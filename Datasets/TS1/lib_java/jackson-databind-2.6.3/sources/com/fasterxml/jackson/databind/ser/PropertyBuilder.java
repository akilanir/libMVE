...
/* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/ser/PropertyBuilder.class */
public class PropertyBuilder {
    ...
    protected BeanPropertyWriter buildWriter(SerializerProvider prov, BeanPropertyDefinition propDef, JavaType declaredType, JsonSerializer<?> ser, TypeSerializer typeSer, TypeSerializer contentTypeSer, AnnotatedMember am, boolean defaultUseStaticTyping) throws JsonMappingException {
        ...
        if (contentTypeSer != null) {
            ...
            JavaType ct = serializationType.mo4getContentType();
            if (ct == null) {
            ...
            serializationType.mo4getContentType();
        }
        ...
        switch (AnonymousClass1.$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[inclusion.ordinal()]) {
            case 1:
    ...
    /* loaded from: jackson-databind-2.6.3.jar:com/fasterxml/jackson/databind/ser/PropertyBuilder$1.class */
