...
/* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/IconicsDrawable.class */
public class IconicsDrawable extends Drawable {
    ...
    public IconicsDrawable(Context context, String icon) {
        ...
        icon(font.getIcon(icon.replace("-", "_")));
    }
    ...
    public IconicsDrawable colorRes(int colorRes) {
        return color(this.mContext.getResources().getColor(colorRes));
    }
    ...
    public IconicsDrawable backgroundColorRes(int backgroundColorRes) {
        return backgroundColor(this.mContext.getResources().getColor(backgroundColorRes));
    }
    ...
    public IconicsDrawable m3clone() {
