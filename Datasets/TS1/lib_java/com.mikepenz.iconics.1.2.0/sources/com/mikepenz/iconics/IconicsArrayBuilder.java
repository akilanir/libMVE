...
/* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/IconicsArrayBuilder.class */
    ...
    public IconicsDrawable[] build() {
        ...
        for (int i = 0; i < this.mIcons.size(); i++) {
            if (this.mIcons.get(i) instanceof IIcon) {
                iconicsDrawables[i] = this.mIconBase.m3clone().icon((IIcon) this.mIcons.get(i));
            } else if (this.mIcons.get(i) instanceof Character) {
                iconicsDrawables[i] = this.mIconBase.m3clone().icon((Character) this.mIcons.get(i));
            } else if (this.mIcons.get(i) instanceof String) {
                iconicsDrawables[i] = this.mIconBase.m3clone().icon((String) this.mIcons.get(i));
            }
        }
