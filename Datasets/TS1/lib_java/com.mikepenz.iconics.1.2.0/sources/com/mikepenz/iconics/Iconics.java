...
/* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/Iconics.class */
public final class Iconics {
    ...
    public static SpannableString style(Context ctx, HashMap<String, ITypeface> fonts, SpannableString textSpanned, List<CharacterStyle> styles, HashMap<String, List<CharacterStyle>> stylesFor) {
        ...
        do {
            ...
            String iconString = text.substring(startIndex + 1, endIndex - 1).replaceAll("-", "_");
            try {
                ...
                Log.w(TAG, "Wrong icon name: " + iconString);
            }
            fontKey = null;
            while (true) {
    ...
    /* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/Iconics$IconicsBuilderString.class */
    ...
    /* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/Iconics$IconicsBuilderView.class */
    ...
    /* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/Iconics$IconicsBuilder.class */
    ...
    /* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/Iconics$StyleContainer.class */
    ...
    /* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/Iconics$RemoveInfo.class */
