...
/* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/typeface/FontAwesome.class */
public class FontAwesome implements ITypeface {
    ...
    public Typeface getTypeface(Context context) {
        if (typeface == null) {
            try {
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/fontawesome-webfont-4.3.0.ttf");
            } catch (Exception e) {
                return null;
            }
        }
    ...
    /* loaded from: com.mikepenz.iconics.1.2.0.jar:com/mikepenz/iconics/typeface/FontAwesome$Icon.class */
