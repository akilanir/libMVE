...
/* loaded from: com.android.support.preference-v7.23.4.0.jar:android/support/v7/preference/PreferenceDialogFragmentCompat.class */
public abstract class PreferenceDialogFragmentCompat extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(activity).setTitle(this.mDialogTitle).setIcon(this.mDialogIcon).setPositiveButton(this.mPositiveButtonText, this).setNegativeButton(this.mNegativeButtonText, this);
    ...
    public DialogPreference getPreference() {
        if (this.mPreference == null) {
            String key = getArguments().getString(ARG_KEY);
            DialogPreference.TargetFragment fragment = getTargetFragment();
            this.mPreference = (DialogPreference) fragment.findPreference(key);
        }
