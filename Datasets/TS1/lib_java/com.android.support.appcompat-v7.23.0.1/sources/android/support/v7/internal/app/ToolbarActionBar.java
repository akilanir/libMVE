...
/* loaded from: com.android.support.appcompat-v7.23.0.1.jar:android/support/v7/internal/app/ToolbarActionBar.class */
public class ToolbarActionBar extends ActionBar {
    ...
    public void setDisplayOptions(int options, int mask) {
        ...
        this.mDecorToolbar.setDisplayOptions((options & mask) | (currentOptions & (mask ^ (-1))));
    }
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.1.jar:android/support/v7/internal/app/ToolbarActionBar$ToolbarCallbackWrapper.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.1.jar:android/support/v7/internal/app/ToolbarActionBar$ActionMenuPresenterCallback.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.1.jar:android/support/v7/internal/app/ToolbarActionBar$PanelMenuPresenterCallback.class */
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        @Override // android.support.v7.internal.view.menu.MenuPresenter.Callback
        public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            if (menuBuilder == 0 && ToolbarActionBar.this.mWindowCallback != null) {
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.1.jar:android/support/v7/internal/app/ToolbarActionBar$MenuBuilderCallback.class */
