...
/* loaded from: com.android.support.appcompat-v7.23.0.1.jar:android/support/v7/app/TwilightManager.class */
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        int permission = PermissionChecker.checkSelfPermission(this.mContext, "android.permission.ACCESS_FINE_LOCATION");
        if (permission == 0) {
            coarseLocation = getLastKnownLocationForProvider("network");
        }
        int permission2 = PermissionChecker.checkSelfPermission(this.mContext, "android.permission.ACCESS_COARSE_LOCATION");
        if (permission2 == 0) {
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.1.jar:android/support/v7/app/TwilightManager$TwilightState.class */
