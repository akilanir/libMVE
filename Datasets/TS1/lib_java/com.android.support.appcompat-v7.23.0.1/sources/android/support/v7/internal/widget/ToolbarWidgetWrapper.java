...
/* loaded from: com.android.support.appcompat-v7.23.0.1.jar:android/support/v7/internal/widget/ToolbarWidgetWrapper.class */
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        if (visibility == 8) {
            ...
            anim.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.internal.widget.ToolbarWidgetWrapper.2
        ...
        if (visibility == 0) {
            ...
            anim2.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.internal.widget.ToolbarWidgetWrapper.3
