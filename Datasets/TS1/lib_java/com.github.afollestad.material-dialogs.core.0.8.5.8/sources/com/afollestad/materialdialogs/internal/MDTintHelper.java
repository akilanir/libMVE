...
/* loaded from: com.github.afollestad.material-dialogs.core.0.8.5.8.jar:com/afollestad/materialdialogs/internal/MDTintHelper.class */
public class MDTintHelper {
    ...
    public static void setTint(@NonNull RadioButton radioButton, @ColorInt int color) {
        ...
        Drawable radioDrawable = ContextCompat.getDrawable(radioButton.getContext(), com.afollestad.materialdialogs.R.drawable.abc_btn_radio_material);
    ...
    public static void setTint(@NonNull CheckBox box, @ColorInt int color) {
        ...
        Drawable checkDrawable = ContextCompat.getDrawable(box.getContext(), com.afollestad.materialdialogs.R.drawable.abc_btn_check_material);
