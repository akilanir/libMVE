...
/* loaded from: com.android.support.appcompat-v7.22.0.0.jar:android/support/v7/internal/widget/TintManager.class */
public class TintManager {
    ...
    public Drawable getDrawable(int resId) {
        ...
        if (drawable != null) {
            ...
            if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                ...
                drawable = this.mResources.getDrawable(resId);
            } else {
    ...
    private ColorStateList getDefaultColorStateList() {
        if (this.mDefaultColorStateList == null) {
            ...
            int i = 0 + 1;
            r0[i] = new int[]{android.R.attr.state_focused};
            colors[i] = colorControlActivated;
            int i2 = i + 1;
            r0[i2] = new int[]{android.R.attr.state_activated};
            colors[i2] = colorControlActivated;
            int i3 = i2 + 1;
            r0[i3] = new int[]{android.R.attr.state_pressed};
            colors[i3] = colorControlActivated;
            int i4 = i3 + 1;
            r0[i4] = new int[]{android.R.attr.state_checked};
            colors[i4] = colorControlActivated;
            int i5 = i4 + 1;
            r0[i5] = new int[]{android.R.attr.state_selected};
            colors[i5] = colorControlActivated;
            int i6 = i5 + 1;
            r0[i6] = new int[0];
            colors[i6] = colorControlNormal;
            int i7 = i6 + 1;
            this.mDefaultColorStateList = new ColorStateList(r0, colors);
        }
    ...
    private ColorStateList getSwitchTrackColorStateList() {
        if (this.mSwitchTrackStateList == null) {
            ...
            int i = 0 + 1;
            r0[i] = new int[]{android.R.attr.state_checked};
            ...
            int i3 = i2 + 1;
            this.mSwitchTrackStateList = new ColorStateList(r0, colors);
        }
    ...
    private ColorStateList getSwitchThumbColorStateList() {
        if (this.mSwitchThumbStateList == null) {
            ...
            int i3 = i2 + 1;
            this.mSwitchThumbStateList = new ColorStateList(r0, colors);
        }
    ...
    int getThemeAttrColor(int attr, float alpha) {
        ...
        return (color & 16777215) | (Math.round(originalAlpha * alpha) << 24);
    }
    ...
    /* loaded from: com.android.support.appcompat-v7.22.0.0.jar:android/support/v7/internal/widget/TintManager$ColorFilterLruCache.class */
