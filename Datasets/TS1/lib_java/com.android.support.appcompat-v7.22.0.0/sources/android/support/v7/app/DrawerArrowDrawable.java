...
/* loaded from: com.android.support.appcompat-v7.22.0.0.jar:android/support/v7/app/DrawerArrowDrawable.class */
abstract class DrawerArrowDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mSpin) {
            canvas.rotate(canvasRotate * (this.mVerticalMirror ^ isRtl ? -1 : 1));
        } else if (isRtl) {
