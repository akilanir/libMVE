...
/* loaded from: com.journeyapps.zxing-android-embedded.3.0.3.jar:com/journeyapps/barcodescanner/Decoder.class */
    ...
    protected Result decode(BinaryBitmap bitmap) {
        ...
        try {
            if (this.reader instanceof MultiFormatReader) {
                Result decodeWithState = this.reader.decodeWithState(bitmap);
                this.reader.reset();
