...
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/ser/ContainerSerializer.class */
public abstract class ContainerSerializer<T> extends StdSerializer<T> {
    ...
    protected boolean hasContentTypeAnnotation(SerializerProvider provider, BeanProperty property) {
        ...
        if (property != null && (intr = provider.getAnnotationIntrospector()) != null && intr.findSerializationContentType(property.getMember(), property.getType()) != null) {
            return true;
        }
        return false;
    }
