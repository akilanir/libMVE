...
@JacksonStdImpl
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/ser/std/JsonValueSerializer.class */
    ...
    public JsonSerializer<?> createContextual(SerializerProvider provider, BeanProperty property) throws JsonMappingException {
        ...
        if (ser == null) {
            if (provider.isEnabled(MapperFeature.USE_STATIC_TYPING) || Modifier.isFinal(this._accessorMethod.getReturnType().getModifiers())) {
                ...
                JsonSerializer<?> ser2 = provider.findPrimaryPropertySerializer(t, this._property);
