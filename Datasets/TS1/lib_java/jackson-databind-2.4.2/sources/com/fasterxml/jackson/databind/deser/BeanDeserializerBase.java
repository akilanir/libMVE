...
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/deser/BeanDeserializerBase.class */
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer, Serializable {
    ...
    public void resolve(DeserializationContext ctxt) throws JsonMappingException {
        ...
        while (i$.hasNext()) {
            ...
            if (!prop2.hasValueDeserializer()) {
                ...
                JsonDeserializer<?> cd = ctxt.handlePrimaryContextualization(deser2, prop2);
                if (cd != deser2) {
            ...
            if (u != null) {
                ...
                if (u != origProp) {
                    this._beanProperties.replace(u);
                }
            } else {
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        ...
        if (accessor != null && (ignorals = intr.findPropertiesToIgnore(accessor)) != null && ignorals.length != 0) {
    ...
    public Object deserializeWithType(JsonParser jp, DeserializationContext ctxt, TypeDeserializer typeDeserializer) throws IOException, JsonProcessingException {
        ...
        if (this._objectIdReader != null) {
            if (jp.canReadObjectId() && (id = jp.getObjectId()) != null) {
    ...
    /* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/deser/BeanDeserializerBase$1.class */
