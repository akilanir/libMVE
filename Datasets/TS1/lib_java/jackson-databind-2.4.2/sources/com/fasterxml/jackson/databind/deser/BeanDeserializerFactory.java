...
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/deser/BeanDeserializerFactory.class */
public class BeanDeserializerFactory extends BasicDeserializerFactory implements Serializable {
    ...
    protected JsonDeserializer<?> findStdDeserializer(DeserializationContext ctxt, JavaType type, BeanDescription beanDesc) throws JsonMappingException {
        ...
        if (AtomicReference.class.isAssignableFrom(cls)) {
            ...
            return new AtomicReferenceDeserializer(referencedType, valueTypeDeser, findDeserializerFromAnnotation(ctxt, refdDesc.getClassInfo()));
        }
