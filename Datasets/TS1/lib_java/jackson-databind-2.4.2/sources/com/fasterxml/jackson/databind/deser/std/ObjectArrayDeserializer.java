...
@JacksonStdImpl
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/deser/std/ObjectArrayDeserializer.class */
public class ObjectArrayDeserializer extends ContainerDeserializerBase<Object[]> implements ContextualDeserializer {
    ...
    public ObjectArrayDeserializer(ArrayType arrayType, JsonDeserializer<Object> elemDeser, TypeDeserializer elemTypeDeser) {
        ...
        this._elementClass = arrayType.mo3getContentType().getRawClass();
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        ...
        if (deser2 == null) {
            deser = ctxt.findContextualValueDeserializer(this._arrayType.mo3getContentType(), property);
        } else {
    ...
    public JavaType getContentType() {
        return this._arrayType.mo3getContentType();
    }
