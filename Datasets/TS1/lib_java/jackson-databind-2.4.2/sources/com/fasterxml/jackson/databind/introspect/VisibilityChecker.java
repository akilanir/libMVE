...
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/introspect/VisibilityChecker.class */
public interface VisibilityChecker<T extends VisibilityChecker<T>> {
    ...
    /* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/introspect/VisibilityChecker$Std.class */
    public static class Std implements VisibilityChecker<Std>, Serializable {
        ...
        public Std with(JsonAutoDetect ann) {
            Std curr = this;
            if (ann != null) {
                curr = curr.withGetterVisibility(ann.getterVisibility()).withIsGetterVisibility(ann.isGetterVisibility()).withSetterVisibility(ann.setterVisibility()).withCreatorVisibility(ann.creatorVisibility()).withFieldVisibility(ann.fieldVisibility());
            }
            return curr;
        }
        ...
        public Std withVisibility(PropertyAccessor method, JsonAutoDetect.Visibility v) {
            switch (AnonymousClass1.$SwitchMap$com$fasterxml$jackson$annotation$PropertyAccessor[method.ordinal()]) {
                case 1:
    ...
    /* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/introspect/VisibilityChecker$1.class */
