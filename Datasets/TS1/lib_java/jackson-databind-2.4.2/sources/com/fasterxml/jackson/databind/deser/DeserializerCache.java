...
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/deser/DeserializerCache.class */
public final class DeserializerCache implements Serializable {
    ...
    protected JsonDeserializer<Object> _createAndCache2(DeserializationContext ctxt, DeserializerFactory factory, JavaType type) throws JsonMappingException {
        try {
            ...
            boolean addToCache = _createDeserializer.isCachable();
            if (isResolvable) {
    ...
    private JavaType modifyTypeByAnnotation(DeserializationContext ctxt, Annotated a, JavaType type) throws JsonMappingException {
        ...
        if (type.isContainerType()) {
            Class<?> keyClass = intr.findDeserializationKeyType(a, type.mo4getKeyType());
            if (keyClass != null) {
            ...
            Class<?> cc = intr.findDeserializationContentType(a, type.mo3getContentType());
            if (cc != null) {
                try {
