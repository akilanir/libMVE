...
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/ObjectWriter.class */
public class ObjectWriter implements Versioned, Serializable {
    ...
    public ObjectWriter withType(JavaType rootType) {
        ...
        if (rootType == null || rootType.hasRawClass(Object.class)) {
            ...
            rootType2 = rootType.withStaticTyping();
            rootSer = _prefetchRootSerializer(this._config, rootType2);
        }
        return new ObjectWriter(this, this._config, rootType2, rootSer, this._prettyPrinter, this._schema, this._characterEscapes);
    }
    ...
    private void _configureJsonGenerator(JsonGenerator jgen) {
        if (this._prettyPrinter != null) {
            ...
            if (pp == NULL_PRETTY_PRINTER) {
                jgen.setPrettyPrinter((PrettyPrinter) null);
            } else {
