...
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/ser/PropertyBuilder.class */
public class PropertyBuilder {
    ...
    @Deprecated
    protected final BeanPropertyWriter buildWriter(BeanPropertyDefinition propDef, JavaType declaredType, JsonSerializer<?> ser, TypeSerializer typeSer, TypeSerializer contentTypeSer, AnnotatedMember am, boolean defaultUseStaticTyping) {
    ...
    protected BeanPropertyWriter buildWriter(SerializerProvider prov, BeanPropertyDefinition propDef, JavaType declaredType, JsonSerializer<?> ser, TypeSerializer typeSer, TypeSerializer contentTypeSer, AnnotatedMember am, boolean defaultUseStaticTyping) throws JsonMappingException {
        ...
        if (contentTypeSer != null) {
            ...
            JavaType ct = serializationType.mo3getContentType();
            if (ct == null) {
            ...
            serializationType.mo3getContentType();
        }
        Object valueToSuppress = null;
        boolean suppressNulls = false;
        JsonInclude.Include methodProps = this._annotationIntrospector.findSerializationInclusion(am, this._outputProps);
        if (methodProps != null) {
            switch (AnonymousClass1.$SwitchMap$com$fasterxml$jackson$annotation$JsonInclude$Include[methodProps.ordinal()]) {
                case 1:
    ...
    /* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/ser/PropertyBuilder$1.class */
