...
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/deser/SettableAnyProperty.class */
public class SettableAnyProperty implements Serializable {
    ...
    public SettableAnyProperty(BeanProperty property, AnnotatedMethod setter, JavaType type, JsonDeserializer<Object> valueDeser) {
        this(property, setter, type, valueDeser, (TypeDeserializer) null);
    }
    ...
    public SettableAnyProperty(BeanProperty property, Method rawSetter, JavaType type, JsonDeserializer<Object> valueDeser) {
        this(property, rawSetter, type, valueDeser, (TypeDeserializer) null);
    }
    ...
    public final void deserializeAndSet(JsonParser jp, DeserializationContext ctxt, Object instance, String propName) throws IOException {
        try {
            ...
            AnySetterReferring referring = new AnySetterReferring(this, e, this._type.getRawClass(), instance, propName);
            e.getRoid().appendReferring(referring);
        }
    }
    ...
    /* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/deser/SettableAnyProperty$AnySetterReferring.class */
