...
/* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/deser/std/FromStringDeserializer.class */
public abstract class FromStringDeserializer<T> extends StdScalarDeserializer<T> {
    ...
    /* JADX WARN: Type inference failed for: r0v31, types: [com.fasterxml.jackson.databind.JsonMappingException, java.lang.Throwable] */
            ...
            if (valueAsString.length() != 0) {
                ...
                if (trim.length() != 0) {
                    ...
                    if (illegalArgumentException != null) {
                        str = str + "problem: " + illegalArgumentException.getMessage();
                    }
                    ?? weirdStringException = deserializationContext.weirdStringException(trim, this._valueClass, str);
                    if (illegalArgumentException != null) {
                        weirdStringException.initCause(illegalArgumentException);
                    }
    ...
    /* loaded from: jackson-databind-2.4.2.jar:com/fasterxml/jackson/databind/deser/std/FromStringDeserializer$Std.class */
