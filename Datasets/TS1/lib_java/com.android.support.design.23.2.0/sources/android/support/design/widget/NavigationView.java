...
/* loaded from: com.android.support.design.23.2.0.jar:android/support/design/widget/NavigationView.class */
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    /* loaded from: com.android.support.design.23.2.0.jar:android/support/design/widget/NavigationView$OnNavigationItemSelectedListener.class */
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(android.support.design.R.attr.colorControlActivated, value, true)) {
            return null;
        }
    ...
    /* loaded from: com.android.support.design.23.2.0.jar:android/support/design/widget/NavigationView$SavedState.class */
    public static class SavedState extends View.BaseSavedState {
        ...
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: android.support.design.widget.NavigationView.SavedState.1
            ...
            public SavedState m20createFromParcel(Parcel parcel, ClassLoader loader) {
                return new SavedState(parcel, loader);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public SavedState[] m19newArray(int size) {
