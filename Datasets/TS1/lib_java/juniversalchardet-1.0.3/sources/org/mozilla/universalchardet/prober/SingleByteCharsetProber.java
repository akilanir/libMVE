...
/* loaded from: juniversalchardet-1.0.3.jar:org/mozilla/universalchardet/prober/SingleByteCharsetProber.class */
public class SingleByteCharsetProber extends CharsetProber {
    ...
    public float getConfidence() {
        if (this.totalSeqs > 0) {
            float r = ((((1.0f * this.seqCounters[3]) / this.totalSeqs) / this.model.getTypicalPositiveRatio()) * this.freqChar) / this.totalChar;
            if (r >= 1.0f) {
                r = 0.99f;
            }
            return r;
