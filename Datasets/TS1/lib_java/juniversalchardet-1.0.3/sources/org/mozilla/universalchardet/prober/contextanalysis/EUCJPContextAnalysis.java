...
/* loaded from: juniversalchardet-1.0.3.jar:org/mozilla/universalchardet/prober/contextanalysis/EUCJPContextAnalysis.class */
public class EUCJPContextAnalysis extends JapaneseContextAnalysis {
    ...
    protected void getOrder(JapaneseContextAnalysis.Order order, byte[] buf, int offset) {
        ...
        order.order = -1;
        order.charLength = 1;
        int firstByte = buf[offset] & PkgInt.UNIT_MASK_8BITS;
    ...
    protected int getOrder(byte[] buf, int offset) {
        int lowbyte;
        int highbyte = buf[offset] & PkgInt.UNIT_MASK_8BITS;
