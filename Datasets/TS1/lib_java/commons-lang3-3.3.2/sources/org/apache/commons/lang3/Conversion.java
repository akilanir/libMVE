...
/* loaded from: commons-lang3-3.3.2.jar:org/apache/commons/lang3/Conversion.class */
public class Conversion {
    ...
    public static char binaryBeMsb0ToHexDigit(boolean[] src, int srcPos) {
        ...
        if (paddedSrc[0]) {
            if (paddedSrc.length <= 0 + 1 || !paddedSrc[0 + 1]) {
                if (paddedSrc.length <= 0 + 2 || !paddedSrc[0 + 2]) {
                    if (paddedSrc.length > 0 + 3 && paddedSrc[0 + 3]) {
                        return '9';
                    }
                    return '8';
                }
    ...
    public static boolean[] shortToBinary(short src, int srcPos, boolean[] dst, int dstPos, int nBools) {
        ...
        if (!$assertionsDisabled && (nBools - 1) * 1 >= 16 - srcPos) {
