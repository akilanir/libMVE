...
/* loaded from: commons-codec-1.5.jar:org/apache/commons/codec/binary/Base32.class */
    ...
    public Base32(int lineLength, byte[] lineSeparator, boolean useHex) {
        ...
        if (lineLength > 0) {
            ...
            if (containsAlphabetOrPad(lineSeparator)) {
                ...
                throw new IllegalArgumentException(new StringBuffer().append("lineSeparator must not contain Base32 characters: [").append(sep).append("]").toString());
            }
