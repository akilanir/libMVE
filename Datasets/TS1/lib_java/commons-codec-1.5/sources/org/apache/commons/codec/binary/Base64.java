...
/* loaded from: commons-codec-1.5.jar:org/apache/commons/codec/binary/Base64.class */
    ...
    public Base64(int lineLength, byte[] lineSeparator, boolean urlSafe) {
        ...
        if (lineSeparator != null) {
            if (containsAlphabetOrPad(lineSeparator)) {
                ...
                throw new IllegalArgumentException(new StringBuffer().append("lineSeparator must not contain base64 characters: [").append(sep).append("]").toString());
            }
            if (lineLength > 0) {
