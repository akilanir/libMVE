...
/* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/query/DeleteQuery.class */
public class DeleteQuery<T> extends AbstractQuery<T> {
    ...
    /* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/query/DeleteQuery$QueryData.class */
