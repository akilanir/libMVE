...
/* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/query/LazyList.class */
public class LazyList<E> implements List<E>, Closeable {
    ...
    /* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/query/LazyList$LazyIterator.class */
