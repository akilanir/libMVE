...
/* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/async/AsyncOperationExecutor.class */
class AsyncOperationExecutor implements Runnable, Handler.Callback {
    ...
    */
    private void mergeTxAndExecute(de.greenrobot.dao.async.AsyncOperation r5, de.greenrobot.dao.async.AsyncOperation r6) {
        /*
    ...
    /* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/async/AsyncOperationExecutor$1.class */
