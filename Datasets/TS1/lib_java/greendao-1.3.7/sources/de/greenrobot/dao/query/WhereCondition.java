...
/* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/query/WhereCondition.class */
public interface WhereCondition {
    void appendTo(StringBuilder sb, String str);

    void appendValuesTo(List<Object> list);

    /* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/query/WhereCondition$AbstractCondition.class */
    ...
    /* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/query/WhereCondition$PropertyCondition.class */
    ...
    /* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/query/WhereCondition$StringCondition.class */
