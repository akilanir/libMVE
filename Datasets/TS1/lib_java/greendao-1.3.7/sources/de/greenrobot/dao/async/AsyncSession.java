...
/* loaded from: greendao-1.3.7.jar:de/greenrobot/dao/async/AsyncSession.class */
public class AsyncSession {
    ...
    private AsyncOperation enqueueDatabaseOperation(AsyncOperation.OperationType type, Object param, int flags) {
        AsyncOperation operation = new AsyncOperation(type, this.daoSession.getDatabase(), param, flags);
