...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/imaging/ImageMetadataReader.class */
    ...
    public static void main(@NotNull String[] args) throws MetadataException, IOException {
        ...
        for (String filePath : argList) {
            ...
            if (markdownFormat) {
                ...
                String make = exifIFD0Directory == null ? "" : exifIFD0Directory.getString(ExifDirectoryBase.TAG_MAKE);
                String model = exifIFD0Directory == null ? "" : exifIFD0Directory.getString(ExifDirectoryBase.TAG_MODEL);
                System.out.println();
                System.out.println("---");
                System.out.println();
            ...
            if (args.length > 1 && thumbRequested) {
                ExifThumbnailDirectory directory2 = (ExifThumbnailDirectory) metadata.getFirstDirectoryOfType(ExifThumbnailDirectory.class);
                if (directory2 != null && directory2.hasThumbnailData()) {
                    System.out.println("Writing thumbnail...");
                    directory2.writeThumbnail(args[0].trim() + ".thumb.jpg");
                } else {
