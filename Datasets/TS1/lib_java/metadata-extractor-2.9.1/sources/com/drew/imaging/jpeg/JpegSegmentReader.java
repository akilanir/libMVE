...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/imaging/jpeg/JpegSegmentReader.class */
public class JpegSegmentReader {
    ...
    public static JpegSegmentData readSegments(@NotNull File file, @Nullable Iterable<JpegSegmentType> segmentTypes) throws JpegProcessingException, IOException {
        ...
        try {
            ...
            JpegSegmentData readSegments = readSegments(new StreamReader(stream), segmentTypes);
            if (stream != null) {
                stream.close();
            }
            return readSegments;
