...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/imaging/tiff/TiffHandler.class */
public interface TiffHandler {
    ...
    void completed(@NotNull RandomAccessReader randomAccessReader, int i);
    ...
    void setString(int i, @NotNull String str);
