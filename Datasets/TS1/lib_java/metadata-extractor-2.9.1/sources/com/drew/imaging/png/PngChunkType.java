...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/imaging/png/PngChunkType.class */
public class PngChunkType {
    ...
    static {
        ...
        _identifiersAllowingMultiples = new HashSet(Arrays.asList("IDAT", "sPLT", "iTXt", "tEXt", "zTXt"));
