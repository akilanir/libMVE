...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/lang/ByteTrie.class */
public class ByteTrie<T> {
    private final ByteTrieNode<T> _root = new ByteTrieNode<>();
    private int _maxDepth;

    /* loaded from: metadata-extractor-2.9.1.jar:com/drew/lang/ByteTrie$ByteTrieNode.class */
