...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/FujifilmMakernoteDescriptor.class */
public class FujifilmMakernoteDescriptor extends TagDescriptor<FujifilmMakernoteDirectory> {
    ...
    public String getDescription(int tagType) {
        switch (tagType) {
            ...
            case FujifilmMakernoteDirectory.TAG_MACRO /* 4128 */:
                return getMacroDescription();
            case FujifilmMakernoteDirectory.TAG_FOCUS_MODE /* 4129 */:
                return getFocusModeDescription();
            case FujifilmMakernoteDirectory.TAG_SLOW_SYNC /* 4144 */:
                return getSlowSyncDescription();
            case FujifilmMakernoteDirectory.TAG_PICTURE_MODE /* 4145 */:
                return getPictureModeDescription();
            case FujifilmMakernoteDirectory.TAG_EXR_AUTO /* 4147 */:
    ...
    public String getPictureModeDescription() {
        Integer value = ((FujifilmMakernoteDirectory) this._directory).getInteger(FujifilmMakernoteDirectory.TAG_PICTURE_MODE);
        if (value == null) {
            return null;
        }
        switch (value.intValue()) {
