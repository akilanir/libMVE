...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/photoshop/PhotoshopDirectory.class */
public class PhotoshopDirectory extends Directory {
    ...
    static {
        _tagNameMap.put(Integer.valueOf(TAG_CHANNELS_ROWS_COLUMNS_DEPTH_MODE), "Channels, Rows, Columns, Depth, Mode");
        _tagNameMap.put(Integer.valueOf(TAG_MAC_PRINT_INFO), "Mac Print Info");
        _tagNameMap.put(Integer.valueOf(TAG_XML), "XML Data");
        _tagNameMap.put(Integer.valueOf(TAG_INDEXED_COLOR_TABLE), "Indexed Color Table");
        _tagNameMap.put(Integer.valueOf(TAG_RESOLUTION_INFO), "Resolution Info");
        _tagNameMap.put(Integer.valueOf(TAG_ALPHA_CHANNELS), "Alpha Channels");
        _tagNameMap.put(Integer.valueOf(TAG_DISPLAY_INFO_OBSOLETE), "Display Info (Obsolete)");
        _tagNameMap.put(Integer.valueOf(TAG_CAPTION), "Caption");
        _tagNameMap.put(Integer.valueOf(TAG_BORDER_INFORMATION), "Border Information");
        _tagNameMap.put(Integer.valueOf(TAG_BACKGROUND_COLOR), "Background Color");
        _tagNameMap.put(Integer.valueOf(TAG_PRINT_FLAGS), "Print Flags");
        _tagNameMap.put(Integer.valueOf(TAG_GRAYSCALE_AND_MULTICHANNEL_HALFTONING_INFORMATION), "Grayscale and Multichannel Halftoning Information");
        _tagNameMap.put(Integer.valueOf(TAG_COLOR_HALFTONING_INFORMATION), "Color Halftoning Information");
        _tagNameMap.put(Integer.valueOf(TAG_DUOTONE_HALFTONING_INFORMATION), "Duotone Halftoning Information");
        _tagNameMap.put(Integer.valueOf(TAG_GRAYSCALE_AND_MULTICHANNEL_TRANSFER_FUNCTION), "Grayscale and Multichannel Transfer Function");
        _tagNameMap.put(Integer.valueOf(TAG_COLOR_TRANSFER_FUNCTIONS), "Color Transfer Functions");
        _tagNameMap.put(Integer.valueOf(TAG_DUOTONE_TRANSFER_FUNCTIONS), "Duotone Transfer Functions");
        _tagNameMap.put(Integer.valueOf(TAG_DUOTONE_IMAGE_INFORMATION), "Duotone Image Information");
        _tagNameMap.put(Integer.valueOf(TAG_EFFECTIVE_BLACK_AND_WHITE_VALUES), "Effective Black and White Values");
        _tagNameMap.put(Integer.valueOf(TAG_EPS_OPTIONS), "EPS Options");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_GRID_AND_GUIDES_INFORMATION), "Grid and Guides Information");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_GLOBAL_ANGLE), "Global Angle");
        _tagNameMap.put(Integer.valueOf(TAG_ICC_PROFILE_BYTES), "ICC Profile Bytes");
        _tagNameMap.put(Integer.valueOf(TAG_WATERMARK), "Watermark");
        _tagNameMap.put(Integer.valueOf(TAG_ICC_UNTAGGED_PROFILE), "ICC Untagged Profile");
        _tagNameMap.put(Integer.valueOf(TAG_EFFECTS_VISIBLE), "Effects Visible");
        _tagNameMap.put(Integer.valueOf(TAG_SPOT_HALFTONE), "Spot Halftone");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_AUTO_SAVE_FILE_PATH), "Auto Save File Path");
        _tagNameMap.put(Integer.valueOf(TAG_AUTO_SAVE_FORMAT), "Auto Save Format");
        _tagNameMap.put(Integer.valueOf(TAG_PATH_SELECTION_STATE), "Path Selection State");
        _tagNameMap.put(Integer.valueOf(TAG_CLIPPING_PATH_NAME), "Clipping Path Name");
        _tagNameMap.put(Integer.valueOf(TAG_ORIGIN_PATH_INFO), "Origin Path Info");
    ...
    public byte[] getThumbnailBytes() {
        ...
        if (storedBytes == null) {
            storedBytes = getByteArray(TAG_THUMBNAIL_OLD);
        }
