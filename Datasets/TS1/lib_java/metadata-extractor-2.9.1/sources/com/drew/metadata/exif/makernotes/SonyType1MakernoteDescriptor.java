...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/SonyType1MakernoteDescriptor.class */
public class SonyType1MakernoteDescriptor extends TagDescriptor<SonyType1MakernoteDirectory> {
    ...
    public String getFlashLevelDescription() {
        ...
        switch (value.intValue()) {
            ...
            case -2:
                return "-2/3";
            case BmpHeaderDirectory.TAG_HEADER_SIZE /* -1 */:
                return "-1/3";
            case 0:
                return "Normal";
            case 1:
