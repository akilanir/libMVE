...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/Directory.class */
public abstract class Directory {
    private static final DecimalFormat _floatFormat;
    ...
    static {
        ...
        _floatFormat = new DecimalFormat("0.###");
    }
    ...
    public String[] getStringArray(int tagType) {
        ...
        if (o instanceof byte[]) {
            ...
            for (int i2 = 0; i2 < strings2.length; i2++) {
                strings2[i2] = Byte.toString(bytes[i2]);
            }
            return strings2;
        }
        if (o instanceof Rational[]) {
            Rational[] rationals = (Rational[]) o;
            String[] strings3 = new String[rationals.length];
            for (int i3 = 0; i3 < strings3.length; i3++) {
                strings3[i3] = rationals[i3].toSimpleString(false);
            }
            return strings3;
        }
        return null;
    ...
    public Boolean getBooleanObject(int tagType) {
        ...
        if (o instanceof String) {
            try {
                return Boolean.valueOf(Boolean.getBoolean((String) o));
            } catch (NumberFormatException e) {
                return null;
            }
        }
    ...
    public Date getDate(int tagType, @Nullable String subsecond, @Nullable TimeZone timeZone) {
        ...
        Date date = null;
        if (o instanceof String) {
            String[] datePatterns = {"yyyy:MM:dd HH:mm:ss", "yyyy:MM:dd HH:mm", "yyyy-MM-dd HH:mm:ss", "yyyy-MM-dd HH:mm", "yyyy.MM.dd HH:mm:ss", "yyyy.MM.dd HH:mm", "yyyy-MM-dd'T'HH:mm:ss", "yyyy-MM-dd'T'HH:mm", "yyyy-MM-dd", "yyyy-MM", "yyyy"};
        ...
        if (o.getClass().isArray()) {
            ...
            if (Object.class.isAssignableFrom(componentType)) {
                ...
                for (int i5 = 0; i5 < arrayLength; i5++) {
                    ...
                    string.append(_floatFormat.format(Array.getFloat(o, i5)));
                }
                ...
                for (int i6 = 0; i6 < arrayLength; i6++) {
                    ...
                    string.append(_floatFormat.format(Array.getDouble(o, i6)));
                }
