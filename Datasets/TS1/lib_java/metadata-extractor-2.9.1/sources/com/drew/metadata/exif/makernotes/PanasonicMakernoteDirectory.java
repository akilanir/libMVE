...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/PanasonicMakernoteDirectory.class */
public class PanasonicMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(TAG_TITLE), "Title");
        _tagNameMap.put(102, "Baby Name");
        _tagNameMap.put(Integer.valueOf(TAG_LOCATION), "Location");
        _tagNameMap.put(Integer.valueOf(TAG_COUNTRY), "Country");
        _tagNameMap.put(107, "State");
        _tagNameMap.put(Integer.valueOf(TAG_CITY), "City");
        _tagNameMap.put(Integer.valueOf(TAG_LANDMARK), "Landmark");
        _tagNameMap.put(Integer.valueOf(TAG_INTELLIGENT_RESOLUTION), "Intelligent Resolution");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_WB_GREEN_LEVEL), "White Balance (Green)");
