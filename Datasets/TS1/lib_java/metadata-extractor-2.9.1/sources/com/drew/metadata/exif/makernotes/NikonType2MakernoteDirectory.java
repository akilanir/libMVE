...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/NikonType2MakernoteDirectory.class */
public class NikonType2MakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(TAG_CONTRAST_CURVE), "Contrast Curve");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_UNKNOWN_11), "Unknown 11");
        _tagNameMap.put(Integer.valueOf(TAG_RETOUCH_HISTORY), "Retouch History");
        _tagNameMap.put(Integer.valueOf(TAG_UNKNOWN_12), "Unknown 12");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_UNKNOWN_20), "Unknown 20");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_UNKNOWN_47), "Unknown 47");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_DIGITAL_VARI_PROGRAM), "Digital Vari Program");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_CAMERA_COLOR_MODE), "Colour Mode");
