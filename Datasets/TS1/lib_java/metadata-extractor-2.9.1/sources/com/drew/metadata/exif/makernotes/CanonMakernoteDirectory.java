...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory.class */
public class CanonMakernoteDirectory extends Directory {
    ...
    /* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$AFInfo.class */
    ...
    /* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$CameraSettings.class */
    ...
    /* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$FocalLength.class */
    ...
    /* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$Panorama.class */
    ...
    /* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/CanonMakernoteDirectory$ShotInfo.class */
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_UNKNOWN_4), "Unknown Camera Setting 4");
        ...
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_UNKNOWN_9), "Unknown Camera Setting 9");
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_UNKNOWN_10), "Unknown Camera Setting 10");
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_FLASH_ACTIVITY), "Flash Activity");
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_UNKNOWN_12), "Unknown Camera Setting 12");
        _tagNameMap.put(Integer.valueOf(CameraSettings.TAG_UNKNOWN_13), "Unknown Camera Setting 13");
        ...
        _tagNameMap.put(Integer.valueOf(AFInfo.TAG_AF_POINTS_IN_FOCUS), "AF Points in Focus Count");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_VRD_OFFSET), "VRD Offset");
        ...
        switch (tagType) {
            ...
            case 18:
                ...
                for (int i5 = 0; i5 < ints5.length; i5++) {
                    setInt(AFInfo.TAG_NUM_AF_POINTS + i5, ints5[i5]);
                }
                break;
            default:
