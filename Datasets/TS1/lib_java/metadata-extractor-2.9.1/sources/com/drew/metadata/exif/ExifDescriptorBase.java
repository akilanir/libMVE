...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/ExifDescriptorBase.class */
public abstract class ExifDescriptorBase<T extends Directory> extends TagDescriptor<T> {
    ...
    public String getDescription(int tagType) {
        switch (tagType) {
            ...
            case ExifDirectoryBase.TAG_COLOR_SPACE /* 40961 */:
    ...
    public String getYResolutionDescription() {
        Rational value = this._directory.getRational(ExifDirectoryBase.TAG_Y_RESOLUTION);
        if (value == null) {
            return null;
        }
    ...
    public String getXResolutionDescription() {
        Rational value = this._directory.getRational(ExifDirectoryBase.TAG_X_RESOLUTION);
        if (value == null) {
            return null;
        }
        String unit = getResolutionDescription();
    ...
    public String getYCbCrSubsamplingDescription() {
        int[] positions = this._directory.getIntArray(ExifDirectoryBase.TAG_YCBCR_SUBSAMPLING);
    ...
    public String getPlanarConfigurationDescription() {
        return getIndexedDescription(ExifDirectoryBase.TAG_PLANAR_CONFIGURATION, 1, "Chunky (contiguous for each subsampling pixel)", "Separate (Y-plane/Cb-plane/Cr-plane format)");
    }
    ...
    public String getStripByteCountsDescription() {
        String value = this._directory.getString(ExifDirectoryBase.TAG_STRIP_BYTE_COUNTS);
        if (value == null) {
            return null;
        }
        return value + " bytes";
    ...
    public String getPhotometricInterpretationDescription() {
        Integer value = this._directory.getInteger(ExifDirectoryBase.TAG_PHOTOMETRIC_INTERPRETATION);
        if (value == null) {
            return null;
        }
    ...
    public String getNewSubfileTypeDescription() {
        return getIndexedDescription(ExifDirectoryBase.TAG_NEW_SUBFILE_TYPE, 1, "Full-resolution image", "Reduced-resolution image", "Single page of multi-page reduced-resolution image", "Transparency mask", "Transparency mask of reduced-resolution image", "Transparency mask of multi-page image", "Transparency mask of reduced-resolution multi-page image");
    }
    ...
    public String getThresholdingDescription() {
        return getIndexedDescription(ExifDirectoryBase.TAG_THRESHOLDING, 1, "No dithering or halftoning", "Ordered dither or halftone", "Randomized dither");
    }

    @Nullable
    public String getFillOrderDescription() {
        return getIndexedDescription(ExifDirectoryBase.TAG_FILL_ORDER, 1, "Normal", "Reversed");
    }
    ...
    public String get35mmFilmEquivFocalLengthDescription() {
        ...
        return value.intValue() == 0 ? "Unknown" : getFocalLengthDescription(value.intValue());
    }
    ...
    public String getDigitalZoomRatioDescription() {
        ...
        return value.getNumerator() == 0 ? "Digital zoom not used" : SimpleDecimalFormatter.format(value.doubleValue());
    }
    ...
    public String getColorSpaceDescription() {
        Integer value = this._directory.getInteger(ExifDirectoryBase.TAG_COLOR_SPACE);
        if (value == null) {
            return null;
        }
        if (value.intValue() == 1) {
    ...
    public String getShutterSpeedDescription() {
        Float apexValue = this._directory.getFloatObject(ExifDirectoryBase.TAG_SHUTTER_SPEED);
        if (apexValue == null) {
            return null;
        }
