...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/NikonType2MakernoteDescriptor.class */
public class NikonType2MakernoteDescriptor extends TagDescriptor<NikonType2MakernoteDirectory> {
    ...
    public String getDigitalZoomDescription() {
        Rational value = ((NikonType2MakernoteDirectory) this._directory).getRational(NikonType2MakernoteDirectory.TAG_DIGITAL_ZOOM);
        if (value == null) {
            return null;
        }
    ...
    public String getColorModeDescription() {
        String value = ((NikonType2MakernoteDirectory) this._directory).getString(NikonType2MakernoteDirectory.TAG_CAMERA_COLOR_MODE);
        if (value == null) {
            return null;
        }
