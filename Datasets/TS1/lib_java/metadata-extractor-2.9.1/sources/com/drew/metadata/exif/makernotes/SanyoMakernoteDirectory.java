...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/SanyoMakernoteDirectory.class */
public class SanyoMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(TAG_COLOR_ADJUSTMENT_MODE), "Color Adjustment Node");
