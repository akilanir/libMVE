...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/FujifilmMakernoteDirectory.class */
public class FujifilmMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(TAG_SLOW_SYNC), "Slow Sync");
        _tagNameMap.put(Integer.valueOf(TAG_PICTURE_MODE), "Picture Mode");
        _tagNameMap.put(Integer.valueOf(TAG_EXR_AUTO), "EXR Auto");
