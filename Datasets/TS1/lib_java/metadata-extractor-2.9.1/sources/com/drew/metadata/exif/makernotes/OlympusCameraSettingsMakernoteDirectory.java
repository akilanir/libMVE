...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/OlympusCameraSettingsMakernoteDirectory.class */
public class OlympusCameraSettingsMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(TagAfPointSelected), "AF Point Selected");
        _tagNameMap.put(Integer.valueOf(TagAfFineTune), "AF Fine Tune");
        _tagNameMap.put(Integer.valueOf(TagAfFineTuneAdj), "AF Fine Tune Adj");
        _tagNameMap.put(1024, "Flash Mode");
        _tagNameMap.put(Integer.valueOf(TagFlashExposureComp), "Flash Exposure Comp");
        ...
        _tagNameMap.put(Integer.valueOf(TagDriveMode), "Drive Mode");
        _tagNameMap.put(Integer.valueOf(TagPanoramaMode), "Panorama Mode");
