...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/ico/IcoReader.class */
public class IcoReader {
    static final /* synthetic */ boolean $assertionsDisabled;

    static {
        $assertionsDisabled = !IcoReader.class.desiredAssertionStatus();
    }
        ...
        try {
            ...
            for (int imageIndex = 0; imageIndex < imageCount; imageIndex++) {
                ...
                try {
                    ...
                    if (!$assertionsDisabled && directory4 == null) {
