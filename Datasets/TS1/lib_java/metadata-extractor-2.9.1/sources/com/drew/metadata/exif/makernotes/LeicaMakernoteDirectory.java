...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/LeicaMakernoteDirectory.class */
public class LeicaMakernoteDirectory extends Directory {
    ...
    static {
        ...
        _tagNameMap.put(Integer.valueOf(TAG_LENS_TYPE), "Lens Type");
        _tagNameMap.put(Integer.valueOf(TAG_EXTERNAL_SENSOR_BRIGHTNESS_VALUE), "External Sensor Brightness Value");
        ...
        _tagNameMap.put(Integer.valueOf(TAG_CAMERA_TEMPERATURE), "Camera Temperature");
