...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/ExifDirectoryBase.class */
public abstract class ExifDirectoryBase extends Directory {
    ...
    protected static void addExifTagNames(HashMap<Integer, String> map) {
        ...
        map.put(Integer.valueOf(TAG_IMAGE_DESCRIPTION), "Image Description");
