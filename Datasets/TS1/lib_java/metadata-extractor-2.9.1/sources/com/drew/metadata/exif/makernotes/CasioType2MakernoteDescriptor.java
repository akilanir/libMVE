...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/CasioType2MakernoteDescriptor.class */
public class CasioType2MakernoteDescriptor extends TagDescriptor<CasioType2MakernoteDirectory> {
    ...
    public String getObjectDistanceDescription() {
        Integer value = ((CasioType2MakernoteDirectory) this._directory).getInteger(CasioType2MakernoteDirectory.TAG_OBJECT_DISTANCE);
        if (value == null) {
            return null;
        }
