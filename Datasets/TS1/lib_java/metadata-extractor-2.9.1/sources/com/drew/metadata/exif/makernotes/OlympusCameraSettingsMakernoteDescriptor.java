...
/* loaded from: metadata-extractor-2.9.1.jar:com/drew/metadata/exif/makernotes/OlympusCameraSettingsMakernoteDescriptor.class */
public class OlympusCameraSettingsMakernoteDescriptor extends TagDescriptor<OlympusCameraSettingsMakernoteDirectory> {
    ...
    public String getAfPointSelectedDescription() {
        Rational[] values = ((OlympusCameraSettingsMakernoteDirectory) this._directory).getRationalArray(OlympusCameraSettingsMakernoteDirectory.TagAfPointSelected);
        if (values == null) {
            return "n/a";
        }
        if (values.length < 4) {
    ...
    public String getWhiteBalance2Description() {
        Integer value = ((OlympusCameraSettingsMakernoteDirectory) this._directory).getInteger(OlympusCameraSettingsMakernoteDirectory.TagWhiteBalance2);
        if (value == null) {
            return null;
        }
        switch (value.intValue()) {
    ...
    public String getSceneModeDescription() {
        ...
        switch (value.intValue()) {
            ...
            case IccDirectory.TAG_XYZ_VALUES /* 68 */:
            case 69:
            ...
            case KodakMakernoteDirectory.TAG_DIGITAL_ZOOM /* 104 */:
            ...
            case 136:
            case 137:
            case NikonType2MakernoteDirectory.TAG_UNKNOWN_20 /* 138 */:
            case NikonType2MakernoteDirectory.TAG_LENS_STOPS /* 139 */:
            case NikonType2MakernoteDirectory.TAG_CONTRAST_CURVE /* 140 */:
            ...
            case NikonType2MakernoteDirectory.TAG_UNKNOWN_37 /* 39 */:
                return "High Key";
            case 40:
    ...
    public String getDriveModeDescription() {
        int[] values = ((OlympusCameraSettingsMakernoteDirectory) this._directory).getIntArray(OlympusCameraSettingsMakernoteDirectory.TagDriveMode);
        if (values == null) {
            return null;
        }
    ...
    public String getPanoramaModeDescription() {
        String a;
        int[] values = ((OlympusCameraSettingsMakernoteDirectory) this._directory).getIntArray(OlympusCameraSettingsMakernoteDirectory.TagPanoramaMode);
        if (values == null) {
            return null;
        }
        if (values.length == 0 || values[0] == 0) {
