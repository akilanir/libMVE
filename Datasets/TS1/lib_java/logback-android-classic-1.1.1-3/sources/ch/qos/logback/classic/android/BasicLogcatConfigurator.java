...
/* loaded from: logback-android-classic-1.1.1-3.jar:ch/qos/logback/classic/android/BasicLogcatConfigurator.class */
public class BasicLogcatConfigurator {
    ...
    public static void configure(LoggerContext loggerContext) {
        ...
        loggerContext.m4getLogger("ROOT").addAppender(logcatAppender);
    }
