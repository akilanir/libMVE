...
/* loaded from: jackson-core-2.7.3.jar:com/fasterxml/jackson/core/json/UTF8JsonGenerator.class */
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    public void writeNumber(BigDecimal value) throws IOException {
        ...
        if (this._cfgNumbersAsStrings) {
            String raw = JsonGenerator.Feature.WRITE_BIGDECIMAL_AS_PLAIN.enabledIn(this._features) ? value.toPlainString() : value.toString();
            _writeQuotedRaw(raw);
