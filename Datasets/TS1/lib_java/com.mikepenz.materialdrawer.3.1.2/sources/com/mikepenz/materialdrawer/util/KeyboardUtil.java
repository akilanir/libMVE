...
/* loaded from: com.mikepenz.materialdrawer.3.1.2.jar:com/mikepenz/materialdrawer/util/KeyboardUtil.class */
public class KeyboardUtil {
    private View decorView;
    private View contentView;
    private float initialDpDiff = -1.0f;
    ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.mikepenz.materialdrawer.util.KeyboardUtil.1
        @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
        public void onGlobalLayout() {
            Rect r = new Rect();
            KeyboardUtil.this.decorView.getWindowVisibleDisplayFrame(r);
            float heightDiffDp = UIUtils.convertPixelsToDp(KeyboardUtil.this.decorView.getRootView().getHeight() - (r.bottom - r.top), KeyboardUtil.this.decorView.getContext());
