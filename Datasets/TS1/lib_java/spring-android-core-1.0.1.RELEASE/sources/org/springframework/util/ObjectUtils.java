...
/* loaded from: spring-android-core-1.0.1.RELEASE.jar:org/springframework/util/ObjectUtils.class */
public abstract class ObjectUtils {
    ...
    public static int nullSafeHashCode(Object[] array) {
        ...
        for (Object obj : array) {
            hash = (MULTIPLIER * hash) + nullSafeHashCode(obj);
        }
        return hash;
    }
    ...
    public static int nullSafeHashCode(boolean[] array) {
        ...
        int hash = INITIAL_HASH;
        for (boolean z : array) {
            hash = (MULTIPLIER * hash) + hashCode(z);
        }
        return hash;
    }
    ...
    public static int nullSafeHashCode(double[] array) {
        ...
        int hash = INITIAL_HASH;
        for (double d : array) {
            hash = (MULTIPLIER * hash) + hashCode(d);
        }
        return hash;
    }
    ...
    public static int nullSafeHashCode(float[] array) {
        ...
        int hash = INITIAL_HASH;
        for (float f : array) {
            hash = (MULTIPLIER * hash) + hashCode(f);
        }
        return hash;
    }
    ...
    public static int nullSafeHashCode(long[] array) {
        ...
        int hash = INITIAL_HASH;
        for (long j : array) {
            hash = (MULTIPLIER * hash) + hashCode(j);
        }
        return hash;
    }
