...
/* loaded from: spring-android-core-1.0.1.RELEASE.jar:org/springframework/util/StringUtils.class */
public abstract class StringUtils {
    ...
    public static String getFilenameExtension(String path) {
        int extIndex;
        if (path == null || (extIndex = path.lastIndexOf(EXTENSION_SEPARATOR)) == -1) {
            return null;
        }
