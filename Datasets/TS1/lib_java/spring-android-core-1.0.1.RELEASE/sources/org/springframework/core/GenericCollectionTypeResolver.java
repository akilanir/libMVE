...
/* loaded from: spring-android-core-1.0.1.RELEASE.jar:org/springframework/core/GenericCollectionTypeResolver.class */
public abstract class GenericCollectionTypeResolver {
    ...
    private static Class<?> extractTypeFromParameterizedType(ParameterizedType ptype, Class<?> source, int typeIndex, Map<TypeVariable<?>, Type> typeVariableMap, Map<Integer, Integer> typeIndexesPerLevel, int nestingLevel, int currentLevel) {
        ...
        if (nestingLevel - currentLevel > 0) {
            ...
            Integer currentTypeIndex = typeIndexesPerLevel != null ? typeIndexesPerLevel.get(Integer.valueOf(nextLevel)) : null;
            int indexToUse = currentTypeIndex != null ? currentTypeIndex.intValue() : paramTypes.length - 1;
            return extractType(paramTypes[indexToUse], source, typeIndex, typeVariableMap, typeIndexesPerLevel, nestingLevel, nextLevel);
        }
