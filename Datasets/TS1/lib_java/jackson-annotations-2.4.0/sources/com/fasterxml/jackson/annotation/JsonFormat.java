...
/* loaded from: jackson-annotations-2.4.0.jar:com/fasterxml/jackson/annotation/JsonFormat.class */
public @interface JsonFormat {
    ...
    /* loaded from: jackson-annotations-2.4.0.jar:com/fasterxml/jackson/annotation/JsonFormat$Shape.class */
    public enum Shape {
        ANY,
        SCALAR,
        ARRAY,
    ...
    /* loaded from: jackson-annotations-2.4.0.jar:com/fasterxml/jackson/annotation/JsonFormat$Value.class */
    public static class Value {
        ...
        public Value() {
            this(JsonProperty.USE_DEFAULT_NAME, Shape.ANY, JsonProperty.USE_DEFAULT_NAME, JsonProperty.USE_DEFAULT_NAME);
        }
