...
/* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/AsyncNetworkSocket.class */
public class AsyncNetworkSocket implements AsyncSocket {
    ...
    public void onDataWritable() {
        if (!this.mChannel.isChunked()) {
            this.mKey.interestOps((-5) & this.mKey.interestOps());
        }
    ...
    private void handleRemaining(int remaining) throws IOException {
        ...
        if (remaining > 0) {
            ...
            this.mKey.interestOps(4 | this.mKey.interestOps());
            return;
        }
        this.mKey.interestOps((-5) & this.mKey.interestOps());
    }
