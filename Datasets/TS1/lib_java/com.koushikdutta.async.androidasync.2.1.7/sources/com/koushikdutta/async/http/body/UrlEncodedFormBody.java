...
/* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/http/body/UrlEncodedFormBody.class */
public class UrlEncodedFormBody implements AsyncHttpRequestBody<Multimap> {
    ...
    private void buildData() {
        ...
        try {
            Iterator i$ = this.mParameters.iterator();
            while (i$.hasNext()) {
