...
/* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/http/AsyncSocketMiddleware.class */
public class AsyncSocketMiddleware extends SimpleMiddleware {
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/http/AsyncSocketMiddleware$IdleSocketHolder.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/http/AsyncSocketMiddleware$ConnectionInfo.class */
    ...
    /* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/http/AsyncSocketMiddleware$1.class */
    class AnonymousClass1 extends TransformFuture<AsyncSocket, InetAddress[]> {
        ...
        public void transform(InetAddress[] result) throws Exception {
            ...
            for (final InetAddress address : result) {
                final String inetSockAddress = String.format("%s:%s", address, Integer.valueOf(this.val$port));
    ...
    public void onResponseComplete(AsyncHttpClientMiddleware.OnResponseCompleteDataOnRequestSentData data) {
        ...
        try {
            ...
            if (HttpUtil.isKeepAlive(data.response.protocol(), data.response.headers()) && HttpUtil.isKeepAlive(Protocol.HTTP_1_1, data.request.getHeaders())) {
