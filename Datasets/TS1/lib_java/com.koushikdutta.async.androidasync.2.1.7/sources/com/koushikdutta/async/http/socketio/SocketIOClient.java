...
@Deprecated
/* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/http/socketio/SocketIOClient.class */
public class SocketIOClient extends EventEmitter {
    ...
    public static Future<SocketIOClient> connect(AsyncHttpClient client, final SocketIORequest request, final ConnectCallback callback) {
        ...
        connection.clients.add(new SocketIOClient(connection, BuildConfig.FLAVOR, wrappedCallback));
