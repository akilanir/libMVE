...
/* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/http/HttpTransportMiddleware.class */
public class HttpTransportMiddleware extends SimpleMiddleware {
    ...
    public boolean exchangeHeaders(final AsyncHttpClientMiddleware.OnExchangeHeaderData data) {
        ...
        boolean waitForBody = requestBody != null && requestBody.length() >= 0 && requestBody.length() < 1024;
        if (waitForBody) {
        ...
        final BufferedDataSink bufferedDataSink = bsink;
        Util.writeAll(headerSink, rs.getBytes(), new CompletedCallback() { // from class: com.koushikdutta.async.http.HttpTransportMiddleware.1
            ...
            public void onStringAvailable(String s) {
                ...
                try {
                    ...
                    if (this.statusLine == null) {
                        ...
                        data.response.message(parts.length == 3 ? parts[2] : BuildConfig.FLAVOR);
