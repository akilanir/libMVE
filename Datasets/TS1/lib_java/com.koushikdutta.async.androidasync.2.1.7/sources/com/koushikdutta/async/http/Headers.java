...
/* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/http/Headers.class */
public class Headers {
    ...
    public List<String> getAll(String header) {
        return this.map.get(header.toLowerCase());
    }

    public String get(String header) {
        return this.map.getString(header.toLowerCase());
    }
    ...
    public Headers addLine(String line) {
        if (line != null) {
            ...
            if (parts.length == 2) {
                ...
                add(parts[0].trim(), BuildConfig.FLAVOR);
            }
        }
        return this;
    }
    ...
    public List<String> removeAll(String header) {
        return (List) this.map.remove(header.toLowerCase());
    }
