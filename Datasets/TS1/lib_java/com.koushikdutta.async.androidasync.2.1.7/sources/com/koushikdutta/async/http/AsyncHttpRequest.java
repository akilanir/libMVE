...
/* loaded from: com.koushikdutta.async.androidasync.2.1.7.jar:com/koushikdutta/async/http/AsyncHttpRequest.class */
public class AsyncHttpRequest {
    ...
    private String getLogMessage(String message) {
        ...
        return String.format("(%d ms) %s: %s", Long.valueOf(elapsed), getUri(), message);
    }
