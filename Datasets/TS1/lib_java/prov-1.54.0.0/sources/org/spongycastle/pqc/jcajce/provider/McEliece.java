...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/pqc/jcajce/provider/McEliece.class */
public class McEliece {
    private static final String PREFIX = "org.spongycastle.pqc.jcajce.provider.mceliece.";

    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/pqc/jcajce/provider/McEliece$Mappings.class */
