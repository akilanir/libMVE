...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/x509/X509Util.class */
class X509Util {
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/x509/X509Util$Implementation.class */
    ...
    static Implementation getImplementation(String baseName, String algorithm, Provider prov) throws NoSuchAlgorithmException {
        String algorithm2;
        Class cls;
        String upperCase = Strings.toUpperCase(algorithm);
        while (true) {
            algorithm2 = upperCase;
