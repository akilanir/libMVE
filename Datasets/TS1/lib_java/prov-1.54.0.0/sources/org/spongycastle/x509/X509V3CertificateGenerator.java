...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/x509/X509V3CertificateGenerator.class */
public class X509V3CertificateGenerator {
    ...
    public void copyAndAddExtension(String oid, boolean critical, X509Certificate cert) throws CertificateParsingException {
        ...
        try {
            addExtension(oid, critical, (ASN1Encodable) X509ExtensionUtil.fromExtensionValue(extValue));
        } catch (IOException e) {
