...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/x509/CertPathValidatorUtilities.class */
class CertPathValidatorUtilities {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x0107, code lost:
        ...
        r21 = r14.getCriticalExtensionOIDs().contains(org.spongycastle.x509.CertPathValidatorUtilities.CERTIFICATE_POLICIES);
     */
    ...
    */
    protected static void prepareNextCertB1(int r10, java.util.List[] r11, java.lang.String r12, java.util.Map r13, java.security.cert.X509Certificate r14) throws org.spongycastle.jce.provider.AnnotatedException, java.security.cert.CertPathValidatorException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.spongycastle.x509.CertPathValidatorUtilities.prepareNextCertB1(int, java.util.List[], java.lang.String, java.util.Map, java.security.cert.X509Certificate):void");
    }
    ...
    protected static Collection findCertificates(X509CertStoreSelector certSelect, List certStores) throws AnnotatedException {
        ...
        for (Object obj : certStores) {
            if (obj instanceof Store) {
                ...
                try {
                    for (Object cert : certStore.getMatches(certSelect)) {
                ...
                try {
                    certs.addAll(certStore2.getCertificates(certSelect));
