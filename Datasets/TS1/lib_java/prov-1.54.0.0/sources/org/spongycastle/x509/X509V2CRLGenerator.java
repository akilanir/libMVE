...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/x509/X509V2CRLGenerator.class */
public class X509V2CRLGenerator {
    ...
    public X509CRL generate(PrivateKey key, SecureRandom random) throws CRLException, IllegalStateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        ...
        try {
            byte[] signature = X509Util.calculateSignature(this.sigOID, this.signatureAlgorithm, key, random, tbsCrl);
    ...
    public X509CRL generate(PrivateKey key, String provider, SecureRandom random) throws CRLException, IllegalStateException, NoSuchProviderException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        TBSCertList tbsCrl = generateCertList();
        try {
            byte[] signature = X509Util.calculateSignature(this.sigOID, this.signatureAlgorithm, provider, key, random, tbsCrl);
            return generateJcaObject(tbsCrl, signature);
        } catch (IOException e) {
            throw new ExtCRLException("cannot generate CRL encoding", e);
        }
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/x509/X509V2CRLGenerator$ExtCRLException.class */
