...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jce/provider/JCEECPrivateKey.class */
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo info) throws IOException {
        ...
        if (params.isNamedCurve()) {
            ...
            if (ecP == null) {
                ...
                this.ecSpec = new ECNamedCurveSpec(ECGOST3410NamedCurves.getName(oid), ellipticCurve, new ECPoint(gParam.getG().getAffineXCoord().toBigInteger(), gParam.getG().getAffineYCoord().toBigInteger()), gParam.getN(), gParam.getH());
            } else {
        ...
        ASN1Sequence parsePrivateKey = info.parsePrivateKey();
        if (parsePrivateKey instanceof ASN1Integer) {
            ASN1Integer derD = ASN1Integer.getInstance(parsePrivateKey);
            this.d = derD.getValue();
        } else {
            ECPrivateKeyStructure ec = new ECPrivateKeyStructure(parsePrivateKey);
            this.d = ec.getKey();
