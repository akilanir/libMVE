...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jce/provider/BrokenJCEBlockCipher.class */
public class BrokenJCEBlockCipher implements BrokenPBE {
    ...
    protected void engineSetMode(String mode) {
        ...
        if (modeName.startsWith("CFB")) {
            this.ivLength = this.cipher.getUnderlyingCipher().getBlockSize();
            if (modeName.length() != 3) {
                int wordSize2 = Integer.parseInt(modeName.substring(3));
                this.cipher = new PaddedBufferedBlockCipher(new CFBBlockCipher(this.cipher.getUnderlyingCipher(), wordSize2));
                return;
            } else {
    ...
    protected void engineInit(int opmode, Key key, AlgorithmParameterSpec params, SecureRandom random) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (key instanceof BCPBEKey) {
            rC5Parameters = BrokenPBE.Util.makePBEParameters((BCPBEKey) key, params, this.pbeType, this.pbeHash, this.cipher.getUnderlyingCipher().getAlgorithmName(), this.pbeKeySize, this.pbeIvSize);
            if (this.pbeIvSize != 0) {
            ...
            if (this.ivLength != 0) {
                rC5Parameters = new ParametersWithIV(new KeyParameter(key.getEncoded()), ((IvParameterSpec) params).getIV());
                this.ivParam = rC5Parameters;
            } else {
                rC5Parameters = new KeyParameter(key.getEncoded());
            }
            ...
            rC5Parameters = new RC2Parameters(key.getEncoded(), ((RC2ParameterSpec) params).getEffectiveKeyBits());
            if (rc2Param.getIV() != null && this.ivLength != 0) {
                rC5Parameters = new ParametersWithIV(rC5Parameters, rc2Param.getIV());
                this.ivParam = rC5Parameters;
            }
        } else if (params instanceof RC5ParameterSpec) {
            RC5ParameterSpec rc5Param = (RC5ParameterSpec) params;
            rC5Parameters = new RC5Parameters(key.getEncoded(), ((RC5ParameterSpec) params).getRounds());
            if (rc5Param.getWordSize() != 32) {
                throw new IllegalArgumentException("can only accept RC5 word size 32 (at the moment...)");
            }
            if (rc5Param.getIV() != null && this.ivLength != 0) {
                rC5Parameters = new ParametersWithIV(rC5Parameters, rc5Param.getIV());
                this.ivParam = rC5Parameters;
            }
        } else {
        ...
        if (this.ivLength != 0 && !(rC5Parameters instanceof ParametersWithIV)) {
            ...
            if (opmode == 1 || opmode == 3) {
                ...
                random.nextBytes(iv);
                rC5Parameters = new ParametersWithIV(rC5Parameters, iv);
                this.ivParam = rC5Parameters;
            } else {
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jce/provider/BrokenJCEBlockCipher$BrokePBEWithMD5AndDES.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jce/provider/BrokenJCEBlockCipher$BrokePBEWithSHA1AndDES.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jce/provider/BrokenJCEBlockCipher$BrokePBEWithSHAAndDES3Key.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jce/provider/BrokenJCEBlockCipher$OldPBEWithSHAAndDES3Key.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jce/provider/BrokenJCEBlockCipher$BrokePBEWithSHAAndDES2Key.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jce/provider/BrokenJCEBlockCipher$OldPBEWithSHAAndTwofish.class */
    public static class OldPBEWithSHAAndTwofish extends BrokenJCEBlockCipher {
        public OldPBEWithSHAAndTwofish() {
            super(new CBCBlockCipher(new TwofishEngine()), 3, 1, 256, X509KeyUsage.digitalSignature);
        }
    }
}
