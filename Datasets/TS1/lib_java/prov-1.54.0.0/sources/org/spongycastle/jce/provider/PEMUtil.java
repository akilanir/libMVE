...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jce/provider/PEMUtil.class */
public class PEMUtil {
    ...
    ASN1Sequence readPEMObject(InputStream in) throws IOException {
        ...
        if (pemBuf.length() != 0) {
            ASN1Sequence readObject = new ASN1InputStream(Base64.decode(pemBuf.toString())).readObject();
