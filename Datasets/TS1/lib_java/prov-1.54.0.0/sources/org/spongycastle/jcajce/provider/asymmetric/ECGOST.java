...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/asymmetric/ECGOST.class */
public class ECGOST {
    private static final String PREFIX = "org.spongycastle.jcajce.provider.asymmetric.ecgost.";

    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/asymmetric/ECGOST$Mappings.class */
