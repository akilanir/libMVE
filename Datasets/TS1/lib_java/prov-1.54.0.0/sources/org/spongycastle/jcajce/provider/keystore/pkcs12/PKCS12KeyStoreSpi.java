...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi.class */
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$CertId.class */
    ...
    private static byte[] getDigest(SubjectPublicKeyInfo spki) {
        ...
        byte[] resBuf = new byte[sHA1Digest.getDigestSize()];
        byte[] bytes = spki.getPublicKeyData().getBytes();
        sHA1Digest.update(bytes, 0, bytes.length);
        sHA1Digest.doFinal(resBuf, 0);
        return resBuf;
    }
            ...
            while (c != null) {
                ...
                if (bytes != null) {
                    try {
                        ...
                        byte[] authBytes = aIn.readObject().getOctets();
    ...
    public void engineLoad(InputStream stream, char[] password) throws IOException {
        ...
        ASN1Sequence obj = bIn.readObject();
        ...
        if (bag.getMacData() != null) {
            ...
            byte[] data = info.getContent().getOctets();
            try {
        ...
        if (info.getContentType().equals(data)) {
            ASN1InputStream bIn2 = new ASN1InputStream(info.getContent().getOctets());
            AuthenticatedSafe authSafe = AuthenticatedSafe.getInstance(bIn2.readObject());
            ContentInfo[] c = authSafe.getContentInfo();
            for (int i = 0; i != c.length; i++) {
                if (c[i].getContentType().equals(data)) {
                    ASN1InputStream dIn = new ASN1InputStream(c[i].getContent().getOctets());
                        ...
                        if (b.getBagId().equals(pkcs8ShroudedKeyBag)) {
                            ...
                            if (b.getBagAttributes() != null) {
                                ...
                                while (e3.hasMoreElements()) {
                                    ...
                                    ASN1Set attrSet = sq.getObjectAt(1);
                                    ASN1Encodable aSN1Encodable = null;
                                    if (attrSet.size() > 0) {
                                        aSN1Encodable = (ASN1Primitive) attrSet.getObjectAt(0);
                                        ASN1Encodable existing = bagAttr.getBagAttribute(aOid);
                                        if (existing != null) {
                                            if (!existing.toASN1Primitive().equals(aSN1Encodable)) {
                                                throw new IOException("attempt to add existing attribute with different value");
                                            }
                                        } else {
                                            bagAttr.setBagAttribute(aOid, aSN1Encodable);
                                        }
                                    }
                                    if (aOid.equals(pkcs_9_at_friendlyName)) {
                                        alias = ((DERBMPString) aSN1Encodable).getString();
                                        this.keys.put(alias, privKey);
                                    } else if (aOid.equals(pkcs_9_at_localKeyId)) {
                                        localId = (ASN1OctetString) aSN1Encodable;
                                    }
                                }
                            }
                            if (localId != null) {
                    ...
                    ASN1Sequence seq2 = ASN1Primitive.fromByteArray(octets);
                    for (int j2 = 0; j2 != seq2.size(); j2++) {
                        ...
                        if (b2.getBagId().equals(certBag)) {
                            ...
                            while (e4.hasMoreElements()) {
                                ...
                                ASN1Set attrSet2 = sq2.getObjectAt(1);
                                ASN1Encodable aSN1Encodable2 = null;
                                if (attrSet2.size() > 0) {
                                    aSN1Encodable2 = (ASN1Primitive) attrSet2.getObjectAt(0);
                                    ASN1Encodable existing2 = bagAttr2.getBagAttribute(aOid2);
                                    if (existing2 != null) {
                                        if (!existing2.toASN1Primitive().equals(aSN1Encodable2)) {
                                            throw new IOException("attempt to add existing attribute with different value");
                                        }
                                    } else {
                                        bagAttr2.setBagAttribute(aOid2, aSN1Encodable2);
                                    }
                                }
                                if (aOid2.equals(pkcs_9_at_friendlyName)) {
                                    alias2 = ((DERBMPString) aSN1Encodable2).getString();
                                    this.keys.put(alias2, privKey2);
                                } else if (aOid2.equals(pkcs_9_at_localKeyId)) {
                                    localId2 = (ASN1OctetString) aSN1Encodable2;
                                }
                            }
                            ...
                            while (e5.hasMoreElements()) {
                                ...
                                if (attrSet3.size() > 0) {
                                    DERBMPString dERBMPString = (ASN1Primitive) attrSet3.getObjectAt(0);
                                    ASN1Encodable existing3 = bagAttr3.getBagAttribute(aOid3);
                                    if (existing3 != null) {
                                        if (!existing3.toASN1Primitive().equals(dERBMPString)) {
                                            throw new IOException("attempt to add existing attribute with different value");
                                        }
                                    } else {
                                        bagAttr3.setBagAttribute(aOid3, dERBMPString);
                                    }
                                    if (aOid3.equals(pkcs_9_at_friendlyName)) {
                                        alias3 = dERBMPString.getString();
                                        this.keys.put(alias3, privKey3);
                                    } else if (aOid3.equals(pkcs_9_at_localKeyId)) {
                                        localId3 = (ASN1OctetString) dERBMPString;
                                    }
                                }
                            }
        ...
        for (int i2 = 0; i2 != chain.size(); i2++) {
            ...
            try {
                ByteArrayInputStream cIn = new ByteArrayInputStream(cb.getCertValue().getOctets());
                ...
                if (b3.getBagAttributes() != null) {
                    ...
                    while (e6.hasMoreElements()) {
                        ...
                        if (attrSet4.size() > 0) {
                            ASN1Encodable aSN1Encodable3 = (ASN1Primitive) attrSet4.getObjectAt(0);
                            if (generateCertificate instanceof PKCS12BagAttributeCarrier) {
                                ...
                                if (existing4 != null) {
                                    if (!existing4.toASN1Primitive().equals(aSN1Encodable3)) {
                                        throw new IOException("attempt to add existing attribute with different value");
                                    }
                                } else {
                                    bagAttr4.setBagAttribute(oid, aSN1Encodable3);
                                }
                            }
                            if (oid.equals(pkcs_9_at_friendlyName)) {
                                alias4 = ((DERBMPString) aSN1Encodable3).getString();
                            } else if (oid.equals(pkcs_9_at_localKeyId)) {
                                localId4 = (ASN1OctetString) aSN1Encodable3;
                            }
                        }
                    }
                }
                ...
                if (unmarkedKey) {
                    ...
                    if (alias4 != null) {
                        this.certs.put(alias4, generateCertificate);
                    }
                }
            } catch (Exception e7) {
    ...
    private void doStore(OutputStream stream, char[] password, boolean useDEREncoding) throws IOException {
        ...
        while (ks.hasMoreElements()) {
            ...
            if (privKey instanceof PKCS12BagAttributeCarrier) {
                ...
                DERBMPString nm = bagAttrs.getBagAttribute(pkcs_9_at_friendlyName);
        ...
        while (cs.hasMoreElements()) {
            try {
                ...
                Certificate engineGetCertificate = engineGetCertificate(name2);
                ...
                if (engineGetCertificate instanceof PKCS12BagAttributeCarrier) {
                    ...
                    DERBMPString nm2 = bagAttrs2.getBagAttribute(pkcs_9_at_friendlyName);
            ...
            try {
                ...
                if (this.keys.get(certId) == null) {
                    ...
                    if (certificate instanceof PKCS12BagAttributeCarrier) {
                        ...
                        DERBMPString nm3 = bagAttrs3.getBagAttribute(pkcs_9_at_friendlyName);
        ...
        byte[] data = mainInfo.getContent().getOctets();
        try {
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$BCPKCS12KeyStore.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$BCPKCS12KeyStore3DES.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefPKCS12KeyStore.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefPKCS12KeyStore3DES.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$IgnoresCaseHashtable.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefaultSecretKeyProvider.class */
    private static class DefaultSecretKeyProvider {
        private final Map KEY_SIZES;

        DefaultSecretKeyProvider() {
            Map keySizes = new HashMap();
            keySizes.put(new ASN1ObjectIdentifier("1.2.840.113533.7.66.10"), Integers.valueOf(X509KeyUsage.digitalSignature));
