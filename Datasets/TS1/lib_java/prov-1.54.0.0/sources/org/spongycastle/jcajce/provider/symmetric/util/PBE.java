...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/symmetric/util/PBE.class */
public interface PBE {
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/symmetric/util/PBE$Util.class */
    public static class Util {
        private static PBEParametersGenerator makePBEGenerator(int type, int hash) {
            PKCS12ParametersGenerator pKCS5S1ParametersGenerator;
            if (type == 0 || type == 4) {
                switch (hash) {
                    case 0:
                ...
                switch (hash) {
                    case 0:
                        pKCS5S1ParametersGenerator = new PKCS5S2ParametersGenerator(new MD5Digest());
                        break;
                    case 1:
                        pKCS5S1ParametersGenerator = new PKCS5S2ParametersGenerator(new SHA1Digest());
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        pKCS5S1ParametersGenerator = new PKCS5S2ParametersGenerator(new SHA256Digest());
                        break;
                    case 5:
