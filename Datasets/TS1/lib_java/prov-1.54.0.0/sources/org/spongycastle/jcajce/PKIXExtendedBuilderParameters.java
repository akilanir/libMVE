...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/PKIXExtendedBuilderParameters.class */
public class PKIXExtendedBuilderParameters implements CertPathParameters {
    private final PKIXExtendedParameters baseParameters;
    private final Set<X509Certificate> excludedCerts;
    private final int maxPathLength;

    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/PKIXExtendedBuilderParameters$Builder.class */
