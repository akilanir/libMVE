...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/asymmetric/ecgost/SignatureSpi.class */
    ...
    protected void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof ECPublicKey) {
            ...
            try {
                ...
                generatePublicKeyParameter = ECUtil.generatePublicKeyParameter(BouncyCastleProvider.getPublicKey(SubjectPublicKeyInfo.getInstance(bytes)));
            } catch (Exception e) {
