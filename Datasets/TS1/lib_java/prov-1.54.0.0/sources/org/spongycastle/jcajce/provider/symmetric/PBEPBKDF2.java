...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/symmetric/PBEPBKDF2.class */
public class PBEPBKDF2 {
    private PBEPBKDF2() {
    }

    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/symmetric/PBEPBKDF2$AlgParams.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/symmetric/PBEPBKDF2$BasePBKDF2.class */
    public static class BasePBKDF2 extends BaseSecretKeyFactory {
        ...
        protected SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
            if (keySpec instanceof PBEKeySpec) {
                ...
                CipherParameters param2 = PBE.Util.makePBEMacParameters(pbeSpec, this.scheme, 1, keySize2);
                return new BCPBEKey(this.algName, this.algOid, this.scheme, 1, keySize2, -1, pbeSpec, param2);
            }
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/symmetric/PBEPBKDF2$PBKDF2withUTF8.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/symmetric/PBEPBKDF2$PBKDF2with8BIT.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/symmetric/PBEPBKDF2$Mappings.class */
