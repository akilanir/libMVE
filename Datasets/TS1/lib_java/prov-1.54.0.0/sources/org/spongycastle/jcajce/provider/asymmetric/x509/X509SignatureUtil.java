...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/asymmetric/x509/X509SignatureUtil.class */
    ...
    static String getSignatureName(AlgorithmIdentifier sigAlgId) {
        ...
        if (params != null && !derNull.equals(params)) {
            ...
            if (sigAlgId.getAlgorithm().equals(X9ObjectIdentifiers.ecdsa_with_SHA2)) {
                ...
                return getDigestAlgName(ecDsaParams.getObjectAt(0)) + "withECDSA";
            }
        }
