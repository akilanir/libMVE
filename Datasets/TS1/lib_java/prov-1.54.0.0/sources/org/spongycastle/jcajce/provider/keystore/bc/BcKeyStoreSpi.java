...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi.class */
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$StoreEntry.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$BouncyCastleStore.class */
    public static class BouncyCastleStore extends BcKeyStoreSpi {
        ...
        public void engineLoad(InputStream stream, char[] password) throws IOException {
            ...
            DigestInputStream dgIn = new DigestInputStream(cIn, sHA1Digest);
            loadStore(dgIn);
            byte[] hash = new byte[sHA1Digest.getDigestSize()];
            sHA1Digest.doFinal(hash, 0);
            byte[] oldHash = new byte[sHA1Digest.getDigestSize()];
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$Std.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi$Version1.class */
