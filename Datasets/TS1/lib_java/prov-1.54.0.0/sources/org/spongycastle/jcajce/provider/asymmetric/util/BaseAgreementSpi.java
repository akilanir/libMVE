...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/asymmetric/util/BaseAgreementSpi.class */
public abstract class BaseAgreementSpi extends KeyAgreementSpi {
    ...
    static {
        ...
        Integer i128 = Integers.valueOf(X509KeyUsage.digitalSignature);
    ...
    protected SecretKey engineGenerateSecret(String algorithm) throws NoSuchAlgorithmException {
        ...
        if (this.kdf != null) {
            ...
            if (this.kdf instanceof DHKEKGenerator) {
                try {
                    ASN1ObjectIdentifier oid = new ASN1ObjectIdentifier(oidAlgorithm);
                ...
                KDFParameters params2 = new KDFParameters(secret, this.ukmParameters);
                this.kdf.init(params2);
            }
