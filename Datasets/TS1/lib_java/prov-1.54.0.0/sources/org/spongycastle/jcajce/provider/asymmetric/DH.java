...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/asymmetric/DH.class */
public class DH {
    private static final String PREFIX = "org.spongycastle.jcajce.provider.asymmetric.dh.";

    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/provider/asymmetric/DH$Mappings.class */
