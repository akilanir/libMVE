...
/* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/PKIXCertStoreSelector.class */
public class PKIXCertStoreSelector<T extends Certificate> implements Selector<T> {
    private final CertSelector baseSelector;

    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/PKIXCertStoreSelector$Builder.class */
    ...
    /* loaded from: prov-1.54.0.0.jar:org/spongycastle/jcajce/PKIXCertStoreSelector$SelectorClone.class */
