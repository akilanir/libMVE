...
/* loaded from: com.android.support.recyclerview-v7.23.2.0.jar:android/support/v7/widget/GridLayoutManager.class */
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult result) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (this.mOrientation == 1) {
                measureChildWithDecorationsAndMargin(view2, spec, mainSpec, false, false);
            } else {
                measureChildWithDecorationsAndMargin(view2, mainSpec, spec, false, false);
            }
    ...
    private void guessMeasurement(float maxSizeInOther, int currentOtherDirSize) {
        int contentSize = Math.round(maxSizeInOther * this.mSpanCount);
    ...
    /* loaded from: com.android.support.recyclerview-v7.23.2.0.jar:android/support/v7/widget/GridLayoutManager$SpanSizeLookup.class */
    ...
    */
    ...
    /* loaded from: com.android.support.recyclerview-v7.23.2.0.jar:android/support/v7/widget/GridLayoutManager$DefaultSpanSizeLookup.class */
    ...
    /* loaded from: com.android.support.recyclerview-v7.23.2.0.jar:android/support/v7/widget/GridLayoutManager$LayoutParams.class */
