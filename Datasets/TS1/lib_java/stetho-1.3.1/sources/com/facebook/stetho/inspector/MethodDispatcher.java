...
@ThreadSafe
/* loaded from: stetho-1.3.1.jar:com/facebook/stetho/inspector/MethodDispatcher.class */
public class MethodDispatcher {
    ...
    /* loaded from: stetho-1.3.1.jar:com/facebook/stetho/inspector/MethodDispatcher$MethodDispatchHelper.class */
    private static class MethodDispatchHelper {
        ...
        public JSONObject invoke(JsonRpcPeer peer, @Nullable JSONObject params) throws InvocationTargetException, IllegalAccessException, JSONException, JsonRpcException {
            Object internalResult = this.mMethod.invoke(this.mInstance, peer, params);
            ...
            return (JSONObject) this.mObjectMapper.convertValue(convertableResult, JSONObject.class);
        }
    }
    ...
    private static boolean isDevtoolsMethod(Method method) throws IllegalArgumentException {
        ...
        Util.throwIfNot(args.length == 2, "%s: expected 2 args, got %s", methodName, Integer.valueOf(args.length));
