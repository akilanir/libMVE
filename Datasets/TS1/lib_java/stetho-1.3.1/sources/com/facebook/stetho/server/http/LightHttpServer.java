...
/* loaded from: stetho-1.3.1.jar:com/facebook/stetho/server/http/LightHttpServer.class */
public class LightHttpServer {
    ...
    public void serve(SocketLike socket) throws IOException {
        ...
        while (true) {
            ...
            if (request != null) {
                scratchResponse.reset();
                boolean keepGoing = dispatchToHandler(anotherSocketLike, request, scratchResponse);
                if (keepGoing) {
                    writeFullResponse(scratchResponse, writer, output);
                } else {
                    return;
                }
            } else {
    ...
    private static void readHeaders(LightHttpMessage message, HttpMessageReader reader) throws IOException {
        while (true) {
            ...
            if (!BuildConfig.FLAVOR.equals(headerLine)) {
    ...
    /* loaded from: stetho-1.3.1.jar:com/facebook/stetho/server/http/LightHttpServer$HttpMessageReader.class */
    private static class HttpMessageReader {
        ...
        /* loaded from: stetho-1.3.1.jar:com/facebook/stetho/server/http/LightHttpServer$HttpMessageReader$NewLineDetector.class */
        private static class NewLineDetector {
            ...
            public void accept(char c) {
                switch (this.state) {
                    ...
                    case 2:
                        if (c == '\n') {
                            this.state = STATE_ON_CRLF;
                            return;
                        } else {
                            this.state = 1;
                            return;
                        }
                    case STATE_ON_CRLF /* 3 */:
                        if (c == '\r') {
                            this.state = 2;
                            return;
                        } else {
    ...
    /* loaded from: stetho-1.3.1.jar:com/facebook/stetho/server/http/LightHttpServer$HttpMessageWriter.class */
