...
/* loaded from: com.einmalfel.earl.1.1.0.jar:com/einmalfel/earl/AtomPerson.class */
public class AtomPerson extends AtomCommonAttributes {
    ...
    @NonNull
    static AtomPerson read(XmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    public AtomPerson(@Nullable AtomCommonAttributes atomCommonAttributes, @NonNull String name, @Nullable URI uri, @Nullable String email) {
