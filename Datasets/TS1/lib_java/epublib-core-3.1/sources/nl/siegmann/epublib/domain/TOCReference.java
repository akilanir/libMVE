...
/* loaded from: epublib-core-3.1.jar:nl/siegmann/epublib/domain/TOCReference.class */
public class TOCReference extends TitledResourceReference implements Serializable {
    ...
    private static final Comparator<TOCReference> COMPARATOR_BY_TITLE_IGNORE_CASE = new Comparator<TOCReference>() { // from class: nl.siegmann.epublib.domain.TOCReference.1
