...
/* loaded from: epublib-core-3.1.jar:nl/siegmann/epublib/util/commons/io/XmlStreamReader.class */
public class XmlStreamReader extends Reader {
    ...
    private static final ByteOrderMark[] XML_GUESS_BYTES = {new ByteOrderMark("UTF-8", 60, 63, 120, 109), new ByteOrderMark(UTF_16BE, 0, 60, 0, 63), new ByteOrderMark(UTF_16LE, 60, 0, 63, 0), new ByteOrderMark(EBCDIC, 76, 111, 167, 148)};
    ...
    String calculateRawEncoding(String bomEnc, String xmlGuessEnc, String xmlEnc) throws IOException {
        ...
        String msg5 = MessageFormat.format(RAW_EX_2, bomEnc, xmlGuessEnc, xmlEnc);
    ...
    static String getContentTypeEncoding(String httpContentType) {
        ...
        if (httpContentType != null && (i = httpContentType.indexOf(";")) > -1) {
            ...
            encoding = encoding2 != null ? encoding2.toUpperCase() : null;
        }
        return encoding;
    }
