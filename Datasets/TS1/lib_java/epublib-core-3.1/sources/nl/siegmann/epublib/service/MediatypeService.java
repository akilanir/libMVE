...
/* loaded from: epublib-core-3.1.jar:nl/siegmann/epublib/service/MediatypeService.class */
public class MediatypeService {
    ...
    public static MediaType[] mediatypes = {XHTML, EPUB, JPG, PNG, GIF, CSS, SVG, TTF, NCX, XPGT, OPENTYPE, WOFF, SMIL, PLS, JAVASCRIPT, MP3, MP4};
