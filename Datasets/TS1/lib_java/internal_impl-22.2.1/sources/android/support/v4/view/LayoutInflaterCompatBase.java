...
/* loaded from: internal_impl-22.2.1.jar:android/support/v4/view/LayoutInflaterCompatBase.class */
class LayoutInflaterCompatBase {
    LayoutInflaterCompatBase() {
    }

    /* loaded from: internal_impl-22.2.1.jar:android/support/v4/view/LayoutInflaterCompatBase$FactoryWrapper.class */
