...
/* loaded from: picasso-2.4.0.jar:com/squareup/picasso/Stats.class */
class Stats {
    ...
    private void processBitmap(Bitmap bitmap, int what) {
        ...
        this.handler.sendMessage(this.handler.obtainMessage(what, bitmapSize, CACHE_HIT));
    }
    ...
    /* loaded from: picasso-2.4.0.jar:com/squareup/picasso/Stats$StatsHandler.class */
