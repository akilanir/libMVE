...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/asn1/sec/SECNamedCurves.class */
public class SECNamedCurves {
    ...
    static X9ECParametersHolder sect113r1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.sec.SECNamedCurves.16
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.F2m(AlertDescription.bad_certificate_status_response, 9, a, b, n, h));
    ...
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.sec.SECNamedCurves.20
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2L);
            ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.F2m(CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, a, b, n, h));
    ...
    static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.sec.SECNamedCurves.23
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2L);
            ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.F2m(CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256, 15, a, b, n, h));
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.sec.SECNamedCurves.27
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(4L);
            ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.F2m(239, CipherSuite.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, a, b, n, h));
