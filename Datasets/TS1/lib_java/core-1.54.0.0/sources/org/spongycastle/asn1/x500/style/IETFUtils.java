...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/asn1/x500/style/IETFUtils.class */
public class IETFUtils {
    ...
    public static String canonicalize(String s) {
        ...
        if (value.length() > 0 && value.charAt(0) == '#') {
            Encodable decodeObject = decodeObject(value);
            if (decodeObject instanceof ASN1String) {
                value = Strings.toLowerCase(((ASN1String) decodeObject).getString());
            }
        }
        if (value.length() > 1) {
            int start = 0;
