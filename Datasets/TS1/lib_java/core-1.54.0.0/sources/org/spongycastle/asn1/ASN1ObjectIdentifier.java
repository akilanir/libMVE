...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/asn1/ASN1ObjectIdentifier.class */
public class ASN1ObjectIdentifier extends ASN1Primitive {
    ...
    ASN1ObjectIdentifier(byte[] bytes) {
        ...
        for (int i = 0; i != bytes.length; i++) {
            int b = bytes[i] & 255;
            if (value <= LONG_LIMIT) {
                long value2 = value + (b & CertificateBody.profileType);
                if ((b & 128) == 0) {
                    if (first) {
                        if (value2 < 40) {
                            objId.append('0');
                ...
                BigInteger bigValue2 = (bigValue == null ? BigInteger.valueOf(value) : bigValue).or(BigInteger.valueOf(b & CertificateBody.profileType));
                if ((b & 128) == 0) {
                    if (first) {
                        objId.append('2');
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/asn1/ASN1ObjectIdentifier$OidHandle.class */
