...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/asn1/x509/GeneralName.class */
public class GeneralName extends ASN1Object implements ASN1Choice {
    ...
    private void parseIPv4(String ip, byte[] addr, int offset) {
        ...
        while (sTok.hasMoreTokens()) {
            int i = index;
            index++;
            addr[offset + i] = (byte) Integer.parseInt(sTok.nextToken());
        }
    }
    ...
    private int[] parseIPv6(String ip) {
        ...
        while (sTok.hasMoreTokens()) {
            ...
            if (e.equals(":")) {
                ...
                int i3 = index;
                int index2 = index + 1;
                val[i3] = (Integer.parseInt(eTok.nextToken()) << 8) | Integer.parseInt(eTok.nextToken());
                index = index2 + 1;
        ...
        if (index != val.length) {
            ...
            for (int i4 = doubleColon; i4 != val.length - (index - doubleColon); i4++) {
                val[i4] = 0;
            }
        }
        return val;
