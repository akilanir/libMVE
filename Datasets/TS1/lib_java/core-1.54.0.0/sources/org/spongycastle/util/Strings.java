...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/util/Strings.class */
public final class Strings {
    ...
    public static String fromUTF8ByteArray(byte[] bytes) {
        ...
        while (i2 < bytes.length) {
            if ((bytes[i2] & 240) == 240) {
                ...
                int U = codePoint - PKIFailureInfo.notAuthorized;
    ...
    public static void toUTF8ByteArray(char[] string, OutputStream sOut) throws IOException {
        ...
        while (i < string.length) {
            ...
            if (ch < 128) {
                ...
                char ch2 = string[i];
                if (ch <= 56319) {
                    int codePoint = (((ch & 1023) << 10) | (ch2 & 1023)) + PKIFailureInfo.notAuthorized;
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/util/Strings$StringListImpl.class */
