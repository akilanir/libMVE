...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/util/Arrays.class */
public final class Arrays {
    ...
    public static int hashCode(long[] data) {
        ...
        while (true) {
            ...
            if (i >= 0) {
                long di = data[i];
                i2 = (((hc * 257) ^ ((int) di)) * 257) ^ ((int) (di >>> 32));
            } else {
                return hc;
            }
        }
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/util/Arrays$Iterator.class */
