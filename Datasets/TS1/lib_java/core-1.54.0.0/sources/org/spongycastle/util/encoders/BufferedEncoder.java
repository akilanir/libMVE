...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/util/encoders/BufferedEncoder.class */
public class BufferedEncoder {
    ...
    public int processBytes(byte[] in, int inOff, int len, byte[] out, int outOff) {
        ...
        if (len > gapLen) {
            ...
            resultLen = resultLen2 + this.translator.encode(in, inOff2, chunkSize, out, outOff2);
            len = len2 - chunkSize;
