...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecT571R1Point.class */
public class SecT571R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint b) {
        ...
        if (X2.isZero()) {
            ...
            ECFieldElement Y3 = L.multiply(X12.add(X3)).add(X3).add(Y1);
    ...
    public ECPoint twicePlus(ECPoint b) {
        ...
        if (A.isZero()) {
            return new SecT571R1Point(curve, A, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
        }
