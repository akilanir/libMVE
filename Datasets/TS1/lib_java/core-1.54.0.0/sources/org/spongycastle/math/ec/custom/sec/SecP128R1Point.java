...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecP128R1Point.class */
public class SecP128R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint b) {
        ...
        Nat128.mul(S1, G, tt1);
        int c = Nat128.addBothTo(t3, t3, G);
    ...
    public ECPoint twice() {
        ...
        int c = Nat128.addBothTo(t2, t2, t2);
        SecP128R1Field.reduce32(c, t2);
        SecP128R1Field.multiply(Y1Squared, X1.x, Y1Squared);
        int c2 = Nat.shiftUpBits(4, Y1Squared, 2, 0);
        SecP128R1Field.reduce32(c2, Y1Squared);
        int c3 = Nat.shiftUpBits(4, T, 3, 0, t1);
        SecP128R1Field.reduce32(c3, t1);
