...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/Tnaf.class */
class Tnaf {
    ...
    public static byte[] tauAdicWNaf(byte mu, ZTauElement lambda, byte width, BigInteger pow2w, BigInteger tw, ZTauElement[] alpha) {
        ...
        while (true) {
            if (!r0.equals(ECConstants.ZERO) || !r1.equals(ECConstants.ZERO)) {
                ...
                BigInteger t = r0;
                if (mu == 1) {
                    subtract = r1.add(r0.shiftRight(1));
                } else {
                    subtract = r1.subtract(r0.shiftRight(1));
                }
                r0 = subtract;
                r1 = t.shiftRight(1).negate();
                i++;
