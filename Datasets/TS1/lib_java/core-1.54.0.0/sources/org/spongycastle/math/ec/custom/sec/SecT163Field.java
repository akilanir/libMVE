...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecT163Field.class */
public class SecT163Field {
    ...
    public static void reduce(long[] xx, long[] z) {
        ...
        long x4 = xx[4];
        long x5 = xx[5];
        long x22 = x2 ^ ((((x5 << 29) ^ (x5 << 32)) ^ (x5 << 35)) ^ (x5 << 36));
        long x32 = x3 ^ ((((x5 >>> 35) ^ (x5 >>> 32)) ^ (x5 >>> 29)) ^ (x5 >>> 28));
        long x12 = x1 ^ ((((x4 << 29) ^ (x4 << 32)) ^ (x4 << 35)) ^ (x4 << 36));
        long x23 = x22 ^ ((((x4 >>> 35) ^ (x4 >>> 32)) ^ (x4 >>> 29)) ^ (x4 >>> 28));
        long x02 = x0 ^ ((((x32 << 29) ^ (x32 << 32)) ^ (x32 << 35)) ^ (x32 << 36));
        long x13 = x12 ^ ((((x32 >>> 35) ^ (x32 >>> 32)) ^ (x32 >>> 29)) ^ (x32 >>> 28));
        long t = x23 >>> 35;
        z[0] = (((x02 ^ t) ^ (t << 3)) ^ (t << 6)) ^ (t << 7);
        z[1] = x13;
        z[2] = x23 & M35;
    }
    ...
    protected static void implMultiply(long[] x, long[] y, long[] zz) {
        ...
        long w22 = w2 ^ (w12 >>> 55);
        long w13 = w12 & M55;
        long w03 = (w02 >>> 1) ^ ((w13 & 1) << 54);
        long w14 = (w13 >>> 1) ^ ((w22 & 1) << 54);
        long w23 = w22 >>> 1;
        long w04 = w03 ^ (w03 << 1);
        long w05 = w04 ^ (w04 << 2);
        long w06 = w05 ^ (w05 << 4);
        ...
        long w111 = (w110 ^ (w110 << 32)) & M55;
        long w24 = w23 ^ (w111 >>> 54);
        long w25 = w24 ^ (w24 << 1);
        long w26 = w25 ^ (w25 << 2);
        long w27 = w26 ^ (w26 << 4);
        long w28 = w27 ^ (w27 << 8);
    ...
    protected static void implSquare(long[] x, long[] zz) {
        ...
        zz[5] = Interleave.expand8to16((int) (x2 >>> 32)) & 4294967295L;
    }
}
