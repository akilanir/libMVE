...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecT409Field.class */
public class SecT409Field {
    ...
    public static void reduce(long[] xx, long[] z) {
        ...
        long x034 = x033 ^ (u5 >>> 2);
        long x002 = x00 ^ (x072 << 39);
        long x013 = x012 ^ ((x072 >>> 25) ^ (x072 << 62));
        long x024 = x023 ^ (x072 >>> 2);
        long t = x063 >>> 25;
        z[0] = x002 ^ t;
        z[1] = x013 ^ (t << 23);
        z[2] = x024;
    ...
    public static void sqrt(long[] x, long[] z) {
        ...
        long c2 = (u03 >>> 32) | (u13 & (-4294967296L));
