...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecT283Field.class */
public class SecT283Field {
    ...
    public static void reduce(long[] xx, long[] z) {
        ...
        long x7 = xx[7];
        long x8 = xx[8];
        long x32 = x3 ^ ((((x8 << 37) ^ (x8 << 42)) ^ (x8 << 44)) ^ (x8 << 49));
        long x42 = x4 ^ ((((x8 >>> 27) ^ (x8 >>> 22)) ^ (x8 >>> 20)) ^ (x8 >>> 15));
        long x22 = x2 ^ ((((x7 << 37) ^ (x7 << 42)) ^ (x7 << 44)) ^ (x7 << 49));
        long x33 = x32 ^ ((((x7 >>> 27) ^ (x7 >>> 22)) ^ (x7 >>> 20)) ^ (x7 >>> 15));
        long x12 = x1 ^ ((((x6 << 37) ^ (x6 << 42)) ^ (x6 << 44)) ^ (x6 << 49));
        long x23 = x22 ^ ((((x6 >>> 27) ^ (x6 >>> 22)) ^ (x6 >>> 20)) ^ (x6 >>> 15));
        long x02 = x0 ^ ((((x5 << 37) ^ (x5 << 42)) ^ (x5 << 44)) ^ (x5 << 49));
        long x13 = x12 ^ ((((x5 >>> 27) ^ (x5 >>> 22)) ^ (x5 >>> 20)) ^ (x5 >>> 15));
        long t = x42 >>> 27;
        z[0] = (((x02 ^ t) ^ (t << 5)) ^ (t << 7)) ^ (t << 12);
        z[1] = x13;
        z[2] = x23;
        z[3] = x33;
        z[4] = x42 & M27;
    ...
    protected static void implMulw(long x, long y, long[] z, int zOff) {
        ...
        z[zOff] = l & M57;
        z[zOff + 1] = (l >>> 57) ^ ((h ^ (((x & 72198606942111744L) & ((y << 7) >> 63)) >>> 8)) << 7);
    }
