...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecP384R1Field.class */
public class SecP384R1Field {
    ...
    public static void reduce(int[] xx, int[] z) {
        ...
        long t5 = xx21 - xx23;
        long t6 = xx22 - xx23;
        long cc = 0 + (xx[0] & M) + t0 + t5;
        z[0] = (int) cc;
        long cc2 = (cc >> 32) + (((xx[1] & M) + xx23) - t0) + t1;
        z[1] = (int) cc2;
        long cc3 = (cc2 >> 32) + (((xx[2] & M) - xx21) - t1) + t2;
        z[2] = (int) cc3;
        long cc4 = (cc3 >> 32) + (((xx[3] & M) + t0) - t2) + t3 + t5;
        z[3] = (int) cc4;
        long cc5 = (cc4 >> 32) + ((((((xx[4] & M) + xx16) + xx21) + t0) + t1) - t3) + t5;
        z[4] = (int) cc5;
        long cc6 = (cc5 >> 32) + ((xx[5] & M) - xx16) + t1 + t2 + t4;
        z[5] = (int) cc6;
        long cc7 = (cc6 >> 32) + (((xx[6] & M) + xx18) - xx17) + t2 + t3;
        z[6] = (int) cc7;
        long cc8 = (cc7 >> 32) + ((((xx[7] & M) + xx16) + xx19) - xx18) + t3;
        z[7] = (int) cc8;
        long cc9 = (cc8 >> 32) + (((((xx[8] & M) + xx16) + xx17) + xx20) - xx19);
        z[8] = (int) cc9;
        long cc10 = (cc9 >> 32) + (((xx[9] & M) + xx18) - xx20) + t4;
        z[9] = (int) cc10;
        long cc11 = (cc10 >> 32) + ((((xx[10] & M) + xx18) + xx19) - t5) + t6;
        z[10] = (int) cc11;
        long cc12 = (cc11 >> 32) + ((((xx[11] & M) + xx19) + xx20) - t6);
        z[11] = (int) cc12;
    ...
    public static void reduce32(int x, int[] z) {
        ...
        if (x != 0) {
            long xx12 = x & M;
            long cc2 = 0 + (z[0] & M) + xx12;
            z[0] = (int) cc2;
            long cc3 = (cc2 >> 32) + ((z[1] & M) - xx12);
            z[1] = (int) cc3;
            long cc4 = cc3 >> 32;
            if (cc4 != 0) {
                long cc5 = cc4 + (z[2] & M);
            ...
            long cc6 = cc4 + (z[3] & M) + xx12;
            z[3] = (int) cc6;
            long cc7 = (cc6 >> 32) + (z[4] & M) + xx12;
            z[4] = (int) cc7;
            cc = cc7 >> 32;
        }
