...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/raw/Nat128.class */
public abstract class Nat128 {
    ...
    public static void mul(int[] x, int[] y, int[] zz) {
        ...
        for (int i = 1; i < 4; i++) {
            long x_i = x[i] & M;
            long c5 = 0 + (x_i * y_0) + (zz[i + 0] & M);
            zz[i + 0] = (int) c5;
            long c6 = (c5 >>> 32) + (x_i * y_1) + (zz[i + 1] & M);
            zz[i + 1] = (int) c6;
            long c7 = (c6 >>> 32) + (x_i * y_2) + (zz[i + 2] & M);
            zz[i + 2] = (int) c7;
            long c8 = (c7 >>> 32) + (x_i * y_3) + (zz[i + 3] & M);
            zz[i + 3] = (int) c8;
            zz[i + 4] = (int) (c8 >>> 32);
        }
    }
    ...
    public static void mul(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 1; i < 4; i++) {
            zzOff++;
            long x_i = x[xOff + i] & M;
            long c5 = 0 + (x_i * y_0) + (zz[zzOff + 0] & M);
            zz[zzOff + 0] = (int) c5;
            long c6 = (c5 >>> 32) + (x_i * y_1) + (zz[zzOff + 1] & M);
            zz[zzOff + 1] = (int) c6;
            long c7 = (c6 >>> 32) + (x_i * y_2) + (zz[zzOff + 2] & M);
            zz[zzOff + 2] = (int) c7;
            long c8 = (c7 >>> 32) + (x_i * y_3) + (zz[zzOff + 3] & M);
            zz[zzOff + 3] = (int) c8;
    ...
    public static void square(int[] x, int xOff, int[] zz, int zzOff) {
        ...
        zz[zzOff + 6] = (w6 << 1) | c7;
        int c8 = w6 >>> 31;
        zz[zzOff + 7] = ((zz[zzOff + 7] + ((int) (zz_62 >> 32))) << 1) | c8;
    }
