...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecT163R2Point.class */
public class SecT163R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twicePlus(ECPoint b) {
        ...
        if (A.isZero()) {
            return new SecT163R2Point(curve, A, curve.getB().sqrt(), this.withCompression);
        }
