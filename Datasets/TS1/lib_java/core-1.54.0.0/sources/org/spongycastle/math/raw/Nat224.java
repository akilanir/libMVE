...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/raw/Nat224.class */
public abstract class Nat224 {
    ...
    public static void mul(int[] x, int[] y, int[] zz) {
        ...
        for (int i = 1; i < 7; i++) {
            long x_i = x[i] & M;
            long c8 = 0 + (x_i * y_0) + (zz[i + 0] & M);
            zz[i + 0] = (int) c8;
            long c9 = (c8 >>> 32) + (x_i * y_1) + (zz[i + 1] & M);
            zz[i + 1] = (int) c9;
            long c10 = (c9 >>> 32) + (x_i * y_2) + (zz[i + 2] & M);
            zz[i + 2] = (int) c10;
            long c11 = (c10 >>> 32) + (x_i * y_3) + (zz[i + 3] & M);
            zz[i + 3] = (int) c11;
            long c12 = (c11 >>> 32) + (x_i * y_4) + (zz[i + 4] & M);
            zz[i + 4] = (int) c12;
            long c13 = (c12 >>> 32) + (x_i * y_5) + (zz[i + 5] & M);
            zz[i + 5] = (int) c13;
            long c14 = (c13 >>> 32) + (x_i * y_6) + (zz[i + 6] & M);
            zz[i + 6] = (int) c14;
            zz[i + 7] = (int) (c14 >>> 32);
        }
    }
    ...
    public static void mul(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        for (int i = 1; i < 7; i++) {
            zzOff++;
            long x_i = x[xOff + i] & M;
            long c8 = 0 + (x_i * y_0) + (zz[zzOff + 0] & M);
            zz[zzOff + 0] = (int) c8;
            long c9 = (c8 >>> 32) + (x_i * y_1) + (zz[zzOff + 1] & M);
            zz[zzOff + 1] = (int) c9;
            long c10 = (c9 >>> 32) + (x_i * y_2) + (zz[zzOff + 2] & M);
            zz[zzOff + 2] = (int) c10;
            long c11 = (c10 >>> 32) + (x_i * y_3) + (zz[zzOff + 3] & M);
            zz[zzOff + 3] = (int) c11;
            long c12 = (c11 >>> 32) + (x_i * y_4) + (zz[zzOff + 4] & M);
            zz[zzOff + 4] = (int) c12;
            long c13 = (c12 >>> 32) + (x_i * y_5) + (zz[zzOff + 5] & M);
            zz[zzOff + 5] = (int) c13;
            long c14 = (c13 >>> 32) + (x_i * y_6) + (zz[zzOff + 6] & M);
            zz[zzOff + 6] = (int) c14;
