...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/raw/Nat.class */
public abstract class Nat {
    ...
    public static int add33At(int len, int x, int[] z, int zOff, int zPos) {
        ...
        z[zOff + zPos] = (int) c;
        long c2 = (c >>> 32) + (z[zOff + zPos + 1] & M) + 1;
    ...
    public static int addBothTo(int len, int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            long c2 = c + (x[xOff + i] & M) + (y[yOff + i] & M) + (z[zOff + i] & M);
            z[zOff + i] = (int) c2;
            c = c2 >>> 32;
        }
        return (int) c;
    ...
    public static int addDWordAt(int len, long x, int[] z, int zOff, int zPos) {
        long c = (z[zOff + zPos] & M) + (x & M);
        z[zOff + zPos] = (int) c;
        long c2 = (c >>> 32) + (z[zOff + zPos + 1] & M) + (x >>> 32);
        z[zOff + zPos + 1] = (int) c2;
        if ((c2 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addTo(int len, int[] x, int xOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            long c2 = c + (x[xOff + i] & M) + (z[zOff + i] & M);
            z[zOff + i] = (int) c2;
            c = c2 >>> 32;
        }
        return (int) c;
    ...
    public static int mulAddTo(int len, int[] x, int[] y, int[] zz) {
        long zc = 0;
        for (int i = 0; i < len; i++) {
            long c = (mulWordAddTo(len, x[i], y, 0, zz, i) & M) + zc + (zz[i + len] & M);
            zz[i + len] = (int) c;
            zc = c >>> 32;
        }
        return (int) zc;
    ...
    public static int mulAddTo(int len, int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        long zc = 0;
        for (int i = 0; i < len; i++) {
            long c = (mulWordAddTo(len, x[xOff + i], y, yOff, zz, zzOff) & M) + zc + (zz[zzOff + len] & M);
            zz[zzOff + len] = (int) c;
            zc = c >>> 32;
            zzOff++;
        }
    ...
    public static int mul31BothAdd(int len, int a, int[] x, int b, int[] y, int[] z, int zOff) {
        ...
        int i = 0;
        do {
            long c2 = c + (aVal * (x[i] & M)) + (bVal * (y[i] & M)) + (z[zOff + i] & M);
            z[zOff + i] = (int) c2;
            c = c2 >>> 32;
            i++;
        } while (i < len);
    ...
    public static int mulWordAddTo(int len, int x, int[] y, int yOff, int[] z, int zOff) {
        ...
        int i = 0;
        do {
            long c2 = c + (xVal * (y[yOff + i] & M)) + (z[zOff + i] & M);
            z[zOff + i] = (int) c2;
            c = c2 >>> 32;
            i++;
        } while (i < len);
    ...
    public static int mulWordDwordAddAt(int len, int x, long y, int[] z, int zPos) {
        long xVal = x & M;
        long c = 0 + (xVal * (y & M)) + (z[zPos + 0] & M);
        z[zPos + 0] = (int) c;
        long c2 = (c >>> 32) + (xVal * (y >>> 32)) + (z[zPos + 1] & M);
        z[zPos + 1] = (int) c2;
        long c3 = (c2 >>> 32) + (z[zPos + 2] & M);
        z[zPos + 2] = (int) c3;
        if ((c3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int squareWordAdd(int[] x, int xPos, int[] z) {
        ...
        int i = 0;
        do {
            long c2 = c + (xVal * (x[i] & M)) + (z[xPos + i] & M);
            z[xPos + i] = (int) c2;
            c = c2 >>> 32;
            i++;
        } while (i < xPos);
    ...
    public static int squareWordAdd(int[] x, int xOff, int xPos, int[] z, int zOff) {
        ...
        int i = 0;
        do {
            long c2 = c + (xVal * (x[xOff + i] & M)) + (z[xPos + zOff] & M);
            z[xPos + zOff] = (int) c2;
            c = c2 >>> 32;
            zOff++;
            i++;
    ...
    public static int sub(int len, int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            long c2 = c + ((x[xOff + i] & M) - (y[yOff + i] & M));
            z[zOff + i] = (int) c2;
            c = c2 >> 32;
        }
        return (int) c;
    ...
    public static int subBothFrom(int len, int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            long c2 = c + (((z[zOff + i] & M) - (x[xOff + i] & M)) - (y[yOff + i] & M));
            z[zOff + i] = (int) c2;
            c = c2 >> 32;
        }
        return (int) c;
    ...
    public static int subFrom(int len, int[] x, int xOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            long c2 = c + ((z[zOff + i] & M) - (x[xOff + i] & M));
            z[zOff + i] = (int) c2;
            c = c2 >> 32;
        }
        return (int) c;
