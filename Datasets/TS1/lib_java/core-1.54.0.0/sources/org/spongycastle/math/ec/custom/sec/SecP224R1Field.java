...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecP224R1Field.class */
public class SecP224R1Field {
    ...
    public static void reduce(int[] xx, int[] z) {
        ...
        z[1] = (int) cc2;
        long cc3 = (cc2 >> 32) + ((xx[2] & M) - t2);
        z[2] = (int) cc3;
        long cc4 = (cc3 >> 32) + (((xx[3] & M) + t0) - xx10);
        long z3 = cc4 & M;
        long cc5 = (cc4 >> 32) + (((xx[4] & M) + t1) - xx11);
        z[4] = (int) cc5;
        long cc6 = (cc5 >> 32) + (((xx[5] & M) + t2) - xx12);
        z[5] = (int) cc6;
        long cc7 = (cc6 >> 32) + (((xx[6] & M) + xx10) - xx13);
        z[6] = (int) cc7;
        long cc8 = (cc7 >> 32) + 1;
        long z32 = z3 + cc8;
        long z02 = z0 - cc8;
