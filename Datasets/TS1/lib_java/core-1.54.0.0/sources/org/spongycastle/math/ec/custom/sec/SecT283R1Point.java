...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecT283R1Point.class */
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twicePlus(ECPoint b) {
        ...
        if (A.isZero()) {
            return new SecT283R1Point(curve, A, curve.getB().sqrt(), this.withCompression);
        }
