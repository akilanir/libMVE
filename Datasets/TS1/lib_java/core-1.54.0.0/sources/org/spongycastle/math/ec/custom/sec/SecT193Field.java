...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecT193Field.class */
public class SecT193Field {
    ...
    public static void reduce(long[] xx, long[] z) {
        ...
        long x42 = x4 ^ (x6 >>> 50);
        long x12 = x1 ^ (x5 << 63);
        long x23 = x22 ^ ((x5 >>> M01) ^ (x5 << 14));
        long x33 = x32 ^ (x5 >>> 50);
        long x02 = x0 ^ (x42 << 63);
        long x13 = x12 ^ ((x42 >>> M01) ^ (x42 << 14));
        long x24 = x23 ^ (x42 >>> 50);
        long t = x33 >>> M01;
        z[0] = (x02 ^ t) ^ (t << 15);
        z[1] = x13 ^ (t >>> 49);
    ...
    public static void sqrt(long[] x, long[] z) {
        ...
        long e1 = (u02 & 4294967295L) ^ (x[3] << 32);
        long c1 = u02 >>> 32;
        z[0] = e0 ^ (c0 << 8);
