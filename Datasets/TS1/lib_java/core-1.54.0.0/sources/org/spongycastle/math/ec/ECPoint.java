...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/ECPoint.class */
public abstract class ECPoint {
    ...
    public boolean isValid() {
        ...
        if (curve != null) {
            if (!satisfiesCurveEquation() || !satisfiesCofactor()) {
                return false;
            }
            return true;
        }
    ...
    public int hashCode() {
        ECCurve c = getCurve();
        int hc = null == c ? 0 : c.hashCode() ^ (-1);
        if (!isInfinity()) {
            ECPoint p = normalize();
            hc = (hc ^ (p.getXCoord().hashCode() * 17)) ^ (p.getYCoord().hashCode() * 257);
        }
        return hc;
    }
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/ECPoint$AbstractFp.class */
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/ECPoint$Fp.class */
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/ECPoint$AbstractF2m.class */
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/ECPoint$F2m.class */
