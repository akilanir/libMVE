...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecT113Field.class */
public class SecT113Field {
    ...
    public static void reduce(long[] xx, long[] z) {
        ...
        long x2 = xx[2];
        long x3 = xx[3];
        long x12 = x1 ^ ((x3 << 15) ^ (x3 << 24));
        long x22 = x2 ^ ((x3 >>> 49) ^ (x3 >>> 40));
        long x02 = x0 ^ ((x22 << 15) ^ (x22 << 24));
        long x13 = x12 ^ ((x22 >>> 49) ^ (x22 >>> 40));
        long t = x13 >>> 49;
        z[0] = (x02 ^ t) ^ (t << 9);
        z[1] = x13 & M49;
    }
