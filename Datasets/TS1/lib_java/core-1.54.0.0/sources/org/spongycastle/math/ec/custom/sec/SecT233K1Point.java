...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/math/ec/custom/sec/SecT233K1Point.class */
public class SecT233K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twicePlus(ECPoint b) {
        ...
        if (A.isZero()) {
            return new SecT233K1Point(curve, A, curve.getB(), this.withCompression);
        }
