...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/digests/SHA1Digest.class */
public class SHA1Digest extends GeneralDigest implements EncodableDigest {
    ...
    protected void processBlock() {
        ...
        for (int j = 0; j < 4; j++) {
            int i2 = idx;
            int idx2 = idx + 1;
            int E2 = E + ((A << 5) | (A >>> 27)) + f(B, C, D) + this.X[i2] + Y1;
            int B2 = (B << 30) | (B >>> 2);
            int idx3 = idx2 + 1;
        ...
        for (int j2 = 0; j2 < 4; j2++) {
            int i3 = idx;
            int idx6 = idx + 1;
            int E3 = E + ((A << 5) | (A >>> 27)) + h(B, C, D) + this.X[i3] + Y2;
            int B3 = (B << 30) | (B >>> 2);
            int idx7 = idx6 + 1;
        ...
        for (int j3 = 0; j3 < 4; j3++) {
            int i4 = idx;
            int idx10 = idx + 1;
            int E4 = E + ((A << 5) | (A >>> 27)) + g(B, C, D) + this.X[i4] + Y3;
            int B4 = (B << 30) | (B >>> 2);
            int idx11 = idx10 + 1;
        ...
        for (int j4 = 0; j4 <= 3; j4++) {
            int i5 = idx;
            int idx14 = idx + 1;
            int E5 = E + ((A << 5) | (A >>> 27)) + h(B, C, D) + this.X[i5] + Y4;
            int B5 = (B << 30) | (B >>> 2);
            int idx15 = idx14 + 1;
