...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/engines/RC2Engine.class */
public class RC2Engine implements BlockCipher {
    ...
    private int[] generateWorkingKey(byte[] key, int bits) {
        ...
        int len2 = (bits + 7) >> 3;
        int x2 = piTable[xKey[128 - len2] & (255 >> (7 & (-bits)))] & 255;
        xKey[128 - len2] = x2;
        for (int i4 = (128 - len2) - 1; i4 >= 0; i4--) {
            x2 = piTable[x2 ^ xKey[i4 + len2]] & 255;
            xKey[i4] = x2;
        }
        int[] newKey = new int[64];
        for (int i5 = 0; i5 != newKey.length; i5++) {
            newKey[i5] = xKey[2 * i5] + (xKey[(2 * i5) + 1] << 8);
        }
        return newKey;
    }
    ...
    private void encryptBlock(byte[] in, int inOff, byte[] out, int outOff) {
        ...
        for (int i = 0; i <= 16; i += 4) {
            x10 = rotateWordLeft(x10 + (x32 & (x76 ^ (-1))) + (x54 & x76) + this.workingKey[i], 1);
            x32 = rotateWordLeft(x32 + (x54 & (x10 ^ (-1))) + (x76 & x10) + this.workingKey[i + 1], 2);
            x54 = rotateWordLeft(x54 + (x76 & (x32 ^ (-1))) + (x10 & x32) + this.workingKey[i + 2], 3);
            x76 = rotateWordLeft(x76 + (x10 & (x54 ^ (-1))) + (x32 & x54) + this.workingKey[i + 3], 5);
        }
        ...
        for (int i2 = 20; i2 <= 40; i2 += 4) {
            x102 = rotateWordLeft(x102 + (x322 & (x762 ^ (-1))) + (x542 & x762) + this.workingKey[i2], 1);
            x322 = rotateWordLeft(x322 + (x542 & (x102 ^ (-1))) + (x762 & x102) + this.workingKey[i2 + 1], 2);
            x542 = rotateWordLeft(x542 + (x762 & (x322 ^ (-1))) + (x102 & x322) + this.workingKey[i2 + 2], 3);
            x762 = rotateWordLeft(x762 + (x102 & (x542 ^ (-1))) + (x322 & x542) + this.workingKey[i2 + 3], 5);
        }
        ...
        for (int i3 = 44; i3 < 64; i3 += 4) {
            x103 = rotateWordLeft(x103 + (x323 & (x763 ^ (-1))) + (x543 & x763) + this.workingKey[i3], 1);
            x323 = rotateWordLeft(x323 + (x543 & (x103 ^ (-1))) + (x763 & x103) + this.workingKey[i3 + 1], 2);
            x543 = rotateWordLeft(x543 + (x763 & (x323 ^ (-1))) + (x103 & x323) + this.workingKey[i3 + 2], 3);
            x763 = rotateWordLeft(x763 + (x103 & (x543 ^ (-1))) + (x323 & x543) + this.workingKey[i3 + 3], 5);
        }
    ...
    private void decryptBlock(byte[] in, int inOff, byte[] out, int outOff) {
        ...
        for (int i = 60; i >= 44; i -= 4) {
            x76 = rotateWordLeft(x76, 11) - (((x10 & (x54 ^ (-1))) + (x32 & x54)) + this.workingKey[i + 3]);
            x54 = rotateWordLeft(x54, 13) - (((x76 & (x32 ^ (-1))) + (x10 & x32)) + this.workingKey[i + 2]);
            x32 = rotateWordLeft(x32, 14) - (((x54 & (x10 ^ (-1))) + (x76 & x10)) + this.workingKey[i + 1]);
            x10 = rotateWordLeft(x10, 15) - (((x32 & (x76 ^ (-1))) + (x54 & x76)) + this.workingKey[i]);
        }
        ...
        for (int i2 = 40; i2 >= 20; i2 -= 4) {
            x762 = rotateWordLeft(x762, 11) - (((x102 & (x542 ^ (-1))) + (x322 & x542)) + this.workingKey[i2 + 3]);
            x542 = rotateWordLeft(x542, 13) - (((x762 & (x322 ^ (-1))) + (x102 & x322)) + this.workingKey[i2 + 2]);
            x322 = rotateWordLeft(x322, 14) - (((x542 & (x102 ^ (-1))) + (x762 & x102)) + this.workingKey[i2 + 1]);
            x102 = rotateWordLeft(x102, 15) - (((x322 & (x762 ^ (-1))) + (x542 & x762)) + this.workingKey[i2]);
        }
        ...
        for (int i3 = 16; i3 >= 0; i3 -= 4) {
            x763 = rotateWordLeft(x763, 11) - (((x103 & (x543 ^ (-1))) + (x323 & x543)) + this.workingKey[i3 + 3]);
            x543 = rotateWordLeft(x543, 13) - (((x763 & (x323 ^ (-1))) + (x103 & x323)) + this.workingKey[i3 + 2]);
            x323 = rotateWordLeft(x323, 14) - (((x543 & (x103 ^ (-1))) + (x763 & x103)) + this.workingKey[i3 + 1]);
            x103 = rotateWordLeft(x103, 15) - (((x323 & (x763 ^ (-1))) + (x543 & x763)) + this.workingKey[i3]);
        }
        out[outOff + 0] = (byte) x103;
        out[outOff + 1] = (byte) (x103 >> 8);
        out[outOff + 2] = (byte) x323;
