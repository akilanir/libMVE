...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/engines/Salsa20Engine.class */
public class Salsa20Engine implements SkippingStreamCipher {
    ...
    protected void retreatCounter(long diff) {
        ...
        int lo = (int) diff;
        if (hi != 0) {
            if ((this.engineState[9] & 4294967295L) >= (hi & 4294967295L)) {
                int[] iArr = this.engineState;
                iArr[9] = iArr[9] - hi;
            } else {
        ...
        if ((this.engineState[8] & 4294967295L) >= (lo & 4294967295L)) {
            int[] iArr2 = this.engineState;
            iArr2[8] = iArr2[8] - lo;
        } else {
