...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/engines/ChaChaEngine.class */
public class ChaChaEngine extends Salsa20Engine {
    ...
    protected void retreatCounter(long diff) {
        ...
        int lo = (int) diff;
        if (hi != 0) {
            if ((this.engineState[13] & 4294967295L) >= (hi & 4294967295L)) {
                int[] iArr = this.engineState;
                iArr[13] = iArr[13] - hi;
            } else {
        ...
        if ((this.engineState[12] & 4294967295L) >= (lo & 4294967295L)) {
            int[] iArr2 = this.engineState;
            iArr2[12] = iArr2[12] - lo;
        } else {
