...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/digests/LongDigest.class */
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    protected void processBlock() {
        ...
        int t2 = 0;
        for (int i = 0; i < 10; i++) {
            long Sum1 = Sum1(e) + Ch(e, f, g) + K[t2];
            int i2 = t2;
            int t3 = t2 + 1;
            long h2 = h + Sum1 + this.W[i2];
            long d2 = d + h2;
            long h3 = h2 + Sum0(a) + Maj(a, b, c);
            long Sum12 = Sum1(d2) + Ch(d2, e, f) + K[t3];
            int t4 = t3 + 1;
            long g2 = g + Sum12 + this.W[t3];
            long c2 = c + g2;
            long g3 = g2 + Sum0(h3) + Maj(h3, a, b);
            long Sum13 = Sum1(c2) + Ch(c2, d2, e) + K[t4];
            int t5 = t4 + 1;
            long f2 = f + Sum13 + this.W[t4];
            long b2 = b + f2;
            long f3 = f2 + Sum0(g3) + Maj(g3, h3, a);
            long Sum14 = Sum1(b2) + Ch(b2, c2, d2) + K[t5];
            int t6 = t5 + 1;
            long e2 = e + Sum14 + this.W[t5];
            long a2 = a + e2;
            long e3 = e2 + Sum0(f3) + Maj(f3, g3, h3);
            long Sum15 = Sum1(a2) + Ch(a2, b2, c2) + K[t6];
            int t7 = t6 + 1;
            long d3 = d2 + Sum15 + this.W[t6];
            h = h3 + d3;
            d = d3 + Sum0(e3) + Maj(e3, f3, g3);
            long Sum16 = Sum1(h) + Ch(h, a2, b2) + K[t7];
            int t8 = t7 + 1;
            long c3 = c2 + Sum16 + this.W[t7];
            g = g3 + c3;
            c = c3 + Sum0(d) + Maj(d, e3, f3);
            long Sum17 = Sum1(g) + Ch(g, h, a2) + K[t8];
            int t9 = t8 + 1;
            long b3 = b2 + Sum17 + this.W[t8];
            f = f3 + b3;
            b = b3 + Sum0(c) + Maj(c, d, e3);
            long Sum18 = Sum1(f) + Ch(f, g, h) + K[t9];
            t2 = t9 + 1;
            long a3 = a2 + Sum18 + this.W[t9];
            e = e3 + a3;
