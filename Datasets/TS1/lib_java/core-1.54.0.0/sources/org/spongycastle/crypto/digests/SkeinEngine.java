...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/digests/SkeinEngine.class */
public class SkeinEngine implements Memoable {
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/digests/SkeinEngine$Configuration.class */
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/digests/SkeinEngine$Parameter.class */
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/digests/SkeinEngine$UbiTweak.class */
    private static class UbiTweak {
        ...
        public void setType(int type) {
            this.tweak[1] = (this.tweak[1] & (-274877906944L)) | ((type & 63) << 56);
        }
        ...
        public void advancePosition(int advance) {
            if (this.extendedPosition) {
                ...
                parts[0] = this.tweak[0] & 4294967295L;
                parts[1] = (this.tweak[0] >>> 32) & 4294967295L;
                parts[2] = this.tweak[1] & 4294967295L;
                long carry = advance;
            ...
            long position = this.tweak[0] + advance;
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/digests/SkeinEngine$UBI.class */
    private class UBI {
        ...
        private void processBlock(long[] output) {
            ...
            for (int i2 = 0; i2 < output.length; i2++) {
                int i3 = i2;
                output[i3] = output[i3] ^ this.message[i2];
            }
        }
    ...
    private static void sort(Parameter[] params) {
        ...
        for (int i = 1; i < params.length; i++) {
            ...
            while (true) {
                hole = i2;
                if (hole <= 0 || param.getType() >= params[hole - 1].getType()) {
                    break;
                }
    ...
    public int doFinal(byte[] out, int outOff) {
        ...
        for (int i2 = 0; i2 < blocksRequired; i2++) {
            int toWrite = Math.min(blockSize, this.outputSizeBytes - (i2 * blockSize));
            output(i2, out, outOff + (i2 * blockSize), toWrite);
        }
        reset();
        return this.outputSizeBytes;
    }
