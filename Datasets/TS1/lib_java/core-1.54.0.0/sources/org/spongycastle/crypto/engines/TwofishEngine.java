...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/engines/TwofishEngine.class */
public final class TwofishEngine implements BlockCipher {
    ...
    private void encryptBlock(byte[] src, int srcIndex, byte[] dst, int dstIndex) {
        ...
        for (int r = 0; r < 16; r += 2) {
            ...
            int i = k;
            int k2 = k + 1;
            int x22 = x2 ^ ((t0 + t1) + this.gSubKeys[i]);
            x2 = (x22 >>> 1) | (x22 << 31);
            int k3 = k2 + 1;
            x3 = ((x3 << 1) | (x3 >>> 31)) ^ ((t0 + (2 * t1)) + this.gSubKeys[k2]);
            int t02 = Fe32_0(x2);
            int t12 = Fe32_3(x3);
            int k4 = k3 + 1;
            ...
            x0 = (x02 >>> 1) | (x02 << 31);
            k = k4 + 1;
            x1 = ((x1 << 1) | (x1 >>> 31)) ^ ((t02 + (2 * t12)) + this.gSubKeys[k4]);
        }
        Bits32ToBytes(x2 ^ this.gSubKeys[4], dst, dstIndex);
        Bits32ToBytes(x3 ^ this.gSubKeys[5], dst, dstIndex + 4);
        Bits32ToBytes(x0 ^ this.gSubKeys[6], dst, dstIndex + 8);
        Bits32ToBytes(x1 ^ this.gSubKeys[7], dst, dstIndex + 12);
    }
    ...
    private void decryptBlock(byte[] src, int srcIndex, byte[] dst, int dstIndex) {
        ...
        for (int r = 0; r < 16; r += 2) {
            ...
            int i = k;
            int k2 = k - 1;
            int x12 = x1 ^ ((t0 + (2 * t1)) + this.gSubKeys[i]);
            int k3 = k2 - 1;
            ...
            int t12 = Fe32_3(x1);
            int k4 = k3 - 1;
            int x32 = x3 ^ ((t02 + (2 * t12)) + this.gSubKeys[k3]);
            k = k4 - 1;
            x2 = ((x2 << 1) | (x2 >>> 31)) ^ ((t02 + t12) + this.gSubKeys[k4]);
            x3 = (x32 >>> 1) | (x32 << 31);
        }
        Bits32ToBytes(x0 ^ this.gSubKeys[0], dst, dstIndex);
        Bits32ToBytes(x1 ^ this.gSubKeys[1], dst, dstIndex + 4);
        Bits32ToBytes(x2 ^ this.gSubKeys[2], dst, dstIndex + 8);
        Bits32ToBytes(x3 ^ this.gSubKeys[3], dst, dstIndex + 12);
    }
    ...
    private int F32(int x, int[] k32) {
        ...
        switch (this.k64Cnt & 3) {
            case 0:
                ...
                b2 = (P[0][b2] & 255) ^ b2(k2);
                b3 = (P[0][b3] & 255) ^ b3(k2);
                result = ((this.gMDS0[(P[0][(P[0][b0] & 255) ^ b0(k1)] & 255) ^ b0(k0)] ^ this.gMDS1[(P[0][(P[1][b1] & 255) ^ b1(k1)] & 255) ^ b1(k0)]) ^ this.gMDS2[(P[1][(P[0][b2] & 255) ^ b2(k1)] & 255) ^ b2(k0)]) ^ this.gMDS3[(P[1][(P[1][b3] & 255) ^ b3(k1)] & 255) ^ b3(k0)];
                break;
            case 1:
                result = ((this.gMDS0[(P[0][b0] & 255) ^ b0(k0)] ^ this.gMDS1[(P[0][b1] & 255) ^ b1(k0)]) ^ this.gMDS2[(P[1][b2] & 255) ^ b2(k0)]) ^ this.gMDS3[(P[1][b3] & 255) ^ b3(k0)];
                break;
            case 2:
                result = ((this.gMDS0[(P[0][(P[0][b0] & 255) ^ b0(k1)] & 255) ^ b0(k0)] ^ this.gMDS1[(P[0][(P[1][b1] & 255) ^ b1(k1)] & 255) ^ b1(k0)]) ^ this.gMDS2[(P[1][(P[0][b2] & 255) ^ b2(k1)] & 255) ^ b2(k0)]) ^ this.gMDS3[(P[1][(P[1][b3] & 255) ^ b3(k1)] & 255) ^ b3(k0)];
                break;
    ...
    private int RS_rem(int x) {
        ...
        int g3 = ((b >>> 1) ^ ((b & 1) != 0 ? CipherSuite.TLS_DH_anon_WITH_AES_128_GCM_SHA256 : 0)) ^ g2;
    ...
    private int Fe32_0(int x) {
        return ((this.gSBox[0 + (2 * (x & 255))] ^ this.gSBox[1 + (2 * ((x >>> 8) & 255))]) ^ this.gSBox[512 + (2 * ((x >>> 16) & 255))]) ^ this.gSBox[513 + (2 * ((x >>> 24) & 255))];
    }

    private int Fe32_3(int x) {
        return ((this.gSBox[0 + (2 * ((x >>> 24) & 255))] ^ this.gSBox[1 + (2 * (x & 255))]) ^ this.gSBox[512 + (2 * ((x >>> 8) & 255))]) ^ this.gSBox[513 + (2 * ((x >>> 16) & 255))];
    }
