...
/* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/engines/ThreefishEngine.class */
public class ThreefishEngine implements BlockCipher {
    ...
    public static long bytesToWord(byte[] bytes, int off) {
        ...
        int index = off + 1;
        long word = bytes[off] & 255;
        long word2 = word | ((bytes[index] & 255) << 8);
        long word3 = word2 | ((bytes[r11] & 255) << 16);
        long word4 = word3 | ((bytes[r11] & 255) << 24);
        long word5 = word4 | ((bytes[r11] & 255) << 32);
        long word6 = word5 | ((bytes[r11] & 255) << 40);
        long word7 = word6 | ((bytes[r11] & 255) << 48);
        int i = index + 1 + 1 + 1 + 1 + 1 + 1 + 1;
        return word7 | ((bytes[r11] & 255) << 56);
    }
    ...
    public static void wordToBytes(long word, byte[] bytes, int off) {
        ...
        int index3 = index2 + 1;
        bytes[index2] = (byte) (word >> 16);
        int index4 = index3 + 1;
        bytes[index3] = (byte) (word >> 24);
        int index5 = index4 + 1;
        bytes[index4] = (byte) (word >> 32);
        int index6 = index5 + 1;
        bytes[index5] = (byte) (word >> 40);
        int index7 = index6 + 1;
        bytes[index6] = (byte) (word >> 48);
        int i = index7 + 1;
        bytes[index7] = (byte) (word >> 56);
    }
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/engines/ThreefishEngine$ThreefishCipher.class */
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/engines/ThreefishEngine$Threefish256Cipher.class */
    private static final class Threefish256Cipher extends ThreefishCipher {
        ...
        void encryptBlock(long[] block, long[] out) {
            ...
            for (int d = 1; d < 18; d += 2) {
                ...
                int dm3 = mod3[d];
                long b03 = b12;
                long b13 = ThreefishEngine.rotlXor(b03, 14, b02 + b12);
                long b23 = b22 + b32;
                long b33 = ThreefishEngine.rotlXor(b32, 16, b23);
                long b04 = b03 + b33;
                long b34 = ThreefishEngine.rotlXor(b33, 52, b04);
                long b24 = b23 + b13;
                ...
                long b26 = b25 + b15;
                long b16 = ThreefishEngine.rotlXor(b15, 37, b26);
                long b07 = b06 + kw[dm5];
                long b17 = b16 + kw[dm5 + 1] + t[dm3];
                long b27 = b26 + kw[dm5 + 2] + t[dm3 + 1];
                long b37 = b36 + kw[dm5 + 3] + d;
                long b08 = b07 + b17;
                long b18 = ThreefishEngine.rotlXor(b17, 25, b08);
                long b28 = b27 + b37;
                long b38 = ThreefishEngine.rotlXor(b37, 33, b28);
                long b09 = b08 + b38;
                long b39 = ThreefishEngine.rotlXor(b38, 46, b09);
                long b29 = b28 + b18;
                long b19 = ThreefishEngine.rotlXor(b18, 12, b29);
                long b010 = b09 + b19;
                long b110 = ThreefishEngine.rotlXor(b19, 58, b010);
                long b210 = b29 + b39;
        ...
        void decryptBlock(long[] block, long[] state) {
            ...
            for (int d = 17; d >= 1; d -= 2) {
                ...
                long b32 = ThreefishEngine.xorRotr(b3 - ((kw[dm5 + 4] + d) + 1), 32, b02);
                long b03 = b02 - b32;
                ...
                long b17 = b16 - (kw[dm5 + 1] + t[dm3]);
                long b27 = b26 - (kw[dm5 + 2] + t[dm3 + 1]);
                long b36 = ThreefishEngine.xorRotr(b35 - (kw[dm5 + 3] + d), 5, b07);
                long b08 = b07 - b36;
                long b18 = ThreefishEngine.xorRotr(b17, 37, b27);
                long b28 = b27 - b18;
                long b19 = ThreefishEngine.xorRotr(b18, 23, b08);
                long b09 = b08 - b19;
                long b37 = ThreefishEngine.xorRotr(b36, 40, b28);
                long b29 = b28 - b37;
                long b38 = ThreefishEngine.xorRotr(b37, 52, b09);
                long b010 = b09 - b38;
                long b110 = ThreefishEngine.xorRotr(b19, 57, b29);
                long b210 = b29 - b110;
                b1 = ThreefishEngine.xorRotr(b110, 14, b010);
                b0 = b010 - b1;
                b3 = ThreefishEngine.xorRotr(b38, 16, b210);
                b2 = b210 - b3;
            }
            long b011 = b0 - kw[0];
            long b111 = b1 - (kw[1] + t[0]);
            long b211 = b2 - (kw[2] + t[1]);
            long b39 = b3 - kw[3];
            state[0] = b011;
            state[1] = b111;
            state[2] = b211;
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/engines/ThreefishEngine$Threefish512Cipher.class */
    private static final class Threefish512Cipher extends ThreefishCipher {
        ...
        public void encryptBlock(long[] block, long[] out) {
            ...
            for (int d = 1; d < 18; d += 2) {
                ...
                int dm3 = mod3[d];
                long b03 = b12;
                long b13 = ThreefishEngine.rotlXor(b03, 46, b02 + b12);
                long b23 = b22 + b32;
                long b33 = ThreefishEngine.rotlXor(b32, 36, b23);
                long b43 = b42 + b52;
                long b53 = ThreefishEngine.rotlXor(b52, 19, b43);
                long b63 = b62 + b72;
                long b73 = ThreefishEngine.rotlXor(b72, 37, b63);
                long b24 = b23 + b13;
                ...
                long b610 = b69 + b39;
                long b310 = ThreefishEngine.rotlXor(b39, ROTATION_6_1, b610);
                long b010 = b09 + b59;
                long b510 = ThreefishEngine.rotlXor(b59, 39, b010);
                long b210 = b29 + b79;
                long b710 = ThreefishEngine.rotlXor(b79, 43, b210);
                long b611 = b610 + b110;
                long b111 = ThreefishEngine.rotlXor(b110, 8, b611);
                long b011 = b010 + b710;
                long b711 = ThreefishEngine.rotlXor(b710, 35, b011);
                long b211 = b210 + b510;
        ...
        public void decryptBlock(long[] block, long[] state) {
            ...
            for (int d = 17; d >= 1; d -= 2) {
                ...
                long b44 = b43 - b14;
                long b34 = ThreefishEngine.xorRotr(b33, ROTATION_6_1, b63);
                long b64 = b63 - b34;
                ...
                long b67 = b66 - (kw[dm9 + 6] + t[dm3 + 1]);
                long b77 = b76 - (kw[dm9 + 7] + d);
                long b18 = ThreefishEngine.xorRotr(b17, 44, b67);
                long b68 = b67 - b18;
                ...
                long b48 = b47 - b38;
                long b19 = ThreefishEngine.xorRotr(b18, 17, b48);
                long b49 = b48 - b19;
                long b39 = ThreefishEngine.xorRotr(b38, 49, b68);
                long b69 = b68 - b39;
                long b59 = ThreefishEngine.xorRotr(b58, 36, b08);
                long b09 = b08 - b59;
                long b79 = ThreefishEngine.xorRotr(b78, 39, b28);
                long b29 = b28 - b79;
                long b110 = ThreefishEngine.xorRotr(b19, 33, b29);
                long b210 = b29 - b110;
                long b710 = ThreefishEngine.xorRotr(b79, 27, b49);
                long b410 = b49 - b710;
                long b510 = ThreefishEngine.xorRotr(b59, 14, b69);
                long b610 = b69 - b510;
                long b310 = ThreefishEngine.xorRotr(b39, 42, b09);
                long b010 = b09 - b310;
                b1 = ThreefishEngine.xorRotr(b110, 46, b010);
                b0 = b010 - b1;
                b3 = ThreefishEngine.xorRotr(b310, 36, b210);
                b2 = b210 - b3;
                b5 = ThreefishEngine.xorRotr(b510, 19, b410);
                b4 = b410 - b5;
                b7 = ThreefishEngine.xorRotr(b710, 37, b610);
                b6 = b610 - b7;
            }
            long b011 = b0 - kw[0];
            long b111 = b1 - kw[1];
    ...
    /* loaded from: core-1.54.0.0.jar:org/spongycastle/crypto/engines/ThreefishEngine$Threefish1024Cipher.class */
    private static final class Threefish1024Cipher extends ThreefishCipher {
        ...
        void encryptBlock(long[] block, long[] out) {
            ...
            for (int d = 1; d < 20; d += 2) {
                ...
                int dm3 = mod3[d];
                long b03 = b16;
                long b17 = ThreefishEngine.rotlXor(b03, 24, b02 + b16);
                long b23 = b22 + b32;
        ...
        void decryptBlock(long[] block, long[] state) {
            ...
            for (int d = 19; d >= 1; d -= 2) {
                ...
                long b152 = ThreefishEngine.xorRotr(b15 - ((kw[dm17 + 16] + d) + 1), 9, b02);
                long b03 = b02 - b152;
                ...
                long b137 = b136 - (kw[dm17 + 13] + t[dm3]);
                long b147 = b146 - (kw[dm17 + 14] + t[dm3 + 1]);
                long b156 = ThreefishEngine.xorRotr(b155 - (kw[dm17 + 15] + d), 5, b07);
                long b08 = b07 - b156;
                ...
                long b48 = b47 - b98;
                long b119 = ThreefishEngine.xorRotr(b111, 47, b147);
                long b148 = b147 - b119;
                ...
                long b129 = b128 - b157;
                long b139 = ThreefishEngine.xorRotr(b138, 41, b148);
                long b149 = b148 - b139;
                long b1110 = ThreefishEngine.xorRotr(b118, 59, b88);
                long b89 = b88 - b1110;
                long b99 = ThreefishEngine.xorRotr(b98, 17, b108);
                long b109 = b108 - b99;
                long b910 = ThreefishEngine.xorRotr(b99, ROTATION_1_0, b09);
                long b010 = b09 - b910;
                ...
                long b510 = ThreefishEngine.xorRotr(b59, 23, b149);
                long b1410 = b149 - b510;
                ...
                b12 = b1210 - b13;
                b15 = ThreefishEngine.xorRotr(b158, 37, b1410);
                b14 = b1410 - b15;
            }
            long b011 = b0 - kw[0];
            long b130 = b1 - kw[1];
