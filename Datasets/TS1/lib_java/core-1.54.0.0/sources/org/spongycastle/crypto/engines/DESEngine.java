    ...
    protected int[] generateWorkingKey(boolean encrypting, byte[] key) {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            for (int j4 = 0; j4 < 24; j4++) {
                if (pcr[pc2[j4]]) {
                    int i2 = m;
                    newKey[i2] = newKey[i2] | bigbyte[j4];
                }
                if (pcr[pc2[j4 + 24]]) {
        ...
        for (int i3 = 0; i3 != 32; i3 += 2) {
            int i1 = newKey[i3];
            int i22 = newKey[i3 + 1];
            newKey[i3] = ((i1 & 16515072) << 6) | ((i1 & 4032) << 10) | ((i22 & 16515072) >>> 10) | ((i22 & 4032) >>> 6);
            newKey[i3 + 1] = ((i1 & 258048) << 12) | ((i1 & 63) << 16) | ((i22 & 258048) >>> 4) | (i22 & 63);
        }
        return newKey;
    }
