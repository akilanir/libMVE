...
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/node/ValueNode.class */
public abstract class ValueNode extends BaseJsonNode {
    ...
    @Override // com.fasterxml.jackson.databind.JsonNode
    /* renamed from: get */
    public final JsonNode mo9get(int index) {
        return null;
    }

    @Override // com.fasterxml.jackson.databind.JsonNode
    /* renamed from: path */
    public final JsonNode mo7path(int index) {
        return MissingNode.getInstance();
    }
    ...
    @Override // com.fasterxml.jackson.databind.JsonNode
    /* renamed from: get */
    public final JsonNode mo10get(String fieldName) {
        return null;
    }

    @Override // com.fasterxml.jackson.databind.JsonNode
    /* renamed from: path */
    public final JsonNode mo8path(String fieldName) {
        return MissingNode.getInstance();
    }
