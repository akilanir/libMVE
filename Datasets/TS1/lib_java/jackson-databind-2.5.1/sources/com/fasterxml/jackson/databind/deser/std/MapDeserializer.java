...
@JacksonStdImpl
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/deser/std/MapDeserializer.class */
public class MapDeserializer extends ContainerDeserializerBase<Map<Object, Object>> implements ContextualDeserializer, ResolvableDeserializer {
    ...
    protected final boolean _isStdKeyDeser(JavaType mapType, KeyDeserializer keyDeser) {
        JavaType keyType;
        if (keyDeser == null || (keyType = mapType.mo4getKeyType()) == null) {
            return true;
        }
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext deserializationContext, BeanProperty beanProperty) throws JsonMappingException {
        ...
        if (r9 == 0) {
            createContextual = deserializationContext.findKeyDeserializer(this._mapType.mo4getKeyType(), beanProperty);
        } else {
        ...
        JavaType mo3getContentType = this._mapType.mo3getContentType();
        if (findConvertingContentDeserializer == null) {
            handleSecondaryContextualization = deserializationContext.findContextualValueDeserializer(mo3getContentType, beanProperty);
        } else {
            handleSecondaryContextualization = deserializationContext.handleSecondaryContextualization(findConvertingContentDeserializer, beanProperty, mo3getContentType);
        }
    ...
    public JavaType getContentType() {
        return this._mapType.mo3getContentType();
    }
    ...
    protected final void _readAndBind(JsonParser jp, DeserializationContext ctxt, Map<Object, Object> result) throws IOException, JsonProcessingException {
        ...
        if (useObjectId) {
            referringAccumulator = new MapReferringAccumulator(this._mapType.mo3getContentType().getRawClass(), result);
        }
        ...
        while (t == JsonToken.FIELD_NAME) {
            ...
            if (this._ignorableProperties != null && this._ignorableProperties.contains(propName)) {
                ...
                if (prop != null) {
                    ...
                    if (buffer.assignParameter(prop.getCreatorIndex(), value2)) {
                        jp.nextToken();
                        try {
                            ...
                            wrapAndThrow(e, this._mapType.getRawClass(), propName);
                            return null;
                        }
                    }
                } else {
                    ...
                    try {
                        ...
                        wrapAndThrow(e2, this._mapType.getRawClass(), propName);
                        return null;
                    }
                }
            }
    ...
    /* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/deser/std/MapDeserializer$MapReferringAccumulator.class */
    ...
    /* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/deser/std/MapDeserializer$MapReferring.class */
