...
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/ObjectMapper.class */
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    /* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/ObjectMapper$DefaultTyping.class */
    ...
    public /* bridge */ /* synthetic */ Iterator m19readValues(JsonParser x0, TypeReference x1) throws IOException, JsonProcessingException {
        return readValues(x0, (TypeReference<?>) x1);
    }

    /* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/ObjectMapper$DefaultTypeResolverBuilder.class */
        ...
        public boolean useForType(JavaType t) {
            switch (this._appliesFor) {
                case NON_CONCRETE_AND_ARRAYS:
                    while (t.isArrayType()) {
                        t = t.mo3getContentType();
                    }
                    if (t.getRawClass() != Object.class || !t.isConcrete() || TreeNode.class.isAssignableFrom(t.getRawClass())) {
                    }
                    break;
                ...
                case NON_FINAL:
                    ...
                    if (t.isFinal() || TreeNode.class.isAssignableFrom(t.getRawClass())) {
                    }
                    break;
                default:
                    if (t.getRawClass() == Object.class) {
    ...
    protected ObjectMapper(ObjectMapper src) {
        ...
        HashMap<ClassKey, Class<?>> mixins = new HashMap<>(src._mixInAnnotations);
    ...
    public ObjectMapper(JsonFactory jf, DefaultSerializerProvider sp, DefaultDeserializationContext dc) {
        ...
        HashMap<ClassKey, Class<?>> mixins = new HashMap<>();
        this._mixInAnnotations = mixins;
        BaseSettings base = DEFAULT_BASE.withClassIntrospector(defaultClassIntrospector());
        this._serializationConfig = new SerializationConfig(base, this._subtypeResolver, mixins);
        this._deserializationConfig = new DeserializationConfig(base, this._subtypeResolver, mixins);
    ...
    public <T> MappingIterator<T> m18readValues(JsonParser jp, ResolvedType valueType) throws IOException, JsonProcessingException {
    ...
    /* renamed from: readValues, reason: merged with bridge method [inline-methods] */
    public <T> MappingIterator<T> m20readValues(JsonParser jp, Class<T> valueType) throws IOException, JsonProcessingException {
    ...
    public <W extends ObjectWriter> W writer(SerializationFeature serializationFeature) {
        return (W) _newWriter(getSerializationConfig().with(serializationFeature));
    }

    public <W extends ObjectWriter> W writer(SerializationFeature serializationFeature, SerializationFeature... serializationFeatureArr) {
        return (W) _newWriter(getSerializationConfig().with(serializationFeature, serializationFeatureArr));
    }
    ...
    public <W extends ObjectWriter> W writerFor(TypeReference<?> typeReference) {
        return (W) _newWriter(getSerializationConfig(), typeReference == null ? null : this._typeFactory.constructType(typeReference), null);
    }

    public <W extends ObjectWriter> W writerFor(JavaType javaType) {
        return (W) _newWriter(getSerializationConfig(), javaType, null);
    }
    ...
    @Deprecated
    public <W extends ObjectWriter> W writerWithType(TypeReference<?> typeReference) {
        return (W) _newWriter(getSerializationConfig(), typeReference == null ? null : this._typeFactory.constructType(typeReference), null);
    }

    @Deprecated
    public <W extends ObjectWriter> W writerWithType(JavaType javaType) {
        return (W) _newWriter(getSerializationConfig(), javaType, null);
    }

    public <W extends ObjectWriter> W writer(PrettyPrinter prettyPrinter) {
        if (prettyPrinter == null) {
            prettyPrinter = ObjectWriter.NULL_PRETTY_PRINTER;
        }
        return (W) _newWriter(getSerializationConfig(), null, prettyPrinter);
    }
    ...
    public <W extends ObjectWriter> W writer(FormatSchema formatSchema) {
        _verifySchemaType(formatSchema);
        return (W) _newWriter(getSerializationConfig(), formatSchema);
    }

    public <W extends ObjectWriter> W writer(Base64Variant base64Variant) {
        return (W) _newWriter(getSerializationConfig().with(base64Variant));
    }

    public <W extends ObjectWriter> W writer(CharacterEscapes characterEscapes) {
        return (W) _newWriter(getSerializationConfig()).with(characterEscapes);
    }

    public <W extends ObjectWriter> W writer(ContextAttributes contextAttributes) {
        return (W) _newWriter(getSerializationConfig().with(contextAttributes));
    }
    ...
    public <T extends ObjectReader> T reader(DeserializationFeature deserializationFeature) {
        return (T) _newReader(getDeserializationConfig().with(deserializationFeature));
    }

    public <T extends ObjectReader> T reader(DeserializationFeature deserializationFeature, DeserializationFeature... deserializationFeatureArr) {
        return (T) _newReader(getDeserializationConfig().with(deserializationFeature, deserializationFeatureArr));
    }

    public <T extends ObjectReader> T readerForUpdating(Object obj) {
    ...
    public <T extends ObjectReader> T reader(JavaType javaType) {
        return (T) _newReader(getDeserializationConfig(), javaType, null, null, this._injectableValues);
    }

    public <T extends ObjectReader> T reader(Class<?> cls) {
        return (T) _newReader(getDeserializationConfig(), this._typeFactory.constructType(cls), null, null, this._injectableValues);
    }

    public <T extends ObjectReader> T reader(TypeReference<?> typeReference) {
        return (T) _newReader(getDeserializationConfig(), this._typeFactory.constructType(typeReference), null, null, this._injectableValues);
    }

    public <T extends ObjectReader> T reader(JsonNodeFactory jsonNodeFactory) {
        return (T) _newReader(getDeserializationConfig()).with(jsonNodeFactory);
    }

    public <T extends ObjectReader> T reader(FormatSchema formatSchema) {
        _verifySchemaType(formatSchema);
        return (T) _newReader(getDeserializationConfig(), null, null, formatSchema, this._injectableValues);
    }

    public <T extends ObjectReader> T reader(InjectableValues injectableValues) {
        return (T) _newReader(getDeserializationConfig(), null, null, null, injectableValues);
    }

    public <T extends ObjectReader> T readerWithView(Class<?> cls) {
        return (T) _newReader(getDeserializationConfig().withView(cls));
    }

    public <T extends ObjectReader> T reader(Base64Variant base64Variant) {
        return (T) _newReader(getDeserializationConfig().with(base64Variant));
    }

    public <T extends ObjectReader> T reader(ContextAttributes contextAttributes) {
        return (T) _newReader(getDeserializationConfig().with(contextAttributes));
    }
    ...
    protected Object _convert(Object fromValue, JavaType toValueType) throws IllegalArgumentException {
        ...
        try {
            ...
            if (t == JsonToken.VALUE_NULL) {
                result = _findRootDeserializer(createDeserializationContext(jp, deserConfig), toValueType).getNullValue();
    ...
    protected Object _unwrapAndDeserialize(JsonParser p, DeserializationContext ctxt, DeserializationConfig config, JavaType rootType, JsonDeserializer<Object> deser) throws IOException {
        ...
        if (expName == null) {
            PropertyName pname = this._rootNames.findRootName(rootType, config);
            expName = pname.getSimpleName();
        }
        if (p.getCurrentToken() != JsonToken.START_OBJECT) {
            throw JsonMappingException.from(p, "Current token not START_OBJECT (needed to unwrap root name '" + expName + "'), but " + p.getCurrentToken());
        }
        if (p.nextToken() != JsonToken.FIELD_NAME) {
            throw JsonMappingException.from(p, "Current token not FIELD_NAME (to contain expected root name '" + expName + "'), but " + p.getCurrentToken());
        }
        String actualName = p.getCurrentName();
        if (!expName.equals(actualName)) {
            throw JsonMappingException.from(p, "Root name '" + actualName + "' does not match expected ('" + expName + "') for type " + rootType);
        }
        p.nextToken();
        Object result = deser.deserialize(p, ctxt);
        if (p.nextToken() != JsonToken.END_OBJECT) {
            throw JsonMappingException.from(p, "Current token not END_OBJECT (to match wrapper object with root name '" + expName + "'), but " + p.getCurrentToken());
        }
        return result;
    }
