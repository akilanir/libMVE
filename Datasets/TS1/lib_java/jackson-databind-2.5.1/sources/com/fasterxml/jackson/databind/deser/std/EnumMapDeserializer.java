...
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/deser/std/EnumMapDeserializer.class */
public class EnumMapDeserializer extends ContainerDeserializerBase<EnumMap<?, ?>> implements ContextualDeserializer {
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        ...
        if (kd == null) {
            kd = ctxt.findKeyDeserializer(this._mapType.mo4getKeyType(), property);
        }
        JsonDeserializer<?> vd2 = this._valueDeserializer;
        JavaType vt = this._mapType.mo3getContentType();
        if (vd2 == null) {
        ...
        while (jp.nextToken() == JsonToken.FIELD_NAME) {
            ...
            if (key == null) {
                if (!ctxt.isEnabled(DeserializationFeature.READ_UNKNOWN_ENUM_VALUES_AS_NULL)) {
                    throw ctxt.weirdStringException(keyName, this._enumClass, "value not one of declared Enum instance names for " + this._mapType.mo4getKeyType());
                }
                jp.nextToken();
                jp.skipChildren();
            } else {
