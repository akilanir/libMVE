...
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/ser/DefaultSerializerProvider.class */
public abstract class DefaultSerializerProvider extends SerializerProvider implements Serializable {
    ...
    public void serializeValue(JsonGenerator gen, Object value, JavaType rootType, JsonSerializer<Object> ser) throws IOException {
        ...
        if (rootName == null) {
            ...
            if (wrap) {
                gen.writeStartObject();
                PropertyName pname = rootType == null ? this._rootNames.findRootName(value.getClass(), this._config) : this._rootNames.findRootName(rootType, this._config);
                gen.writeFieldName(pname.simpleAsEncoded(this._config));
            }
        } else if (rootName.length() == 0) {
            wrap = false;
    ...
    public void serializePolymorphic(JsonGenerator gen, Object value, TypeSerializer typeSer) throws IOException {
        ...
        if (rootName == null) {
            ...
            if (wrap) {
                gen.writeStartObject();
                PropertyName pname = this._rootNames.findRootName(type, this._config);
                gen.writeFieldName(pname.simpleAsEncoded(this._config));
            }
        } else if (rootName.length() == 0) {
            wrap = false;
    ...
    /* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/ser/DefaultSerializerProvider$Impl.class */
