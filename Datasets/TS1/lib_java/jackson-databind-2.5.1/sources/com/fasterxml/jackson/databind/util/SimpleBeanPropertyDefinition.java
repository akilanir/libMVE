...
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/util/SimpleBeanPropertyDefinition.class */
public class SimpleBeanPropertyDefinition extends BeanPropertyDefinition {
    ...
    public static SimpleBeanPropertyDefinition construct(MapperConfig<?> config, AnnotatedMember member, String name) {
        return new SimpleBeanPropertyDefinition(member, new PropertyName(name), config == null ? null : config.getAnnotationIntrospector(), null, null);
    }
