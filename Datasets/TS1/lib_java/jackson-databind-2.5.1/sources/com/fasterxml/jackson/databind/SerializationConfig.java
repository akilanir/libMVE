...
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/SerializationConfig.class */
public final class SerializationConfig extends MapperConfigBase<SerializationFeature, SerializationConfig> implements Serializable {
    ...
    public SerializationConfig with(DateFormat df) {
        ...
        SerializationConfig cfg2 = new SerializationConfig(this, this._base.withDateFormat(df));
        if (df == null) {
            cfg = cfg2.with(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
        } else {
            cfg = cfg2.without(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
        }
        return cfg;
    }
    ...
    public void initialize(JsonGenerator g) {
        ...
        if (this._generatorFeaturesToChange != 0 || useBigDec) {
            ...
            int newFlags = (orig & (this._generatorFeaturesToChange ^ (-1))) | this._generatorFeatures;
            if (useBigDec) {
