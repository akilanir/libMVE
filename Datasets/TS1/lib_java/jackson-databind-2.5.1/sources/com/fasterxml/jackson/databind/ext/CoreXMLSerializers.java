...
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/ext/CoreXMLSerializers.class */
public class CoreXMLSerializers extends Serializers.Base {
    ...
    /* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/ext/CoreXMLSerializers$XMLGregorianCalendarSerializer.class */
    public static class XMLGregorianCalendarSerializer extends StdSerializer<XMLGregorianCalendar> implements ContextualSerializer {
        ...
        public boolean isEmpty(XMLGregorianCalendar value) {
            return this._delegate.isEmpty(_convert(value));
        }
        ...
        public void serialize(XMLGregorianCalendar value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
            this._delegate.serialize(_convert(value), jgen, provider);
        }
