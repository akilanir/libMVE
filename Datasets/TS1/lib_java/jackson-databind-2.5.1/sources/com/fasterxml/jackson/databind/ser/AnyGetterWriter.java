...
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/ser/AnyGetterWriter.class */
public class AnyGetterWriter {
    ...
    public void getAndFilter(Object bean, JsonGenerator jgen, SerializerProvider provider, PropertyFilter filter) throws Exception {
        ...
        this._serializer.serializeFilteredFields((Map) value, jgen, provider, filter, null);
    }
