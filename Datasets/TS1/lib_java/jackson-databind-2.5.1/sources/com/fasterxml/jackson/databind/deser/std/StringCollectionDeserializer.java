...
@JacksonStdImpl
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/deser/std/StringCollectionDeserializer.class */
public final class StringCollectionDeserializer extends ContainerDeserializerBase<Collection<String>> implements ContextualDeserializer {
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        ...
        JavaType valueType = this._collectionType.mo3getContentType();
        if (valueDeser2 == null) {
    ...
    private Collection<String> deserializeUsingCustom(JsonParser jp, DeserializationContext ctxt, Collection<String> result, JsonDeserializer<String> deser) throws IOException {
        ...
        while (true) {
            if (jp.nextTextValue() == null) {
                JsonToken t = jp.getCurrentToken();
                if (t != JsonToken.END_ARRAY) {
                    deserialize = t == JsonToken.VALUE_NULL ? deser.getNullValue() : deser.deserialize(jp, ctxt);
                } else {
                    return result;
                }
            } else {
