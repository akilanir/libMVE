...
/* loaded from: jackson-databind-2.5.1.jar:com/fasterxml/jackson/databind/ser/std/StdDelegatingSerializer.class */
public class StdDelegatingSerializer extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider provider, BeanProperty property) throws JsonMappingException {
        ...
        return delSer == this._delegateSerializer ? this : withDelegate(this._converter, delegateType, delSer);
    }
    ...
    public void serialize(Object value, JsonGenerator gen, SerializerProvider provider) throws IOException {
        ...
        if (delegateValue == null) {
            ...
            this._delegateSerializer.serialize(delegateValue, gen, provider);
        }
    }
    ...
    public void serializeWithType(Object value, JsonGenerator gen, SerializerProvider provider, TypeSerializer typeSer) throws IOException {
        Object delegateValue = convertValue(value);
        this._delegateSerializer.serializeWithType(delegateValue, gen, provider, typeSer);
    }
