...
/* loaded from: com.koushikdutta.ion.ion.2.1.7.jar:com/koushikdutta/ion/TransformBitmap.class */
class TransformBitmap extends BitmapCallback implements FutureCallback<BitmapInfo> {
    ArrayList<Transform> transforms;
    ArrayList<PostProcess> postProcess;
    String downloadKey;

    /* loaded from: com.koushikdutta.ion.ion.2.1.7.jar:com/koushikdutta/ion/TransformBitmap$PostProcessNullTransform.class */
