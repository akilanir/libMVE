...
/* loaded from: com.koushikdutta.ion.ion.2.1.7.jar:com/koushikdutta/ion/loader/ResourceLoader.class */
public class ResourceLoader extends StreamLoader {

    /* loaded from: com.koushikdutta.ion.ion.2.1.7.jar:com/koushikdutta/ion/loader/ResourceLoader$Resource.class */
    ...
    public static Resource lookupResource(Context context, String uri) throws Exception {
        int id;
        Uri u = Uri.parse(uri);
        ...
        if (u.getPathSegments().size() == 1) {
            id = Integer.valueOf(u.getPathSegments().get(0)).intValue();
    ...
    public Future<BitmapInfo> loadBitmap(final Context context, final Ion ion, final String key, final String uri, final int resizeWidth, final int resizeHeight, final boolean animateGif) {
        ...
        Ion.getBitmapLoadExecutorService().execute(new Runnable() { // from class: com.koushikdutta.ion.loader.ResourceLoader.1
            ...
            public void run() {
                BitmapInfo info;
                try {
                    Resource res = ResourceLoader.lookupResource(context, uri);
                    ...
                    if (animateGif && TextUtils.equals("image/gif", options.outMimeType)) {
                        ...
                        try {
                            info = ResourceLoader.this.loadGif(key, size, in, options);
    ...
    public Future<DataEmitter> load(final Ion ion, final AsyncHttpRequest request, final FutureCallback<Loader.LoaderEmitter> callback) {
        ...
        ion.getHttpClient().getServer().post(new Runnable() { // from class: com.koushikdutta.ion.loader.ResourceLoader.2
            ...
            public void run() {
                try {
                    Resource res = ResourceLoader.lookupResource(ion.getContext(), request.getUri().toString());
