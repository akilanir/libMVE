...
/* loaded from: com.koushikdutta.ion.ion.2.1.7.jar:com/koushikdutta/ion/loader/AssetLoader.class */
public class AssetLoader extends StreamLoader {
    ...
    protected InputStream getInputStream(Context context, String uri) throws Exception {
        return context.getAssets().open(Uri.parse(uri).getPath().replaceFirst("^/android_asset/", BuildConfig.FLAVOR));
    }
    ...
    public Future<DataEmitter> load(final Ion ion, final AsyncHttpRequest request, final FutureCallback<Loader.LoaderEmitter> callback) {
        ...
        ion.getHttpClient().getServer().post(new Runnable() { // from class: com.koushikdutta.ion.loader.AssetLoader.1
            ...
            public void run() {
                try {
                    InputStream stream = AssetLoader.this.getInputStream(ion.getContext(), request.getUri().toString());
                    if (stream == null) {
