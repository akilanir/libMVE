...
/* loaded from: com.mikepenz.aboutlibraries.5.6.5.jar:com/mikepenz/aboutlibraries/util/UIUtils.class */
public class UIUtils {
    public static int getSelectableBackground(Context ctx) {
        ...
        ctx.getTheme().resolveAttribute(android.R.attr.itemBackground, outValue2, true);
