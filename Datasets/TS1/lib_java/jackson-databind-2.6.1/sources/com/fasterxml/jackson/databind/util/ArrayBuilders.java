...
/* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/util/ArrayBuilders.class */
public final class ArrayBuilders {
    ...
    /* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/util/ArrayBuilders$BooleanBuilder.class */
    ...
    /* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/util/ArrayBuilders$ByteBuilder.class */
    ...
    /* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/util/ArrayBuilders$ShortBuilder.class */
    ...
    /* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/util/ArrayBuilders$IntBuilder.class */
    ...
    /* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/util/ArrayBuilders$LongBuilder.class */
    ...
    /* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/util/ArrayBuilders$FloatBuilder.class */
    ...
    /* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/util/ArrayBuilders$DoubleBuilder.class */
    ...
    public static Object getArrayComparator(final Object defaultValue) {
        ...
        return new Object() { // from class: com.fasterxml.jackson.databind.util.ArrayBuilders.1
            public boolean equals(Object other) {
                ...
                if (other == null || other.getClass() != defaultValueType || Array.getLength(other) != length) {
                    return false;
                }
