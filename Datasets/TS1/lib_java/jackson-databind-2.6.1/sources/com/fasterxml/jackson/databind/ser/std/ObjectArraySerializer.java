...
@JacksonStdImpl
/* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/ser/std/ObjectArraySerializer.class */
public class ObjectArraySerializer extends ArraySerializerBase<Object[]> implements ContextualSerializer {
    ...
    public JsonNode getSchema(SerializerProvider provider, Type typeHint) throws JsonMappingException {
        ...
        if (typeHint != null) {
            ...
            if (javaType.isArrayType()) {
                Class<?> componentType = ((ArrayType) javaType).mo4getContentType().getRawClass();
    ...
    public void acceptJsonFormatVisitor(JsonFormatVisitorWrapper visitor, JavaType typeHint) throws JsonMappingException {
        ...
        if (arrayVisitor != null) {
            ...
            JavaType contentType = tf.moreSpecificType(this._elementType, typeHint.mo4getContentType());
            if (contentType == null) {
