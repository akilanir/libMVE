...
/* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/deser/impl/ExternalTypeHandler.class */
public class ExternalTypeHandler {
    ...
    public Object complete(JsonParser jp, DeserializationContext ctxt, PropertyValueBuffer buffer, PropertyBasedCreator creator) throws IOException {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (typeId == null) {
                ...
                throw ctxt.mappingException("Missing property '%s' for external type id '%s'", this._properties[i].getProperty().getName(), this._properties[i].getTypePropertyName());
            }
    ...
    protected final Object _deserialize(JsonParser jp, DeserializationContext ctxt, int index, String typeId) throws IOException {
    ...
    protected final void _deserializeAndSet(JsonParser jp, DeserializationContext ctxt, Object bean, int index, String typeId) throws IOException {
        TokenBuffer merged = new TokenBuffer(jp);
        merged.writeStartArray();
        merged.writeString(typeId);
        JsonParser p2 = this._tokens[index].asParser(jp);
    ...
    /* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/deser/impl/ExternalTypeHandler$Builder.class */
    ...
    /* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/deser/impl/ExternalTypeHandler$ExtTypedProperty.class */
