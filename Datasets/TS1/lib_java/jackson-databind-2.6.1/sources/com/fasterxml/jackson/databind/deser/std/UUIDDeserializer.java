...
/* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/deser/std/UUIDDeserializer.class */
public class UUIDDeserializer extends FromStringDeserializer<UUID> {
    ...
    public UUID _deserialize(String id, DeserializationContext ctxt) throws IOException {
        ...
        long hi = l12 + (l2 | shortFromChars(id, 14));
        int i1 = (shortFromChars(id, 19) << 16) | shortFromChars(id, 24);
        long l13 = i1;
        long l14 = l13 << 32;
        long l22 = intFromChars(id, 28);
