...
/* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/ser/std/DateTimeSerializerBase.class */
public abstract class DateTimeSerializerBase<T> extends StdScalarSerializer<T> implements ContextualSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializers, BeanProperty property) throws JsonMappingException {
        ...
        DateFormat df;
        if (property != null && (format = serializers.getAnnotationIntrospector().findFormat(property.getMember())) != null) {
            ...
            if (tz != null) {
                DateFormat df3 = serializers.getConfig().getDateFormat();
                if (df3.getClass() == StdDateFormat.class) {
                    Locale loc2 = format.hasLocale() ? format.getLocale() : serializers.getLocale();
