...
/* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/introspect/AnnotatedClass.class */
public final class AnnotatedClass extends Annotated {
    ...
    private void resolveCreators() {
        ...
        Method[] arr$ = _findClassMethods(this._class);
        for (Method m : arr$) {
    ...
    protected void _addMemberMethods(Class<?> cls, AnnotatedMethodMap methods, Class<?> mixInCls, AnnotatedMethodMap mixIns) {
        ...
        Method[] arr$ = _findClassMethods(cls);
        for (Method m : arr$) {
    ...
    private List<Annotation> _addFromBundle(Annotation bundle, List<Annotation> result) {
        Annotation[] arr$ = bundle.annotationType().getDeclaredAnnotations();
    ...
    public boolean equals(Object o) {
        ...
        return o != null && o.getClass() == getClass() && ((AnnotatedClass) o)._class == this._class;
    }
}
