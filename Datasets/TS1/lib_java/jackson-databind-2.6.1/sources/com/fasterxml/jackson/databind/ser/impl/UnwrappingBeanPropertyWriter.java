...
/* loaded from: jackson-databind-2.6.1.jar:com/fasterxml/jackson/databind/ser/impl/UnwrappingBeanPropertyWriter.class */
public class UnwrappingBeanPropertyWriter extends BeanPropertyWriter {
    ...
    public void depositSchemaProperty(final JsonObjectFormatVisitor visitor) throws JsonMappingException {
    ...
    protected void _depositSchemaProperty(ObjectNode propertiesNode, JsonNode schemaNode) {
        JsonNode props = schemaNode.mo11get("properties");
        if (props != null) {
