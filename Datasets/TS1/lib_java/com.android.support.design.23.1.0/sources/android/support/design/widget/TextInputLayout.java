...
/* loaded from: com.android.support.design.23.1.0.jar:android/support/design/widget/TextInputLayout.class */
public class TextInputLayout extends LinearLayout {
    ...
    public void setCounterEnabled(boolean enabled) {
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                params.gravity = (params.gravity & 112) | 8388613;
    ...
    /* loaded from: com.android.support.design.23.1.0.jar:android/support/design/widget/TextInputLayout$TextInputAccessibilityDelegate.class */
