...
/* loaded from: dagger-1.2.2.jar:dagger/internal/Linker.class */
public final class Linker {
    ...
    /* loaded from: dagger-1.2.2.jar:dagger/internal/Linker$ErrorHandler.class */
    ...
    public Binding<?> requestBinding(String key, Object requiredBy, ClassLoader classLoader, boolean mustHaveInjections, boolean library) {
        ...
        while (true) {
            ...
            binding = linker2.bindings.get(key);
            if (binding == null) {
                linker = linker2.base;
            } else if (linker2 != this && !binding.isLinked()) {
                throw new AssertionError();
            }
        }
        if (binding == null) {
    ...
    /* loaded from: dagger-1.2.2.jar:dagger/internal/Linker$SingletonBinding.class */
    ...
    /* loaded from: dagger-1.2.2.jar:dagger/internal/Linker$DeferredBinding.class */
