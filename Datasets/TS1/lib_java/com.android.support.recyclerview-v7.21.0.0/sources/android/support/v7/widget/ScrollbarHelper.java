...
/* loaded from: com.android.support.recyclerview-v7.21.0.0.jar:android/support/v7/widget/ScrollbarHelper.class */
class ScrollbarHelper {
    ...
    static int computeScrollOffset(RecyclerView.State state, OrientationHelper orientation, View startChild, View endChild, RecyclerView.LayoutManager lm, boolean smoothScrollbarEnabled, boolean reverseLayout) {
        ...
        int itemsBefore = reverseLayout ? Math.max(0, (state.getItemCount() - maxPosition) - 1) : Math.max(0, minPosition - 1);
