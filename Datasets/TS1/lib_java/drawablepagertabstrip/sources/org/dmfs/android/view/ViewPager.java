...
/* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager.class */
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() { // from class: org.dmfs.android.view.ViewPager.1
        @Override // java.util.Comparator
        public int compare(ItemInfo lhs, ItemInfo rhs) {
            return lhs.position - rhs.position;
        }
    };
    private static final Interpolator sInterpolator = new Interpolator() { // from class: org.dmfs.android.view.ViewPager.2
    ...
    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$Decor.class */
    interface Decor {
    }

    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$OnAdapterChangeListener.class */
    interface OnAdapterChangeListener {
        void onAdapterChanged(PagerAdapter pagerAdapter, PagerAdapter pagerAdapter2);
    }

    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$OnPageChangeListener.class */
    ...
    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$PageTransformer.class */
    public interface PageTransformer {
        void transformPage(View view, float f);
    }

    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$ItemInfo.class */
    ...
    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$SimpleOnPageChangeListener.class */
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new Runnable() { // from class: org.dmfs.android.view.ViewPager.3
    ...
    void populate(int newCurrentItem) {
        ...
        if (curItem != null) {
            ...
            for (int pos = this.mCurItem - 1; pos >= 0; pos += INVALID_POINTER) {
    ...
    private void calculatePageOffsets(ItemInfo curItem, int curIndex, ItemInfo oldCurInfo) {
        ...
        while (i >= 0) {
            ...
            while (pos3 > ii3.position) {
                ...
                int i2 = pos3;
                pos3 += INVALID_POINTER;
                offset3 -= pagerAdapter.getPageWidth(i2) + marginOffset;
            }
    ...
    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$SavedState.class */
    public static class SavedState extends View.BaseSavedState {
        int position;
        Parcelable adapterState;
        ClassLoader loader;
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: org.dmfs.android.view.ViewPager.SavedState.1
            /* renamed from: createFromParcel, reason: merged with bridge method [inline-methods] */
            public SavedState m3createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public SavedState[] m4newArray(int size) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8 && (lp2 = (LayoutParams) child.getLayoutParams()) != null && lp2.isDecor) {
                ...
                if (lp2.width != -2) {
                    widthMode = 1073741824;
                    if (lp2.width != INVALID_POINTER) {
                        widthSize = lp2.width;
                    }
                }
                if (lp2.height != -2) {
                    heightMode = 1073741824;
                    if (lp2.height != INVALID_POINTER) {
    ...
    private void enableLayers(boolean enable) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            ViewCompat.setLayerType(getChildAt(i), layerType, (Paint) null);
        }
    }
    ...
    protected boolean canScroll(View v, boolean checkV, int dx, int x, int y) {
        if (v instanceof ViewGroup) {
            ...
            for (int i = count - 1; i >= 0; i += INVALID_POINTER) {
    ...
    @SuppressLint({"NewApi"})
    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$MyAccessibilityDelegate.class */
    ...
    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$PagerObserver.class */
    ...
    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$LayoutParams.class */
    ...
    /* loaded from: drawablepagertabstrip.jar:org/dmfs/android/view/ViewPager$ViewPositionComparator.class */
    static class ViewPositionComparator implements Comparator<View> {
        ...
        public int compare(View lhs, View rhs) {
            ...
            if (llp.isDecor != rlp.isDecor) {
                ...
                return ViewPager.INVALID_POINTER;
            }
