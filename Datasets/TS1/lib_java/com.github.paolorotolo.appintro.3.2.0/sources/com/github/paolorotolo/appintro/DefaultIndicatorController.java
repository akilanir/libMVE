...
/* loaded from: com.github.paolorotolo.appintro.3.2.0.jar:com/github/paolorotolo/appintro/DefaultIndicatorController.class */
class DefaultIndicatorController implements IndicatorController {
    ...
    public void selectPosition(int index) {
        ...
        while (i < this.mSlideCount) {
            ...
            Drawable drawable = ResourceUtils.getDrawable(this.mContext, drawableId);
