...
/* loaded from: org.osmdroid.osmdroid-android.5.1.jar:org/osmdroid/tileprovider/MapTileProviderArray.class */
    ...
    public Drawable getMapTile(MapTile pTile) {
        ...
        if (!alreadyInProgress) {
            if (OpenStreetMapTileProviderConstants.DEBUG_TILE_PROVIDERS) {
                Log.d(IMapView.LOGTAG, "MapTileProviderArray.getMapTile() requested but not in cache, trying from async providers: " + pTile);
            }
            synchronized (this.mTileProviderList) {
