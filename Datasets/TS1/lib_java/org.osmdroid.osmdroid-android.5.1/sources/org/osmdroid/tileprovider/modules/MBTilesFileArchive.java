...
/* loaded from: org.osmdroid.osmdroid-android.5.1.jar:org/osmdroid/tileprovider/modules/MBTilesFileArchive.class */
public class MBTilesFileArchive implements IArchiveFile {
    ...
    public InputStream getInputStream(ITileSource pTileSource, MapTile pTile) {
        try {
            ...
            Cursor cur = this.mDatabase.query("tiles", tile, "tile_column=? and tile_row=? and zoom_level=?", xyz, null, null, null);
            if (cur.getCount() != 0) {
                cur.moveToFirst();
