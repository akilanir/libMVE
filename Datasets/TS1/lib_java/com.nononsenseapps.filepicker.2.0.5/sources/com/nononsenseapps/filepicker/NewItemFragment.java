...
/* loaded from: com.nononsenseapps.filepicker.2.0.5.jar:com/nononsenseapps/filepicker/NewItemFragment.class */
public abstract class NewItemFragment extends DialogFragment {
    private OnNewFolderListener listener = null;

    /* loaded from: com.nononsenseapps.filepicker.2.0.5.jar:com/nononsenseapps/filepicker/NewItemFragment$OnNewFolderListener.class */
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(R.layout.dialog_folder_name).setTitle(R.string.new_folder).setNegativeButton(R.string.cancel, (DialogInterface.OnClickListener) null).setPositiveButton(R.string.ok, (DialogInterface.OnClickListener) null);
