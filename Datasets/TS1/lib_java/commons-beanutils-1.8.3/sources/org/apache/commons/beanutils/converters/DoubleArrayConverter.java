...
/* loaded from: commons-beanutils-1.8.3.jar:org/apache/commons/beanutils/converters/DoubleArrayConverter.class */
public final class DoubleArrayConverter extends AbstractArrayConverter {
    ...
    public Object convert(Class type, Object value) {
        ...
        try {
            ...
            double[] results2 = new double[list.size()];
            for (int i2 = 0; i2 < results2.length; i2++) {
                results2[i2] = Double.parseDouble((String) list.get(i2));
            }
            return results2;
        } catch (Exception e2) {
            if (this.useDefault) {
