...
/* loaded from: commons-beanutils-1.8.3.jar:org/apache/commons/beanutils/converters/IntegerArrayConverter.class */
public final class IntegerArrayConverter extends AbstractArrayConverter {
    ...
    public Object convert(Class type, Object value) {
        ...
        try {
            ...
            int[] results2 = new int[list.size()];
            for (int i2 = 0; i2 < results2.length; i2++) {
                results2[i2] = Integer.parseInt((String) list.get(i2));
            }
            return results2;
        } catch (Exception e2) {
            if (this.useDefault) {
