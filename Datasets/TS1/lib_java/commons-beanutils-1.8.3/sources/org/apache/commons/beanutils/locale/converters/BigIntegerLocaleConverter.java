...
/* loaded from: commons-beanutils-1.8.3.jar:org/apache/commons/beanutils/locale/converters/BigIntegerLocaleConverter.class */
public class BigIntegerLocaleConverter extends DecimalLocaleConverter {
    ...
    protected Object parse(Object value, String pattern) throws ParseException {
        ...
        try {
            ...
            throw new ConversionException(new StringBuffer().append("Suplied number is not of type BigInteger: ").append(result).toString());
        }
    }
}
