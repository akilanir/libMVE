...
/* loaded from: commons-beanutils-1.8.3.jar:org/apache/commons/beanutils/locale/converters/IntegerLocaleConverter.class */
public class IntegerLocaleConverter extends DecimalLocaleConverter {
    ...
    protected Object parse(Object value, String pattern) throws ParseException {
        ...
        if (parsed.longValue() != parsed.intValue()) {
            throw new ConversionException(new StringBuffer().append("Suplied number is not of type Integer: ").append(parsed.longValue()).toString());
        }
