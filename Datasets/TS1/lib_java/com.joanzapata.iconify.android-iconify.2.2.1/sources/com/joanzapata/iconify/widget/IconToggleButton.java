...
/* loaded from: com.joanzapata.iconify.android-iconify.2.2.1.jar:com/joanzapata/iconify/widget/IconToggleButton.class */
public class IconToggleButton extends ToggleButton implements HasOnViewAttachListener {
    ...
    public void setText(CharSequence text, TextView.BufferType type) {
        super.setText(Iconify.compute(getContext(), text, this), TextView.BufferType.NORMAL);
    }
