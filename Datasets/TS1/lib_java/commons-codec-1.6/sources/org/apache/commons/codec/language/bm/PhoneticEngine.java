...
/* loaded from: commons-codec-1.6.jar:org/apache/commons/codec/language/bm/PhoneticEngine.class */
public class PhoneticEngine {
    ...
    /* loaded from: commons-codec-1.6.jar:org/apache/commons/codec/language/bm/PhoneticEngine$PhonemeBuilder.class */
    ...
    /* loaded from: commons-codec-1.6.jar:org/apache/commons/codec/language/bm/PhoneticEngine$RulesApplication.class */
        ...
        for (Rule.Phoneme phoneme : phonemeBuilder.getPhonemes()) {
            ...
            while (true) {
                ...
                if (i2 < phonemeText.length()) {
                    RulesApplication rulesApplication = new RulesApplication(finalRules, phonemeText, subBuilder, i2).invoke();
