...
/* loaded from: okio-1.6.0.jar:okio/DeflaterSink.class */
public final class DeflaterSink implements Sink {
    ...
    private void deflate(boolean syncFlush) throws IOException {
        ...
        while (true) {
            ...
            if (syncFlush) {
                deflate = this.deflater.deflate(s.data, s.limit, 2048 - s.limit, 2);
            } else {
                deflate = this.deflater.deflate(s.data, s.limit, 2048 - s.limit);
            }
