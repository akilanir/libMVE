...
/* loaded from: okio-1.6.0.jar:okio/Buffer.class */
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    /* JADX WARN: Removed duplicated region for block: B:53:0x013b A[EDGE_INSN: B:53:0x013b->B:45:0x013b BREAK  A[LOOP:0: B:7:0x0027->B:55:?], SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:47:0x0133 A[EDGE_INSN: B:47:0x0133->B:43:0x0133 BREAK  A[LOOP:0: B:7:0x001a->B:49:?], SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
        ...
        while (byteCount > 0) {
            if (byteCount < source.head.limit - source.head.pos) {
                ...
                if (tail != null && tail.owner) {
                    if ((byteCount + tail.limit) - (tail.shared ? 0 : tail.pos) <= 2048) {
    ...
    public long indexOf(byte b, long fromIndex) {
        ...
        do {
            ...
            if (fromIndex >= segmentByteCount) {
                ...
                byte[] data = s.data;
                int limit = s.limit;
                for (int pos = (int) (s.pos + fromIndex); pos < limit; pos++) {
                    if (data[pos] == b) {
    ...
    public String toString() {
        ...
        if (this.size <= 16) {
            ByteString data = m2clone().readByteString();
