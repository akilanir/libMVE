...
/* loaded from: com.journeyapps.zxing-android-embedded.3.0.2.jar:com/google/zxing/client/android/camera/CameraConfigurationUtils.class */
public final class CameraConfigurationUtils {
    ...
    public static void setBestPreviewFPS(Camera.Parameters parameters, int minFPS, int maxFPS) {
        ...
        if (supportedPreviewFpsRanges != null && !supportedPreviewFpsRanges.isEmpty()) {
            ...
            Iterator i$ = supportedPreviewFpsRanges.iterator();
            while (true) {
                if (!i$.hasNext()) {
                    break;
                }
