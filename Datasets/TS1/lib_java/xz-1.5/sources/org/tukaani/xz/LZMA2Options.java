...
/* loaded from: xz-1.5.jar:org/tukaani/xz/LZMA2Options.class */
public class LZMA2Options extends FilterOptions {
    ...
    static Class class$org$tukaani$xz$LZMA2Options;
    ...
    static {
        ...
        if (class$org$tukaani$xz$LZMA2Options == null) {
            ...
            class$org$tukaani$xz$LZMA2Options = cls;
        } else {
            cls = class$org$tukaani$xz$LZMA2Options;
        }
        $assertionsDisabled = !cls.desiredAssertionStatus();
        presetToDictSize = new int[]{262144, 1048576, 2097152, 4194304, 4194304, DICT_SIZE_DEFAULT, DICT_SIZE_DEFAULT, 16777216, 33554432, 67108864};
