...
/* loaded from: xz-1.5.jar:org/tukaani/xz/LZMAInputStream.class */
public class LZMAInputStream extends InputStream {
    ...
    static Class class$org$tukaani$xz$LZMAInputStream;
    ...
    public static int getMemoryUsage(int i, int i2, int i3) {
        ...
        return 10 + (getDictSize(i) / Util.BLOCK_HEADER_SIZE_MAX) + ((1536 << (i2 + i3)) / Util.BLOCK_HEADER_SIZE_MAX);
    }
    ...
    public LZMAInputStream(InputStream inputStream, int i) throws IOException {
        ...
        for (int i3 = 0; i3 < 4; i3++) {
            i2 |= dataInputStream.readUnsignedByte() << (8 * i3);
        }
        long j = 0;
        for (int i4 = 0; i4 < 8; i4++) {
            j |= dataInputStream.readUnsignedByte() << (8 * i4);
        }
    ...
    static {
        ...
        if (class$org$tukaani$xz$LZMAInputStream == null) {
            cls = class$("org.tukaani.xz.LZMAInputStream");
            class$org$tukaani$xz$LZMAInputStream = cls;
        } else {
            cls = class$org$tukaani$xz$LZMAInputStream;
        }
