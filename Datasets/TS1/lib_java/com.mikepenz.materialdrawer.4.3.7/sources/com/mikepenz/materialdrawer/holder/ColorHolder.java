...
/* loaded from: com.mikepenz.materialdrawer.4.3.7.jar:com/mikepenz/materialdrawer/holder/ColorHolder.class */
public class ColorHolder {
    ...
    public void applyTo(IconicsDrawable iconicsDrawable) {
        if (this.mColorInt != 0) {
            iconicsDrawable.color(this.mColorInt);
        } else if (this.mColorRes != -1) {
            iconicsDrawable.colorRes(this.mColorRes);
        }
    }
