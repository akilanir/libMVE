...
/* loaded from: com.mikepenz.materialdrawer.4.3.7.jar:com/mikepenz/materialdrawer/util/DrawerItemViewHelper.class */
public class DrawerItemViewHelper {
    ...
    /* loaded from: com.mikepenz.materialdrawer.4.3.7.jar:com/mikepenz/materialdrawer/util/DrawerItemViewHelper$OnDrawerItemClickListener.class */
    ...
    public View build() {
        ...
        while (it.hasNext()) {
            ...
            if (drawerItem.isEnabled()) {
                ...
                view.setOnClickListener(new View.OnClickListener() { // from class: com.mikepenz.materialdrawer.util.DrawerItemViewHelper.1
