...
/* loaded from: com.mikepenz.materialdrawer.4.3.7.jar:com/mikepenz/materialdrawer/AccountHeader.class */
public class AccountHeader {
    ...
    /* loaded from: com.mikepenz.materialdrawer.4.3.7.jar:com/mikepenz/materialdrawer/AccountHeader$OnAccountHeaderListener.class */
    public interface OnAccountHeaderListener {
        boolean onProfileChanged(View view, IProfile iProfile, boolean z);
    }

    /* loaded from: com.mikepenz.materialdrawer.4.3.7.jar:com/mikepenz/materialdrawer/AccountHeader$OnAccountHeaderSelectionViewClickListener.class */
    ...
    public void updateProfileByIdentifier(@NonNull IProfile newProfile) {
        if (this.mAccountHeaderBuilder.mProfiles != null && newProfile.getIdentifier() >= 0) {
            int found = -1;
            int i = 0;
            while (true) {
    ...
    public void addProfiles(@NonNull IProfile... profiles) {
        ...
        Collections.addAll(this.mAccountHeaderBuilder.mProfiles, IdDistributor.checkIds(profiles));
        this.mAccountHeaderBuilder.updateHeaderAndList();
    }
