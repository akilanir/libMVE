...
/* loaded from: com.android.support.appcompat-v7.20.0.0.jar:android/support/v7/internal/view/menu/MenuItemImpl.class */
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public SupportMenuItem m9setActionView(View view) {
    ...
    /* renamed from: setActionView, reason: merged with bridge method [inline-methods] */
    public SupportMenuItem m8setActionView(int resId) {
        Context context = this.mMenu.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        m9setActionView(inflater.inflate(resId, (ViewGroup) new LinearLayout(context), false));
        return this;
    }
    ...
    public SupportMenuItem m10setShowAsActionFlags(int actionEnum) {
