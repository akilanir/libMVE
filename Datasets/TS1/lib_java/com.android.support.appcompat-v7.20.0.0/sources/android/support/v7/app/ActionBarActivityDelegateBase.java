...
/* loaded from: com.android.support.appcompat-v7.20.0.0.jar:android/support/v7/app/ActionBarActivityDelegateBase.class */
class ActionBarActivityDelegateBase extends ActionBarActivityDelegate implements MenuPresenter.Callback, MenuBuilder.Callback {
    ...
    public View onCreatePanelView(int featureId) {
        ...
        if (featureId == 0 && preparePanel()) {
            createdPanelView = (View) getListMenuView(this.mActivity, this);
        }
    ...
    /* loaded from: com.android.support.appcompat-v7.20.0.0.jar:android/support/v7/app/ActionBarActivityDelegateBase$ActionModeCallbackWrapper.class */
