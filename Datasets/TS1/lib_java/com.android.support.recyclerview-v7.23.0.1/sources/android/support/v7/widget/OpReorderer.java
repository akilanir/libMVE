...
/* loaded from: com.android.support.recyclerview-v7.23.0.1.jar:android/support/v7/widget/OpReorderer.class */
class OpReorderer {
    final Callback mCallback;

    /* loaded from: com.android.support.recyclerview-v7.23.0.1.jar:android/support/v7/widget/OpReorderer$Callback.class */
    interface Callback {
    ...
    void swapMoveRemove(List<AdapterHelper.UpdateOp> list, int movePos, AdapterHelper.UpdateOp moveOp, int removePos, AdapterHelper.UpdateOp removeOp) {
        ...
        if (moveOp.positionStart <= removeOp.positionStart) {
            ...
            extraRm = this.mCallback.obtainUpdateOp(1, moveOp.positionStart + 1, remaining, null);
