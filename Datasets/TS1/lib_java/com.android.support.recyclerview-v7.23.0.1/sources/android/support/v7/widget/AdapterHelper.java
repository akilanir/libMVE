...
/* loaded from: com.android.support.recyclerview-v7.23.0.1.jar:android/support/v7/widget/AdapterHelper.class */
class AdapterHelper implements OpReorderer.Callback {
    ...
    /* loaded from: com.android.support.recyclerview-v7.23.0.1.jar:android/support/v7/widget/AdapterHelper$Callback.class */
    interface Callback {
    ...
    private void applyRemove(UpdateOp op) {
        ...
        while (position < tmpEnd) {
            ...
            if (vh != null || canFindInPreLayout(position)) {
                if (type == 0) {
                    UpdateOp newOp = obtainUpdateOp(1, tmpStart, tmpCount, null);
                ...
                if (type == 1) {
                    UpdateOp newOp2 = obtainUpdateOp(1, tmpStart, tmpCount, null);
    ...
    private void applyUpdate(UpdateOp op) {
        ...
        for (int position = op.positionStart; position < tmpEnd; position++) {
            ...
            if (vh != null || canFindInPreLayout(position)) {
                if (type == 0) {
                    UpdateOp newOp = obtainUpdateOp(2, tmpStart, tmpCount, op.payload);
                    dispatchAndUpdateViewHolders(newOp);
                    tmpCount = 0;
                    tmpStart = position;
                }
                ...
                if (type == 1) {
                    UpdateOp newOp2 = obtainUpdateOp(2, tmpStart, tmpCount, op.payload);
                    postponeAndUpdateViewHolders(newOp2);
                    tmpCount = 0;
                    tmpStart = position;
                }
    ...
    /* loaded from: com.android.support.recyclerview-v7.23.0.1.jar:android/support/v7/widget/AdapterHelper$UpdateOp.class */
    static class UpdateOp {
        ...
        public boolean equals(Object o) {
            ...
            if (this.cmd == MOVE && Math.abs(this.itemCount - this.positionStart) == 1 && this.itemCount == op.positionStart && this.positionStart == op.itemCount) {
                return true;
            }
