...
/* loaded from: com.android.support.recyclerview-v7.23.0.1.jar:android/support/v7/util/AsyncListUtil.class */
public class AsyncListUtil<T> {
    ...
    private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>() { // from class: android.support.v7.util.AsyncListUtil.2
        ...
        public void updateRange(int rangeStart, int rangeEnd, int extRangeStart, int extRangeEnd, int scrollHint) {
            ...
            if (scrollHint == 1) {
                ...
                requestTiles(lastVisibleTileStart + AsyncListUtil.this.mTileSize, this.mLastRequiredTileStart, scrollHint, false);
            } else {
        ...
        private void requestTiles(int firstTileStart, int lastTileStart, int scrollHint, boolean backwards) {
            ...
            while (true) {
                int i2 = i;
                if (i2 <= lastTileStart) {
                    int tileStart = backwards ? (lastTileStart + firstTileStart) - i2 : i2;
                    AsyncListUtil.this.mBackgroundProxy.loadTile(tileStart, scrollHint);
                    i = i2 + AsyncListUtil.this.mTileSize;
                } else {
                    return;
                }
            }
    ...
    /* loaded from: com.android.support.recyclerview-v7.23.0.1.jar:android/support/v7/util/AsyncListUtil$DataCallback.class */
    ...
    /* loaded from: com.android.support.recyclerview-v7.23.0.1.jar:android/support/v7/util/AsyncListUtil$ViewCallback.class */
