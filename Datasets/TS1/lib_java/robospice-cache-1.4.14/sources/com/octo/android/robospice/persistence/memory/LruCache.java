...
/* loaded from: robospice-cache-1.4.14.jar:com/octo/android/robospice/persistence/memory/LruCache.class */
public class LruCache<K, V> {
    ...
    public LruCache(int maxSize) {
        ...
        this.map = new LinkedHashMap<>(0, DEFAULT_LOAD_FACTOR, true);
    }
    ...
    */
    public void trimToSize(int r7) {
        ...
        Lb7:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.octo.android.robospice.persistence.memory.LruCache.trimToSize(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        int hitPercent = accesses != 0 ? (MAX_PERCENT * this.hitCount) / accesses : 0;
