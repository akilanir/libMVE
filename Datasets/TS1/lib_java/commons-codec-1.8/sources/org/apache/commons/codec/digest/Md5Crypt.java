...
/* loaded from: commons-codec-1.8.jar:org/apache/commons/codec/digest/Md5Crypt.class */
public class Md5Crypt {
    ...
    public static String md5Crypt(byte[] keyBytes, String salt, String prefix) {
        ...
        int ii = keyLen;
        while (ii > 0) {
            ctx.update(finalb, 0, ii > BLOCKSIZE ? BLOCKSIZE : ii);
            ii -= 16;
        }
        ...
        for (int i = 0; i < ROUNDS; i++) {
            ...
            if ((i & 1) != 0) {
                ...
                ctx1.update(finalb2, 0, BLOCKSIZE);
            }
            if (i % 3 != 0) {
                ctx1.update(saltBytes);
            }
