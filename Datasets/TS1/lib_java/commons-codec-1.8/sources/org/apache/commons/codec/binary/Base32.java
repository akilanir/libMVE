...
/* loaded from: commons-codec-1.8.jar:org/apache/commons/codec/binary/Base32.class */
    ...
    void encode(byte[] in, int inPos, int inAvail, BaseNCodec.Context context) {
        ...
        if (inAvail < 0) {
            ...
            switch (context.modulus) {
                ...
                case 1:
                    ...
                    int i2 = context.pos;
                    context.pos = i2 + 1;
                    buffer[i2] = this.encodeTable[((int) (context.lbitWorkArea << 2)) & MASK_5BITS];
                    int i3 = context.pos;
                    context.pos = i3 + 1;
                    buffer[i3] = 61;
                    int i4 = context.pos;
                ...
                case 2:
                    int i9 = context.pos;
                    context.pos = i9 + 1;
                    buffer[i9] = this.encodeTable[((int) (context.lbitWorkArea >> 11)) & MASK_5BITS];
                    int i10 = context.pos;
                    context.pos = i10 + 1;
                    buffer[i10] = this.encodeTable[((int) (context.lbitWorkArea >> 6)) & MASK_5BITS];
                    int i11 = context.pos;
                    context.pos = i11 + 1;
                    buffer[i11] = this.encodeTable[((int) (context.lbitWorkArea >> 1)) & MASK_5BITS];
                    int i12 = context.pos;
                    context.pos = i12 + 1;
                    buffer[i12] = this.encodeTable[((int) (context.lbitWorkArea << 4)) & MASK_5BITS];
                    int i13 = context.pos;
                    context.pos = i13 + 1;
                    buffer[i13] = 61;
                    int i14 = context.pos;
                ...
                case 3:
                    int i17 = context.pos;
                    context.pos = i17 + 1;
                    buffer[i17] = this.encodeTable[((int) (context.lbitWorkArea >> 19)) & MASK_5BITS];
                    int i18 = context.pos;
                    context.pos = i18 + 1;
                    buffer[i18] = this.encodeTable[((int) (context.lbitWorkArea >> 14)) & MASK_5BITS];
                    int i19 = context.pos;
                    context.pos = i19 + 1;
                    buffer[i19] = this.encodeTable[((int) (context.lbitWorkArea >> 9)) & MASK_5BITS];
                    int i20 = context.pos;
                    context.pos = i20 + 1;
                    buffer[i20] = this.encodeTable[((int) (context.lbitWorkArea >> 4)) & MASK_5BITS];
                    int i21 = context.pos;
                    context.pos = i21 + 1;
                    buffer[i21] = this.encodeTable[((int) (context.lbitWorkArea << 1)) & MASK_5BITS];
                    int i22 = context.pos;
                    context.pos = i22 + 1;
                    buffer[i22] = 61;
                    int i23 = context.pos;
                ...
                case 4:
                    int i25 = context.pos;
                    context.pos = i25 + 1;
                    buffer[i25] = this.encodeTable[((int) (context.lbitWorkArea >> 27)) & MASK_5BITS];
                    int i26 = context.pos;
                    context.pos = i26 + 1;
                    buffer[i26] = this.encodeTable[((int) (context.lbitWorkArea >> 22)) & MASK_5BITS];
                    int i27 = context.pos;
                    context.pos = i27 + 1;
                    buffer[i27] = this.encodeTable[((int) (context.lbitWorkArea >> 17)) & MASK_5BITS];
                    int i28 = context.pos;
                    context.pos = i28 + 1;
                    buffer[i28] = this.encodeTable[((int) (context.lbitWorkArea >> 12)) & MASK_5BITS];
                    int i29 = context.pos;
                    context.pos = i29 + 1;
                    buffer[i29] = this.encodeTable[((int) (context.lbitWorkArea >> 7)) & MASK_5BITS];
                    int i30 = context.pos;
                    context.pos = i30 + 1;
                    buffer[i30] = this.encodeTable[((int) (context.lbitWorkArea >> 2)) & MASK_5BITS];
                    int i31 = context.pos;
                    context.pos = i31 + 1;
                    buffer[i31] = this.encodeTable[((int) (context.lbitWorkArea << 3)) & MASK_5BITS];
                    int i32 = context.pos;
                    context.pos = i32 + 1;
                    buffer[i32] = 61;
                    break;
        ...
        for (int i33 = 0; i33 < inAvail; i33++) {
            ...
            if (0 == context.modulus) {
                int i35 = context.pos;
                context.pos = i35 + 1;
                buffer2[i35] = this.encodeTable[((int) (context.lbitWorkArea >> 35)) & MASK_5BITS];
                int i36 = context.pos;
                context.pos = i36 + 1;
                buffer2[i36] = this.encodeTable[((int) (context.lbitWorkArea >> 30)) & MASK_5BITS];
                int i37 = context.pos;
                context.pos = i37 + 1;
                buffer2[i37] = this.encodeTable[((int) (context.lbitWorkArea >> 25)) & MASK_5BITS];
                int i38 = context.pos;
                context.pos = i38 + 1;
                buffer2[i38] = this.encodeTable[((int) (context.lbitWorkArea >> 20)) & MASK_5BITS];
                int i39 = context.pos;
                context.pos = i39 + 1;
                buffer2[i39] = this.encodeTable[((int) (context.lbitWorkArea >> 15)) & MASK_5BITS];
                int i40 = context.pos;
                context.pos = i40 + 1;
                buffer2[i40] = this.encodeTable[((int) (context.lbitWorkArea >> 10)) & MASK_5BITS];
                int i41 = context.pos;
                context.pos = i41 + 1;
                buffer2[i41] = this.encodeTable[((int) (context.lbitWorkArea >> 5)) & MASK_5BITS];
                int i42 = context.pos;
                context.pos = i42 + 1;
                buffer2[i42] = this.encodeTable[((int) context.lbitWorkArea) & MASK_5BITS];
