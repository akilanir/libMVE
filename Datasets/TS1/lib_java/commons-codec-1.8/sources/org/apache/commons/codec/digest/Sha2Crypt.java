...
/* loaded from: commons-codec-1.8.jar:org/apache/commons/codec/digest/Sha2Crypt.class */
public class Sha2Crypt {
    ...
    private static String sha2Crypt(byte[] keyBytes, String salt, String saltPrefix, int blocksize, String algorithm) {
        ...
        if (m.group(3) != null) {
            ...
            rounds = Math.max(ROUNDS_MIN, Math.min(ROUNDS_MAX, rounds2));
            roundsCustom = true;
        }
        ...
        if (blocksize == SHA256_BLOCKSIZE) {
            ...
            B64.b64from24bit(altResult2[53], altResult2[11], altResult2[SHA256_BLOCKSIZE], 4, buffer);
