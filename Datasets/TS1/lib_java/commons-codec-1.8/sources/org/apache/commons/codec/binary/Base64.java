...
/* loaded from: commons-codec-1.8.jar:org/apache/commons/codec/binary/Base64.class */
    ...
    void encode(byte[] in, int inPos, int inAvail, BaseNCodec.Context context) {
        ...
        if (inAvail < 0) {
            ...
            switch (context.modulus) {
                ...
                case 1:
                    ...
                    int i2 = context.pos;
                    context.pos = i2 + 1;
                    buffer[i2] = this.encodeTable[(context.ibitWorkArea << BYTES_PER_ENCODED_BLOCK) & MASK_6BITS];
                ...
                case 2:
                    ...
                    int i6 = context.pos;
                    context.pos = i6 + 1;
                    buffer[i6] = this.encodeTable[(context.ibitWorkArea >> BYTES_PER_ENCODED_BLOCK) & MASK_6BITS];
                    int i7 = context.pos;
                    context.pos = i7 + 1;
        ...
        for (int i9 = 0; i9 < inAvail; i9++) {
            ...
            if (0 == context.modulus) {
                ...
                int i13 = context.pos;
                context.pos = i13 + 1;
                buffer2[i13] = this.encodeTable[(context.ibitWorkArea >> BITS_PER_ENCODED_BYTE) & MASK_6BITS];
                int i14 = context.pos;
                context.pos = i14 + 1;
    ...
    void decode(byte[] in, int inPos, int inAvail, BaseNCodec.Context context) {
        ...
        while (true) {
            ...
            if (b2 >= 0 && b2 < DECODE_TABLE.length && (b = DECODE_TABLE[b2]) >= 0) {
                ...
                context.ibitWorkArea = (context.ibitWorkArea << BITS_PER_ENCODED_BYTE) + b;
