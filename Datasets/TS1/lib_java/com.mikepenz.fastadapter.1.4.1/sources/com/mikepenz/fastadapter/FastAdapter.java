...
/* loaded from: com.mikepenz.fastadapter.1.4.1.jar:com/mikepenz/fastadapter/FastAdapter.class */
public class FastAdapter<Item extends IItem> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /* loaded from: com.mikepenz.fastadapter.1.4.1.jar:com/mikepenz/fastadapter/FastAdapter$OnBindViewHolderListener.class */
    public interface OnBindViewHolderListener {
        void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i);
    }

    /* loaded from: com.mikepenz.fastadapter.1.4.1.jar:com/mikepenz/fastadapter/FastAdapter$OnClickListener.class */
    public interface OnClickListener<Item extends IItem> {
        boolean onClick(View view, IAdapter<Item> iAdapter, Item item, int i);
    }

    /* loaded from: com.mikepenz.fastadapter.1.4.1.jar:com/mikepenz/fastadapter/FastAdapter$OnCreateViewHolderListener.class */
    ...
    /* loaded from: com.mikepenz.fastadapter.1.4.1.jar:com/mikepenz/fastadapter/FastAdapter$OnLongClickListener.class */
    ...
    /* loaded from: com.mikepenz.fastadapter.1.4.1.jar:com/mikepenz/fastadapter/FastAdapter$OnTouchListener.class */
    ...
    /* loaded from: com.mikepenz.fastadapter.1.4.1.jar:com/mikepenz/fastadapter/FastAdapter$RelativeInfo.class */
    ...
    public Item getTypeInstance(int type) {
        return (Item) this.mTypeInstances.get(Integer.valueOf(type));
    }
    ...
    public int getPreItemCount(int position) {
        ...
        return this.mAdapterSizes.floorKey(Integer.valueOf(position)).intValue();
    }
            ...
            if (expandable.isExpanded() && expandable.getSubItems() != null && expandable.getSubItems().size() > 0) {
                ...
                for (int i2 = length - 1; i2 >= 0; i2--) {
                    if (this.mExpanded.keyAt(i2) > position && this.mExpanded.keyAt(i2) <= position + totalAddedItems) {
                        ...
                        internalCollapse(this.mExpanded.keyAt(i2), notifyItemChanged);
                    }
                }
    ...
    /* loaded from: com.mikepenz.fastadapter.1.4.1.jar:com/mikepenz/fastadapter/FastAdapter$OnCreateViewHolderListenerImpl.class */
    ...
    /* loaded from: com.mikepenz.fastadapter.1.4.1.jar:com/mikepenz/fastadapter/FastAdapter$OnBindViewHolderListenerImpl.class */
