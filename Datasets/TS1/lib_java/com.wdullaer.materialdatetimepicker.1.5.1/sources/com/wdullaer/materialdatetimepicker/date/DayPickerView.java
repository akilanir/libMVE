...
/* loaded from: com.wdullaer.materialdatetimepicker.1.5.1.jar:com/wdullaer/materialdatetimepicker/date/DayPickerView.class */
public abstract class DayPickerView extends ListView implements AbsListView.OnScrollListener, DatePickerDialog.OnDateChangedListener {
    ...
    public void setAccentColor(int accentColor) {
        this.mAdapter.setAccentColor(accentColor);
    }
    ...
    /* loaded from: com.wdullaer.materialdatetimepicker.1.5.1.jar:com/wdullaer/materialdatetimepicker/date/DayPickerView$ScrollStateRunnable.class */
    ...
    private static String getMonthAndYearString(MonthAdapter.CalendarDay day) {
        ...
        String sbuf = BuildConfig.FLAVOR + cal.getDisplayName(2, 2, Locale.getDefault());
        return (sbuf + " ") + YEAR_FORMAT.format(cal.getTime());
    }
