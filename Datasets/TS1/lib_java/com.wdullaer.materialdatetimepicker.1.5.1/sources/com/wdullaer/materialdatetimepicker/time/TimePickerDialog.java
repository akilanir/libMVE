...
/* loaded from: com.wdullaer.materialdatetimepicker.1.5.1.jar:com/wdullaer/materialdatetimepicker/time/TimePickerDialog.class */
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    /* loaded from: com.wdullaer.materialdatetimepicker.1.5.1.jar:com/wdullaer/materialdatetimepicker/time/TimePickerDialog$OnTimeSetListener.class */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mCancelButton.setOnClickListener(new View.OnClickListener() { // from class: com.wdullaer.materialdatetimepicker.time.TimePickerDialog.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                TimePickerDialog.this.tryVibrate();
        ...
        if (this.mAccentColor == -1 && (accentColor = Utils.getAccentColorFromThemeIfAvailable(getActivity())) != -1) {
        ...
        if (this.mAccentColor != -1) {
            ...
            this.mTimePicker.setAccentColor(this.mAccentColor);
            timePickerHeader.setBackgroundColor(this.mAccentColor);
    ...
    /* loaded from: com.wdullaer.materialdatetimepicker.1.5.1.jar:com/wdullaer/materialdatetimepicker/time/TimePickerDialog$Node.class */
    ...
    /* loaded from: com.wdullaer.materialdatetimepicker.1.5.1.jar:com/wdullaer/materialdatetimepicker/time/TimePickerDialog$KeyboardListener.class */
