...
/* loaded from: com.wdullaer.materialdatetimepicker.1.5.1.jar:com/wdullaer/materialdatetimepicker/time/CircleView.class */
public class CircleView extends View {
    ...
    public CircleView(Context context) {
        ...
        this.mDotColor = res.getColor(R.color.mdtp_accent_color);
