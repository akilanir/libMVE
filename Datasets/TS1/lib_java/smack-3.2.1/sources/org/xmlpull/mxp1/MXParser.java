...
/* loaded from: smack-3.2.1.jar:org/xmlpull/mxp1/MXParser.class */
public class MXParser implements XmlPullParser {
    ...
    public String getPositionDescription() {
        ...
        return new StringBuffer().append(" ").append(XmlPullParser.TYPES[this.eventType]).append(fragment != null ? new StringBuffer().append(" seen ").append(printable(fragment)).append("...").toString() : XmlPullParser.NO_NAMESPACE).append(" ").append(this.location != null ? this.location : XmlPullParser.NO_NAMESPACE).append("@").append(getLineNumber()).append(":").append(getColumnNumber()).toString();
    }
    ...
    public void require(int type, String namespace, String name) throws XmlPullParserException, IOException {
        ...
        if (type != getEventType() || ((namespace != null && !namespace.equals(getNamespace())) || (name != null && !name.equals(getName())))) {
            throw new XmlPullParserException(new StringBuffer().append("expected event ").append(XmlPullParser.TYPES[type]).append(name != null ? new StringBuffer().append(" with name '").append(name).append("'").toString() : XmlPullParser.NO_NAMESPACE).append((namespace == null || name == null) ? XmlPullParser.NO_NAMESPACE : " and").append(namespace != null ? new StringBuffer().append(" with namespace '").append(namespace).append("'").toString() : XmlPullParser.NO_NAMESPACE).append(" but got").append(type != getEventType() ? new StringBuffer().append(" ").append(XmlPullParser.TYPES[getEventType()]).toString() : XmlPullParser.NO_NAMESPACE).append((name == null || getName() == null || name.equals(getName())) ? XmlPullParser.NO_NAMESPACE : new StringBuffer().append(" name '").append(getName()).append("'").toString()).append((namespace == null || name == null || getName() == null || name.equals(getName()) || getNamespace() == null || namespace.equals(getNamespace())) ? XmlPullParser.NO_NAMESPACE : " and").append((namespace == null || getNamespace() == null || namespace.equals(getNamespace())) ? XmlPullParser.NO_NAMESPACE : new StringBuffer().append(" namespace '").append(getNamespace()).append("'").toString()).append(" (position:").append(getPositionDescription()).append(")").toString());
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:105:0x03f5, code lost:
        ...
        if (r16 >= r9.attributeCount) goto L155;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:108:0x03ff, code lost:
        ...
        if (r17 >= r16) goto L158;
     */
    /* JADX WARN: Code restructure failed: missing block: B:110:0x0406, code lost:
    
        if (r9.allStringsInterned == false) goto L113;
     */
    /* JADX WARN: Code restructure failed: missing block: B:112:0x041a, code lost:
    
        if (r9.attributeName[r17].equals(r9.attributeName[r16]) != false) goto L156;
     */
    /* JADX WARN: Code restructure failed: missing block: B:114:0x0421, code lost:
    
        if (r9.allStringsInterned != false) goto L159;
     */
    /* JADX WARN: Code restructure failed: missing block: B:116:0x0432, code lost:
    
        if (r9.attributeNameHash[r17] != r9.attributeNameHash[r16]) goto L160;
     */
    /* JADX WARN: Code restructure failed: missing block: B:118:0x0446, code lost:
    
        if (r9.attributeName[r17].equals(r9.attributeName[r16]) == false) goto L161;
     */
    /* JADX WARN: Code restructure failed: missing block: B:120:0x0482, code lost:
    
        throw new org.xmlpull.v1.XmlPullParserException(new java.lang.StringBuffer().append("duplicated attributes ").append(r9.attributeName[r17]).append(" and ").append(r9.attributeName[r16]).toString(), r9, null);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:54:0x023c, code lost:
        ...
        if (r9.processNamespaces == false) goto L103;
     */
    /* JADX WARN: Code restructure failed: missing block: B:55:0x023f, code lost:
    
        r16 = getNamespace(r15);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:61:0x0275, code lost:
        ...
        throw new org.xmlpull.v1.XmlPullParserException(new java.lang.StringBuffer().append("could not determine namespace bound to element prefix ").append(r15).toString(), r9, null);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:64:0x028a, code lost:
        ...
        if (r17 >= r9.attributeCount) goto L143;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:72:0x02d2, code lost:
        ...
        r9.attributeUri[r17] = org.xmlpull.v1.XmlPullParser.NO_NAMESPACE;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:76:0x02ea, code lost:
        ...
        if (r17 >= r9.attributeCount) goto L147;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:93:0x035f, code lost:
        ...
        if (r9.attributeUri[r18] == null) goto L95;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:96:0x0392, code lost:
        ...
        if (r9.attributeUri[r17] == null) goto L98;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:99:0x03dc, code lost:
        ...
        throw new org.xmlpull.v1.XmlPullParserException(new java.lang.StringBuffer().append("duplicated attributes ").append(r19).append(" and ").append(r20).toString(), r9, null);
     */
    /*
    ...
    */
            ...
            while (true) {
                if (ch == '?') {
                    ...
                    if (!seenQ) {
                        ...
                        int i = piTargetStart - this.bufAbsoluteStart;
                        int i2 = piTargetEnd - this.bufAbsoluteStart;
                        if (this.tokenize) {
    ...
    protected void fillBuf() throws IOException, XmlPullParserException {
        ...
        int len = this.buf.length - this.bufEnd > READ_CHUNK_SIZE ? READ_CHUNK_SIZE : this.buf.length - this.bufEnd;
    ...
    protected void ensurePC(int end) {
        int newSize = end > READ_CHUNK_SIZE ? 2 * end : 16384;
    ...
    protected String printable(char ch) {
        ...
        return new StringBuffer().append(XmlPullParser.NO_NAMESPACE).append(ch).toString();
    }
