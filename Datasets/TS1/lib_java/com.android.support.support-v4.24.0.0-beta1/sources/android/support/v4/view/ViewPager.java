...
/* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager.class */
public class ViewPager extends ViewGroup {
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$DecorView.class */
    public @interface DecorView {
    }

    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$OnAdapterChangeListener.class */
    public interface OnAdapterChangeListener {
        void onAdapterChanged(@NonNull ViewPager viewPager, @Nullable PagerAdapter pagerAdapter, @Nullable PagerAdapter pagerAdapter2);
    }

    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$OnPageChangeListener.class */
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$PageTransformer.class */
    public interface PageTransformer {
        void transformPage(View view, float f);
    }

    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$ItemInfo.class */
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$SimpleOnPageChangeListener.class */
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$SavedState.class */
    public static class SavedState extends AbsSavedState {
        ...
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: android.support.v4.view.ViewPager.SavedState.1
            ...
            public SavedState m99createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(in, loader);
            }

            /* renamed from: newArray, reason: merged with bridge method [inline-methods] */
            public SavedState[] m98newArray(int size) {
    ...
    */
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            for (int pos = firstPos; pos < lastPos; pos++) {
                ...
                if (drawAt + this.mPageMargin > scrollX) {
                    this.mMarginDrawable.setBounds(Math.round(drawAt), this.mTopPageBounds, Math.round(drawAt + this.mPageMargin), this.mBottomPageBounds);
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$MyAccessibilityDelegate.class */
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$PagerObserver.class */
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$LayoutParams.class */
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/view/ViewPager$ViewPositionComparator.class */
