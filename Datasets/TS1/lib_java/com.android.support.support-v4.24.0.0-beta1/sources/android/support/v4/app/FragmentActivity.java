...
/* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/app/FragmentActivity.class */
public class FragmentActivity extends BaseFragmentActivityApi24 implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompatApi23.RequestPermissionsRequestCodeValidator {
    ...
    @CallSuper
    public /* bridge */ /* synthetic */ void onPictureInPictureModeChanged(boolean x0) {
        super.onPictureInPictureModeChanged(x0);
    }

    @CallSuper
    public /* bridge */ /* synthetic */ void onMultiWindowModeChanged(boolean x0) {
        super.onMultiWindowModeChanged(x0);
    }
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/app/FragmentActivity$NonConfigurationInstances.class */
    ...
    public void startIntentSenderFromFragment(Fragment fragment, IntentSender intent, int requestCode, @Nullable Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws IntentSender.SendIntentException {
        ...
        try {
            if (requestCode == -1) {
                ...
                checkForValidRequestCode(requestCode);
                int requestIndex = allocateRequestIndex(fragment);
                ActivityCompat.startIntentSenderForResult(this, intent, ((requestIndex + 1) << 16) + (requestCode & SupportMenu.USER_MASK), fillInIntent, flagsMask, flagsValues, extraFlags, options);
                this.mStartedIntentSenderFromFragment = false;
            }
        } catch (Throwable th) {
            this.mStartedIntentSenderFromFragment = false;
    ...
    public void requestPermissionsFromFragment(Fragment fragment, String[] permissions, int requestCode) {
        ...
        try {
            ...
            int requestIndex = allocateRequestIndex(fragment);
            ActivityCompat.requestPermissions(this, permissions, ((requestIndex + 1) << 16) + (requestCode & SupportMenu.USER_MASK));
    ...
    /* loaded from: com.android.support.support-v4.24.0.0-beta1.jar:android/support/v4/app/FragmentActivity$HostCallbacks.class */
