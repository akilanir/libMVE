...
/* loaded from: okhttp-2.5.0.jar:com/squareup/okhttp/ConnectionSpec.class */
public final class ConnectionSpec {
    ...
    public boolean isCompatible(SSLSocket socket) {
        ...
        if (this.cipherSuites == null) {
            ...
            requiredCiphersEnabled = nonEmptyIntersection(this.cipherSuites, enabledCipherSuites);
        }
    ...
    /* loaded from: okhttp-2.5.0.jar:com/squareup/okhttp/ConnectionSpec$Builder.class */
