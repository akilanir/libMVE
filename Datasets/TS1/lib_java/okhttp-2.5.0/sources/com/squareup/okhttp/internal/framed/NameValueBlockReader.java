...
/* loaded from: okhttp-2.5.0.jar:com/squareup/okhttp/internal/framed/NameValueBlockReader.class */
class NameValueBlockReader {
    ...
    public NameValueBlockReader(BufferedSource source) {
        ForwardingSource forwardingSource = new ForwardingSource(source) { // from class: com.squareup.okhttp.internal.framed.NameValueBlockReader.1
