...
/* loaded from: okhttp-2.3.0.jar:com/squareup/okhttp/internal/http/HttpEngine.class */
public final class HttpEngine {
    ...
    /* loaded from: okhttp-2.3.0.jar:com/squareup/okhttp/internal/http/HttpEngine$NetworkInterceptorChain.class */
    ...
    public Request followUpRequest() throws IOException {
        ...
        switch (responseCode) {
            ...
            case 302:
            case 303:
                if (!this.client.getFollowRedirects() || (location = this.userResponse.header("Location")) == null) {
                    return null;
                }
