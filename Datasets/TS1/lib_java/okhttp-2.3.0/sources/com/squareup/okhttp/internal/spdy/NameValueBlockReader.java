...
/* loaded from: okhttp-2.3.0.jar:com/squareup/okhttp/internal/spdy/NameValueBlockReader.class */
class NameValueBlockReader {
    ...
    public NameValueBlockReader(BufferedSource source) {
        ForwardingSource forwardingSource = new ForwardingSource(source) { // from class: com.squareup.okhttp.internal.spdy.NameValueBlockReader.1
