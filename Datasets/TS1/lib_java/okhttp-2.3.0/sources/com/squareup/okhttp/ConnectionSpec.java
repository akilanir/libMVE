...
/* loaded from: okhttp-2.3.0.jar:com/squareup/okhttp/ConnectionSpec.class */
public final class ConnectionSpec {
    ...
    private ConnectionSpec supportedSpec(SSLSocket sslSocket) {
        ...
        String[] tlsVersionsToEnable = (String[]) Util.intersect(String.class, this.tlsVersions, protocolsToSelectFrom);
        return new Builder(this).cipherSuites(cipherSuitesToEnable).tlsVersions(tlsVersionsToEnable).build();
    }
    ...
    /* loaded from: okhttp-2.3.0.jar:com/squareup/okhttp/ConnectionSpec$Builder.class */
