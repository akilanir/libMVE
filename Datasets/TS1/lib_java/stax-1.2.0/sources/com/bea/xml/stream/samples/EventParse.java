...
/* loaded from: stax-1.2.0.jar:com/bea/xml/stream/samples/EventParse.class */
public class EventParse {
    ...
    private static void printEvent(XMLStreamReader xmlr) {
        System.out.print(new StringBuffer().append("EVENT:[").append(xmlr.getLocation().getLineNumber()).append("][").append(xmlr.getLocation().getColumnNumber()).append("] ").toString());
        ...
        switch (xmlr.getEventType()) {
            ...
            case 7:
                ...
                System.out.print(new StringBuffer().append(" version='").append(xmlr.getVersion()).append("'").toString());
                System.out.print(new StringBuffer().append(" encoding='").append(xmlr.getCharacterEncodingScheme()).append("'").toString());
                ...
                break;
            case 9:
                System.out.print(new StringBuffer().append(xmlr.getLocalName()).append("=").toString());
                if (xmlr.hasText()) {
                    System.out.print(new StringBuffer().append("[").append(xmlr.getText()).append("]").toString());
                    break;
                }
                break;
            case 12:
    ...
    private static void printName(String prefix, String uri, String localName) {
        if (uri != null && !"".equals(uri)) {
            System.out.print(new StringBuffer().append("['").append(uri).append("']:").toString());
        }
        if (prefix != null) {
            System.out.print(new StringBuffer().append(prefix).append(":").toString());
        }
        if (localName != null) {
    ...
    private static void printAttribute(Attribute a) {
        ...
        System.out.print(new StringBuffer().append("='").append(a.getValue()).append("'").toString());
    }
    ...
    private static void printNamespace(Namespace n) {
        if (n.isDefaultNamespaceDeclaration()) {
            System.out.print(new StringBuffer().append("xmlns='").append(n.getNamespaceURI()).append("'").toString());
        } else {
            System.out.print(new StringBuffer().append("xmlns:").append(n.getPrefix()).append("='").append(n.getNamespaceURI()).append("'").toString());
        }
    }
}
