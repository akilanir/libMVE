...
/* loaded from: fastjson-1.2.11.jar:com/alibaba/fastjson/serializer/ASMSerializerFactory.class */
public class ASMSerializerFactory implements Opcodes {
    ...
    /* loaded from: fastjson-1.2.11.jar:com/alibaba/fastjson/serializer/ASMSerializerFactory$Context.class */
    static class Context {
        ...
        public int getFieldOrinal(String name) {
            ...
            while (true) {
                ...
                FieldInfo item = this.getters.get(i);
    ...
    public ObjectSerializer createJavaBeanSerializer(Class<?> clazz, Map<String, String> aliasMap) throws Exception {
        ...
        if (orders != null && orders.length != 0) {
            ...
            getters = new ArrayList(unsortedGetters);
        ...
        for (int i2 = 0; i2 < getters.size(); i2++) {
            ...
            if (!fieldInfo3.fieldClass.isPrimitive() && !fieldInfo3.fieldClass.isEnum() && fieldInfo3.fieldClass != String.class) {
                ...
                if (fieldInfo3.method != null) {
                    ...
                    mw.visitVarInsn(25, 0);
                    mw.visitLdcInsn(Integer.valueOf(i2));
        ...
        if (jsonType != null) {
            ...
            while (true) {
                ...
                SerializerFeature featrues = serialzeFeatures[i3];
        ...
        for (int i4 = 0; i4 < 3; i4++) {
            ...
            if (!nativeSorted && !context.writeDirect && (jsonType == null || jsonType.alphabetic())) {
                ...
                mw2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, SerializeWriter, "isSortField", "()Z");
                mw2.visitJumpInsn(Opcodes.IFNE, _else);
                ...
                mw2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, classNameType, "writeUnsorted", "(L" + JSONSerializer + ";Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
            ...
            if (context.writeDirect && !nonContext) {
                ...
                mw2.visitVarInsn(25, 1);
                mw2.visitVarInsn(25, 0);
                mw2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "writeDirect", "(" + JavaBeanSerializer_desc + ")Z");
                mw2.visitJumpInsn(Opcodes.IFNE, _directElse);
                mw2.visitVarInsn(25, 0);
                mw2.visitVarInsn(25, 1);
                mw2.visitVarInsn(25, 2);
                mw2.visitVarInsn(25, 3);
                mw2.visitVarInsn(25, 4);
                mw2.visitVarInsn(21, 5);
                mw2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, classNameType, "writeNormal", "(L" + JSONSerializer + ";Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
                mw2.visitInsn(Opcodes.RETURN);
                mw2.visitLabel(_directElse);
                mw2.visitVarInsn(25, context.var("out"));
                mw2.visitLdcInsn(Integer.valueOf(SerializerFeature.DisableCircularReferenceDetect.mask));
                mw2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, SerializeWriter, "isEnabled", "(I)Z");
                mw2.visitJumpInsn(Opcodes.IFEQ, _direct);
                mw2.visitVarInsn(25, 0);
                mw2.visitVarInsn(25, 1);
                mw2.visitVarInsn(25, 2);
                mw2.visitVarInsn(25, 3);
                mw2.visitVarInsn(25, 4);
                mw2.visitVarInsn(21, 5);
                mw2.visitMethodInsn(Opcodes.INVOKEVIRTUAL, classNameType, "writeDirectNonContext", "(L" + JSONSerializer + ";Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
                mw2.visitInsn(Opcodes.RETURN);
        ...
        for (int i5 = 0; i5 < 3; i5++) {
            ...
            Context context3 = new Context(getters, jsonType, classNameType, beanSerializeFeatures, writeDirect2, nonContext2);
        ...
        Class<?> exampleClass = this.classLoader.defineClassPublic(classNameFull, code, 0, code.length);
    ...
    private void _get(MethodVisitor mw, Context context, FieldInfo property) {
        ...
        if (method != null) {
            ...
            mw.visitVarInsn(25, context.var("entity"));
            mw.visitFieldInsn(Opcodes.GETFIELD, ASMUtils.type(property.declaringClass), property.field.getName(), ASMUtils.desc(property.fieldClass));
        }
    }
    ...
    private void _processValue(MethodVisitor mw, FieldInfo fieldInfo, Context context, Label _end) {
        ...
        mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONSerializer, "processValue", "(" + SerializeFilterable_desc + ASMUtils.desc((Class<?>) BeanContext.class) + "Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;");
        mw.visitVarInsn(58, Context.processValue);
        mw.visitVarInsn(25, Context.original);
        mw.visitVarInsn(25, Context.processValue);
