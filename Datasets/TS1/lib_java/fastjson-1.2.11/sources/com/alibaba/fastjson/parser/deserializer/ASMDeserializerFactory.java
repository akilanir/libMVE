...
/* loaded from: fastjson-1.2.11.jar:com/alibaba/fastjson/parser/deserializer/ASMDeserializerFactory.class */
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        MethodVisitor mw = new MethodWriter(cw, 1, "deserialze", "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;", null, null);
        ...
        for (int i3 = 0; i3 < fieldListSize; i3++) {
            ...
            if (fieldClass3 == Boolean.TYPE) {
                ...
                mw.visitVarInsn(25, 1);
                mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, DefaultJSONParser, "getSymbolTable", "()" + ASMUtils.desc((Class<?>) SymbolTable.class));
                mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONLexerBase, "scanFieldSymbol", "([C" + ASMUtils.desc((Class<?>) SymbolTable.class) + ")Ljava/lang/String;");
                mw.visitInsn(89);
                mw.visitVarInsn(58, context.var(fieldInfo3.name + "_asm_enumName"));
                mw.visitJumpInsn(Opcodes.IFNULL, enumNull_);
                mw.visitVarInsn(25, context.var(fieldInfo3.name + "_asm_enumName"));
                mw.visitMethodInsn(Opcodes.INVOKESTATIC, ASMUtils.type(fieldClass3), "valueOf", "(Ljava/lang/String;)" + ASMUtils.desc(fieldClass3));
                mw.visitVarInsn(58, context.var(fieldInfo3.name + "_asm"));
    ...
    /* loaded from: fastjson-1.2.11.jar:com/alibaba/fastjson/parser/deserializer/ASMDeserializerFactory$Context.class */
    ...
    private void _init(ClassWriter cw, Context context) {
        int size = context.fieldInfoList.length;
        for (int i = 0; i < size; i++) {
            FieldWriter fw = new FieldWriter(cw, 1, context.fieldInfoList[i].name + "_asm_prefix__", "[C");
            fw.visitEnd();
        }
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (!fieldClass.isPrimitive()) {
                if (Collection.class.isAssignableFrom(fieldClass)) {
                    ...
                    FieldWriter fw3 = new FieldWriter(cw, 1, fieldInfo.name + "_asm_deser__", ASMUtils.desc((Class<?>) ObjectDeserializer.class));
                    fw3.visitEnd();
                }
            }
        }
        MethodVisitor mw = new MethodWriter(cw, 1, "<init>", "(" + ASMUtils.desc((Class<?>) ParserConfig.class) + "Ljava/lang/Class;)V", null, null);
        mw.visitVarInsn(25, 0);
        mw.visitVarInsn(25, 1);
        mw.visitVarInsn(25, 2);
        mw.visitMethodInsn(Opcodes.INVOKESPECIAL, ASMUtils.type(JavaBeanDeserializer.class), "<init>", "(" + ASMUtils.desc((Class<?>) ParserConfig.class) + "Ljava/lang/Class;)V");
