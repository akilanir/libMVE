...
/* loaded from: fastjson-1.2.11.jar:com/alibaba/fastjson/serializer/SerializeConfig.class */
public class SerializeConfig {
    ...
    public void addFilter(Class<?> clazz, SerializeFilter filter) {
        ...
        if (objectWriter instanceof SerializeFilterable) {
            ((SerializeFilterable) objectWriter).addFilter(filter);
        }
    }
    ...
    public ObjectSerializer getObjectWriter(Class<?> clazz) {
        ...
        if (writer == null) {
            if (Map.class.isAssignableFrom(clazz)) {
                ...
                put(clazz, new JavaBeanSerializer(clazz, null, features | SerializerFeature.WriteClassName.mask));
