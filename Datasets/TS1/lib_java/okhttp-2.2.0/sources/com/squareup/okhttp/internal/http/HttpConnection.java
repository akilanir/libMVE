...
/* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/http/HttpConnection.class */
public final class HttpConnection {
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/http/HttpConnection$FixedLengthSink.class */
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/http/HttpConnection$ChunkedSink.class */
    private final class ChunkedSink implements Sink {
        ...
        private void writeHex(long i) throws IOException {
            ...
            do {
                cursor--;
                this.hex[cursor] = HttpConnection.HEX_DIGITS[(int) (i & 15)];
                j = i >>> 4;
                i = j;
            } while (j != 0);
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/http/HttpConnection$AbstractSource.class */
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/http/HttpConnection$FixedLengthSource.class */
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/http/HttpConnection$ChunkedSource.class */
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/http/HttpConnection$UnknownLengthSource.class */
