...
/* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/MultipartBuilder.class */
public final class MultipartBuilder {
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/MultipartBuilder$MultipartRequestBody.class */
    private static final class MultipartRequestBody extends RequestBody {
        ...
        public void writeTo(BufferedSink sink) throws IOException {
            ...
            for (int p = 0; p < partCount; p++) {
                ...
                if (contentLength != -1) {
                    sink.writeUtf8("Content-Length: ").writeUtf8(Long.toString(contentLength)).write(MultipartBuilder.CRLF);
                }
                sink.write(MultipartBuilder.CRLF);
