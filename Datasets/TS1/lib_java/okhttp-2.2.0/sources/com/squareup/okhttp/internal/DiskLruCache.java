...
/*  JADX ERROR: NullPointerException in pass: ClassModifier
    ...
    */
/* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/DiskLruCache.class */
public final class DiskLruCache implements Closeable {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Failed to check method for inline after forced processcom.squareup.okhttp.internal.DiskLruCache.Entry.access$1402(com.squareup.okhttp.internal.DiskLruCache$Entry, long):long */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static String sourceToString(Source in) throws IOException {
        try {
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/DiskLruCache$Snapshot.class */
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/DiskLruCache$Editor.class */
    public final class Editor {
        ...
        public Source newSource(int index) throws IOException {
            synchronized (DiskLruCache.this) {
                ...
                try {
                    return Okio.source(this.entry.cleanFiles[index]);
        ...
        /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/DiskLruCache$Editor$FaultHidingSink.class */
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/DiskLruCache$Entry.class */
    private final class Entry {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x0002: MOVE_MULTI
            ...
            */
        static /* synthetic */ long access$1402(com.squareup.okhttp.internal.DiskLruCache.Entry r6, long r7) {
            /*
                r0 = r6
                r1 = r7
                ...
                return r-1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.squareup.okhttp.internal.DiskLruCache.Entry.access$1402(com.squareup.okhttp.internal.DiskLruCache$Entry, long):long");
        }
        ...
        void writeLengths(BufferedSink writer) throws IOException {
            for (long length : this.lengths) {
                writer.writeByte(32).writeUtf8(Long.toString(length));
            }
        }
        ...
        Snapshot snapshot() {
            ...
            for (int i = 0; i < DiskLruCache.this.valueCount; i++) {
                try {
                    closeableArr[i] = Okio.source(this.cleanFiles[i]);
                } catch (FileNotFoundException e) {
            ...
            return new Snapshot(DiskLruCache.this, this.key, this.sequenceNumber, closeableArr, this.lengths, null);
        }
    }
}
