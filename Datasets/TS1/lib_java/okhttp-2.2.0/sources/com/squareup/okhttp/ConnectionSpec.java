...
/* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/ConnectionSpec.class */
public final class ConnectionSpec {
    ...
    void apply(SSLSocket sslSocket, Route route) {
        ...
        if (route.shouldSendTlsFallbackIndicator) {
            ...
            if (socketSupportsFallbackScsv) {
                String[] newEnabledCipherSuites = new String[cipherSuitesToEnable.length + 1];
                System.arraycopy(cipherSuitesToEnable, 0, newEnabledCipherSuites, 0, cipherSuitesToEnable.length);
    ...
    private ConnectionSpec supportedSpec(SSLSocket sslSocket) {
        List<String> supportedCipherSuites = Util.intersect(this.cipherSuites, sslSocket.getSupportedCipherSuites());
        List<String> supportedTlsVersions = Util.intersect(this.tlsVersions, sslSocket.getSupportedProtocols());
    ...
    public boolean equals(Object other) {
        ...
        if (this.tls) {
            return Arrays.equals(this.cipherSuites, that.cipherSuites) && Arrays.equals(this.tlsVersions, that.tlsVersions) && this.supportsTlsExtensions == that.supportsTlsExtensions;
        }
        return true;
    }
    ...
    public int hashCode() {
        int result = 17;
        if (this.tls) {
            int result2 = (31 * 17) + Arrays.hashCode(this.cipherSuites);
            result = (31 * ((31 * result2) + Arrays.hashCode(this.tlsVersions))) + (this.supportsTlsExtensions ? 0 : 1);
        }
        return result;
    }
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/ConnectionSpec$Builder.class */
