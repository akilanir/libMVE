...
/* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/Call.class */
public class Call {
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/Call$AsyncCall.class */
    final class AsyncCall extends NamedRunnable {
        ...
        protected void execute() {
            try {
                Response response = Call.this.getResponseWithInterceptorChain();
    ...
    /* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/Call$ApplicationInterceptorChain.class */
    class ApplicationInterceptorChain implements Interceptor.Chain {
        ...
        public Response proceed(Request request) throws IOException {
            if (this.index < Call.this.client.interceptors().size()) {
                ApplicationInterceptorChain chain = Call.this.new ApplicationInterceptorChain(this.index + 1, request);
