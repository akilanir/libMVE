...
/* loaded from: okhttp-2.2.0.jar:com/squareup/okhttp/internal/tls/OkHostnameVerifier.class */
    ...
    private static List<String> getSubjectAltNames(X509Certificate certificate, int type) {
        ...
        try {
            ...
            for (Object subjectAltName : subjectAltNames) {
                ...
                if (entry != null && entry.size() >= ALT_DNS_NAME && (altNameType = (Integer) entry.get(0)) != null) {
