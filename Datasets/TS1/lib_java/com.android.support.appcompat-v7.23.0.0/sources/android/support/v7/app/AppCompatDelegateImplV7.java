...
/* loaded from: com.android.support.appcompat-v7.23.0.0.jar:android/support/v7/app/AppCompatDelegateImplV7.class */
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflaterFactory {
        ...
        if (mode != null) {
                ...
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new Runnable() { // from class: android.support.v7.app.AppCompatDelegateImplV7.4
                        ...
                        public void run() {
                            ...
                            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.app.AppCompatDelegateImplV7.4.1
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode2, mode2.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: android.support.v7.app.AppCompatDelegateImplV7.5
                        public void onAnimationEnd(View view) {
                            ViewCompat.setAlpha(AppCompatDelegateImplV7.this.mActionModeView, 1.0f);
                            AppCompatDelegateImplV7.this.mFadeAnim.setListener((ViewPropertyAnimatorListener) null);
                            AppCompatDelegateImplV7.this.mFadeAnim = null;
    ...
    boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (Build.VERSION.SDK_INT < 11 && onKeyShortcut(keyCode, event)) {
            return true;
        }
        return false;
    }
        ...
        if (this.mDecorContentParent != null && this.mDecorContentParent.canShowOverflowMenu() && (!ViewConfigurationCompat.hasPermanentMenuKey(ViewConfiguration.get(this.mContext)) || this.mDecorContentParent.isOverflowMenuShowPending())) {
            ...
            if (!this.mDecorContentParent.isOverflowMenuShowing() || !toggleMenuMode) {
                if (windowCallback != null && !isDestroyed()) {
                    ...
                    PanelFeatureState st = getPanelState(0, true);
                    if (st.menu != null && !st.refreshMenuContent && windowCallback.onPreparePanel(0, st.createdPanelView, st.menu)) {
                        windowCallback.onMenuOpened(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, st.menu);
    ...
    public void checkCloseActionMenu(MenuBuilder menuBuilder) {
        ...
        if (cb != null && !isDestroyed()) {
            cb.onPanelClosed(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, menuBuilder);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v11, types: [android.support.v7.internal.view.menu.MenuBuilder] */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.0.jar:android/support/v7/app/AppCompatDelegateImplV7$ActionModeCallbackWrapperV7.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.0.jar:android/support/v7/app/AppCompatDelegateImplV7$PanelMenuPresenterCallback.class */
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menu, boolean allMenusAreClosing) {
            ...
            PanelFeatureState panel = AppCompatDelegateImplV7.this.findMenuPanel(isSubMenu ? rootMenu : menu);
            if (panel != null) {
                if (isSubMenu) {
        ...
        public boolean onOpenSubMenu(MenuBuilder menuBuilder) {
            Window.Callback cb;
            if (menuBuilder == 0 && AppCompatDelegateImplV7.this.mHasActionBar && (cb = AppCompatDelegateImplV7.this.getWindowCallback()) != null && !AppCompatDelegateImplV7.this.isDestroyed()) {
                cb.onMenuOpened(AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR, menuBuilder);
                return true;
            }
            return true;
        }
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.0.jar:android/support/v7/app/AppCompatDelegateImplV7$ActionMenuPresenterCallback.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.0.jar:android/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState.class */
    private static final class PanelFeatureState {
        ...
        /* loaded from: com.android.support.appcompat-v7.23.0.0.jar:android/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState$SavedState.class */
    ...
    /* loaded from: com.android.support.appcompat-v7.23.0.0.jar:android/support/v7/app/AppCompatDelegateImplV7$ListMenuDecorView.class */
