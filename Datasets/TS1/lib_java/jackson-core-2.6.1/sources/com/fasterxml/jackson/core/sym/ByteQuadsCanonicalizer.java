...
/* loaded from: jackson-core-2.6.1.jar:com/fasterxml/jackson/core/sym/ByteQuadsCanonicalizer.class */
public final class ByteQuadsCanonicalizer {
    ...
    public int calcHash(int q1, int q2) {
        ...
        int hash3 = hash2 + (hash2 >>> MIN_HASH_SIZE);
    ...
    public int calcHash(int q1, int q2, int q3) {
        int hash = q1 ^ this._seed;
        int hash2 = (((hash + (hash >>> 9)) * MULT3) + q2) * 33;
    ...
    /* loaded from: jackson-core-2.6.1.jar:com/fasterxml/jackson/core/sym/ByteQuadsCanonicalizer$TableInfo.class */
