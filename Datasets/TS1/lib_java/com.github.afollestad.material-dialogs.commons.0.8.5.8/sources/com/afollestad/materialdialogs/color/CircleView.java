...
/* loaded from: com.github.afollestad.material-dialogs.commons.0.8.5.8.jar:com/afollestad/materialdialogs/color/CircleView.class */
public class CircleView extends FrameLayout {
    ...
    private void update(@ColorInt int color) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ?? r0 = {new int[]{R.attr.state_pressed}};
            int[] colors = {shiftColorUp(color)};
            ColorStateList rippleColors = new ColorStateList(r0, colors);
    ...
    private Drawable createSelector(int color) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_pressed}, darkerCircle);
