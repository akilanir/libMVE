...
/* loaded from: me.zhanghai.android.materialprogressbar.library.1.1.4.jar:me/zhanghai/android/materialprogressbar/IndeterminateProgressDrawable.class */
public class IndeterminateProgressDrawable extends IndeterminateProgressDrawableBase {
    ...
    private void drawRing(Canvas canvas, Paint paint) {
        ...
        float startAngle = (-90.0f) + (360.0f * (this.mRingPathTransform.mTrimPathOffset + this.mRingPathTransform.mTrimPathStart));
    ...
    /* loaded from: me.zhanghai.android.materialprogressbar.library.1.1.4.jar:me/zhanghai/android/materialprogressbar/IndeterminateProgressDrawable$RingPathTransform.class */
    ...
    /* loaded from: me.zhanghai.android.materialprogressbar.library.1.1.4.jar:me/zhanghai/android/materialprogressbar/IndeterminateProgressDrawable$RingRotation.class */
