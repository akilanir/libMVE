...
/* loaded from: me.zhanghai.android.materialprogressbar.library.1.1.4.jar:me/zhanghai/android/materialprogressbar/IndeterminateHorizontalProgressDrawable.class */
public class IndeterminateHorizontalProgressDrawable extends IndeterminateProgressDrawableBase implements ShowTrackDrawable {
    ...
    public int getOpacity() {
        ...
        if (!this.mShowTrack || this.mTrackAlpha == 1.0f) {
            return -1;
        }
        return -3;
    }
    ...
    /* loaded from: me.zhanghai.android.materialprogressbar.library.1.1.4.jar:me/zhanghai/android/materialprogressbar/IndeterminateHorizontalProgressDrawable$RectTransformX.class */
