...
/* loaded from: dagger-compiler-1.2.2.jar:dagger/internal/codegen/Util.class */
final class Util {
            ...
            if (rawTypeToString(annotation.getAnnotationType(), '$').equals(annotationType.getName())) {
                ...
                for (Map.Entry<? extends ExecutableElement, ? extends AnnotationValue> e : annotation.getElementValues().entrySet()) {
                    ...
                    if (!lenientIsInstance(defaultValue.getClass(), value)) {
                        ...
                        objArr[4] = value instanceof Object[] ? Arrays.toString((Object[]) value) : value;
    ...
    /* loaded from: dagger-compiler-1.2.2.jar:dagger/internal/codegen/Util$3.class */
    ...
    /* loaded from: dagger-compiler-1.2.2.jar:dagger/internal/codegen/Util$CodeGenerationIncompleteException.class */
