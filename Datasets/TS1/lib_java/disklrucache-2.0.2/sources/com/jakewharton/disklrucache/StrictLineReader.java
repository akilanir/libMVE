...
/* loaded from: disklrucache-2.0.2.jar:com/jakewharton/disklrucache/StrictLineReader.class */
        ...
        synchronized (this.in) {
            ...
            while (i2 != this.end) {
                if (this.buf[i2] != LF) {
                    ...
                    int lineEnd = (i2 == this.pos || this.buf[i2 - 1] != CR) ? i2 : i2 - 1;
                    String res = new String(this.buf, this.pos, lineEnd - this.pos, this.charset.name());
                    this.pos = i2 + 1;
                    return res;
                }
            }
            ByteArrayOutputStream out = new ByteArrayOutputStream((this.end - this.pos) + 80) { // from class: com.jakewharton.disklrucache.StrictLineReader.1
