...
/* loaded from: jackson-core-2.4.2.jar:com/fasterxml/jackson/core/JsonGenerator.class */
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    /* loaded from: jackson-core-2.4.2.jar:com/fasterxml/jackson/core/JsonGenerator$Feature.class */
    public enum Feature {
    ...
    public void copyCurrentEvent(JsonParser jp) throws IOException {
        ...
        switch (t.id()) {
            ...
            case JsonTokenId.ID_NUMBER_FLOAT /* 8 */:
                JsonParser.NumberType n2 = jp.getNumberType();
