...
/* loaded from: jackson-core-2.4.2.jar:com/fasterxml/jackson/core/util/TextBuffer.class */
public final class TextBuffer {
    ...
    public char[] expandCurrentSegment() {
        char[] curr = this._currentSegment;
        int len = curr.length;
        int newLen = len == MAX_SEGMENT_LEN ? 262145 : Math.min(MAX_SEGMENT_LEN, len + (len >> 1));
