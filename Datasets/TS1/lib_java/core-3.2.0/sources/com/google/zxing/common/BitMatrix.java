...
/* loaded from: core-3.2.0.jar:com/google/zxing/common/BitMatrix.class */
public final class BitMatrix implements Cloneable {
    ...
    public int hashCode() {
        int hash = this.width;
        return (31 * ((31 * ((31 * ((31 * hash) + this.width)) + this.height)) + this.rowSize)) + Arrays.hashCode(this.bits);
    }
