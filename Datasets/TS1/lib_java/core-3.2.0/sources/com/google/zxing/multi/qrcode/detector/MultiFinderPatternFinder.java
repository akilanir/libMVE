...
/* loaded from: core-3.2.0.jar:com/google/zxing/multi/qrcode/detector/MultiFinderPatternFinder.class */
final class MultiFinderPatternFinder extends FinderPatternFinder {
    ...
    /* loaded from: core-3.2.0.jar:com/google/zxing/multi/qrcode/detector/MultiFinderPatternFinder$ModuleSizeComparator.class */
        ...
        while (true) {
            ...
            for (int j = 0; j < maxJ; j++) {
                if (image.get(j, i2)) {
                    ...
                    if (currentState == 4) {
                        if (foundPatternCross(stateCount) && handlePossibleCenter(stateCount, i2, j, pureBarcode)) {
                            currentState = 0;
                            stateCount[0] = 0;
                            stateCount[1] = 0;
                            stateCount[2] = 0;
            ...
            if (foundPatternCross(stateCount)) {
                handlePossibleCenter(stateCount, i2, maxJ, pureBarcode);
            }
            i = i2 + iSkip;
        }
