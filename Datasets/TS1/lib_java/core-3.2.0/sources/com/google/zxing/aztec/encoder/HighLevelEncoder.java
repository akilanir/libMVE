...
/* loaded from: core-3.2.0.jar:com/google/zxing/aztec/encoder/HighLevelEncoder.class */
public final class HighLevelEncoder {
    ...
    private static void updateStateForPair(State state, int index, int pairCode, Collection<State> result) {
        ...
        if (pairCode == 3 || pairCode == MODE_PUNCT) {
            State digit_state = stateNoBinary.latchAndAppend(MODE_DIGIT, 16 - pairCode).latchAndAppend(MODE_DIGIT, MODE_LOWER);
