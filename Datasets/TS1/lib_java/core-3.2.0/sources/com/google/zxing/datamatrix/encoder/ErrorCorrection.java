...
/* loaded from: core-3.2.0.jar:com/google/zxing/datamatrix/encoder/ErrorCorrection.class */
    ...
    public static String encodeECC200(String codewords, SymbolInfo symbolInfo) {
        ...
        if (blockCount == 1) {
            ...
            for (int block = 0; block < blockCount; block++) {
                ...
                while (true) {
                    int d = i2;
                    if (d >= symbolInfo.getDataCapacity()) {
                        break;
                    }
                ...
                while (true) {
                    int e = i3;
                    if (e < errorSizes[block] * blockCount) {
                        int i4 = pos;
                        pos++;
                        sb.setCharAt(symbolInfo.getDataCapacity() + e, ecc2.charAt(i4));
                        i3 = e + blockCount;
                    }
                }
            }
