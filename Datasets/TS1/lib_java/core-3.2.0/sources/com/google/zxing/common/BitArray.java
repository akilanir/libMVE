...
/* loaded from: core-3.2.0.jar:com/google/zxing/common/BitArray.class */
public final class BitArray implements Cloneable {
    ...
    public int getNextSet(int from) {
        ...
        int i = this.bits[bitsOffset] & (((1 << (from & 31)) - 1) ^ (-1));
        while (true) {
            int currentBits = i;
            if (currentBits == 0) {
                bitsOffset++;
    ...
    public int getNextUnset(int from) {
        ...
        int bitsOffset = from / 32;
        int i = (this.bits[bitsOffset] ^ (-1)) & (((1 << (from & 31)) - 1) ^ (-1));
        while (true) {
            int currentBits = i;
            if (currentBits == 0) {
                bitsOffset++;
    ...
    public void reverse() {
        ...
        for (int i = 0; i < oldBitsLen; i++) {
            long x = this.bits[i];
            long x2 = ((x >> 1) & 1431655765) | ((x & 1431655765) << 1);
            long x3 = ((x2 >> 2) & 858993459) | ((x2 & 858993459) << 2);
            long x4 = ((x3 >> 4) & 252645135) | ((x3 & 252645135) << 4);
            long x5 = ((x4 >> 8) & 16711935) | ((x4 & 16711935) << 8);
            newBits[len - i] = (int) (((x5 >> 16) & 65535) | ((x5 & 65535) << 16));
        }
