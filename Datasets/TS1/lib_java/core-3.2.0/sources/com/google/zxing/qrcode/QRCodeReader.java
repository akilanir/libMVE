...
/* loaded from: core-3.2.0.jar:com/google/zxing/qrcode/QRCodeReader.class */
public class QRCodeReader implements Reader {
    ...
    private static BitMatrix extractPureBits(BitMatrix image) throws NotFoundException {
        ...
        int nudgedTooFarRight = (left2 + ((int) ((matrixWidth - 1) * moduleSize))) - right;
        ...
        int nudgedTooFarDown = (top2 + ((int) ((matrixHeight - 1) * moduleSize))) - bottom;
        ...
        for (int y = 0; y < matrixHeight; y++) {
            ...
            for (int x = 0; x < matrixWidth; x++) {
                if (image.get(left2 + ((int) (x * moduleSize)), iOffset)) {
                    bits.set(x, y);
                }
            }
        }
