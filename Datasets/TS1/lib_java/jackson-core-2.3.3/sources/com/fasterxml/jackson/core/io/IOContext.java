...
/* loaded from: jackson-core-2.3.3.jar:com/fasterxml/jackson/core/io/IOContext.class */
public class IOContext {
    ...
    public byte[] allocReadIOBuffer(int i) {
        _verifyAlloc(this._readIOBuffer);
        byte[] allocByteBuffer = this._bufferRecycler.allocByteBuffer(BufferRecycler.ByteBufferType.READ_IO_BUFFER, i);
        this._readIOBuffer = allocByteBuffer;
        return allocByteBuffer;
    }
    ...
    public byte[] allocWriteEncodingBuffer(int i) {
        _verifyAlloc(this._writeEncodingBuffer);
        byte[] allocByteBuffer = this._bufferRecycler.allocByteBuffer(BufferRecycler.ByteBufferType.WRITE_ENCODING_BUFFER, i);
        this._writeEncodingBuffer = allocByteBuffer;
        return allocByteBuffer;
    }
