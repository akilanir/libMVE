...
/* loaded from: com.android.support.recyclerview-v7.24.0.0.jar:android/support/v7/widget/StaggeredGridLayoutManager.class */
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    private void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state, boolean shouldCheckForGaps) {
        ...
        if (shouldCheckForGaps && !state.isPreLayout()) {
            boolean needToCheckForGaps = this.mGapStrategy != 0 && getChildCount() > 0 && (this.mLaidOutInvalidFullSpan || hasGapsToFix() != null);
    ...
    private void repositionToWrapContentIfNecessary() {
        ...
        int desired = Math.round(maxSize * this.mSpanCount);
    ...
    private void measureChildWithDecorationsAndMargin(View child, int widthSpec, int heightSpec, boolean alreadyMeasured) {
        ...
        if (alreadyMeasured) {
            shouldMeasureChild = shouldReMeasureChild(child, widthSpec2, heightSpec2, lp);
        } else {
            shouldMeasureChild = shouldMeasureChild(child, widthSpec2, heightSpec2, lp);
        }
        boolean measure = shouldMeasureChild;
        if (measure) {
    ...
    /* loaded from: com.android.support.recyclerview-v7.24.0.0.jar:android/support/v7/widget/StaggeredGridLayoutManager$LayoutParams.class */
    ...
    /* loaded from: com.android.support.recyclerview-v7.24.0.0.jar:android/support/v7/widget/StaggeredGridLayoutManager$Span.class */
    class Span {
    ...
    /* loaded from: com.android.support.recyclerview-v7.24.0.0.jar:android/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup.class */
    static class LazySpanLookup {
        ...
        /* loaded from: com.android.support.recyclerview-v7.24.0.0.jar:android/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem.class */
    ...
    /* loaded from: com.android.support.recyclerview-v7.24.0.0.jar:android/support/v7/widget/StaggeredGridLayoutManager$SavedState.class */
    ...
    /* loaded from: com.android.support.recyclerview-v7.24.0.0.jar:android/support/v7/widget/StaggeredGridLayoutManager$AnchorInfo.class */
    class AnchorInfo {
        int mPosition;
        int mOffset;
