...
/* loaded from: okhttp-3.1.2.jar:okhttp3/Cookie.class */
public final class Cookie {
    ...
    public boolean matches(HttpUrl url) {
        ...
        boolean domainMatch2 = domainMatch;
        if (domainMatch2 && pathMatch(url, this.path)) {
    ...
    /* loaded from: okhttp-3.1.2.jar:okhttp3/Cookie$Builder.class */
    ...
    public int hashCode() {
        int hash = (31 * 17) + this.name.hashCode();
        return (31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * hash) + this.value.hashCode())) + this.domain.hashCode())) + this.path.hashCode())) + ((int) (this.expiresAt ^ (this.expiresAt >>> 32))))) + (this.secure ? 0 : 1))) + (this.httpOnly ? 0 : 1))) + (this.persistent ? 0 : 1))) + (this.hostOnly ? 0 : 1);
    }
}
