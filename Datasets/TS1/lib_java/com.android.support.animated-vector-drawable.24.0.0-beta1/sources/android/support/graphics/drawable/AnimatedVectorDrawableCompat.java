...
@TargetApi(21)
/* loaded from: com.android.support.animated-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/AnimatedVectorDrawableCompat.class */
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable {
    ...
    /* loaded from: com.android.support.animated-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/AnimatedVectorDrawableCompat$AnimatedVectorDrawableDelegateState.class */
    private static class AnimatedVectorDrawableDelegateState extends Drawable.ConstantState {
        ...
        /* JADX WARN: Type inference failed for: r0v0, types: [android.graphics.drawable.Drawable, android.support.graphics.drawable.AnimatedVectorDrawableCompat] */
        ...
        public Drawable newDrawable() {
            ...
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable.setCallback(((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mCallback);
        ...
        public Drawable newDrawable(Resources res) {
            ?? animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat();
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable = this.mDelegateState.newDrawable(res);
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable.setCallback(((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mCallback);
            return animatedVectorDrawableCompat;
        }
        ...
        public Drawable newDrawable(Resources res, Resources.Theme theme) {
            ?? animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat();
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable = this.mDelegateState.newDrawable(res, theme);
            ((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mDelegateDrawable.setCallback(((AnimatedVectorDrawableCompat) animatedVectorDrawableCompat).mCallback);
            return animatedVectorDrawableCompat;
        }
    ...
    /* loaded from: com.android.support.animated-vector-drawable.24.0.0-beta1.jar:android/support/graphics/drawable/AnimatedVectorDrawableCompat$AnimatedVectorDrawableCompatState.class */
        ...
        public AnimatedVectorDrawableCompatState(Context context, AnimatedVectorDrawableCompatState copy, Drawable.Callback owner, Resources res) {
            if (copy != null) {
                ...
                if (copy.mVectorDrawable != null) {
                    ...
                    if (res != null) {
                        this.mVectorDrawable = cs.newDrawable(res);
                    } else {
                        this.mVectorDrawable = cs.newDrawable();
                    }
