...
/* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/tileprovider/LRUMapTileCache.class */
public class LRUMapTileCache extends LinkedHashMap<MapTile, Drawable> {
    ...
    /* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/tileprovider/LRUMapTileCache$TileRemovedListener.class */
    ...
    public void ensureCapacity(int aCapacity) {
        if (aCapacity > this.mCapacity) {
            Log.i(IMapView.LOGTAG, "Tile cache increased from " + this.mCapacity + " to " + aCapacity);
            this.mCapacity = aCapacity;
        }
    }
