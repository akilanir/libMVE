...
/* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/tileprovider/modules/MapTileAssetsProvider.class */
public class MapTileAssetsProvider extends MapTileFileStorageProviderBase {
    ...
    public MapTileAssetsProvider(IRegisterReceiver pRegisterReceiver, AssetManager pAssets, ITileSource pTileSource) {
        this(pRegisterReceiver, pAssets, pTileSource, 8, 40);
    }
    ...
    /* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/tileprovider/modules/MapTileAssetsProvider$TileLoader.class */
