...
/* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/tileprovider/constants/OpenStreetMapTileProviderConstants.class */
public class OpenStreetMapTileProviderConstants {
    ...
    public static File TILE_PATH_BASE = new File(OSMDROID_PATH, MBTilesFileArchive.TABLE_TILES);
