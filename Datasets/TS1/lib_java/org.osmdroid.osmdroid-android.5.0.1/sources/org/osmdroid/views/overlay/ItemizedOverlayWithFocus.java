...
/* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/views/overlay/ItemizedOverlayWithFocus.class */
public class ItemizedOverlayWithFocus<Item extends OverlayItem> extends ItemizedIconOverlay<Item> {
    ...
    public void draw(Canvas c, MapView osmv, boolean shadow) {
        ...
        while (i < widths.length) {
            ...
            if (curLineWidth + charwidth > 200.0f) {
        ...
        int descBoxTop = ((descBoxBottom - 2) - ((lines.length + 1) * 12)) - 6;
