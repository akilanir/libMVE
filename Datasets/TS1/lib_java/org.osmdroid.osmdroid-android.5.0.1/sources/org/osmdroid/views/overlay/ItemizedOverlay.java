...
/* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/views/overlay/ItemizedOverlay.class */
public abstract class ItemizedOverlay<Item extends OverlayItem> extends Overlay implements Overlay.Snappable {
    ...
    /* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/views/overlay/ItemizedOverlay$OnFocusChangeListener.class */
    ...
    protected void draw(Canvas canvas, MapView mapView, boolean shadow) {
        ...
        for (int i = size; i >= 0; i--) {
            ...
            if (item != null) {
                ...
                canvas.scale(1.0f / scaleX, 1.0f / scaleY, x, y);
                marker.draw(canvas);
    ...
    /* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/views/overlay/ItemizedOverlay$1.class */
