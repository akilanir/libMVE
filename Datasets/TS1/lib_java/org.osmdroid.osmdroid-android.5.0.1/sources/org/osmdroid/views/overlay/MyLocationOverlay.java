...
/* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/views/overlay/MyLocationOverlay.class */
public class MyLocationOverlay extends Overlay implements IMyLocationOverlay, IOverlayMenuProvider, SensorEventListener, LocationListener, Overlay.Snappable {
    ...
    protected void drawMyLocation(Canvas canvas, MapView mapView, Location lastFix) {
        ...
        int zoomDiff = TileSystem.getMaximumZoomLevel() - pj.getZoomLevel();
        if (this.mDrawAccuracyEnabled) {
            float radius = lastFix.getAccuracy() / ((float) org.osmdroid.util.TileSystem.GroundResolution(lastFix.getLatitude(), mapView.getZoomLevel()));
    ...
    protected Rect getMyLocationDrawingBounds(int zoomLevel, Location lastFix, Rect reuse) {
        ...
        int zoomDiff = TileSystem.getMaximumZoomLevel() - zoomLevel;
        ...
        if (this.mDrawAccuracyEnabled) {
            int radius = (int) Math.ceil(lastFix.getAccuracy() / ((float) org.osmdroid.util.TileSystem.GroundResolution(lastFix.getLatitude(), zoomLevel)));
    ...
    public void onLocationChanged(Location location) {
        ...
        org.osmdroid.util.TileSystem.LatLongToPixelXY(location.getLatitude(), location.getLongitude(), TileSystem.getMaximumZoomLevel(), this.mMapCoords);
        int worldSize_2 = org.osmdroid.util.TileSystem.MapSize(TileSystem.getMaximumZoomLevel()) / 2;
    ...
    public void enableFollowLocation() {
        ...
        if (isMyLocationEnabled()) {
            ...
            if (this.mLocation != null) {
                org.osmdroid.util.TileSystem.LatLongToPixelXY(this.mLocation.getLatitude(), this.mLocation.getLongitude(), TileSystem.getMaximumZoomLevel(), this.mMapCoords);
                int worldSize_2 = org.osmdroid.util.TileSystem.MapSize(TileSystem.getMaximumZoomLevel()) / 2;
                this.mMapCoords.offset(-worldSize_2, -worldSize_2);
