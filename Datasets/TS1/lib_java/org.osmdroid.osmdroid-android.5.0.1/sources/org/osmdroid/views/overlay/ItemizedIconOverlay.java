...
/* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/views/overlay/ItemizedIconOverlay.class */
public class ItemizedIconOverlay<Item extends OverlayItem> extends ItemizedOverlay<Item> {
    ...
    /* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/views/overlay/ItemizedIconOverlay$ActiveItem.class */
    public interface ActiveItem {
        boolean run(int i);
    }

    /* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:org/osmdroid/views/overlay/ItemizedIconOverlay$OnItemGestureListener.class */
