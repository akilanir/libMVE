...
/* loaded from: org.osmdroid.osmdroid-android.5.0.1.jar:microsoft/mappoint/TileSystem.class */
public final class TileSystem {
    ...
    public static void setTileSize(int tileSize) {
        int pow2 = (int) (Math.log(tileSize) / Math.log(2.0d));
    ...
    public static int MapSize(int levelOfDetail) {
        return mTileSize << (levelOfDetail < getMaximumZoomLevel() ? levelOfDetail : getMaximumZoomLevel());
    }
