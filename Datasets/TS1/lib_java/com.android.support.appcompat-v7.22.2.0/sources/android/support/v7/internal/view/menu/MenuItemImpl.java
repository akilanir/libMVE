...
/* loaded from: com.android.support.appcompat-v7.22.2.0.jar:android/support/v7/internal/view/menu/MenuItemImpl.class */
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public SupportMenuItem m13setActionView(View view) {
    ...
    /* renamed from: setActionView, reason: merged with bridge method [inline-methods] */
    public SupportMenuItem m12setActionView(int resId) {
        Context context = this.mMenu.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        m13setActionView(inflater.inflate(resId, (ViewGroup) new LinearLayout(context), false));
        return this;
    }
    ...
    public SupportMenuItem m14setShowAsActionFlags(int actionEnum) {
