...
/* loaded from: com.android.support.support-vector-drawable.23.2.0.jar:android/support/graphics/drawable/AndroidResources.class */
class AndroidResources {
    ...
    static final int[] styleable_VectorDrawableTypeArray = {R.attr.name, R.attr.tint, R.attr.height, R.attr.width, R.attr.alpha, R.attr.autoMirrored, R.attr.mode, R.attr.viewportWidth, R.attr.viewportHeight};
