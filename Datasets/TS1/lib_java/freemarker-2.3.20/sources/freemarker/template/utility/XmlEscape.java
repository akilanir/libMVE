...
/* loaded from: freemarker-2.3.20.jar:freemarker/template/utility/XmlEscape.class */
public class XmlEscape implements TemplateTransformModel {
    ...
    public Writer getWriter(Writer out, Map args) {
        return new Writer(this, out) { // from class: freemarker.template.utility.XmlEscape.1
