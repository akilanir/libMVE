...
/* loaded from: freemarker-2.3.20.jar:freemarker/ext/jsp/EventForwarding.class */
public class EventForwarding implements ServletContextAttributeListener, ServletContextListener, HttpSessionListener, HttpSessionAttributeListener {
    ...
    private void addListener(EventListener listener) {
        ...
        if (!added) {
            logger.warn(new StringBuffer().append("Listener of class ").append(listener.getClass().getName()).append("wasn't registered as it doesn't implement any of the ").append("recognized listener interfaces.").toString());
        }
    }
