...
/* loaded from: osmdroid-android-4.3.jar:org/osmdroid/tileprovider/modules/MapTileModuleProviderBase.class */
public abstract class MapTileModuleProviderBase implements OpenStreetMapTileProviderConstants {
    ...
    /* loaded from: osmdroid-android-4.3.jar:org/osmdroid/tileprovider/modules/MapTileModuleProviderBase$TileLoader.class */
            ...
            while (true) {
                ...
                if (state != null) {
                    try {
                        ...
                        MapTileModuleProviderBase.logger.info("Tile loader can't continue: " + state.getMapTile(), e);
                        MapTileModuleProviderBase.this.clearQueue();
                    } catch (Throwable e2) {
                        MapTileModuleProviderBase.logger.error("Error downloading tile: " + state.getMapTile(), e2);
                    }
                    if (result == null) {
    ...
    /* loaded from: osmdroid-android-4.3.jar:org/osmdroid/tileprovider/modules/MapTileModuleProviderBase$CantContinueException.class */
