...
/* loaded from: osmdroid-android-4.3.jar:org/osmdroid/views/overlay/ItemizedIconOverlay.class */
public class ItemizedIconOverlay<Item extends OverlayItem> extends ItemizedOverlay<Item> {
    ...
    /* loaded from: osmdroid-android-4.3.jar:org/osmdroid/views/overlay/ItemizedIconOverlay$ActiveItem.class */
    public interface ActiveItem {
        boolean run(int i);
    }

    /* loaded from: osmdroid-android-4.3.jar:org/osmdroid/views/overlay/ItemizedIconOverlay$OnItemGestureListener.class */
