...
/* loaded from: osmdroid-android-4.3.jar:org/osmdroid/ResourceProxy.class */
public interface ResourceProxy {

    /* loaded from: osmdroid-android-4.3.jar:org/osmdroid/ResourceProxy$bitmap.class */
    public enum bitmap {
        unknown,
        center,
        direction_arrow,
    ...
    /* loaded from: osmdroid-android-4.3.jar:org/osmdroid/ResourceProxy$string.class */
    public enum string {
        mapnik,
        cyclemap,
        public_transport,
