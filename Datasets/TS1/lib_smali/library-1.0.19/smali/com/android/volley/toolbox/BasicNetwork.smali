...
.method public performRequest(Lcom/android/volley/Request;)Lcom/android/volley/NetworkResponse;
    ...
    :try_end_9b
    .catch Ljava/net/SocketTimeoutException; {:try_start_c .. :try_end_9b} :catch_1af
    .catch Lorg/apache/http/conn/ConnectTimeoutException; {:try_start_c .. :try_end_9b} :catch_dc
    .catch Ljava/net/MalformedURLException; {:try_start_c .. :try_end_9b} :catch_ed
    .catch Ljava/io/IOException; {:try_start_c .. :try_end_9b} :catch_10f
    ...
    if-lt v13, v2, :cond_b1

    const/16 v2, 0x12b

    if-le v13, v2, :cond_ca
    ...
    .catch Lorg/apache/http/conn/ConnectTimeoutException; {:try_start_9c .. :try_end_b7} :catch_1ac
    .catch Ljava/net/MalformedURLException; {:try_start_9c .. :try_end_b7} :catch_1a9
    .catch Ljava/io/IOException; {:try_start_9c .. :try_end_b7} :catch_1a6
    ...
    new-array v10, v2, [B
    :try_end_c9
    .catch Ljava/net/SocketTimeoutException; {:try_start_c7 .. :try_end_c9} :catch_1af
    .catch Lorg/apache/http/conn/ConnectTimeoutException; {:try_start_c7 .. :try_end_c9} :catch_dc
    .catch Ljava/net/MalformedURLException; {:try_start_c7 .. :try_end_c9} :catch_ed
    .catch Ljava/io/IOException; {:try_start_c7 .. :try_end_c9} :catch_10f
    ...
    :try_end_d9
    .catch Ljava/net/SocketTimeoutException; {:try_start_ca .. :try_end_d9} :catch_b7
    .catch Lorg/apache/http/conn/ConnectTimeoutException; {:try_start_ca .. :try_end_d9} :catch_1ac
    .catch Ljava/net/MalformedURLException; {:try_start_ca .. :try_end_d9} :catch_1a9
    .catch Ljava/io/IOException; {:try_start_ca .. :try_end_d9} :catch_1a6
    ...
    if-eq v13, v2, :cond_155

    const/16 v2, 0x193

    if-ne v13, v2, :cond_182
    ...
    if-eq v13, v2, :cond_18a

    const/16 v2, 0x12e

    if-ne v13, v2, :cond_198
    ...
    invoke-direct {v3, v12}, Lcom/android/volley/RedirectError;-><init>(Lcom/android/volley/NetworkResponse;)V
