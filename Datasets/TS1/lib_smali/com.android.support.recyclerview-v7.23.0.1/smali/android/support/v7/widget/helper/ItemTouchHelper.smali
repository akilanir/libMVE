...
.method private scrollIfNecessary()Z
    ...
    iget-object v3, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mSelected:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    iget-wide v3, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mDragScrollStartTimeInMs:J
    ...
    .line 700
    .local v21, "lm":Landroid/support/v7/widget/RecyclerView$LayoutManager;
    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mTmpRect:Landroid/graphics/Rect;
    ...
    iput-object v3, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mTmpRect:Landroid/graphics/Rect;
    ...
    iget-object v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mTmpRect:Landroid/graphics/Rect;

    move-object/from16 v0, v21

    invoke-virtual {v0, v3, v4}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->calculateItemDecorationsForChild(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 706
    invoke-virtual/range {v21 .. v21}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollHorizontally()Z
    ...
    iget-object v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mRecyclerView:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 720
    .end local v18    # "curX":I
    .end local v20    # "leftDiff":I
    :cond_77
    :goto_77
    invoke-virtual/range {v21 .. v21}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->canScrollVertically()Z
    ...
    iget v3, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mSelectedStartY:F

    move-object/from16 v0, p0

    iget v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mDy:F
    ...
    .line 733
    .end local v19    # "curY":I
    .end local v25    # "topDiff":I
    :cond_a8
    :goto_a8
    if-eqz v6, :cond_c8
    ...
    iget-object v3, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mCallback:Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;
    ...
    invoke-virtual/range {v3 .. v9}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->interpolateOutOfBoundsScroll(Landroid/support/v7/widget/RecyclerView;IIIJ)I
    ...
    iget-object v10, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mCallback:Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;
    ...
    invoke-virtual/range {v10 .. v16}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->interpolateOutOfBoundsScroll(Landroid/support/v7/widget/RecyclerView;IIIJ)I
    ...
    invoke-virtual {v3, v6, v13}, Landroid/support/v7/widget/RecyclerView;->scrollBy(II)V
    ...
    .end local v8    # "scrollDuration":J
    .end local v13    # "scrollY":I
    .end local v21    # "lm":Landroid/support/v7/widget/RecyclerView$LayoutManager;
    :cond_107
    move-object/from16 v0, p0
    ...
    .restart local v8    # "scrollDuration":J
    .restart local v13    # "scrollY":I
    .restart local v18    # "curX":I
    .restart local v20    # "leftDiff":I
    .restart local v21    # "lm":Landroid/support/v7/widget/RecyclerView$LayoutManager;
    :cond_10f
    move-object/from16 v0, p0
    ...
    .end local v18    # "curX":I
    .end local v20    # "leftDiff":I
    .end local v24    # "rightDiff":I
    .restart local v19    # "curY":I
    .restart local v25    # "topDiff":I
    :cond_144
    move-object/from16 v0, p0
...
.method private select(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    iget v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mActionState:I
    ...
    iget v7, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mActionState:I

    .line 542
    .local v7, "prevActionState":I
    const/4 v4, 0x1
    ...
    invoke-direct {v0, v1, v4}, Landroid/support/v7/widget/helper/ItemTouchHelper;->endRecoverAnimation(Landroid/support/v7/widget/RecyclerView$ViewHolder;Z)I
    ...
    iput-object v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mOverdrawChild:Landroid/view/View;
    ...
    .line 557
    .local v5, "prevSelected":Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    iget-object v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mTmpPosition:[F

    move-object/from16 v0, p0

    invoke-direct {v0, v4}, Landroid/support/v7/widget/helper/ItemTouchHelper;->getSelectedDxDy([F)V
    ...
    invoke-direct/range {v3 .. v13}, Landroid/support/v7/widget/helper/ItemTouchHelper$3;-><init>(Landroid/support/v7/widget/helper/ItemTouchHelper;Landroid/support/v7/widget/RecyclerView$ViewHolder;IIFFFFILandroid/support/v7/widget/RecyclerView$ViewHolder;)V

    .line 620
    .local v3, "rv":Landroid/support/v7/widget/helper/ItemTouchHelper$RecoverAnimation;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v4, v13, v6, v0, v1}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->getAnimationDuration(Landroid/support/v7/widget/RecyclerView;IFF)J
    ...
    invoke-virtual {v3, v0, v1}, Landroid/support/v7/widget/helper/ItemTouchHelper$RecoverAnimation;->setDuration(J)V

    .line 623
    move-object/from16 v0, p0

    iget-object v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mRecoverAnimations:Ljava/util/List;

    invoke-interface {v4, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 624
    invoke-virtual {v3}, Landroid/support/v7/widget/helper/ItemTouchHelper$RecoverAnimation;->start()V

    .line 625
    const/16 v17, 0x1

    .line 630
    .end local v3    # "rv":Landroid/support/v7/widget/helper/ItemTouchHelper$RecoverAnimation;
    .end local v6    # "animationType":I
    .end local v8    # "currentTranslateX":F
    .end local v9    # "currentTranslateY":F
    .end local v10    # "targetTranslateX":F
    .end local v11    # "targetTranslateY":F
    .end local v12    # "swipeDir":I
    ...
    iput-object v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mSelected:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    .line 632
    .end local v5    # "prevSelected":Landroid/support/v7/widget/RecyclerView$ViewHolder;
    :cond_b0
    if-eqz p1, :cond_fb
    ...
    invoke-virtual {v4, v13, v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->getAbsoluteMovementFlags(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    iget v13, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mActionState:I
    ...
    iput v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mSelectedFlags:I
    ...
    iput v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mSelectedStartX:F
    ...
    iput v4, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mSelectedStartY:F
    ...
    invoke-virtual {v4, v13}, Landroid/view/View;->performHapticFeedback(I)Z
    ...
    .line 645
    .local v18, "rvParent":Landroid/view/ViewParent;
    if-eqz v18, :cond_111
    ...
    invoke-virtual {v4}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->requestSimpleAnimationsInNextLayout()V
    ...
    iget-object v13, v0, Landroid/support/v7/widget/helper/ItemTouchHelper;->mSelected:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v4, v13, v0}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->onSelectedChanged(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    .line 558
    .end local v18    # "rvParent":Landroid/view/ViewParent;
    .restart local v5    # "prevSelected":Landroid/support/v7/widget/RecyclerView$ViewHolder;
    :cond_13a
    move-object/from16 v0, p0

    invoke-direct {v0, v5}, Landroid/support/v7/widget/helper/ItemTouchHelper;->swipeIfNecessary(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    ...
    .line 569
    .restart local v12    # "swipeDir":I
    :sswitch_142
    const/4 v11, 0x0

    .line 570
    .restart local v11    # "targetTranslateY":F
    move-object/from16 v0, p0
    ...
    mul-float v10, v4, v13

    .line 571
    .restart local v10    # "targetTranslateX":F
    goto/16 :goto_63
    ...
    invoke-direct {v0, v4}, Landroid/support/v7/widget/helper/ItemTouchHelper;->removeChildDrawingOrderCallbackIfNecessary(Landroid/view/View;)V
    ...
    invoke-virtual {v4, v13, v5}, Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;->clearView(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;)V

    goto/16 :goto_ab

    .line 646
    .end local v5    # "prevSelected":Landroid/support/v7/widget/RecyclerView$ViewHolder;
    .restart local v18    # "rvParent":Landroid/view/ViewParent;
    :cond_18a
    const/4 v4, 0x0
