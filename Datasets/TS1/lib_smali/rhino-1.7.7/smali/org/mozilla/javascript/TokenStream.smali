...
.method private static stringToKeyword(Ljava/lang/String;)I
    ...
    packed-switch v67, :pswitch_data_49c
    ...
    sparse-switch v67, :sswitch_data_4b6
    ...
    sparse-switch v67, :sswitch_data_4d0
    ...
    packed-switch v67, :pswitch_data_4f6
    ...
    sparse-switch v67, :sswitch_data_522
    ...
    sparse-switch v67, :sswitch_data_54c
    ...
    sparse-switch v67, :sswitch_data_566
...
.method final getToken()I
    ...
    :try_end_346
    .catch Ljava/lang/NumberFormatException; {:try_start_343 .. :try_end_346} :catch_34f
    ...
    if-eq v4, v0, :cond_376

    const/16 v21, 0x27

    move/from16 v0, v21

    if-ne v4, v0, :cond_4c7
    ...
    if-eq v4, v0, :cond_3a2

    const/16 v21, -0x1

    move/from16 v0, v21

    if-ne v4, v0, :cond_3c2
    ...
    .line 528
    sparse-switch v4, :sswitch_data_82e
    ...
    if-gt v0, v4, :cond_41c

    const/16 v21, 0x38

    move/from16 v0, v21

    if-ge v4, v0, :cond_41c
    ...
    if-gt v0, v4, :cond_415

    const/16 v21, 0x38

    move/from16 v0, v21

    if-ge v4, v0, :cond_415
    ...
    .end local v19    # "str":Ljava/lang/String;
    :cond_4c7
    sparse-switch v4, :sswitch_data_854
