...
.method private pruneAndGetAllocationCount(Lokhttp3/internal/io/RealConnection;J)I
    ...
    iput-wide v3, p1, Lokhttp3/internal/io/RealConnection;->idleAtNanos:J
...
.method cleanup(J)J
    ...
    .line 182
    .local v5, "inUseConnectionCount":I
    const/4 v2, 0x0
    ...
    .line 187
    .local v7, "longestIdleDurationNs":J
    monitor-enter p0

    .line 188
    :try_start_6
    iget-object v9, p0, Lokhttp3/ConnectionPool;->connections:Ljava/util/Deque;
    ...
    .line 200
    iget-wide v9, v0, Lokhttp3/internal/io/RealConnection;->idleAtNanos:J
    ...
    .end local v3    # "idleDurationNs":J
    :cond_2e
    iget-wide v9, p0, Lokhttp3/ConnectionPool;->keepAliveDurationNs:J

    cmp-long v9, v7, v9

    if-gez v9, :cond_38

    iget v9, p0, Lokhttp3/ConnectionPool;->maxIdleConnections:I
    ...
    invoke-interface {v9, v6}, Ljava/util/Deque;->remove(Ljava/lang/Object;)Z
    ...
    iput-boolean v9, p0, Lokhttp3/ConnectionPool;->cleanupRunning:Z
