...
.method static parse(JLokhttp3/HttpUrl;Ljava/lang/String;)Lokhttp3/Cookie;
    ...
    .line 234
    .local v5, "cookieValue":Ljava/lang/String;
    const-wide v6, 0xe677d21fdbffL

    .line 235
    .local v6, "expiresAt":J
    ...
    invoke-static {v0, v1, v14}, Lokhttp3/internal/Util;->trimSubstring(Ljava/lang/String;II)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v1}, Lokhttp3/Cookie;->parseExpires(Ljava/lang/String;II)J
    :try_end_99
    .catch Ljava/lang/IllegalArgumentException; {:try_start_8e .. :try_end_99} :catch_154
    ...
    .line 262
    :try_start_a9
    invoke-static/range {v17 .. v17}, Lokhttp3/Cookie;->parseMaxAge(Ljava/lang/String;)J
    :try_end_ac
    .catch Ljava/lang/NumberFormatException; {:try_start_a9 .. :try_end_ac} :catch_14e
    ...
    .line 269
    :try_start_b7
    invoke-static/range {v17 .. v17}, Lokhttp3/Cookie;->parseDomain(Ljava/lang/String;)Ljava/lang/String;
    :try_end_ba
    .catch Ljava/lang/IllegalArgumentException; {:try_start_b7 .. :try_end_ba} :catch_151
    ...
    .end local v16    # "attributePairEnd":I
    .end local v17    # "attributeValue":Ljava/lang/String;
    :cond_dc
    ...
    .line 310
    .local v23, "encodedPath":Ljava/lang/String;
    const/16 v3, 0x2f
    ...
    .line 314
    .end local v23    # "encodedPath":Ljava/lang/String;
    ...
    .line 290
    const-wide v28, 0x20c49ba5e353f7L
    ...
    mul-long v19, v21, v28

    .line 293
    .local v19, "deltaMilliseconds":J
    :goto_125
    add-long v6, p0, v19
    ...
    .line 290
    .end local v19    # "deltaMilliseconds":J
    :cond_13a
    ...
    .line 311
    .restart local v23    # "encodedPath":Ljava/lang/String;
    ...
    .end local v23    # "encodedPath":Ljava/lang/String;
    .end local v24    # "lastSlash":I
    .restart local v14    # "attributeEqualsSign":I
    .restart local v15    # "attributeName":Ljava/lang/String;
    .restart local v16    # "attributePairEnd":I
    .restart local v17    # "attributeValue":Ljava/lang/String;
    :catch_14e
    move-exception v3
