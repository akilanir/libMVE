...
.method private parseResponse(Lcom/squareup/okhttp/Response;)Lretrofit/Response;
    ...
    invoke-direct {v7, v8, v9, v10}, Lretrofit/OkHttpCall$NoContentResponseBody;-><init>(Lcom/squareup/okhttp/MediaType;J)V
...
.method public enqueue(Lretrofit/Callback;)V
    ...
    :try_end_17
    .catch Ljava/lang/Throwable; {:try_start_14 .. :try_end_17} :catch_2a
