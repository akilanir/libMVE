...
.method static constructor <clinit>()V
    ...
    .line 58
    .local v3, "keepAliveDurationString":Ljava/lang/String;
    if-eqz v3, :cond_34
    ...
    .line 62
    .local v1, "keepAliveDurationMs":J
    :goto_1b
    new-instance v6, Lokhttp3/ConnectionPool;

    sget-object v7, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-direct {v6, v4, v1, v2, v7}, Lokhttp3/ConnectionPool;-><init>(IJLjava/util/concurrent/TimeUnit;)V
    ...
    .line 49
    .end local v1    # "keepAliveDurationMs":J
    .end local v3    # "keepAliveDurationString":Ljava/lang/String;
    ...
    .restart local v3    # "keepAliveDurationString":Ljava/lang/String;
    :cond_34
