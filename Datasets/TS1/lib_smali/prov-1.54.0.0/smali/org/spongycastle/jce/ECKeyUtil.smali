...
.method public static privateToExplicitParameters(Ljava/security/PrivateKey;Ljava/security/Provider;)Ljava/security/PrivateKey;
    ...
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_24} :catch_ba
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_24} :catch_bc
    ...
    :try_end_b9
    .catch Ljava/lang/IllegalArgumentException; {:try_start_26 .. :try_end_b9} :catch_24
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_26 .. :try_end_b9} :catch_ba
    .catch Ljava/lang/Exception; {:try_start_26 .. :try_end_b9} :catch_bc
...
.method public static publicToExplicitParameters(Ljava/security/PublicKey;Ljava/security/Provider;)Ljava/security/PublicKey;
    ...
    :try_end_24
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_24} :catch_24
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_24} :catch_be
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_24} :catch_c0
    ...
    invoke-direct {v0, v8, v9, v10, v11}, Lorg/spongycastle/asn1/x9/X9ECParameters;-><init>(Lorg/spongycastle/math/ec/ECCurve;Lorg/spongycastle/math/ec/ECPoint;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    :try_end_bd
    .catch Ljava/lang/IllegalArgumentException; {:try_start_26 .. :try_end_bd} :catch_24
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_26 .. :try_end_bd} :catch_be
    .catch Ljava/lang/Exception; {:try_start_26 .. :try_end_bd} :catch_c0
