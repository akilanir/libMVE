...
.method private static checkCRL(Lorg/spongycastle/asn1/x509/DistributionPoint;Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Lorg/spongycastle/jce/provider/CertStatus;Lorg/spongycastle/jce/provider/ReasonsMask;Ljava/util/List;Lorg/spongycastle/jcajce/util/JcaJceHelper;)V
    ...
    const-string v7, "Validation time is in future."
    ...
    .line 1784
    .local v24, "validCrlFound":Z
    const/16 v23, 0x0

    .line 1785
    .local v23, "lastException":Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    invoke-static {v5, v0}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->processCRLD(Ljava/security/cert/X509CRL;Lorg/spongycastle/asn1/x509/DistributionPoint;)Lorg/spongycastle/jce/provider/ReasonsMask;

    move-result-object v20

    .line 1802
    .local v20, "interimReasonsMask":Lorg/spongycastle/jce/provider/ReasonsMask;
    ...
    .line 1808
    invoke-static/range {v5 .. v11}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->processCRLF(Ljava/security/cert/X509CRL;Ljava/lang/Object;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/util/List;Lorg/spongycastle/jcajce/util/JcaJceHelper;)Ljava/util/Set;

    move-result-object v22

    .line 1811
    .local v22, "keys":Ljava/util/Set;
    move-object/from16 v0, v22

    invoke-static {v5, v0}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->processCRLG(Ljava/security/cert/X509CRL;Ljava/util/Set;)Ljava/security/PublicKey;

    move-result-object v21

    .line 1813
    .local v21, "key":Ljava/security/PublicKey;
    const/16 v17, 0x0

    .line 1815
    .local v17, "deltaCRL":Ljava/security/cert/X509CRL;
    move-object/from16 v25, v16

    .line 1817
    .local v25, "validityDate":Ljava/util/Date;
    ...
    invoke-static {v0, v5, v6, v7}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->getDeltaCRLs(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object v18

    .line 1828
    .local v18, "deltaCRLs":Ljava/util/Set;
    ...
    .line 1844
    .end local v18    # "deltaCRLs":Ljava/util/Set;
    :cond_9d
    ...
    .end local v17    # "deltaCRL":Ljava/security/cert/X509CRL;
    .end local v20    # "interimReasonsMask":Lorg/spongycastle/jce/provider/ReasonsMask;
    .end local v21    # "key":Ljava/security/PublicKey;
    .end local v22    # "keys":Ljava/util/Set;
    .end local v25    # "validityDate":Ljava/util/Date;
    :catch_c0
    move-exception v19

    .line 1912
    .local v19, "e":Lorg/spongycastle/jce/provider/AnnotatedException;
    ...
    .line 1857
    .end local v19    # "e":Lorg/spongycastle/jce/provider/AnnotatedException;
    .restart local v5    # "crl":Ljava/security/cert/X509CRL;
    .restart local v17    # "deltaCRL":Ljava/security/cert/X509CRL;
    .restart local v20    # "interimReasonsMask":Lorg/spongycastle/jce/provider/ReasonsMask;
    .restart local v21    # "key":Ljava/security/PublicKey;
    .restart local v22    # "keys":Ljava/util/Set;
    .restart local v25    # "validityDate":Ljava/util/Date;
    :cond_c5
    move-object/from16 v0, p0

    move-object/from16 v1, p2

    invoke-static {v0, v1, v5}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->processCRLB1(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V
    ...
    invoke-static {v0, v1, v5}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->processCRLB2(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V
    ...
    invoke-static {v0, v5, v1}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->processCRLC(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)V
    ...
    invoke-static {v0, v5, v1, v2}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->processCRLJ(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/spongycastle/jce/provider/CertStatus;)V
    ...
    .line 1881
    .local v12, "criticalExtensions":Ljava/util/Set;
    if-eqz v12, :cond_132
    ...
    .line 1884
    .end local v12    # "criticalExtensions":Ljava/util/Set;
    ...
    invoke-interface {v13, v6}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z
    ...
    .restart local v12    # "criticalExtensions":Ljava/util/Set;
    :cond_132
    if-eqz v17, :cond_160

    .line 1895
    invoke-virtual/range {v17 .. v17}, Ljava/security/cert/X509CRL;->getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    throw v6
    :try_end_15f
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_47 .. :try_end_15f} :catch_c0
...
.method protected static checkCRLs(Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Ljava/util/List;Lorg/spongycastle/jcajce/util/JcaJceHelper;)V
    ...
    :try_end_f
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_f} :catch_44
    ...
    :try_end_38
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_19 .. :try_end_38} :catch_39
    ...
    :try_end_91
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_80 .. :try_end_91} :catch_a1
    ...
    :try_end_c5
    .catch Ljava/lang/Exception; {:try_start_b5 .. :try_end_c5} :catch_104
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_b5 .. :try_end_c5} :catch_10f
    ...
    :try_end_f9
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_c6 .. :try_end_f9} :catch_10f
    ...
    throw v2
    :try_end_10f
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_105 .. :try_end_10f} :catch_10f
...
.method protected static prepareCertB(Ljava/security/cert/CertPath;I[Ljava/util/List;Lorg/spongycastle/jce/provider/PKIXPolicyNode;I)Lorg/spongycastle/jce/provider/PKIXPolicyNode;
    ...
    :try_end_1d
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_14 .. :try_end_1d} :catch_7f
    ...
    :try_end_103
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_fb .. :try_end_103} :catch_16e
...
.method protected static prepareNextCertA(Ljava/security/cert/CertPath;I)V
    ...
    :try_end_15
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_c .. :try_end_15} :catch_50
...
.method protected static processCRLA1i(Ljava/util/Date;Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509CRL;)Ljava/util/Set;
    ...
    :try_end_15
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_c .. :try_end_15} :catch_47
    ...
    invoke-static {v4}, Lorg/spongycastle/asn1/x509/CRLDistPoint;->getInstance(Ljava/lang/Object;)Lorg/spongycastle/asn1/x509/CRLDistPoint;
    :try_end_21
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_18 .. :try_end_21} :catch_50
    ...
    invoke-interface {v0, v4}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z
    :try_end_3b
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_30 .. :try_end_3b} :catch_59
    ...
    :try_end_46
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_3b .. :try_end_46} :catch_62
...
.method protected static processCRLA1ii(Ljava/util/Date;Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/security/cert/X509CRL;)[Ljava/util/Set;
    ...
    :try_end_54
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_45 .. :try_end_54} :catch_77
...
.method protected static processCRLB1(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V
    ...
    :try_end_49
    .catch Ljava/io/IOException; {:try_start_38 .. :try_end_49} :catch_6e
...
.method protected static processCRLB2(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V
    ...
    :try_end_b
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_b} :catch_3f
    ...
    :try_end_6e
    .catch Ljava/lang/Exception; {:try_start_53 .. :try_end_6e} :catch_6f
    ...
    :try_end_103
    .catch Ljava/lang/Exception; {:try_start_f0 .. :try_end_103} :catch_104
    ...
    :try_end_181
    .catch Ljava/lang/Exception; {:try_start_174 .. :try_end_181} :catch_19c
...
.method protected static processCRLC(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)V
    ...
    invoke-static {p1, v6}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/spongycastle/asn1/ASN1Primitive;
    :try_end_65
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_60 .. :try_end_65} :catch_77
    ...
    invoke-static {p0, v6}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/spongycastle/asn1/ASN1Primitive;
    :try_end_6c
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_67 .. :try_end_6c} :catch_80
...
.method protected static processCRLF(Ljava/security/cert/X509CRL;Ljava/lang/Object;Ljava/security/cert/X509Certificate;Ljava/security/PublicKey;Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/util/List;Lorg/spongycastle/jcajce/util/JcaJceHelper;)Ljava/util/Set;
    ...
    :try_end_34
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_1b .. :try_end_34} :catch_79
    ...
    :try_end_ef
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_86 .. :try_end_ef} :catch_f1
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_86 .. :try_end_ef} :catch_106
    .catch Ljava/lang/Exception; {:try_start_86 .. :try_end_ef} :catch_113
    ...
    invoke-virtual {v14, v0}, Lorg/spongycastle/jcajce/PKIXExtendedParameters$Builder;->setRevocationEnabled(Z)V
    :try_end_105
    .catch Ljava/security/cert/CertPathBuilderException; {:try_start_100 .. :try_end_105} :catch_f1
    .catch Ljava/security/cert/CertPathValidatorException; {:try_start_100 .. :try_end_105} :catch_106
    .catch Ljava/lang/Exception; {:try_start_100 .. :try_end_105} :catch_113
...
.method protected static processCertA(Ljava/security/cert/CertPath;Lorg/spongycastle/jcajce/PKIXExtendedParameters;ILjava/security/PublicKey;ZLorg/spongycastle/asn1/x500/X500Name;Ljava/security/cert/X509Certificate;Lorg/spongycastle/jcajce/util/JcaJceHelper;)V
    ...
    :try_end_13
    .catch Ljava/security/GeneralSecurityException; {:try_start_c .. :try_end_13} :catch_64
    ...
    :try_end_1a
    .catch Ljava/security/cert/CertificateExpiredException; {:try_start_13 .. :try_end_1a} :catch_6d
    .catch Ljava/security/cert/CertificateNotYetValidException; {:try_start_13 .. :try_end_1a} :catch_8b
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_13 .. :try_end_1a} :catch_a9
    ...
    :try_end_2c
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_20 .. :try_end_2c} :catch_b2
...
.method protected static processCertBC(Ljava/security/cert/CertPath;ILorg/spongycastle/jce/provider/PKIXNameConstraintValidator;)V
    ...
    :try_end_27
    .catch Ljava/lang/Exception; {:try_start_20 .. :try_end_27} :catch_77
    ...
    :try_end_32
    .catch Lorg/spongycastle/jce/provider/PKIXNameConstraintValidatorException; {:try_start_28 .. :try_end_32} :catch_88
    ...
    :try_end_3e
    .catch Ljava/lang/Exception; {:try_start_33 .. :try_end_3e} :catch_99
    ...
    :try_end_74
    .catch Lorg/spongycastle/jce/provider/PKIXNameConstraintValidatorException; {:try_start_6a .. :try_end_74} :catch_aa
    ...
    :try_end_c1
    .catch Ljava/lang/Exception; {:try_start_be .. :try_end_c1} :catch_e2
    ...
    :try_end_df
    .catch Lorg/spongycastle/jce/provider/PKIXNameConstraintValidatorException; {:try_start_cd .. :try_end_df} :catch_f3
...
.method protected static processCertD(Ljava/security/cert/CertPath;ILjava/util/Set;Lorg/spongycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;I)Lorg/spongycastle/jce/provider/PKIXPolicyNode;
    ...
    :try_end_21
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_16 .. :try_end_21} :catch_76
...
.method protected static processCertE(Ljava/security/cert/CertPath;ILorg/spongycastle/jce/provider/PKIXPolicyNode;)Lorg/spongycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {v4}, Lorg/spongycastle/asn1/DERSequence;->getInstance(Ljava/lang/Object;)Lorg/spongycastle/asn1/ASN1Sequence;
    :try_end_14
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_b .. :try_end_14} :catch_19
...
.method protected static wrapupCertB(Ljava/security/cert/CertPath;II)I
    ...
    :try_end_15
    .catch Lorg/spongycastle/jce/provider/AnnotatedException; {:try_start_c .. :try_end_15} :catch_41
