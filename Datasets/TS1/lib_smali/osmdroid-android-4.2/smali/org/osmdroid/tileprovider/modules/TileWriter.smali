...
.method private cutCurrentCache()V
    ...
    .line 219
    .local v7, "z":Ljava/util/List;, "Ljava/util/List<Ljava/io/File;>;"
    const/4 v8, 0x0
    ...
    .end local v3    # "i$":I
    .end local v4    # "len$":I
    .end local v7    # "z":Ljava/util/List;, "Ljava/util/List<Ljava/io/File;>;"
    :cond_5e
    monitor-exit v9
    ...
    .restart local v7    # "z":Ljava/util/List;, "Ljava/util/List<Ljava/io/File;>;"
    :cond_60
    invoke-virtual {v1}, Ljava/io/File;->length()J
...
.method public saveFile(Lorg/osmdroid/tileprovider/tilesource/ITileSource;Lorg/osmdroid/tileprovider/MapTile;Ljava/io/InputStream;)Z
    ...
    :try_end_41
    .catch Ljava/io/IOException; {:try_start_31 .. :try_end_41} :catch_5d
    .catchall {:try_start_31 .. :try_end_41} :catchall_64
    ...
    invoke-direct {p0}, Lorg/osmdroid/tileprovider/modules/TileWriter;->cutCurrentCache()V
    :try_end_56
    .catch Ljava/io/IOException; {:try_start_41 .. :try_end_56} :catch_6e
    .catchall {:try_start_41 .. :try_end_56} :catchall_6b
