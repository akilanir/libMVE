.class Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lorg/alexd/jsonrpc/JSONRPCThreadedClient;->callLong(Ljava/lang/String;Lorg/alexd/jsonrpc/JSONRPCThreadedClient$OnLongResultListener;Lorg/json/JSONObject;)V
.end annotation
...
.method constructor <init>(Lorg/alexd/jsonrpc/JSONRPCThreadedClient;Ljava/lang/String;Lorg/json/JSONObject;Landroid/os/Handler;)V
    ...
    .prologue
    .line 1
    iput-object p1, p0, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;->this$0:Lorg/alexd/jsonrpc/JSONRPCThreadedClient;

    iput-object p2, p0, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;->val$method:Ljava/lang/String;

    iput-object p3, p0, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;->val$params:Lorg/json/JSONObject;

    iput-object p4, p0, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;->val$handler:Landroid/os/Handler;
...
.method public run()V
    ...
    :try_start_2
    iget-object v4, p0, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;->this$0:Lorg/alexd/jsonrpc/JSONRPCThreadedClient;

    iget-object v5, p0, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;->val$method:Ljava/lang/String;

    iget-object v6, p0, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;->val$params:Lorg/json/JSONObject;
    ...
    :goto_20
    iget-object v4, p0, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;->val$handler:Landroid/os/Handler;

    iget-object v5, p0, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$16;->val$handler:Landroid/os/Handler;
    ...
    invoke-direct {v2, v4, v5, v6}, Lorg/alexd/jsonrpc/JSONRPCThreadedClient$MessageObject;-><init>(Lorg/alexd/jsonrpc/JSONRPCThreadedClient;Lorg/alexd/jsonrpc/JSONRPCThreadedClient$Description;Ljava/lang/Object;)V
    :try_end_4d
    .catch Ljava/lang/NumberFormatException; {:try_start_39 .. :try_end_4d} :catch_57
    .catch Lorg/json/JSONException; {:try_start_39 .. :try_end_4d} :catch_62
