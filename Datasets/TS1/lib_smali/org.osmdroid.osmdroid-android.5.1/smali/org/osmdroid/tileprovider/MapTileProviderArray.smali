...
.method public getMapTile(Lorg/osmdroid/tileprovider/MapTile;)Landroid/graphics/drawable/Drawable;
    ...
    monitor-exit v6
    :try_end_1a
    .catchall {:try_start_13 .. :try_end_1a} :catchall_61

    .line 92
    if-nez v0, :cond_e

    .line 93
    sget-boolean v5, Lorg/osmdroid/tileprovider/constants/OpenStreetMapTileProviderConstants;->DEBUG_TILE_PROVIDERS:Z
    ...
    const-string v7, "MapTileProviderArray.getMapTile() requested but not in cache, trying from async providers: "
    ...
    monitor-exit v6
    :try_end_51
    .catchall {:try_start_3b .. :try_end_51} :catchall_64
    ...
    monitor-exit v6
    :try_end_6d
    .catchall {:try_start_67 .. :try_end_6d} :catchall_5e
