...
.method private resolveDirect()V
    ...
    .line 117
    :try_start_0
    iget-object v5, p0, Lcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver;->timingElement:Lcom/google/android/exoplayer/dash/mpd/UtcTimingElement;

    iget-object v5, v5, Lcom/google/android/exoplayer/dash/mpd/UtcTimingElement;->value:Ljava/lang/String;

    invoke-static {v5}, Lcom/google/android/exoplayer/util/Util;->parseXsDateTime(Ljava/lang/String;)J

    move-result-wide v3

    .line 118
    .local v3, "utcTimestamp":J
    iget-wide v5, p0, Lcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver;->timingElementElapsedRealtime:J

    sub-long v1, v3, v5

    .line 119
    .local v1, "elapsedRealtimeOffset":J
    iget-object v5, p0, Lcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver;->callback:Lcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver$UtcTimingCallback;
    ...
    invoke-interface {v5, v6, v1, v2}, Lcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver$UtcTimingCallback;->onTimestampResolved(Lcom/google/android/exoplayer/dash/mpd/UtcTimingElement;J)V
    :try_end_13
    .catch Ljava/text/ParseException; {:try_start_0 .. :try_end_13} :catch_14

    .line 123
    .end local v1    # "elapsedRealtimeOffset":J
    .end local v3    # "utcTimestamp":J
    :goto_13
    return-void
    ...
    invoke-interface {v5, v6, v7}, Lcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver$UtcTimingCallback;->onTimestampError(Lcom/google/android/exoplayer/dash/mpd/UtcTimingElement;Ljava/io/IOException;)V
...
.method public static resolveTimingElement(Lcom/google/android/exoplayer/upstream/UriDataSource;Lcom/google/android/exoplayer/dash/mpd/UtcTimingElement;JLcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver$UtcTimingCallback;)V
    ...
    .prologue
    .line 87
    new-instance v0, Lcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver;
    ...
    .line 89
    .local v0, "resolver":Lcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver;
    invoke-direct {v0}, Lcom/google/android/exoplayer/dash/mpd/UtcTimingElementResolver;->resolve()V
