...
.method public constructor <init>(ZLcom/google/android/exoplayer/upstream/DataSource;Ljava/lang/String;Lcom/google/android/exoplayer/hls/HlsPlaylist;Lcom/google/android/exoplayer/hls/HlsTrackSelector;Lcom/google/android/exoplayer/upstream/BandwidthMeter;Lcom/google/android/exoplayer/hls/PtsTimestampAdjusterProvider;IJJ)V
    ...
    .line 227
    .local v12, "variants":Ljava/util/List;, "Ljava/util/List<Lcom/google/android/exoplayer/hls/Variant;>;"
    ...
    invoke-direct {v2, v0, v12, v3}, Lcom/google/android/exoplayer/hls/HlsMasterPlaylist;-><init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
...
.method public getChunkOperation(Lcom/google/android/exoplayer/hls/TsChunk;JLcom/google/android/exoplayer/chunk/ChunkOperationHolder;)V
    ...
    aget-object v28, v11, v29

    .line 385
    .local v28, "mediaPlaylist":Lcom/google/android/exoplayer/hls/HlsMediaPlaylist;
    if-nez v28, :cond_45
    ...
    .end local v28    # "mediaPlaylist":Lcom/google/android/exoplayer/hls/HlsMediaPlaylist;
    .end local v29    # "nextVariantIndex":I
    :cond_22
    ...
    .line 379
    .restart local v29    # "nextVariantIndex":I
    if-eqz p1, :cond_43
    ...
    .line 391
    .restart local v10    # "switchingVariantSpliced":Z
    .restart local v28    # "mediaPlaylist":Lcom/google/android/exoplayer/hls/HlsMediaPlaylist;
    :cond_45
    move/from16 v0, v29
    ...
    check-cast v30, Lcom/google/android/exoplayer/hls/HlsMediaPlaylist$Segment;

    .line 426
    .local v30, "segment":Lcom/google/android/exoplayer/hls/HlsMediaPlaylist$Segment;
    move-object/from16 v0, v28
    ...
    .line 431
    .local v26, "keyUri":Landroid/net/Uri;
    move-object/from16 v0, p0
    ...
    .line 444
    .end local v26    # "keyUri":Landroid/net/Uri;
    :cond_144
    :goto_144
    ...
    iget v11, v0, Lcom/google/android/exoplayer/hls/HlsMediaPlaylist$Segment;->byterangeOffset:I

    int-to-long v4, v11

    move-object/from16 v0, v30

    iget v11, v0, Lcom/google/android/exoplayer/hls/HlsMediaPlaylist$Segment;->byterangeLength:I
    ...
    .line 467
    .local v27, "lastPathSegment":Ljava/lang/String;
    ...
    .end local v27    # "lastPathSegment":Ljava/lang/String;
    :cond_1ba
    ...
    .restart local v27    # "lastPathSegment":Ljava/lang/String;
    :cond_1cf
    ...
    .line 482
    .local v32, "timestampAdjuster":Lcom/google/android/exoplayer/extractor/ts/PtsTimestampAdjuster;
    if-eqz v32, :cond_21
    ...
    .end local v4    # "extractorWrapper":Lcom/google/android/exoplayer/hls/HlsExtractorWrapper;
    .end local v9    # "extractor":Lcom/google/android/exoplayer/extractor/Extractor;
    .end local v32    # "timestampAdjuster":Lcom/google/android/exoplayer/extractor/ts/PtsTimestampAdjuster;
    :cond_21c
    if-eqz p1, :cond_232
    ...
    .line 497
    .restart local v32    # "timestampAdjuster":Lcom/google/android/exoplayer/extractor/ts/PtsTimestampAdjuster;
    if-eqz v32, :cond_21
    ...
    check-cast v31, Lcom/google/android/exoplayer/hls/HlsChunkSource$ExposedTrack;

    .line 502
    .local v31, "selectedTrack":Lcom/google/android/exoplayer/hls/HlsChunkSource$ExposedTrack;
    new-instance v9, Lcom/google/android/exoplayer/extractor/ts/TsExtractor;

    move-object/from16 v0, v32

    invoke-direct {v9, v0}, Lcom/google/android/exoplayer/extractor/ts/TsExtractor;-><init>(Lcom/google/android/exoplayer/extractor/ts/PtsTimestampAdjuster;)V
    ...
    invoke-static/range {v31 .. v31}, Lcom/google/android/exoplayer/hls/HlsChunkSource$ExposedTrack;->access$200(Lcom/google/android/exoplayer/hls/HlsChunkSource$ExposedTrack;)I

    move-result v11

    # getter for: Lcom/google/android/exoplayer/hls/HlsChunkSource$ExposedTrack;->adaptiveMaxHeight:I
    invoke-static/range {v31 .. v31}, Lcom/google/android/exoplayer/hls/HlsChunkSource$ExposedTrack;->access$300(Lcom/google/android/exoplayer/hls/HlsChunkSource$ExposedTrack;)I
    ...
    .end local v4    # "extractorWrapper":Lcom/google/android/exoplayer/hls/HlsExtractorWrapper;
    .end local v9    # "extractor":Lcom/google/android/exoplayer/extractor/Extractor;
    .end local v31    # "selectedTrack":Lcom/google/android/exoplayer/hls/HlsChunkSource$ExposedTrack;
    .end local v32    # "timestampAdjuster":Lcom/google/android/exoplayer/extractor/ts/PtsTimestampAdjuster;
    :cond_268
    move-object/from16 v0, p1
