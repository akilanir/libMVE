...
.method private notifyAudioTrackUnderrun(IJJ)V
    ...
    .line 436
    iget-object v7, p0, Lcom/google/android/exoplayer/MediaCodecAudioTrackRenderer;->eventHandler:Landroid/os/Handler;

    new-instance v0, Lcom/google/android/exoplayer/MediaCodecAudioTrackRenderer$3;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/google/android/exoplayer/MediaCodecAudioTrackRenderer$3;-><init>(Lcom/google/android/exoplayer/MediaCodecAudioTrackRenderer;IJJ)V
...
.method protected getDecoderInfo(Lcom/google/android/exoplayer/MediaCodecSelector;Lcom/google/android/exoplayer/MediaFormat;Z)Lcom/google/android/exoplayer/DecoderInfo;
    ...
    .param p2, "format"    # Lcom/google/android/exoplayer/MediaFormat;
...
.method protected processOutputBuffer(JJLandroid/media/MediaCodec;Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;IZ)Z
    ...
    :try_end_81
    .catch Lcom/google/android/exoplayer/audio/AudioTrack$WriteException; {:try_start_63 .. :try_end_81} :catch_119
    ...
    .line 343
    .local v17, "e":Lcom/google/android/exoplayer/audio/AudioTrack$InitializationException;
    move-object/from16 v0, p0

    move-object/from16 v1, v17

    invoke-direct {v0, v1}, Lcom/google/android/exoplayer/MediaCodecAudioTrackRenderer;->notifyAudioTrackInitializationError(Lcom/google/android/exoplayer/audio/AudioTrack$InitializationException;)V
    ...
    .line 351
    .end local v17    # "e":Lcom/google/android/exoplayer/audio/AudioTrack$InitializationException;
    :cond_cc
    move-object/from16 v0, p0
    ...
    .end local v15    # "bufferSizeUs":J
    :catch_119
    move-exception v17

    .line 367
    .local v17, "e":Lcom/google/android/exoplayer/audio/AudioTrack$WriteException;
    move-object/from16 v0, p0

    move-object/from16 v1, v17

    invoke-direct {v0, v1}, Lcom/google/android/exoplayer/MediaCodecAudioTrackRenderer;->notifyAudioTrackWriteError(Lcom/google/android/exoplayer/audio/AudioTrack$WriteException;)V
    ...
    .line 384
    .end local v17    # "e":Lcom/google/android/exoplayer/audio/AudioTrack$WriteException;
