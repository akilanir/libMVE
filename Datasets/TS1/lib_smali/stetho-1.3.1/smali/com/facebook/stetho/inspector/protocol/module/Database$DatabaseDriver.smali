...
.method static synthetic access$300(Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseDriver;Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;)V
    .registers 2
    .param p0, "x0"    # Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseDriver;
...
.method private final onRegistered(Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;)V
    ...
    .line 340
    .local v2, "databaseParams":Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseObject;
    ...
    .line 342
    iget-object v5, p0, Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseDriver;->mContext:Landroid/content/Context;

    invoke-virtual {v5}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v5

    iput-object v5, v2, Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseObject;->domain:Ljava/lang/String;

    .line 343
    const-string v5, "N/A"

    iput-object v5, v2, Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseObject;->version:Ljava/lang/String;
    ...
    .line 345
    .local v3, "eventParams":Lcom/facebook/stetho/inspector/protocol/module/Database$AddDatabaseEvent;
    iput-object v2, v3, Lcom/facebook/stetho/inspector/protocol/module/Database$AddDatabaseEvent;->database:Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseObject;

    .line 346
    const-string v5, "Database.addDatabase"

    const/4 v6, 0x0

    invoke-virtual {p1, v5, v3, v6}, Lcom/facebook/stetho/inspector/jsonrpc/JsonRpcPeer;->invokeMethod(Ljava/lang/String;Ljava/lang/Object;Lcom/facebook/stetho/inspector/jsonrpc/PendingRequestCallback;)V

    goto :goto_8

    .line 348
    .end local v0    # "database":Ljava/lang/String;
    .end local v2    # "databaseParams":Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseObject;
    .end local v3    # "eventParams":Lcom/facebook/stetho/inspector/protocol/module/Database$AddDatabaseEvent;
    :cond_37
    return-void
.end method
