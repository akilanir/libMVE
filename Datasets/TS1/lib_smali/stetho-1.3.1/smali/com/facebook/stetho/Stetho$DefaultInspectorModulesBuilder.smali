...
.method public finish()Ljava/lang/Iterable;
    ...
    .prologue
    .line 324
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/Console;

    invoke-direct {v4}, Lcom/facebook/stetho/inspector/protocol/module/Console;-><init>()V
    ...
    .line 325
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/Debugger;

    invoke-direct {v4}, Lcom/facebook/stetho/inspector/protocol/module/Debugger;-><init>()V
    ...
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/DOM;

    invoke-direct {v4, v2}, Lcom/facebook/stetho/inspector/protocol/module/DOM;-><init>(Lcom/facebook/stetho/inspector/elements/Document;)V

    invoke-direct {p0, v4}, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->provideIfDesired(Lcom/facebook/stetho/inspector/protocol/ChromeDevtoolsDomain;)Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;

    .line 330
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/CSS;

    invoke-direct {v4, v2}, Lcom/facebook/stetho/inspector/protocol/module/CSS;-><init>(Lcom/facebook/stetho/inspector/elements/Document;)V
    ...
    :cond_2b
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/DOMStorage;

    iget-object v5, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mContext:Landroid/app/Application;

    invoke-direct {v4, v5}, Lcom/facebook/stetho/inspector/protocol/module/DOMStorage;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v4}, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->provideIfDesired(Lcom/facebook/stetho/inspector/protocol/ChromeDevtoolsDomain;)Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;

    .line 333
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/HeapProfiler;

    invoke-direct {v4}, Lcom/facebook/stetho/inspector/protocol/module/HeapProfiler;-><init>()V

    invoke-direct {p0, v4}, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->provideIfDesired(Lcom/facebook/stetho/inspector/protocol/ChromeDevtoolsDomain;)Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;

    .line 334
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/Inspector;

    invoke-direct {v4}, Lcom/facebook/stetho/inspector/protocol/module/Inspector;-><init>()V

    invoke-direct {p0, v4}, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->provideIfDesired(Lcom/facebook/stetho/inspector/protocol/ChromeDevtoolsDomain;)Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;

    .line 335
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/Network;

    iget-object v5, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mContext:Landroid/app/Application;

    invoke-direct {v4, v5}, Lcom/facebook/stetho/inspector/protocol/module/Network;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v4}, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->provideIfDesired(Lcom/facebook/stetho/inspector/protocol/ChromeDevtoolsDomain;)Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;

    .line 336
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/Page;

    iget-object v5, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mContext:Landroid/app/Application;

    invoke-direct {v4, v5}, Lcom/facebook/stetho/inspector/protocol/module/Page;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v4}, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->provideIfDesired(Lcom/facebook/stetho/inspector/protocol/ChromeDevtoolsDomain;)Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;

    .line 337
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/Profiler;

    invoke-direct {v4}, Lcom/facebook/stetho/inspector/protocol/module/Profiler;-><init>()V

    invoke-direct {p0, v4}, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->provideIfDesired(Lcom/facebook/stetho/inspector/protocol/ChromeDevtoolsDomain;)Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;

    .line 338
    new-instance v5, Lcom/facebook/stetho/inspector/protocol/module/Runtime;

    iget-object v4, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mRuntimeRepl:Lcom/facebook/stetho/inspector/console/RuntimeReplFactory;
    ...
    :goto_69
    invoke-direct {v5, v4}, Lcom/facebook/stetho/inspector/protocol/module/Runtime;-><init>(Lcom/facebook/stetho/inspector/console/RuntimeReplFactory;)V
    ...
    .line 343
    new-instance v4, Lcom/facebook/stetho/inspector/protocol/module/Worker;

    invoke-direct {v4}, Lcom/facebook/stetho/inspector/protocol/module/Worker;-><init>()V
    ...
    new-instance v5, Lcom/facebook/stetho/inspector/database/SqliteDatabaseDriver;

    iget-object v6, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mContext:Landroid/app/Application;

    iget-object v4, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mDatabaseFilesProvider:Lcom/facebook/stetho/inspector/database/DatabaseFilesProvider;
    ...
    :goto_8c
    invoke-direct {v5, v6, v4}, Lcom/facebook/stetho/inspector/database/SqliteDatabaseDriver;-><init>(Landroid/content/Context;Lcom/facebook/stetho/inspector/database/DatabaseFilesProvider;)V

    invoke-virtual {v0, v5}, Lcom/facebook/stetho/inspector/protocol/module/Database;->add(Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseDriver;)V

    .line 350
    iget-object v4, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mDatabaseDrivers:Ljava/util/List;
    ...
    .line 352
    .local v1, "databaseDriver":Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseDriver;
    ...
    .end local v1    # "databaseDriver":Lcom/facebook/stetho/inspector/protocol/module/Database$DatabaseDriver;
    :cond_ac
    new-instance v4, Lcom/facebook/stetho/inspector/runtime/RhinoDetectingRuntimeReplFactory;

    iget-object v6, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mContext:Landroid/app/Application;

    invoke-direct {v4, v6}, Lcom/facebook/stetho/inspector/runtime/RhinoDetectingRuntimeReplFactory;-><init>(Landroid/content/Context;)V
    ...
    :cond_b4
    new-instance v4, Lcom/facebook/stetho/inspector/database/DefaultDatabaseFilesProvider;

    iget-object v7, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mContext:Landroid/app/Application;

    invoke-direct {v4, v7}, Lcom/facebook/stetho/inspector/database/DefaultDatabaseFilesProvider;-><init>(Landroid/content/Context;)V
    ...
    .end local v0    # "database":Lcom/facebook/stetho/inspector/protocol/module/Database;
    :cond_bf
    iget-object v4, p0, Lcom/facebook/stetho/Stetho$DefaultInspectorModulesBuilder;->mDelegate:Lcom/facebook/stetho/Stetho$PluginBuilder;

    invoke-virtual {v4}, Lcom/facebook/stetho/Stetho$PluginBuilder;->finish()Ljava/lang/Iterable;
