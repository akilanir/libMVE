...
.method public build()Landroid/view/View;
    ...
    iget-object v4, p0, Lcom/mikepenz/materialdrawer/util/DrawerItemViewHelper;->mContext:Landroid/content/Context;
    ...
    invoke-static {v4, v5, v6}, Lcom/mikepenz/materialize/util/UIUtils;->getThemeColorFromAttrOrRes(Landroid/content/Context;II)I
    ...
    :cond_47
    iget-object v4, p0, Lcom/mikepenz/materialdrawer/util/DrawerItemViewHelper;->mDrawerItems:Ljava/util/ArrayList;
    ...
    invoke-interface {v1, v5}, Lcom/mikepenz/materialdrawer/model/interfaces/IDrawerItem;->generateView(Landroid/content/Context;)Landroid/view/View;
    ...
    invoke-static {v5}, Lcom/mikepenz/materialdrawer/util/DrawerUIUtils;->getSelectableBackground(Landroid/content/Context;)I
    ...
    .line 75
    new-instance v5, Lcom/mikepenz/materialdrawer/util/DrawerItemViewHelper$1;

    invoke-direct {v5, p0}, Lcom/mikepenz/materialdrawer/util/DrawerItemViewHelper$1;-><init>(Lcom/mikepenz/materialdrawer/util/DrawerItemViewHelper;)V
