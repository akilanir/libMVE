...
.method protected varargs throwInvalidContextType(Ljava/lang/String;Lcom/mongodb/BSONContextType;[Lcom/mongodb/BSONContextType;)V
    ...
    const-string v2, "%s can only be called when ContextType is %s, not when ContextType is %s."
...
.method protected varargs throwInvalidState(Ljava/lang/String;[Lcom/mongodb/BSONWriter$State;)V
    ...
    .line 503
    :cond_78
    const-string v4, "%s %s value cannot be written to the root level of a BSON document."
    ...
    const-string v4, "%s can only be called when State is %s, not when State is %s"
