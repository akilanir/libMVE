...
.method public constructor <init>(Ljava/lang/String;Lcom/mongodb/ClusterSettings;Lcom/mongodb/ClusterableServerFactory;Lcom/mongodb/ClusterListener;)V
    ...
    .line 52
    const-string v0, "clusterListener"
...
.method private throwIfIncompatible(Lcom/mongodb/ClusterDescription;)V
    ...
    const-string v1, "This version of the driver is not compatible with one or more of the servers to which it is connected: %s"
...
.method public getDescription(JLjava/util/concurrent/TimeUnit;)Lcom/mongodb/ClusterDescription;
    ...
    .line 117
    .local v7, "currentPhase":Ljava/util/concurrent/CountDownLatch;
    move-object/from16 v0, p0
    ...
    .line 121
    .local v11, "selectionFailureLogged":Z
    ...
    .line 123
    .local v9, "endTimeNanos":J
    move-wide v5, v12

    .line 125
    .local v5, "curTimeNanos":J
    :goto_2c
    ...
    const-string v15, "Timed out after %d ms while waiting to connect. Client view of cluster state is %s"
    ...
    throw v14
    :try_end_68
    .catch Ljava/lang/InterruptedException; {:try_start_c .. :try_end_68} :catch_68

    .line 152
    .end local v4    # "curDescription":Lcom/mongodb/ClusterDescription;
    .end local v5    # "curTimeNanos":J
    .end local v7    # "currentPhase":Ljava/util/concurrent/CountDownLatch;
    .end local v9    # "endTimeNanos":J
    .end local v11    # "selectionFailureLogged":Z
    ...
    const-string v15, "Interrupted while waiting to connect"
    ...
    .restart local v5    # "curTimeNanos":J
    .restart local v7    # "currentPhase":Ljava/util/concurrent/CountDownLatch;
    .restart local v9    # "endTimeNanos":J
    .restart local v11    # "selectionFailureLogged":Z
    ...
    const-string v15, "Cluster description not yet available. Waiting for %d ms before timing out"
    ...
    invoke-virtual {v7, v14, v15, v0}, Ljava/util/concurrent/CountDownLatch;->await(JLjava/util/concurrent/TimeUnit;)Z
    ...
    iget-object v4, v0, Lcom/mongodb/BaseCluster;->description:Lcom/mongodb/ClusterDescription;
    :try_end_db
    .catch Ljava/lang/InterruptedException; {:try_start_81 .. :try_end_db} :catch_68
...
.method public getServer(Lcom/mongodb/ServerSelector;JLjava/util/concurrent/TimeUnit;)Lcom/mongodb/Server;
    ...
    const-string v17, "Timed out after %d ms while waiting for a server that matches %s. Client view of cluster state is %s"
    ...
    throw v16
    :try_end_9a
    .catch Ljava/lang/InterruptedException; {:try_start_11 .. :try_end_9a} :catch_9a
    ...
    const-string v17, "Interrupted while waiting for a server that matches %s "
    ...
    const-string v17, "No server chosen by %s from cluster description %s. Waiting for %d ms before timing out"
    ...
    invoke-interface {v0, v4}, Lcom/mongodb/ServerSelector;->choose(Lcom/mongodb/ClusterDescription;)Ljava/util/List;
    :try_end_124
    .catch Ljava/lang/InterruptedException; {:try_start_b9 .. :try_end_124} :catch_9a
...
.method protected declared-synchronized updateDescription(Lcom/mongodb/ClusterDescription;)V
    ...
    const-string v2, "Updating cluster description to  %s"
