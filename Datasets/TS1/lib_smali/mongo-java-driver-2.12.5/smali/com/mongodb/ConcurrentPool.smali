...
.method private createNewAndReleasePermitIfFailure()Ljava/lang/Object;
    ...
    const-string v3, "The factory for the pool created a null item"
...
.method protected acquirePermit(JLjava/util/concurrent/TimeUnit;)Z
    ...
    :try_end_18
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_18} :catch_1a
    ...
    const-string v2, "Interrupted acquiring a permit to retrieve an item from the pool "
...
.method public get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    ...
    const-string v2, "The pool is closed"
    ...
    const-string v2, "Timeout waiting for a pooled item after %d %s"
...
.method public prune()V
    ...
    invoke-virtual {p0, v3, v4, v5}, Lcom/mongodb/ConcurrentPool;->acquirePermit(JLjava/util/concurrent/TimeUnit;)Z
...
.method public release(Ljava/lang/Object;Z)V
    ...
    const-string v1, "Can not return a null item to the pool"
...
.method public toString()Ljava/lang/String;
    ...
    const-string v2, " availableCount "
