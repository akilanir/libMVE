...
.method private instantiateObjectClassInstance()Lcom/mongodb/DBObject;
    ...
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_a} :catch_29
    ...
    const-string v3, "can\'t create instance of type "
...
.method private validateKey(Ljava/lang/String;)V
    ...
    const-string v2, "Document field names can\'t have a NULL character. (Bad Key: \'"
    ...
    const-string v2, "Document field names can\'t have a . in them. (Bad Key: \'"
    ...
    const-string v2, "Document field names can\'t start with \'$\' (Bad Key: \'"
...
.method protected _checkObject(Lcom/mongodb/DBObject;ZZ)Lcom/mongodb/DBObject;
    ...
    const-string v1, "can\'t save partial objects"
...
.method protected checkReadOnly(Z)Z
    ...
    const-string v1, "db is read only"
...
.method public findAndModify(Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;ZLcom/mongodb/DBObject;ZZJLjava/util/concurrent/TimeUnit;)Lcom/mongodb/DBObject;
    ...
    const-string v6, "findandmodify"

    iget-object v7, p0, Lcom/mongodb/DBCollection;->_name:Ljava/lang/String;

    invoke-direct {v3, v6, v7}, Lcom/mongodb/BasicDBObject;-><init>(Ljava/lang/String;Ljava/lang/Object;)V

    .line 428
    .local v3, "cmd":Lcom/mongodb/BasicDBObject;
    if-eqz p1, :cond_1a
    ...
    invoke-virtual {v3, v6, p1}, Lcom/mongodb/BasicDBObject;->append(Ljava/lang/String;Ljava/lang/Object;)Lcom/mongodb/BasicDBObject;
    ...
    invoke-virtual {v3, v6, p2}, Lcom/mongodb/BasicDBObject;->append(Ljava/lang/String;Ljava/lang/Object;)Lcom/mongodb/BasicDBObject;
    ...
    invoke-virtual {v3, v6, p3}, Lcom/mongodb/BasicDBObject;->append(Ljava/lang/String;Ljava/lang/Object;)Lcom/mongodb/BasicDBObject;
    ...
    invoke-virtual {v7, v0, v1, v2}, Ljava/util/concurrent/TimeUnit;->convert(JLjava/util/concurrent/TimeUnit;)J
    ...
    invoke-virtual {v3, v6, v7}, Lcom/mongodb/BasicDBObject;->append(Ljava/lang/String;Ljava/lang/Object;)Lcom/mongodb/BasicDBObject;
    ...
    .line 455
    new-instance v6, Lcom/mongodb/MongoException;

    const-string v7, "FindAndModify: Remove cannot be mixed with the Update, or returnNew params!"

    invoke-direct {v6, v7}, Lcom/mongodb/MongoException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p5, v6, v7}, Lcom/mongodb/DBCollection;->_checkObject(Lcom/mongodb/DBObject;ZZ)Lcom/mongodb/DBObject;

    .line 446
    :cond_a0
    const-string v6, "update"

    invoke-virtual {v3, v6, p5}, Lcom/mongodb/BasicDBObject;->append(Ljava/lang/String;Ljava/lang/Object;)Lcom/mongodb/BasicDBObject;
    ...
    .line 457
    :cond_bc
    iget-object v6, p0, Lcom/mongodb/DBCollection;->_db:Lcom/mongodb/DB;

    invoke-virtual {v6, v3}, Lcom/mongodb/DB;->command(Lcom/mongodb/DBObject;)Lcom/mongodb/CommandResult;

    move-result-object v5

    .line 458
    .local v5, "res":Lcom/mongodb/CommandResult;
    invoke-virtual {v5}, Lcom/mongodb/CommandResult;->ok()Z

    move-result v6

    if-nez v6, :cond_d4

    invoke-virtual {v5}, Lcom/mongodb/CommandResult;->getErrorMessage()Ljava/lang/String;

    move-result-object v6

    const-string v7, "No matching object found"
    ...
    check-cast v6, Lcom/mongodb/DBObject;

    invoke-direct {p0, v6}, Lcom/mongodb/DBCollection;->replaceWithObjectClass(Lcom/mongodb/DBObject;)Lcom/mongodb/DBObject;
...
.method findOne(Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;Lcom/mongodb/ReadPreference;JLjava/util/concurrent/TimeUnit;)Lcom/mongodb/DBObject;
    ...
    .prologue
    .line 862
    new-instance v3, Lcom/mongodb/QueryOpBuilder;

    invoke-direct {v3}, Lcom/mongodb/QueryOpBuilder;-><init>()V

    move-object/from16 v0, p1

    invoke-virtual {v3, v0}, Lcom/mongodb/QueryOpBuilder;->addQuery(Lcom/mongodb/DBObject;)Lcom/mongodb/QueryOpBuilder;

    move-result-object v3

    move-object/from16 v0, p3

    invoke-virtual {v3, v0}, Lcom/mongodb/QueryOpBuilder;->addOrderBy(Lcom/mongodb/DBObject;)Lcom/mongodb/QueryOpBuilder;
    ...
    invoke-virtual {v3, v4, v5}, Lcom/mongodb/QueryOpBuilder;->addMaxTimeMS(J)Lcom/mongodb/QueryOpBuilder;

    move-result-object v14

    .line 865
    .local v14, "queryOpBuilder":Lcom/mongodb/QueryOpBuilder;
    invoke-virtual {p0}, Lcom/mongodb/DBCollection;->getDB()Lcom/mongodb/DB;

    move-result-object v3

    invoke-virtual {v3}, Lcom/mongodb/DB;->getMongo()Lcom/mongodb/Mongo;

    move-result-object v3

    invoke-virtual {v3}, Lcom/mongodb/Mongo;->isMongosConnection()Z
    ...
    invoke-virtual {v14, v0}, Lcom/mongodb/QueryOpBuilder;->addReadPreference(Lcom/mongodb/ReadPreference;)Lcom/mongodb/QueryOpBuilder;

    .line 869
    :cond_32
    invoke-virtual {v14}, Lcom/mongodb/QueryOpBuilder;->get()Lcom/mongodb/DBObject;
    ...
    invoke-virtual {p0}, Lcom/mongodb/DBCollection;->getDecoder()Lcom/mongodb/DBDecoder;
    ...
    invoke-virtual/range {v3 .. v11}, Lcom/mongodb/DBCollection;->find(Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;IIIILcom/mongodb/ReadPreference;Lcom/mongodb/DBDecoder;)Lcom/mongodb/QueryResultIterator;

    move-result-object v12

    .line 871
    .local v12, "i":Ljava/util/Iterator;, "Ljava/util/Iterator<Lcom/mongodb/DBObject;>;"
    ...
    .line 872
    .local v13, "obj":Lcom/mongodb/DBObject;
    :goto_57
    if-eqz v13, :cond_68
    ...
    .line 873
    invoke-interface {v13}, Lcom/mongodb/DBObject;->markAsPartialObject()V
    ...
    .line 871
    .end local v13    # "obj":Lcom/mongodb/DBObject;
    :cond_69
    const/4 v13, 0x0
...
.method public getCount(Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;)J
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/mongodb/DBCollection;->getCount(Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;JJ)J
...
.method public getCount(Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;JJ)J
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/mongodb/DBCollection;->getCount(Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;JJLcom/mongodb/ReadPreference;)J
...
.method getCount(Lcom/mongodb/DBObject;Lcom/mongodb/DBObject;JJLcom/mongodb/ReadPreference;JLjava/util/concurrent/TimeUnit;)J
    ...
    invoke-direct {v3}, Lcom/mongodb/BasicDBObject;-><init>()V
    ...
    invoke-virtual {v3, v6, v7}, Lcom/mongodb/BasicDBObject;->put(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;

    .line 1175
    const-string v6, "query"

    invoke-virtual {v3, v6, p1}, Lcom/mongodb/BasicDBObject;->put(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v6, p2}, Lcom/mongodb/BasicDBObject;->put(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v6, v3, v7, v0}, Lcom/mongodb/DB;->command(Lcom/mongodb/DBObject;ILcom/mongodb/ReadPreference;)Lcom/mongodb/CommandResult;
    ...
    const-string v6, "ns does not exist"
    ...
    invoke-virtual {v5, v6}, Lcom/mongodb/CommandResult;->getLong(Ljava/lang/String;)J
...
.method public getIndexInfo()Ljava/util/List;
    ...
    const-string v4, "system.indexes"
...
.method public mapReduce(Lcom/mongodb/DBObject;)Lcom/mongodb/MapReduceOutput;
    ...
    const-string v2, "need mapreduce arg"
...
.method prepareCommand(Ljava/util/List;Lcom/mongodb/AggregationOptions;)Lcom/mongodb/DBObject;
    ...
    const-string v3, "Aggregation pipelines can not be empty"
...
.method public setObjectClass(Ljava/lang/Class;)V
    ...
    const-string v2, " is not a DBObject"
