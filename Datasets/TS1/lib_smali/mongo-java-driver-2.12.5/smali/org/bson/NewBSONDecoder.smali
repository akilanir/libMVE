...
.method private final _binary(Ljava/lang/String;)V
    ...
    const-string v10, "bad data size subtype 2 len: "
    ...
    const-string v10, "bad data size subtype 3 len: "
...
.method private final decodeElement()Z
    ...
    sparse-switch v7, :sswitch_data_1d4
    ...
    const-string v10, "BSONDecoder doesn\'t understand type : "
...
.method private final readCstr()Ljava/lang/String;
    ...
    :try_end_1b
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_12 .. :try_end_1b} :catch_1c
...
.method private final readUtf8Str()Ljava/lang/String;
    ...
    const-string v4, "String invalid - corruption"
    ...
    iput v3, p0, Lorg/bson/NewBSONDecoder;->_pos:I
    :try_end_2e
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_1c .. :try_end_2e} :catch_2f
    ...
    const-string v4, "What is in the db"
