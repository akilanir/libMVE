...
.method private isUseCache(Lcom/danikula/videocache/GetRequest;)Z
    ...
    iget-wide v5, p1, Lcom/danikula/videocache/GetRequest;->rangeOffset:J
...
.method private newResponseHeaders(Lcom/danikula/videocache/GetRequest;)Ljava/lang/String;
    ...
    iget-wide v11, p1, Lcom/danikula/videocache/GetRequest;->rangeOffset:J
    ...
    const-string v10, "Content-Type: %s\n"
...
.method private responseWithoutCache(Ljava/io/OutputStream;J)V
    ...
    invoke-direct {v2, v3}, Lcom/danikula/videocache/HttpUrlSource;-><init>(Lcom/danikula/videocache/HttpUrlSource;)V

    .line 88
    .local v2, "source":Lcom/danikula/videocache/HttpUrlSource;
    long-to-int v3, p2

    invoke-virtual {v2, v3}, Lcom/danikula/videocache/HttpUrlSource;->open(I)V
    ...
    .local v0, "buffer":[B
    :goto_f
    invoke-virtual {v2, v0}, Lcom/danikula/videocache/HttpUrlSource;->read([B)I
    ...
    invoke-virtual {v3}, Lcom/danikula/videocache/HttpUrlSource;->close()V
    ...
    .end local v2    # "source":Lcom/danikula/videocache/HttpUrlSource;
    :catchall_26
    move-exception v3

    iget-object v4, p0, Lcom/danikula/videocache/HttpProxyCache;->source:Lcom/danikula/videocache/HttpUrlSource;

    invoke-virtual {v4}, Lcom/danikula/videocache/HttpUrlSource;->close()V
...
.method protected onCachePercentsAvailableChanged(I)V
    ...
    iget-object v2, v2, Lcom/danikula/videocache/HttpUrlSource;->url:Ljava/lang/String;
