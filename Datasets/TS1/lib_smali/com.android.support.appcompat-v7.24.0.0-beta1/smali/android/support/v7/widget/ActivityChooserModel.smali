...
.method private readHistoricalDataImpl()V
    ...
    iget-object v14, v0, Landroid/support/v7/widget/ActivityChooserModel;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/support/v7/widget/ActivityChooserModel;->mHistoryFileName:Ljava/lang/String;
    ...
    throw v14
    :try_end_38
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_d .. :try_end_38} :catch_38
    .catch Ljava/io/IOException; {:try_start_d .. :try_end_38} :catch_8f
    .catchall {:try_start_d .. :try_end_38} :catchall_de
    ...
    :try_end_57
    .catchall {:try_start_39 .. :try_end_57} :catchall_de
    ...
    iget-object v4, v0, Landroid/support/v7/widget/ActivityChooserModel;->mHistoricalRecords:Ljava/util/List;
    ...
    invoke-interface {v7}, Lorg/xmlpull/v1/XmlPullParser;->next()I
    :try_end_69
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_5f .. :try_end_69} :catch_38
    .catch Ljava/io/IOException; {:try_start_5f .. :try_end_69} :catch_8f
    .catchall {:try_start_5f .. :try_end_69} :catchall_de
    ...
    throw v14
    :try_end_8f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_7b .. :try_end_8f} :catch_38
    .catch Ljava/io/IOException; {:try_start_7b .. :try_end_8f} :catch_8f
    .catchall {:try_start_7b .. :try_end_8f} :catchall_de
    ...
    :try_end_ae
    .catchall {:try_start_90 .. :try_end_ae} :catchall_de
    ...
    invoke-direct {v8, v1, v9, v10, v12}, Landroid/support/v7/widget/ActivityChooserModel$HistoricalRecord;-><init>(Ljava/lang/String;JF)V

    .line 1005
    .local v8, "readRecord":Landroid/support/v7/widget/ActivityChooserModel$HistoricalRecord;
    invoke-interface {v4, v8}, Ljava/util/List;->add(Ljava/lang/Object;)Z
    :try_end_dd
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_b9 .. :try_end_dd} :catch_38
    .catch Ljava/io/IOException; {:try_start_b9 .. :try_end_dd} :catch_8f
    .catchall {:try_start_b9 .. :try_end_dd} :catchall_de
    ...
    .end local v6    # "nodeName":Ljava/lang/String;
    .end local v7    # "parser":Lorg/xmlpull/v1/XmlPullParser;
    .end local v8    # "readRecord":Landroid/support/v7/widget/ActivityChooserModel$HistoricalRecord;
    .end local v9    # "time":J
    .end local v11    # "type":I
...
.method public setDefaultActivity(I)V
    ...
    invoke-direct {v1, v0, v7, v8, v4}, Landroid/support/v7/widget/ActivityChooserModel$HistoricalRecord;-><init>(Landroid/content/ComponentName;JF)V
