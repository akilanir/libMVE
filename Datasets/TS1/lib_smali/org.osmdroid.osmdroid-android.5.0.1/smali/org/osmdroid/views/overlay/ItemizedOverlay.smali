...
.method protected draw(Landroid/graphics/Canvas;Lorg/osmdroid/views/MapView;Z)V
    ...
    iget-boolean v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mPendingFocusChangedEvent:Z

    if-eqz v12, :cond_1c

    move-object/from16 v0, p0

    iget-object v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mOnFocusChangeListener:Lorg/osmdroid/views/overlay/ItemizedOverlay$OnFocusChangeListener;
    ...
    iget-object v13, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mFocusedItem:Lorg/osmdroid/views/overlay/OverlayItem;

    move-object/from16 v0, p0

    invoke-interface {v12, v0, v13}, Lorg/osmdroid/views/overlay/ItemizedOverlay$OnFocusChangeListener;->onFocusChanged(Lorg/osmdroid/views/overlay/ItemizedOverlay;Lorg/osmdroid/views/overlay/OverlayItem;)V
    ...
    iput-boolean v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mPendingFocusChangedEvent:Z
    ...
    iget-object v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mInternalItemList:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v2}, Lorg/osmdroid/views/overlay/ItemizedOverlay;->getItem(I)Lorg/osmdroid/views/overlay/OverlayItem;
    ...
    iget-object v13, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mCurScreenCoords:Landroid/graphics/Point;

    invoke-virtual {v5, v12, v13}, Lorg/osmdroid/views/Projection;->toPixels(Lorg/osmdroid/api/IGeoPoint;Landroid/graphics/Point;)Landroid/graphics/Point;

    .line 133
    move-object/from16 v0, p0

    iget-object v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mMatrix:Landroid/graphics/Matrix;

    move-object/from16 v0, p1

    invoke-virtual {v0, v12}, Landroid/graphics/Canvas;->getMatrix(Landroid/graphics/Matrix;)V
    ...
    iget-object v13, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mMatrixValues:[F
    ...
    iget-object v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mMatrixValues:[F
    ...
    iget-object v14, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mMatrixValues:[F
    ...
    iget-boolean v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mDrawFocusedItem:Z

    if-eqz v12, :cond_127

    move-object/from16 v0, p0

    iget-object v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mFocusedItem:Lorg/osmdroid/views/overlay/OverlayItem;

    if-ne v12, v3, :cond_127
    ...
    .local v9, "state":I
    :goto_b3
    invoke-virtual {v3, v9}, Lorg/osmdroid/views/overlay/OverlayItem;->getMarker(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v9}, Lorg/osmdroid/views/overlay/ItemizedOverlay;->getDefaultMarker(I)Landroid/graphics/drawable/Drawable;
    ...
    :goto_bf
    invoke-virtual {v3}, Lorg/osmdroid/views/overlay/OverlayItem;->getMarkerHotspot()Lorg/osmdroid/views/overlay/OverlayItem$HotspotPlace;
    ...
    invoke-virtual {v0, v4, v1}, Lorg/osmdroid/views/overlay/ItemizedOverlay;->boundToHotspot(Landroid/graphics/drawable/Drawable;Lorg/osmdroid/views/overlay/OverlayItem$HotspotPlace;)Landroid/graphics/drawable/Drawable;

    .line 151
    move-object/from16 v0, p0

    iget-object v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mCurScreenCoords:Landroid/graphics/Point;
    ...
    iget-object v12, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mRect:Landroid/graphics/Rect;

    invoke-virtual {v4, v12}, Landroid/graphics/drawable/Drawable;->copyBounds(Landroid/graphics/Rect;)V
    ...
    iget-object v13, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mRect:Landroid/graphics/Rect;
    ...
    iget-object v14, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mRect:Landroid/graphics/Rect;
    ...
    iget-object v15, v0, Lorg/osmdroid/views/overlay/ItemizedOverlay;->mRect:Landroid/graphics/Rect;
