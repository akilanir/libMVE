...
.method public static extractJarFileURL(Ljava/net/URL;)Ljava/net/URL;
    ...
    :try_end_17
    .catch Ljava/net/MalformedURLException; {:try_start_12 .. :try_end_17} :catch_18
...
.method public static getFile(Ljava/lang/String;)Ljava/io/File;
    ...
    :try_end_66
    .catch Ljava/net/MalformedURLException; {:try_start_5e .. :try_end_66} :catch_68
...
.method public static getFile(Ljava/net/URL;Ljava/lang/String;)Ljava/io/File;
    ...
    :try_end_41
    .catch Ljava/net/URISyntaxException; {:try_start_34 .. :try_end_41} :catch_42
...
.method public static getURL(Ljava/lang/String;)Ljava/net/URL;
    ...
    invoke-direct {v4, p0}, Ljava/net/URL;-><init>(Ljava/lang/String;)V
    :try_end_58
    .catch Ljava/net/MalformedURLException; {:try_start_53 .. :try_end_58} :catch_59
    ...
    :try_end_66
    .catch Ljava/net/MalformedURLException; {:try_start_5a .. :try_end_66} :catch_68
...
.method public static isUrl(Ljava/lang/String;)Z
    ...
    :try_end_14
    .catch Ljava/net/MalformedURLException; {:try_start_f .. :try_end_14} :catch_16
