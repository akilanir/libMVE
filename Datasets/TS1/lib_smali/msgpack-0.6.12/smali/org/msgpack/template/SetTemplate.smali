...
.method public constructor <init>(Lorg/msgpack/template/Template;)V
    ...
    .prologue
    .line 31
    .local p0, "this":Lorg/msgpack/template/SetTemplate;, "Lorg/msgpack/template/SetTemplate<TE;>;"
...
.method public read(Lorg/msgpack/unpacker/Unpacker;Ljava/util/Set;Z)Ljava/util/Set;
    ...
    .prologue
    .local p0, "this":Lorg/msgpack/template/SetTemplate;, "Lorg/msgpack/template/SetTemplate<TE;>;"
    .local p2, "to":Ljava/util/Set;, "Ljava/util/Set<TE;>;"
    const/4 v3, 0x0
    ...
    .end local p2    # "to":Ljava/util/Set;, "Ljava/util/Set<TE;>;"
    invoke-direct {p2, v2}, Ljava/util/HashSet;-><init>(I)V

    .line 66
    .restart local p2    # "to":Ljava/util/Set;, "Ljava/util/Set<TE;>;"
    :goto_15
    const/4 v1, 0x0
    ...
    .line 67
    iget-object v4, p0, Lorg/msgpack/template/SetTemplate;->elementTemplate:Lorg/msgpack/template/Template;
...
.method public write(Lorg/msgpack/packer/Packer;Ljava/util/Set;Z)V
    ...
    .line 37
    .local p0, "this":Lorg/msgpack/template/SetTemplate;, "Lorg/msgpack/template/SetTemplate<TE;>;"
    .local p2, "target":Ljava/util/Set;, "Ljava/util/Set<TE;>;"
