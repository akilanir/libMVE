...
.method private static parseFourCcVc1Private(Lcom/google/android/exoplayer/util/ParsableByteArray;)Ljava/util/List;
    ...
    .restart local v1    # "compression":J
    :cond_32
    :try_start_32
...
.method public initializeOutput(Lcom/google/android/exoplayer/extractor/ExtractorOutput;IJ)V
    ...
    :cond_e
    :goto_e
    packed-switch v1, :pswitch_data_3fe
    ...
    .line 1358
    .local v19, "format":Lcom/google/android/exoplayer/MediaFormat;
    :goto_151
    move-object/from16 v0, p0
    ...
    .end local v19    # "format":Lcom/google/android/exoplayer/MediaFormat;
    :pswitch_169
    ...
    .line 1242
    .local v20, "h264Data":Landroid/util/Pair;, "Landroid/util/Pair<Ljava/util/List<[B>;Ljava/lang/Integer;>;"
    ...
    .line 1246
    .end local v2    # "mimeType":Ljava/lang/String;
    .end local v20    # "h264Data":Landroid/util/Pair;, "Landroid/util/Pair<Ljava/util/List<[B>;Ljava/lang/Integer;>;"
    :pswitch_1a6
    ...
    .line 1249
    .local v21, "hevcData":Landroid/util/Pair;, "Landroid/util/Pair<Ljava/util/List<[B>;Ljava/lang/Integer;>;"
    ...
    .line 1253
    .end local v2    # "mimeType":Ljava/lang/String;
    .end local v21    # "hevcData":Landroid/util/Pair;, "Landroid/util/Pair<Ljava/util/List<[B>;Ljava/lang/Integer;>;"
    :pswitch_1cb
    ...
    iget v5, v0, Lcom/google/android/exoplayer/extractor/webm/WebmExtractor$Track;->audioBitDepth:I
    ...
    iget v3, v0, Lcom/google/android/exoplayer/extractor/webm/WebmExtractor$Track;->displayWidth:I
    ...
    iget v3, v0, Lcom/google/android/exoplayer/extractor/webm/WebmExtractor$Track;->width:I

    move-object/from16 v0, p0

    iget v5, v0, Lcom/google/android/exoplayer/extractor/webm/WebmExtractor$Track;->displayHeight:I
    ...
    invoke-static/range {v1 .. v11}, Lcom/google/android/exoplayer/MediaFormat;->createVideoFormat(Ljava/lang/String;Ljava/lang/String;IIJIILjava/util/List;IF)Lcom/google/android/exoplayer/MediaFormat;

    move-result-object v19

    .line 1347
    .restart local v19    # "format":Lcom/google/android/exoplayer/MediaFormat;
    goto/16 :goto_151
    ...
    invoke-static/range {v12 .. v18}, Lcom/google/android/exoplayer/MediaFormat;->createImageFormat(Ljava/lang/String;Ljava/lang/String;IJLjava/util/List;Ljava/lang/String;)Lcom/google/android/exoplayer/MediaFormat;
    ...
    .sparse-switch
        ...
        -0x76567dc0 -> :sswitch_f6
        -0x6a615338 -> :sswitch_ba
        -0x672350af -> :sswitch_74
        -0x585f4fcd -> :sswitch_96
        -0x51dc40b2 -> :sswitch_69
        -0x2016c535 -> :sswitch_41
        -0x2016c4e5 -> :sswitch_55
        -0x19552dbd -> :sswitch_11a
        -0x1538b2ba -> :sswitch_de
        0x3c02325 -> :sswitch_8a
        0x3c02353 -> :sswitch_a2
        0x3c030c5 -> :sswitch_c6
        0x4e86155 -> :sswitch_19
        0x4e86156 -> :sswitch_23
        0x5e8da3e -> :sswitch_126
        0x2056f406 -> :sswitch_d2
        0x2b453ce4 -> :sswitch_102
        0x32fdf009 -> :sswitch_5f
        0x54c61e47 -> :sswitch_10e
        0x6bd6c624 -> :sswitch_2d
        0x7446132a -> :sswitch_ae
        0x7446b0a6 -> :sswitch_ea
        0x744ad97d -> :sswitch_7f
    .end sparse-switch
