...
.method private endNalUnit(JIIJ)V
    ...
    invoke-virtual {v3}, Lcom/google/android/exoplayer/extractor/ts/H264Reader$SampleReader;->needsSpsPps()Z
    ...
    invoke-virtual {v3, v0}, Lcom/google/android/exoplayer/extractor/ts/NalUnitTargetBuffer;->endNalUnit(I)Z
    ...
    iget v4, v4, Lcom/google/android/exoplayer/extractor/ts/NalUnitTargetBuffer;->nalLength:I
    ...
    invoke-static {v3}, Lcom/google/android/exoplayer/util/NalUnitUtil;->parseSpsNalUnit(Lcom/google/android/exoplayer/util/ParsableBitArray;)Lcom/google/android/exoplayer/util/NalUnitUtil$SpsData;

    move-result-object v15

    .line 173
    .local v15, "spsData":Lcom/google/android/exoplayer/util/NalUnitUtil$SpsData;
    move-object/from16 v0, p0
    ...
    .line 174
    .local v14, "ppsData":Lcom/google/android/exoplayer/util/NalUnitUtil$PpsData;
    move-object/from16 v0, p0
    ...
    iget v9, v15, Lcom/google/android/exoplayer/util/NalUnitUtil$SpsData;->width:I

    iget v10, v15, Lcom/google/android/exoplayer/util/NalUnitUtil$SpsData;->height:I

    const/4 v12, -0x1

    iget v13, v15, Lcom/google/android/exoplayer/util/NalUnitUtil$SpsData;->pixelWidthAspectRatio:F
    ...
    invoke-interface {v0, v3}, Lcom/google/android/exoplayer/extractor/TrackOutput;->format(Lcom/google/android/exoplayer/MediaFormat;)V
    ...
    invoke-virtual {v3, v15}, Lcom/google/android/exoplayer/extractor/ts/H264Reader$SampleReader;->putSps(Lcom/google/android/exoplayer/util/NalUnitUtil$SpsData;)V
    ...
    invoke-virtual {v3, v14}, Lcom/google/android/exoplayer/extractor/ts/H264Reader$SampleReader;->putPps(Lcom/google/android/exoplayer/util/NalUnitUtil$PpsData;)V
    ...
    invoke-virtual {v3}, Lcom/google/android/exoplayer/extractor/ts/NalUnitTargetBuffer;->reset()V
    ...
    .end local v14    # "ppsData":Lcom/google/android/exoplayer/util/NalUnitUtil$PpsData;
    .end local v15    # "spsData":Lcom/google/android/exoplayer/util/NalUnitUtil$SpsData;
    :cond_bd
    :goto_bd
    move-object/from16 v0, p0
    ...
    invoke-static {v3, v4}, Lcom/google/android/exoplayer/util/NalUnitUtil;->unescapeStream([BI)I

    move-result v16

    .line 196
    .local v16, "unescapedLength":I
    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/google/android/exoplayer/extractor/ts/H264Reader;->seiWrapper:Lcom/google/android/exoplayer/util/ParsableByteArray;
    ...
    iget-object v3, v0, Lcom/google/android/exoplayer/extractor/ts/H264Reader;->seiReader:Lcom/google/android/exoplayer/extractor/ts/SeiReader;
    ...
    invoke-virtual {v3, v0, v1, v4}, Lcom/google/android/exoplayer/extractor/ts/SeiReader;->consume(JLcom/google/android/exoplayer/util/ParsableByteArray;)V

    .line 200
    .end local v16    # "unescapedLength":I
    :cond_fd
    move-object/from16 v0, p0
    ...
    invoke-virtual {v3, v0, v1, v2}, Lcom/google/android/exoplayer/extractor/ts/H264Reader$SampleReader;->endNalUnit(JI)V
    ...
    .line 186
    .restart local v15    # "spsData":Lcom/google/android/exoplayer/util/NalUnitUtil$SpsData;
    move-object/from16 v0, p0
    ...
    .line 190
    .restart local v14    # "ppsData":Lcom/google/android/exoplayer/util/NalUnitUtil$PpsData;
    move-object/from16 v0, p0
...
.method public consume(Lcom/google/android/exoplayer/util/ParsableByteArray;)V
    ...
    iget-object v11, v0, Lcom/google/android/exoplayer/util/ParsableByteArray;->data:[B

    .line 103
    .local v11, "dataArray":[B
    move-object/from16 v0, p0

    iget-wide v5, v0, Lcom/google/android/exoplayer/extractor/ts/H264Reader;->totalBytesWritten:J
    ...
    iput-wide v5, v0, Lcom/google/android/exoplayer/extractor/ts/H264Reader;->totalBytesWritten:J
    ...
    invoke-static {v11, v15, v13, v1}, Lcom/google/android/exoplayer/util/NalUnitUtil;->findNalUnit([BII[Z)I
    ...
    invoke-direct {v0, v11, v15, v13}, Lcom/google/android/exoplayer/extractor/ts/H264Reader;->nalUnitData([BII)V

    .line 138
    .end local v11    # "dataArray":[B
    ...
    .line 117
    .restart local v11    # "dataArray":[B
    .restart local v13    # "limit":I
    .restart local v14    # "nalUnitOffset":I
    .restart local v15    # "offset":I
    :cond_3d
    invoke-static {v11, v14}, Lcom/google/android/exoplayer/util/NalUnitUtil;->getNalUnitType([BI)I
    ...
    invoke-direct {v0, v11, v15, v14}, Lcom/google/android/exoplayer/extractor/ts/H264Reader;->nalUnitData([BII)V
    ...
    iget-wide v6, v0, Lcom/google/android/exoplayer/extractor/ts/H264Reader;->pesTimeUs:J
    ...
    iget-wide v9, v0, Lcom/google/android/exoplayer/extractor/ts/H264Reader;->pesTimeUs:J

    move-object/from16 v5, p0

    move-wide v6, v2

    invoke-direct/range {v5 .. v10}, Lcom/google/android/exoplayer/extractor/ts/H264Reader;->startNalUnit(JIJ)V
