...
.method private constructor <init>(FZ)V
    ...
    .line 80
    iput-wide v1, p0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->vsyncDurationNs:J

    .line 81
    iput-wide v1, p0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->vsyncOffsetNs:J
...
.method public adjustReleaseTime(JJ)J
    ...
    .line 117
    .local v17, "framePresentationTimeNs":J
    ...
    .line 120
    .local v5, "adjustedReleaseTimeNs":J
    move-object/from16 v0, p0

    iget-boolean v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->haveSync:Z
    ...
    iget-wide v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->lastFramePresentationTimeUs:J
    ...
    iget-wide v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->frameCount:J
    ...
    iput-wide v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->frameCount:J

    .line 124
    move-object/from16 v0, p0

    iget-wide v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->pendingAdjustedFrameTimeNs:J

    move-object/from16 v0, p0

    iput-wide v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->adjustedLastFrameTimeNs:J
    ...
    iget-wide v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->syncFramePresentationTimeNs:J

    sub-long v7, v17, v7

    move-object/from16 v0, p0

    iget-wide v9, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->frameCount:J
    ...
    iget-wide v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->adjustedLastFrameTimeNs:J

    add-long v15, v7, v13

    .line 136
    .local v15, "candidateAdjustedFrameTimeNs":J
    move-object/from16 v0, p0
    ...
    iput-boolean v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->haveSync:Z

    .line 153
    .end local v13    # "averageFrameDurationNs":J
    .end local v15    # "candidateAdjustedFrameTimeNs":J
    :cond_55
    :goto_55
    move-object/from16 v0, p0
    ...
    iput-wide v11, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->pendingAdjustedFrameTimeNs:J

    .line 164
    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->vsyncSampler:Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper$VSyncSampler;
    ...
    iget-wide v7, v7, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper$VSyncSampler;->sampledVsyncTimeNs:J
    ...
    .line 172
    .end local v5    # "adjustedReleaseTimeNs":J
    :cond_91
    :goto_91
    return-wide v5

    .line 139
    .restart local v5    # "adjustedReleaseTimeNs":J
    .restart local v13    # "averageFrameDurationNs":J
    .restart local v15    # "candidateAdjustedFrameTimeNs":J
    :cond_92
    move-wide v11, v15
    ...
    iget-wide v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->syncUnadjustedReleaseTimeNs:J

    add-long/2addr v7, v11

    move-object/from16 v0, p0

    iget-wide v9, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->syncFramePresentationTimeNs:J
    ...
    iget-wide v9, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->vsyncDurationNs:J

    invoke-static/range {v5 .. v10}, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->closestVsync(JJJ)J

    move-result-wide v19

    .line 172
    .local v19, "snappedTimeNs":J
    move-object/from16 v0, p0

    iget-wide v7, v0, Lcom/google/android/exoplayer/VideoFrameReleaseTimeHelper;->vsyncOffsetNs:J
