...
.method public static read(Landroid/content/Context;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {v21 .. v22}, Ljava/lang/StringBuilder;->append(C)Ljava/lang/StringBuilder;
    :try_end_e6
    .catch Ljava/lang/SecurityException; {:try_start_0 .. :try_end_e6} :catch_e7
    .catch Ljava/lang/NoSuchMethodException; {:try_start_0 .. :try_end_e6} :catch_1c4
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_e6} :catch_1d6
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_e6} :catch_1e2
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_0 .. :try_end_e6} :catch_1ee
    .catch Ljava/lang/NoSuchFieldException; {:try_start_0 .. :try_end_e6} :catch_1fa
    ...
    sget-object v21, Lorg/acra/ACRA;->log:Lorg/acra/log/ACRALog;

    sget-object v22, Lorg/acra/ACRA;->LOG_TAG:Ljava/lang/String;

    const-string v23, "DropBoxManager not available."

    invoke-interface/range {v21 .. v23}, Lorg/acra/log/ACRALog;->i(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual/range {v21 .. v22}, Ljava/lang/StringBuilder;->append(C)Ljava/lang/StringBuilder;
    :try_end_1c3
    .catch Ljava/lang/SecurityException; {:try_start_f5 .. :try_end_1c3} :catch_e7
    .catch Ljava/lang/NoSuchMethodException; {:try_start_f5 .. :try_end_1c3} :catch_1c4
    .catch Ljava/lang/IllegalArgumentException; {:try_start_f5 .. :try_end_1c3} :catch_1d6
    .catch Ljava/lang/IllegalAccessException; {:try_start_f5 .. :try_end_1c3} :catch_1e2
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_f5 .. :try_end_1c3} :catch_1ee
    .catch Ljava/lang/NoSuchFieldException; {:try_start_f5 .. :try_end_1c3} :catch_1fa
    ...
    :try_end_1d3
    .catch Ljava/lang/SecurityException; {:try_start_1d0 .. :try_end_1d3} :catch_e7
    .catch Ljava/lang/NoSuchMethodException; {:try_start_1d0 .. :try_end_1d3} :catch_1c4
    .catch Ljava/lang/IllegalArgumentException; {:try_start_1d0 .. :try_end_1d3} :catch_1d6
    .catch Ljava/lang/IllegalAccessException; {:try_start_1d0 .. :try_end_1d3} :catch_1e2
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_1d0 .. :try_end_1d3} :catch_1ee
    .catch Ljava/lang/NoSuchFieldException; {:try_start_1d0 .. :try_end_1d3} :catch_1fa
