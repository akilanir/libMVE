...
.method private static implSTRandomPrime(Lorg/spongycastle/crypto/Digest;I[B)Lorg/spongycastle/math/Primes$STOutput;
    ...
    invoke-static {v0, v1, v7, v2}, Lorg/spongycastle/math/Primes;->hash(Lorg/spongycastle/crypto/Digest;[B[BI)V
    ...
    invoke-static {v0, v1, v9, v2}, Lorg/spongycastle/math/Primes;->hash(Lorg/spongycastle/crypto/Digest;[B[BI)V
    ...
    .line 503
    new-instance v22, Lorg/spongycastle/math/Primes$STOutput;
    ...
    .restart local v7    # "c0":[B
    .restart local v9    # "c1":[B
    .restart local v10    # "c64":J
    :cond_7e
    mul-int/lit8 v22, p1, 0x4
    ...
    const-string v23, "Too many iterations in Shawe-Taylor Random_Prime Routine"
    ...
    .end local v9    # "c1":[B
    .end local v10    # "c64":J
    .end local v17    # "primeGenCounter":I
    :cond_8e
    ...
    .line 515
    .local v18, "rec":Lorg/spongycastle/math/Primes$STOutput;
    invoke-virtual/range {v18 .. v18}, Lorg/spongycastle/math/Primes$STOutput;->getPrime()Ljava/math/BigInteger;

    move-result-object v7

    .line 516
    .local v7, "c0":Ljava/math/BigInteger;
    invoke-virtual/range {v18 .. v18}, Lorg/spongycastle/math/Primes$STOutput;->getPrimeSeed()[B

    move-result-object p2

    .line 517
    invoke-virtual/range {v18 .. v18}, Lorg/spongycastle/math/Primes$STOutput;->getPrimeGenCounter()I

    move-result v17

    .line 519
    .restart local v17    # "primeGenCounter":I
    ...
    sget-object v22, Lorg/spongycastle/math/Primes;->ONE:Ljava/math/BigInteger;

    add-int/lit8 v23, p1, -0x1

    invoke-virtual/range {v22 .. v23}, Ljava/math/BigInteger;->shiftLeft(I)Ljava/math/BigInteger;
    ...
    invoke-virtual/range {v22 .. v23}, Ljava/math/BigInteger;->setBit(I)Ljava/math/BigInteger;
    ...
    .line 528
    .local v8, "c0x2":Ljava/math/BigInteger;
    sget-object v22, Lorg/spongycastle/math/Primes;->ONE:Ljava/math/BigInteger;
    ...
    .line 529
    .local v19, "tx2":Ljava/math/BigInteger;
    const/4 v13, 0x0
    ...
    .line 553
    invoke-static {v6}, Lorg/spongycastle/math/Primes;->implHasAnySmallFactors(Ljava/math/BigInteger;)Z
    ...
    sget-object v22, Lorg/spongycastle/math/Primes;->THREE:Ljava/math/BigInteger;
    ...
    sget-object v23, Lorg/spongycastle/math/Primes;->TWO:Ljava/math/BigInteger;
    ...
    .line 563
    .local v21, "z":Ljava/math/BigInteger;
    sget-object v22, Lorg/spongycastle/math/Primes;->ONE:Ljava/math/BigInteger;
    ...
    invoke-virtual {v0, v7, v6}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v0, v6, v1, v2, v3}, Lorg/spongycastle/math/Primes$STOutput;-><init>(Ljava/math/BigInteger;[BILorg/spongycastle/math/Primes$1;)V

    goto/16 :goto_7d

    .line 570
    .end local v5    # "a":Ljava/math/BigInteger;
    .end local v21    # "z":Ljava/math/BigInteger;
    :cond_1aa
    add-int/lit8 v22, v14, 0x1
