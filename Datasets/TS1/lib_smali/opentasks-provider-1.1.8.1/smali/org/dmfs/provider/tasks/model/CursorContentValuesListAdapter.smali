.class public Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;
.super Lorg/dmfs/provider/tasks/model/AbstractListAdapter;
...
.method public constructor <init>(JLandroid/database/Cursor;Landroid/content/ContentValues;)V
    ...
    invoke-direct {p0}, Lorg/dmfs/provider/tasks/model/AbstractListAdapter;-><init>()V

    iput-wide p1, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mId:J

    iput-object p3, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mCursor:Landroid/database/Cursor;

    iput-object p4, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mValues:Landroid/content/ContentValues;
...
.method public commit(Landroid/database/sqlite/SQLiteDatabase;)I
    ...
    iget-object v0, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mValues:Landroid/content/ContentValues;
    ...
    iget-object v1, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mValues:Landroid/content/ContentValues;
    ...
    iget-wide v3, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mId:J
...
.method public bridge synthetic duplicate()Lorg/dmfs/provider/tasks/model/EntityAdapter;
    ...
    invoke-virtual {p0}, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->duplicate()Lorg/dmfs/provider/tasks/model/ListAdapter;
...
.method public duplicate()Lorg/dmfs/provider/tasks/model/ListAdapter;
    .registers 6
    ...
    iget-object v2, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mCursor:Landroid/database/Cursor;
    ...
    iget-object v3, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mCursor:Landroid/database/Cursor;
    ...
    iget-object v4, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mCursor:Landroid/database/Cursor;
    ...
    :cond_30
    new-instance v0, Lorg/dmfs/provider/tasks/model/ContentValuesListAdapter;

    invoke-direct {v0, v1}, Lorg/dmfs/provider/tasks/model/ContentValuesListAdapter;-><init>(Landroid/content/ContentValues;)V
...
.method public id()J
    ...
    iget-wide v0, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mId:J
...
.method public oldValueOf(Lorg/dmfs/provider/tasks/model/adapters/FieldAdapter;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lorg/dmfs/provider/tasks/model/CursorContentValuesListAdapter;->mCursor:Landroid/database/Cursor;
