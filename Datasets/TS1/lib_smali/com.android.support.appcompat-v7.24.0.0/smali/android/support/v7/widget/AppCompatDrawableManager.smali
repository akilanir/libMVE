...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 290
    iget-object v13, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Landroid/support/v4/util/ArrayMap;
    ...
    .line 291
    iget-object v13, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/util/SparseArray;
    ...
    .line 293
    .local v2, "cachedTagName":Ljava/lang/String;
    ...
    .line 371
    .end local v2    # "cachedTagName":Ljava/lang/String;
    :cond_2d
    :goto_2d
    return-object v4
    ...
    iput-object v13, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/util/SparseArray;

    .line 308
    :cond_35
    iget-object v13, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mTypedValue:Landroid/util/TypedValue;
    ...
    iput-object v13, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mTypedValue:Landroid/util/TypedValue;

    .line 311
    :cond_40
    iget-object v11, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mTypedValue:Landroid/util/TypedValue;
    ...
    invoke-virtual {v9, v0, v11, v13}, Landroid/content/res/Resources;->getValue(ILandroid/util/TypedValue;Z)V

    .line 315
    invoke-static {v11}, Landroid/support/v7/widget/AppCompatDrawableManager;->createCacheKey(Landroid/util/TypedValue;)J
    ...
    invoke-direct {p0, v0, v6, v7}, Landroid/support/v7/widget/AppCompatDrawableManager;->getCachedDrawable(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    const-string v14, "No start tag found"

    invoke-direct {v13, v14}, Lorg/xmlpull/v1/XmlPullParserException;-><init>(Ljava/lang/String;)V

    throw v13
    :try_end_89
    .catch Ljava/lang/Exception; {:try_start_6a .. :try_end_89} :catch_89
    ...
    invoke-virtual {v13, v0, v14}, Landroid/util/SparseArray;->append(ILjava/lang/Object;)V
    ...
    .line 347
    .local v3, "delegate":Landroid/support/v7/widget/AppCompatDrawableManager$InflateDelegate;
    if-eqz v3, :cond_bc
    ...
    invoke-interface {v3, v0, v8, v1, v13}, Landroid/support/v7/widget/AppCompatDrawableManager$InflateDelegate;->createFromXmlInner(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    .line 353
    iget v13, v11, Landroid/util/TypedValue;->changingConfigurations:I

    invoke-virtual {v4, v13}, Landroid/graphics/drawable/Drawable;->setChangingConfigurations(I)V

    .line 354
    move-object/from16 v0, p1

    invoke-direct {p0, v0, v6, v7, v4}, Landroid/support/v7/widget/AppCompatDrawableManager;->addDrawableToCache(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    :try_end_c8
    .catch Ljava/lang/Exception; {:try_start_9d .. :try_end_c8} :catch_89
    ...
    .line 371
    .end local v1    # "attrs":Landroid/util/AttributeSet;
    .end local v3    # "delegate":Landroid/support/v7/widget/AppCompatDrawableManager$InflateDelegate;
